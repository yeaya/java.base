...
class HostLocaleProviderAdapterImpl$9 : public ::java::util::spi::LocaleNameProvider {
	$class(HostLocaleProviderAdapterImpl$9, $NO_CLASS_INIT, ::java::util::spi::LocaleNameProvider)
public:
