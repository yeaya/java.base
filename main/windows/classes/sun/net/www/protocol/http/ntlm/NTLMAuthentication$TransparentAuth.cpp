...
void NTLMAuthentication$TransparentAuth::clinit$($Class* clazz) {
...
$Class* NTLMAuthentication$TransparentAuth::load$($String* name, bool initialize) {
	...
	$loadClass(NTLMAuthentication$TransparentAuth, name, initialize, &classInfo$$, NTLMAuthentication$TransparentAuth::clinit$, []($Class* clazz) -> $Object* {
