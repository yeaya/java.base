...
$MethodInfo _WindowsAsynchronousFileChannelImpl$ReadTask_MethodInfo_[] = {
	...
	{"<init>", "(Lsun/nio/ch/WindowsAsynchronousFileChannelImpl;Ljava/nio/ByteBuffer;IIJLsun/nio/ch/PendingFuture;)V", "(Ljava/nio/ByteBuffer;IIJLsun/nio/ch/PendingFuture<Ljava/lang/Integer;TA;>;)V", 0, $method(static_cast<void(WindowsAsynchronousFileChannelImpl$ReadTask::*)($WindowsAsynchronousFileChannelImpl*,$ByteBuffer*,int32_t,int32_t,int64_t,$PendingFuture*)>(&WindowsAsynchronousFileChannelImpl$ReadTask::init$))},
