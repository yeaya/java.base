...
class $export WindowsAsynchronousFileChannelImpl : public ::sun::nio::ch::AsynchronousFileChannelImpl, public ::sun::nio::ch::Iocp$OverlappedChannel, public ::sun::nio::ch::Groupable {
