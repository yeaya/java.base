...
$MethodInfo _ProcessEnvironment_MethodInfo_[] = {
	...
	{"<init>", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(ProcessEnvironment::*)(int32_t)>(&ProcessEnvironment::init$))},
	{"addToEnv", "(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($StringBuilder*,$String*,$String*)>(&ProcessEnvironment::addToEnv))},
	{"addToEnvIfSet", "(Ljava/lang/StringBuilder;Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($StringBuilder*,$String*)>(&ProcessEnvironment::addToEnvIfSet))},
	...
	{"environmentBlock", "()Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $NATIVE, $method(static_cast<$String*(*)()>(&ProcessEnvironment::environmentBlock))},
	...
	{"nonNullString", "(Ljava/lang/Object;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(Object$*)>(&ProcessEnvironment::nonNullString))},
	{"put", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(ProcessEnvironment::*)($String*,$String*)>(&ProcessEnvironment::put))},
	...
	{"toEnvironmentBlock", "()Ljava/lang/String;", nullptr, 0, $method(static_cast<$String*(ProcessEnvironment::*)()>(&ProcessEnvironment::toEnvironmentBlock))},
	{"toEnvironmentBlock", "(Ljava/util/Map;)Ljava/lang/String;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Ljava/lang/String;", $STATIC, $method(static_cast<$String*(*)($Map*)>(&ProcessEnvironment::toEnvironmentBlock))},
	{"validateName", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&ProcessEnvironment::validateName))},
	{"validateValue", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&ProcessEnvironment::validateValue))},
