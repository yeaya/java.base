...
$Class* CgroupV1Subsystem$$Lambda$convertStringToLong::load$($String* name, bool initialize) {
	...
	$loadClass(CgroupV1Subsystem$$Lambda$convertStringToLong, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CgroupV1Subsystem$$Lambda$convertStringToLong);
	});
	return class$;
}
...
int64_t CgroupV1Subsystem::getLongValue($CgroupSubsystemController* controller, $String* parm) {
	$init(CgroupV1Subsystem);
	return $CgroupSubsystemController::getLongValue(controller, parm, $$new(CgroupV1Subsystem$$Lambda$convertStringToLong), $CgroupSubsystem::LONG_RETVAL_UNLIMITED);
}
...
int64_t CgroupV1Subsystem::getMemoryAndSwapFailCount() {
	if (this->memory != nullptr && !this->memory->isSwapEnabled()) {
...
void CgroupV1Subsystem::clinit$($Class* clazz) {
	$assignStatic(CgroupV1Subsystem::PROVIDER_NAME, "cgroupv1"_s);
}

$Class* CgroupV1Subsystem::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("jdk.internal.platform.cgroupv1.CgroupV1Subsystem$$Lambda$convertStringToLong")) {
	...
	$loadClass(CgroupV1Subsystem, name, initialize, &classInfo$$, CgroupV1Subsystem::clinit$, []($Class* clazz) -> $Object* {
