...
$MethodInfo CgroupV1Subsystem$$Lambda$convertStringToLong::methodInfos[3] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CgroupV1Subsystem$$Lambda$convertStringToLong::*)()>(&CgroupV1Subsystem$$Lambda$convertStringToLong::init$))},
...
$MethodInfo _CgroupV1Subsystem_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(CgroupV1Subsystem::*)()>(&CgroupV1Subsystem::init$))},
	...
	{"getHierarchical", "(Ljdk/internal/platform/cgroupv1/CgroupV1MemorySubSystemController;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($CgroupV1MemorySubSystemController*)>(&CgroupV1Subsystem::getHierarchical))},
	{"getInstance", "(Ljava/util/Map;)Ljdk/internal/platform/cgroupv1/CgroupV1Subsystem;", "(Ljava/util/Map<Ljava/lang/String;Ljdk/internal/platform/CgroupInfo;>;)Ljdk/internal/platform/cgroupv1/CgroupV1Subsystem;", $PUBLIC | $STATIC, $method(static_cast<CgroupV1Subsystem*(*)($Map*)>(&CgroupV1Subsystem::getInstance))},
	...
	{"getLongValue", "(Ljdk/internal/platform/CgroupSubsystemController;Ljava/lang/String;)J", nullptr, $PRIVATE | $STATIC, $method(static_cast<int64_t(*)($CgroupSubsystemController*,$String*)>(&CgroupV1Subsystem::getLongValue))},
	...
	{"getSwapEnabled", "(Ljdk/internal/platform/cgroupv1/CgroupV1MemorySubSystemController;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($CgroupV1MemorySubSystemController*)>(&CgroupV1Subsystem::getSwapEnabled))},
	...
	{"initSubSystem", "(Ljava/util/Map;)Ljdk/internal/platform/cgroupv1/CgroupV1Subsystem;", "(Ljava/util/Map<Ljava/lang/String;Ljdk/internal/platform/CgroupInfo;>;)Ljdk/internal/platform/cgroupv1/CgroupV1Subsystem;", $PRIVATE | $STATIC, $method(static_cast<CgroupV1Subsystem*(*)($Map*)>(&CgroupV1Subsystem::initSubSystem))},
	{"isCpuSetMemoryPressureEnabled", "()Ljava/lang/Boolean;", nullptr, $PUBLIC},
	{"isMemoryOOMKillEnabled", "()Ljava/lang/Boolean;", nullptr, $PUBLIC},
	{"setBlkIOController", "(Ljdk/internal/platform/cgroupv1/CgroupV1SubsystemController;)V", nullptr, $PRIVATE, $method(static_cast<void(CgroupV1Subsystem::*)($CgroupV1SubsystemController*)>(&CgroupV1Subsystem::setBlkIOController))},
	{"setCpuAcctController", "(Ljdk/internal/platform/cgroupv1/CgroupV1SubsystemController;)V", nullptr, $PRIVATE, $method(static_cast<void(CgroupV1Subsystem::*)($CgroupV1SubsystemController*)>(&CgroupV1Subsystem::setCpuAcctController))},
	{"setCpuController", "(Ljdk/internal/platform/cgroupv1/CgroupV1SubsystemController;)V", nullptr, $PRIVATE, $method(static_cast<void(CgroupV1Subsystem::*)($CgroupV1SubsystemController*)>(&CgroupV1Subsystem::setCpuController))},
	{"setCpuSetController", "(Ljdk/internal/platform/cgroupv1/CgroupV1SubsystemController;)V", nullptr, $PRIVATE, $method(static_cast<void(CgroupV1Subsystem::*)($CgroupV1SubsystemController*)>(&CgroupV1Subsystem::setCpuSetController))},
	{"setMemorySubSystem", "(Ljdk/internal/platform/cgroupv1/CgroupV1MemorySubSystemController;)V", nullptr, $PRIVATE, $method(static_cast<void(CgroupV1Subsystem::*)($CgroupV1MemorySubSystemController*)>(&CgroupV1Subsystem::setMemorySubSystem))},
