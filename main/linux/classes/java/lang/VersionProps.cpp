...
void clinit$VersionProps($Class* class$) {
	...
	$assignStatic(VersionProps::java_runtime_version, "17-internal+0-adhoc.yaoy.jdk-jdk-17-35"_s);
	...
	$assignStatic(VersionProps::VERSION_OPT, "adhoc.yaoy.jdk-jdk-17-35"_s);
	...
	VersionProps::isLTS = "adhoc.yaoy.jdk-jdk-17-35"_s->startsWith("LTS"_s);
