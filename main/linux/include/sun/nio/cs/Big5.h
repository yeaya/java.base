#ifndef _sun_nio_cs_Big5_h_
#define _sun_nio_cs_Big5_h_
//$ class sun.nio.cs.Big5
...
class $import Big5 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
