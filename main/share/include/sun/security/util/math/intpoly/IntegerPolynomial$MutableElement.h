...
class $import IntegerPolynomial$MutableElement : public ::sun::security::util::math::intpoly::IntegerPolynomial$Element, public ::sun::security::util::math::MutableIntegerModuloP {
