#ifndef _sun_nio_cs_IBM737_h_
#define _sun_nio_cs_IBM737_h_
//$ class sun.nio.cs.IBM737
...
class $import IBM737 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM737, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM737();
