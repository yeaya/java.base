#ifndef _sun_nio_cs_IBM850_h_
#define _sun_nio_cs_IBM850_h_
//$ class sun.nio.cs.IBM850
...
class $import IBM850 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM850, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM850();
