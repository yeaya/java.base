#ifndef _sun_nio_cs_IBM866_h_
#define _sun_nio_cs_IBM866_h_
//$ class sun.nio.cs.IBM866
...
class $import IBM866 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM866, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM866();
