#ifndef _sun_nio_cs_MS950_h_
#define _sun_nio_cs_MS950_h_
//$ class sun.nio.cs.MS950
...
class $import MS950 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
