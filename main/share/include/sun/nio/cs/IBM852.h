#ifndef _sun_nio_cs_IBM852_h_
#define _sun_nio_cs_IBM852_h_
//$ class sun.nio.cs.IBM852
...
class $import IBM852 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM852, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM852();
