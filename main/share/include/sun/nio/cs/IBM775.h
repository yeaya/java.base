#ifndef _sun_nio_cs_IBM775_h_
#define _sun_nio_cs_IBM775_h_
//$ class sun.nio.cs.IBM775
...
class $import IBM775 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM775, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM775();
