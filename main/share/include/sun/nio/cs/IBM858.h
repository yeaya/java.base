#ifndef _sun_nio_cs_IBM858_h_
#define _sun_nio_cs_IBM858_h_
//$ class sun.nio.cs.IBM858
...
class $import IBM858 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM858, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM858();
