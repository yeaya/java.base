#ifndef _sun_nio_cs_MS1252_h_
#define _sun_nio_cs_MS1252_h_
...
class $import MS1252 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(MS1252, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	MS1252();
