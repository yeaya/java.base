#ifndef _sun_nio_cs_IBM857_h_
#define _sun_nio_cs_IBM857_h_
//$ class sun.nio.cs.IBM857
...
class $import IBM857 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM857, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM857();
