#ifndef _sun_nio_cs_MS1251_h_
#define _sun_nio_cs_MS1251_h_
//$ class sun.nio.cs.MS1251
...
class $import MS1251 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(MS1251, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	MS1251();
