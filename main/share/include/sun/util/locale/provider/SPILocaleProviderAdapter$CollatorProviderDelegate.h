...
class $import SPILocaleProviderAdapter$CollatorProviderDelegate : public ::java::text::spi::CollatorProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
