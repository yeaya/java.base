...
class $import SPILocaleProviderAdapter$DecimalFormatSymbolsProviderDelegate : public ::java::text::spi::DecimalFormatSymbolsProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
