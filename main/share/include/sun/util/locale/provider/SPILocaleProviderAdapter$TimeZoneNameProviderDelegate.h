...
class $import SPILocaleProviderAdapter$TimeZoneNameProviderDelegate : public ::java::util::spi::TimeZoneNameProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
