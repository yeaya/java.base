...
class $import RandomSupport$AbstractArbitrarilyJumpableGenerator : public ::jdk::internal::util::random::RandomSupport$AbstractSpliteratorGenerator, public ::java::util::random::RandomGenerator$ArbitrarilyJumpableGenerator {
