...
class $import RandomSupport$AbstractArbitrarilyJumpableGenerator$RandomJumpsSpliterator : public ::jdk::internal::util::random::RandomSupport$RandomSpliterator, public ::java::util::Spliterator {
