#ifndef _jdk_internal_org_objectweb_asm$_tree_MethodNode_h_
#define _jdk_internal_org_objectweb_asm$_tree_MethodNode_h_
//$ class jdk.internal.org.objectweb.asm.tree.MethodNode
...
class $import MethodNode : public ::jdk::internal::org::objectweb::asm$::MethodVisitor {
	$class(MethodNode, $NO_CLASS_INIT, ::jdk::internal::org::objectweb::asm$::MethodVisitor)
public:
	MethodNode();
	void init$();
	void init$(int32_t api);
	void init$(int32_t access, $String* name, $String* descriptor, $String* signature, $StringArray* exceptions);
	void init$(int32_t api, int32_t access, $String* name, $String* descriptor, $String* signature, $StringArray* exceptions);
	...
	virtual ::jdk::internal::org::objectweb::asm$::tree::LabelNode* getLabelNode(::jdk::internal::org::objectweb::asm$::Label* label);
	$Array<::jdk::internal::org::objectweb::asm$::tree::LabelNode>* getLabelNodes($Array<::jdk::internal::org::objectweb::asm$::Label>* labels);
	$ObjectArray* getLabelNodes($ObjectArray* objects);
	...
	::java::util::List* exceptions = nullptr;
	...
	$Object* annotationDefault = nullptr;
	int32_t visibleAnnotableParameterCount = 0;
	$Array<::java::util::List>* visibleParameterAnnotations = nullptr;
	int32_t invisibleAnnotableParameterCount = 0;
	$Array<::java::util::List>* invisibleParameterAnnotations = nullptr;
	::jdk::internal::org::objectweb::asm$::tree::InsnList* instructions = nullptr;
	::java::util::List* tryCatchBlocks = nullptr;
	int32_t maxStack = 0;
	int32_t maxLocals = 0;
	::java::util::List* localVariables = nullptr;
	::java::util::List* visibleLocalVariableAnnotations = nullptr;
	::java::util::List* invisibleLocalVariableAnnotations = nullptr;
	bool visited = false;
};
...
#endif // _jdk_internal_org_objectweb_asm$_tree_MethodNode_h_