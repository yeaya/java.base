...
class $import KeyException : public ::java::security::GeneralSecurityException {
...
public:
	...
	inline KeyException* operator ->() const {
		return (KeyException*)throwing$;
	}
	inline operator KeyException*() const {
		return (KeyException*)throwing$;
	}
};
