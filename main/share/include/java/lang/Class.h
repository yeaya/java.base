...
class $import Class : public ::java::io::Serializable, public ::java::lang::reflect::GenericDeclaration, public ::java::lang::reflect::Type, public ::java::lang::invoke::TypeDescriptor$OfField, public ::java::lang::constant::Constable {
