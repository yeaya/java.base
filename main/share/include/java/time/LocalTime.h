...
class $import LocalTime : public ::java::time::temporal::Temporal, public ::java::time::temporal::TemporalAdjuster, public ::java::lang::Comparable, public ::java::io::Serializable {
...
public:
	...
	static const int64_t MILLIS_PER_DAY = 86400000; // SECONDS_PER_DAY * 1000L
	static const int64_t MICROS_PER_DAY = 86400000000; // SECONDS_PER_DAY * 1000000L
