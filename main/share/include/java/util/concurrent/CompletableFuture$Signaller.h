...
class $import CompletableFuture$Signaller : public ::java::util::concurrent::CompletableFuture$Completion, public ::java::util::concurrent::ForkJoinPool$ManagedBlocker {
