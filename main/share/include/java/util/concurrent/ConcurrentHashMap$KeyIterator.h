...
class $import ConcurrentHashMap$KeyIterator : public ::java::util::concurrent::ConcurrentHashMap$BaseIterator, public ::java::util::Iterator, public ::java::util::Enumeration {
