...
class $import SubmissionPublisher$BufferedSubscription : public ::java::util::concurrent::Flow$Subscription, public ::java::util::concurrent::ForkJoinPool$ManagedBlocker {
