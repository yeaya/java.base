...
class $import AbstractQueuedSynchronizer$ConditionNode : public ::java::util::concurrent::locks::AbstractQueuedSynchronizer$Node, public ::java::util::concurrent::ForkJoinPool$ManagedBlocker {
