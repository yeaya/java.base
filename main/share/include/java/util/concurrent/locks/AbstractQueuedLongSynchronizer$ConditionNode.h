...
class $import AbstractQueuedLongSynchronizer$ConditionNode : public ::java::util::concurrent::locks::AbstractQueuedLongSynchronizer$Node, public ::java::util::concurrent::ForkJoinPool$ManagedBlocker {
