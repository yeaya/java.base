...
class $import CompletableFuture$AsyncSupply : public ::java::util::concurrent::ForkJoinTask, public ::java::lang::Runnable, public ::java::util::concurrent::CompletableFuture$AsynchronousCompletionTask {
