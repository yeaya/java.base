#ifndef _java_util_Collections$SynchronizedNavigableSet_h_
#define _java_util_Collections$SynchronizedNavigableSet_h_
//$ class java.util.Collections$SynchronizedNavigableSet
//$ extends java.util.Collections$SynchronizedSortedSet
...
class $import Collections$SynchronizedNavigableSet : public ::java::util::Collections$SynchronizedSortedSet, public ::java::util::NavigableSet {
...
public:
	...
	void init$(::java::util::NavigableSet* s, Object$* mutex);
...
#endif // _java_util_Collections$SynchronizedNavigableSet_h_