#ifndef _java_util_Collections$SynchronizedList_h_
#define _java_util_Collections$SynchronizedList_h_
...
class $import Collections$SynchronizedList : public ::java::util::Collections$SynchronizedCollection, public ::java::util::List {
	$class(Collections$SynchronizedList, $NO_CLASS_INIT, ::java::util::Collections$SynchronizedCollection, ::java::util::List)
public:
	...
	static const int64_t serialVersionUID = (int64_t)0x9463EFE38344107C;
...
#endif // _java_util_Collections$SynchronizedList_h_