#ifndef _java_util_Collections$SynchronizedSortedSet_h_
#define _java_util_Collections$SynchronizedSortedSet_h_
//$ class java.util.Collections$SynchronizedSortedSet
//$ extends java.util.Collections$SynchronizedSet
...
class $import Collections$SynchronizedSortedSet : public ::java::util::Collections$SynchronizedSet, public ::java::util::SortedSet {
...
public:
	...
	void init$(::java::util::SortedSet* s, Object$* mutex);
	...
	static const int64_t serialVersionUID = (int64_t)0x78ADB1384B50312E;
...
#endif // _java_util_Collections$SynchronizedSortedSet_h_