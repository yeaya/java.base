#ifndef _com_sun_crypto_provider_DESKeyFactory_h_
#define _com_sun_crypto_provider_DESKeyFactory_h_
//$ class com.sun.crypto.provider.DESKeyFactory
...
class $import DESKeyFactory : public ::javax::crypto::SecretKeyFactorySpi {
	$class(DESKeyFactory, $NO_CLASS_INIT, ::javax::crypto::SecretKeyFactorySpi)
public:
	DESKeyFactory();
	void init$();
...
#endif // _com_sun_crypto_provider_DESKeyFactory_h_