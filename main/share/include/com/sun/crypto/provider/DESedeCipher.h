#ifndef _com_sun_crypto_provider_DESedeCipher_h_
#define _com_sun_crypto_provider_DESedeCipher_h_
//$ class com.sun.crypto.provider.DESedeCipher
...
class $import DESedeCipher : public ::javax::crypto::CipherSpi {
	$class(DESedeCipher, $NO_CLASS_INIT, ::javax::crypto::CipherSpi)
public:
	DESedeCipher();
...
#endif // _com_sun_crypto_provider_DESedeCipher_h_