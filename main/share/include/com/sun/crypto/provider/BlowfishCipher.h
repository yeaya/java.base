#ifndef _com_sun_crypto_provider_BlowfishCipher_h_
#define _com_sun_crypto_provider_BlowfishCipher_h_
//$ class com.sun.crypto.provider.BlowfishCipher
...
class $import BlowfishCipher : public ::javax::crypto::CipherSpi {
	$class(BlowfishCipher, $NO_CLASS_INIT, ::javax::crypto::CipherSpi)
public:
	BlowfishCipher();
...
#endif // _com_sun_crypto_provider_BlowfishCipher_h_