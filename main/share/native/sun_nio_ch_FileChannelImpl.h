...
#define sun_nio_ch_FileChannelImpl_MAPPED_TRANSFER_SIZE $LL(8388608)
#undef sun_nio_ch_FileChannelImpl_TRANSFER_SIZE
#define sun_nio_ch_FileChannelImpl_TRANSFER_SIZE 8192L
#undef sun_nio_ch_FileChannelImpl_MAP_INVALID
#define sun_nio_ch_FileChannelImpl_MAP_INVALID -1L
...
JNIEXPORT jlong JNICALL Java_sun_nio_ch_FileChannelImpl_map0
  (JNIEnv *, jobject, jint, jlong, jlong, jboolean);
