...
static void *apple_main (void *arg)
{
    if (main_fptr == NULL) {
// #ifdef STATIC_BUILD
        extern int jcpp_launch0(int argc, char **argv);
        main_fptr = &jcpp_launch0;
// #else
...
#endif
    Dl_info selfInfo;
    dladdr(&CreateExecutionEnvironment, &selfInfo);
    JLI_Snprintf(jvmpath, so_jvmpath, "%s", selfInfo.dli_fname);
