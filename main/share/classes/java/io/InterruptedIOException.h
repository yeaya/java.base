...
class $export InterruptedIOException : public ::java::io::IOException {
...
public:
	...
	inline InterruptedIOException* operator ->() const {
		return (InterruptedIOException*)throwing$;
	}
	inline operator InterruptedIOException*() const {
		return (InterruptedIOException*)throwing$;
	}
};
