...
$MethodInfo _Console_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(Console::*)()>(&Console::init$))},
	{"charset", "()Ljava/nio/charset/Charset;", nullptr, $PUBLIC, $method(static_cast<$Charset*(Console::*)()>(&Console::charset))},
	{"echo", "(Z)Z", nullptr, $PRIVATE | $STATIC | $NATIVE, $method(static_cast<bool(*)(bool)>(&Console::echo)), "java.io.IOException"},
	{"encoding", "()Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $NATIVE, $method(static_cast<$String*(*)()>(&Console::encoding))},
	{"flush", "()V", nullptr, $PUBLIC},
	{"format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/Console;", nullptr, $PUBLIC | $TRANSIENT, $method(static_cast<Console*(Console::*)($String*,$ObjectArray*)>(&Console::format))},
	{"grow", "()[C", nullptr, $PRIVATE, $method(static_cast<$chars*(Console::*)()>(&Console::grow))},
	{"installShutdownHook", "()V", nullptr, $PRIVATE, $method(static_cast<void(Console::*)()>(&Console::installShutdownHook))},
	{"istty", "()Z", nullptr, $PRIVATE | $STATIC | $NATIVE, $method(static_cast<bool(*)()>(&Console::istty))},
	{"printf", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/Console;", nullptr, $PUBLIC | $TRANSIENT, $method(static_cast<Console*(Console::*)($String*,$ObjectArray*)>(&Console::printf))},
	{"readLine", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", nullptr, $PUBLIC | $TRANSIENT, $method(static_cast<$String*(Console::*)($String*,$ObjectArray*)>(&Console::readLine))},
	{"readLine", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Console::*)()>(&Console::readLine))},
	{"readPassword", "(Ljava/lang/String;[Ljava/lang/Object;)[C", nullptr, $PUBLIC | $TRANSIENT, $method(static_cast<$chars*(Console::*)($String*,$ObjectArray*)>(&Console::readPassword))},
	{"readPassword", "()[C", nullptr, $PUBLIC, $method(static_cast<$chars*(Console::*)()>(&Console::readPassword))},
	{"reader", "()Ljava/io/Reader;", nullptr, $PUBLIC, $method(static_cast<$Reader*(Console::*)()>(&Console::reader))},
	{"readline", "(Z)[C", nullptr, $PRIVATE, $method(static_cast<$chars*(Console::*)(bool)>(&Console::readline)), "java.io.IOException"},
	{"writer", "()Ljava/io/PrintWriter;", nullptr, $PUBLIC, $method(static_cast<$PrintWriter*(Console::*)()>(&Console::writer))},
	{}
};
