...
void FileWriter::init$($String* fileName, $Charset* charset) {
	$OutputStreamWriter::init$($$new($FileOutputStream, fileName), charset);
}

void FileWriter::init$($String* fileName, $Charset* charset, bool append) {
	$OutputStreamWriter::init$($$new($FileOutputStream, fileName, append), charset);
}

void FileWriter::init$($File* file, $Charset* charset) {
	$OutputStreamWriter::init$($$new($FileOutputStream, file), charset);
}

void FileWriter::init$($File* file, $Charset* charset, bool append) {
	$OutputStreamWriter::init$($$new($FileOutputStream, file, append), charset);
}
...
$Class* FileWriter::load$($String* name, bool initialize) {
	...
	$loadClass(FileWriter, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
