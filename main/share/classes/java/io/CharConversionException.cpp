...
CharConversionException::CharConversionException(const CharConversionException& e) {
}

CharConversionException CharConversionException::wrapper$() {
	$pendingException(this);
	return *this;
}

void CharConversionException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
