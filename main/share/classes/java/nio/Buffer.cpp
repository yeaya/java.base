...
void Buffer::clinit$($Class* clazz) {
...
$Class* Buffer::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"checkIndex", "(I)I", nullptr, $FINAL, $method(Buffer, checkIndex, int32_t, int32_t), nullptr, nullptr, checkIndexmethodAnnotations$$},
		...
		{"scope", "()Ljdk/internal/misc/ScopedMemoryAccess$Scope;", nullptr, $FINAL, $method(Buffer, scope, $ScopedMemoryAccess$Scope*), nullptr, nullptr, scopemethodAnnotations$$},
	...
	$loadClass(Buffer, name, initialize, &classInfo$$, Buffer::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Buffer);
	});
	return class$;
}
