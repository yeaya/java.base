#ifndef _java_nio_ByteBufferAsCharBufferL_h_
#define _java_nio_ByteBufferAsCharBufferL_h_
...
class ByteBufferAsCharBufferL : public ::java::nio::CharBuffer {
	$class(ByteBufferAsCharBufferL, 0, ::java::nio::CharBuffer)
public:
...
#endif // _java_nio_ByteBufferAsCharBufferL_h_