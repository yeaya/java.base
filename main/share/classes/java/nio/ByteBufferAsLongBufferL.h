#ifndef _java_nio_ByteBufferAsLongBufferL_h_
#define _java_nio_ByteBufferAsLongBufferL_h_
...
class ByteBufferAsLongBufferL : public ::java::nio::LongBuffer {
	$class(ByteBufferAsLongBufferL, 0, ::java::nio::LongBuffer)
public:
...
#endif // _java_nio_ByteBufferAsLongBufferL_h_