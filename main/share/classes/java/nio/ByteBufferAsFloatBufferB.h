#ifndef _java_nio_ByteBufferAsFloatBufferB_h_
#define _java_nio_ByteBufferAsFloatBufferB_h_
...
class ByteBufferAsFloatBufferB : public ::java::nio::FloatBuffer {
	$class(ByteBufferAsFloatBufferB, 0, ::java::nio::FloatBuffer)
public:
...
#endif // _java_nio_ByteBufferAsFloatBufferB_h_