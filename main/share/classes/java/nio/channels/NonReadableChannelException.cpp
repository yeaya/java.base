...
NonReadableChannelException::NonReadableChannelException(const NonReadableChannelException& e) {
}

NonReadableChannelException NonReadableChannelException::wrapper$() {
	$pendingException(this);
	return *this;
}

void NonReadableChannelException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
