...
class $export DatagramChannel : public ::java::nio::channels::spi::AbstractSelectableChannel, public ::java::nio::channels::ByteChannel, public ::java::nio::channels::ScatteringByteChannel, public ::java::nio::channels::GatheringByteChannel, public ::java::nio::channels::MulticastChannel {
