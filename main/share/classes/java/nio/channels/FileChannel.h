...
class $export FileChannel : public ::java::nio::channels::spi::AbstractInterruptibleChannel, public ::java::nio::channels::SeekableByteChannel, public ::java::nio::channels::GatheringByteChannel, public ::java::nio::channels::ScatteringByteChannel {
