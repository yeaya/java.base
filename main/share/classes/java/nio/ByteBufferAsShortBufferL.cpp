...
void ByteBufferAsShortBufferL::clinit$($Class* clazz) {
...
$Class* ByteBufferAsShortBufferL::load$($String* name, bool initialize) {
	...
	$loadClass(ByteBufferAsShortBufferL, name, initialize, &classInfo$$, ByteBufferAsShortBufferL::clinit$, []($Class* clazz) -> $Object* {
