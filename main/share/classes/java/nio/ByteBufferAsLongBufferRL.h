#ifndef _java_nio_ByteBufferAsLongBufferRL_h_
#define _java_nio_ByteBufferAsLongBufferRL_h_
...
class ByteBufferAsLongBufferRL : public ::java::nio::ByteBufferAsLongBufferL {
	$class(ByteBufferAsLongBufferRL, $NO_CLASS_INIT, ::java::nio::ByteBufferAsLongBufferL)
public:
	ByteBufferAsLongBufferRL();
	using ::java::nio::ByteBufferAsLongBufferL::get;
	...
	using ::java::nio::ByteBufferAsLongBufferL::limit;
	virtual ::java::nio::ByteOrder* order() override;
	using ::java::nio::ByteBufferAsLongBufferL::put;
	using ::java::nio::ByteBufferAsLongBufferL::position;
...
#endif // _java_nio_ByteBufferAsLongBufferRL_h_