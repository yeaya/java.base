#ifndef _java_nio_ByteBufferAsDoubleBufferL_h_
#define _java_nio_ByteBufferAsDoubleBufferL_h_
...
class ByteBufferAsDoubleBufferL : public ::java::nio::DoubleBuffer {
	$class(ByteBufferAsDoubleBufferL, 0, ::java::nio::DoubleBuffer)
public:
...
#endif // _java_nio_ByteBufferAsDoubleBufferL_h_