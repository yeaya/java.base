#ifndef _java_nio_ByteBufferAsShortBufferB_h_
#define _java_nio_ByteBufferAsShortBufferB_h_
...
class ByteBufferAsShortBufferB : public ::java::nio::ShortBuffer {
	$class(ByteBufferAsShortBufferB, 0, ::java::nio::ShortBuffer)
public:
...
#endif // _java_nio_ByteBufferAsShortBufferB_h_