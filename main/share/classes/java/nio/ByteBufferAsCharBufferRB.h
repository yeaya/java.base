#ifndef _java_nio_ByteBufferAsCharBufferRB_h_
#define _java_nio_ByteBufferAsCharBufferRB_h_
...
class ByteBufferAsCharBufferRB : public ::java::nio::ByteBufferAsCharBufferB {
	$class(ByteBufferAsCharBufferRB, 0, ::java::nio::ByteBufferAsCharBufferB)
public:
	...
	using ::java::nio::ByteBufferAsCharBufferB::put;
	using ::java::nio::ByteBufferAsCharBufferB::position;
	...
	using ::java::nio::ByteBufferAsCharBufferB::toString;
...
#endif // _java_nio_ByteBufferAsCharBufferRB_h_