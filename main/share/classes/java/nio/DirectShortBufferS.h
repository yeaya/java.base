#ifndef _java_nio_DirectShortBufferS_h_
#define _java_nio_DirectShortBufferS_h_
...
class DirectShortBufferS : public ::java::nio::ShortBuffer, public ::sun::nio::ch::DirectBuffer {
...
#endif // _java_nio_DirectShortBufferS_h_