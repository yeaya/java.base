#ifndef _java_nio_DirectLongBufferS_h_
#define _java_nio_DirectLongBufferS_h_
...
class DirectLongBufferS : public ::java::nio::LongBuffer, public ::sun::nio::ch::DirectBuffer {
...
#endif // _java_nio_DirectLongBufferS_h_