#ifndef _java_nio_ByteBufferAsShortBufferL_h_
#define _java_nio_ByteBufferAsShortBufferL_h_
...
class ByteBufferAsShortBufferL : public ::java::nio::ShortBuffer {
	$class(ByteBufferAsShortBufferL, 0, ::java::nio::ShortBuffer)
public:
...
#endif // _java_nio_ByteBufferAsShortBufferL_h_