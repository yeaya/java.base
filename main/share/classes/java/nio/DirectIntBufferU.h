#ifndef _java_nio_DirectIntBufferU_h_
#define _java_nio_DirectIntBufferU_h_
...
class DirectIntBufferU : public ::java::nio::IntBuffer, public ::sun::nio::ch::DirectBuffer {
	$class(DirectIntBufferU, 0, ::java::nio::IntBuffer, ::sun::nio::ch::DirectBuffer)
public:
	DirectIntBufferU();
...
#endif // _java_nio_DirectIntBufferU_h_