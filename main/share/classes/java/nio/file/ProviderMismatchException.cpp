...
ProviderMismatchException::ProviderMismatchException(const ProviderMismatchException& e) {
}

ProviderMismatchException ProviderMismatchException::wrapper$() {
	$pendingException(this);
	return *this;
}

void ProviderMismatchException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
