#ifndef _java_nio_DirectCharBufferU_h_
#define _java_nio_DirectCharBufferU_h_
...
class DirectCharBufferU : public ::java::nio::CharBuffer, public ::sun::nio::ch::DirectBuffer {
...
#endif // _java_nio_DirectCharBufferU_h_