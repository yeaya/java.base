#ifndef _java_nio_HeapCharBufferR_h_
#define _java_nio_HeapCharBufferR_h_
...
class HeapCharBufferR : public ::java::nio::HeapCharBuffer {
	$class(HeapCharBufferR, 0, ::java::nio::HeapCharBuffer)
public:
	HeapCharBufferR();
	using ::java::nio::HeapCharBuffer::get;
	using ::java::nio::HeapCharBuffer::limit;
	...
	using ::java::nio::HeapCharBuffer::put;
	using ::java::nio::HeapCharBuffer::position;
	...
	using ::java::nio::HeapCharBuffer::toString;
...
#endif // _java_nio_HeapCharBufferR_h_