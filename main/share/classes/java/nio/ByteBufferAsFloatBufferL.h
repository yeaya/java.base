#ifndef _java_nio_ByteBufferAsFloatBufferL_h_
#define _java_nio_ByteBufferAsFloatBufferL_h_
...
class ByteBufferAsFloatBufferL : public ::java::nio::FloatBuffer {
	$class(ByteBufferAsFloatBufferL, 0, ::java::nio::FloatBuffer)
public:
...
#endif // _java_nio_ByteBufferAsFloatBufferL_h_