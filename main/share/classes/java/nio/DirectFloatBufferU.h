#ifndef _java_nio_DirectFloatBufferU_h_
#define _java_nio_DirectFloatBufferU_h_
...
class DirectFloatBufferU : public ::java::nio::FloatBuffer, public ::sun::nio::ch::DirectBuffer {
...
#endif // _java_nio_DirectFloatBufferU_h_