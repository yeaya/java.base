#ifndef _java_nio_DirectDoubleBufferU_h_
#define _java_nio_DirectDoubleBufferU_h_
...
class DirectDoubleBufferU : public ::java::nio::DoubleBuffer, public ::sun::nio::ch::DirectBuffer {
...
#endif // _java_nio_DirectDoubleBufferU_h_