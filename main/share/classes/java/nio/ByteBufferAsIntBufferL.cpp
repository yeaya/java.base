...
void ByteBufferAsIntBufferL::clinit$($Class* clazz) {
...
$Class* ByteBufferAsIntBufferL::load$($String* name, bool initialize) {
	...
	$loadClass(ByteBufferAsIntBufferL, name, initialize, &classInfo$$, ByteBufferAsIntBufferL::clinit$, []($Class* clazz) -> $Object* {
