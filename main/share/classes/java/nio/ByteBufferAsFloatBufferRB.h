#ifndef _java_nio_ByteBufferAsFloatBufferRB_h_
#define _java_nio_ByteBufferAsFloatBufferRB_h_
...
class ByteBufferAsFloatBufferRB : public ::java::nio::ByteBufferAsFloatBufferB {
	$class(ByteBufferAsFloatBufferRB, $NO_CLASS_INIT, ::java::nio::ByteBufferAsFloatBufferB)
public:
	ByteBufferAsFloatBufferRB();
	using ::java::nio::ByteBufferAsFloatBufferB::get;
	...
	using ::java::nio::ByteBufferAsFloatBufferB::limit;
	virtual ::java::nio::ByteOrder* order() override;
	using ::java::nio::ByteBufferAsFloatBufferB::put;
	using ::java::nio::ByteBufferAsFloatBufferB::position;
...
#endif // _java_nio_ByteBufferAsFloatBufferRB_h_