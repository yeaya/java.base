...
$MethodInfo _AccessControlContext_MethodInfo_[] = {
	{"<init>", "([Ljava/security/ProtectionDomain;)V", nullptr, $PUBLIC, $method(static_cast<void(AccessControlContext::*)($ProtectionDomainArray*)>(&AccessControlContext::init$))},
	{"<init>", "(Ljava/security/AccessControlContext;Ljava/security/DomainCombiner;)V", nullptr, $PUBLIC, $method(static_cast<void(AccessControlContext::*)(AccessControlContext*,$DomainCombiner*)>(&AccessControlContext::init$))},
	{"<init>", "(Ljava/security/AccessControlContext;Ljava/security/DomainCombiner;Z)V", nullptr, 0, $method(static_cast<void(AccessControlContext::*)(AccessControlContext*,$DomainCombiner*,bool)>(&AccessControlContext::init$))},
	{"<init>", "(Ljava/security/ProtectionDomain;Ljava/security/DomainCombiner;Ljava/security/AccessControlContext;Ljava/security/AccessControlContext;[Ljava/security/Permission;)V", nullptr, 0, $method(static_cast<void(AccessControlContext::*)($ProtectionDomain*,$DomainCombiner*,AccessControlContext*,AccessControlContext*,$PermissionArray*)>(&AccessControlContext::init$))},
	{"<init>", "([Ljava/security/ProtectionDomain;Z)V", nullptr, 0, $method(static_cast<void(AccessControlContext::*)($ProtectionDomainArray*,bool)>(&AccessControlContext::init$))},
	{"<init>", "([Ljava/security/ProtectionDomain;Ljava/security/AccessControlContext;)V", nullptr, 0, $method(static_cast<void(AccessControlContext::*)($ProtectionDomainArray*,AccessControlContext*)>(&AccessControlContext::init$))},
	{"calculateFields", "(Ljava/security/AccessControlContext;Ljava/security/AccessControlContext;[Ljava/security/Permission;)V", nullptr, $PRIVATE, $method(static_cast<void(AccessControlContext::*)(AccessControlContext*,AccessControlContext*,$PermissionArray*)>(&AccessControlContext::calculateFields))},
	{"checkPermission", "(Ljava/security/Permission;)V", nullptr, $PUBLIC, $method(static_cast<void(AccessControlContext::*)($Permission*)>(&AccessControlContext::checkPermission)), "java.security.AccessControlException"},
	{"checkPermission2", "(Ljava/security/Permission;)V", nullptr, $PRIVATE, $method(static_cast<void(AccessControlContext::*)($Permission*)>(&AccessControlContext::checkPermission2))},
	{"combine", "([Ljava/security/ProtectionDomain;[Ljava/security/ProtectionDomain;)[Ljava/security/ProtectionDomain;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$ProtectionDomainArray*(*)($ProtectionDomainArray*,$ProtectionDomainArray*)>(&AccessControlContext::combine))},
	{"containsAllLimits", "(Ljava/security/AccessControlContext;)Z", nullptr, $PRIVATE, $method(static_cast<bool(AccessControlContext::*)(AccessControlContext*)>(&AccessControlContext::containsAllLimits))},
	{"containsAllPDs", "([Ljava/security/ProtectionDomain;[Ljava/security/ProtectionDomain;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($ProtectionDomainArray*,$ProtectionDomainArray*)>(&AccessControlContext::containsAllPDs))},
	{"equalContext", "(Ljava/security/AccessControlContext;)Z", nullptr, $PRIVATE, $method(static_cast<bool(AccessControlContext::*)(AccessControlContext*)>(&AccessControlContext::equalContext))},
	{"equalLimitedContext", "(Ljava/security/AccessControlContext;)Z", nullptr, $PRIVATE, $method(static_cast<bool(AccessControlContext::*)(AccessControlContext*)>(&AccessControlContext::equalLimitedContext))},
	{"equalPDs", "([Ljava/security/ProtectionDomain;[Ljava/security/ProtectionDomain;)Z", nullptr, $PRIVATE, $method(static_cast<bool(AccessControlContext::*)($ProtectionDomainArray*,$ProtectionDomainArray*)>(&AccessControlContext::equalPDs))},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getAssignedCombiner", "()Ljava/security/DomainCombiner;", nullptr, 0, $method(static_cast<$DomainCombiner*(AccessControlContext::*)()>(&AccessControlContext::getAssignedCombiner))},
	{"getCombiner", "()Ljava/security/DomainCombiner;", nullptr, 0, $method(static_cast<$DomainCombiner*(AccessControlContext::*)()>(&AccessControlContext::getCombiner))},
	{"getContext", "()[Ljava/security/ProtectionDomain;", nullptr, 0, $method(static_cast<$ProtectionDomainArray*(AccessControlContext::*)()>(&AccessControlContext::getContext))},
	{"getDebug", "()Lsun/security/util/Debug;", nullptr, $STATIC, $method(static_cast<$Debug*(*)()>(&AccessControlContext::getDebug))},
	{"getDomainCombiner", "()Ljava/security/DomainCombiner;", nullptr, $PUBLIC, $method(static_cast<$DomainCombiner*(AccessControlContext::*)()>(&AccessControlContext::getDomainCombiner))},
	{"getNextPC", "(Ljava/security/AccessControlContext;)Ljava/security/AccessControlContext;", nullptr, $PRIVATE | $STATIC, $method(static_cast<AccessControlContext*(*)(AccessControlContext*)>(&AccessControlContext::getNextPC))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"isAuthorized", "()Z", nullptr, 0, $method(static_cast<bool(AccessControlContext::*)()>(&AccessControlContext::isAuthorized))},
	{"isPrivileged", "()Z", nullptr, 0, $method(static_cast<bool(AccessControlContext::*)()>(&AccessControlContext::isPrivileged))},
	{"optimize", "()Ljava/security/AccessControlContext;", nullptr, 0, $method(static_cast<AccessControlContext*(AccessControlContext::*)()>(&AccessControlContext::optimize))},
	{}
};
