...
InvalidParameterException::InvalidParameterException(const InvalidParameterException& e) {
}

InvalidParameterException InvalidParameterException::wrapper$() {
	$pendingException(this);
	return *this;
}

void InvalidParameterException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
