...
$Class* X509Certificate::load$($String* name, bool initialize) {
	...
	$NamedAttribute getSubjectDNmethodAnnotations$$$namedAttribute[] = {
		{"since", 's', "16"},
		{}
	};
	$CompoundAttribute getSubjectDNmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", getSubjectDNmethodAnnotations$$$namedAttribute},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"getIssuerDN", "()Ljava/security/Principal;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(X509Certificate, getIssuerDN, $Principal*), nullptr, nullptr, getIssuerDNmethodAnnotations$$},
		...
		{"getSubjectDN", "()Ljava/security/Principal;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(X509Certificate, getSubjectDN, $Principal*), nullptr, nullptr, getSubjectDNmethodAnnotations$$},
	...
	$loadClass(X509Certificate, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
