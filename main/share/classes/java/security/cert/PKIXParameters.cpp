...
$MethodInfo _PKIXParameters_MethodInfo_[] = {
	{"<init>", "(Ljava/util/Set;)V", "(Ljava/util/Set<Ljava/security/cert/TrustAnchor;>;)V", $PUBLIC, $method(static_cast<void(PKIXParameters::*)($Set*)>(&PKIXParameters::init$)), "java.security.InvalidAlgorithmParameterException"},
	{"<init>", "(Ljava/security/KeyStore;)V", nullptr, $PUBLIC, $method(static_cast<void(PKIXParameters::*)($KeyStore*)>(&PKIXParameters::init$)), "java.security.KeyStoreException,java.security.InvalidAlgorithmParameterException"},
