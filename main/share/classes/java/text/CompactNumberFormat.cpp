...
$Class* CompactNumberFormat$$Lambda$lambda$processCompactPatterns$0::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$processCompactPatterns$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$processCompactPatterns$0);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$validateRule$1::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$validateRule$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$validateRule$1);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$1$2::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$1$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$1$2);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$2$3::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$2$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$2$3);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$getNumericValue$4::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$getNumericValue$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$getNumericValue$4);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$toString$5::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$toString$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$toString$5);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$lambda$getPluralCategory$3$6::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$getPluralCategory$3$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$getPluralCategory$3$6);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$getKey$7::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$getKey$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$getKey$7);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$lambda$matchPluralRule$5$8::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$matchPluralRule$5$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$matchPluralRule$5$8);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$lambda$relationCheck$6$9::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$relationCheck$6$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$relationCheck$6$9);
	});
	return class$;
}
...
$Class* CompactNumberFormat$$Lambda$lambda$matchPluralRule$4$10::load$($String* name, bool initialize) {
	...
	$loadClass(CompactNumberFormat$$Lambda$lambda$matchPluralRule$4$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompactNumberFormat$$Lambda$lambda$matchPluralRule$4$10);
	});
	return class$;
}
...
void CompactNumberFormat::init$($String* decimalPattern, $DecimalFormatSymbols* symbols, $StringArray* compactPatterns, $String* pluralRules) {
	...
	$Objects::requireNonNull(decimalPattern, "decimalPattern"_s);
	$Objects::requireNonNull(symbols, "symbols"_s);
	$Objects::requireNonNull(compactPatterns, "compactPatterns"_s);
	$Objects::requireNonNull(pluralRules, "pluralRules"_s);
	...
	$NumberFormat::setGroupingUsed(this->decimalFormat->isGroupingUsed());
	$NumberFormat::setParseIntegerOnly(this->decimalFormat->isParseIntegerOnly());
...
$StringBuffer* CompactNumberFormat::format(Object$* number, $StringBuffer* toAppendTo, $FieldPosition* fieldPosition) {
	...
	if ($instanceOf($Long, number) || $instanceOf($Integer, number) || $instanceOf($Short, number) || $instanceOf($Byte, number) || $instanceOf($AtomicInteger, number) || $instanceOf($AtomicLong, number) || ($instanceOf($BigInteger, number) && $cast($BigInteger, number)->bitLength() < 64)) {
		...
		return format($cast($Number, number)->doubleValue(), toAppendTo, fieldPosition);
	} else {
...
$StringBuffer* CompactNumberFormat::format(double number, $StringBuffer* result, $Format$FieldDelegate* delegate) {
	...
	if (compactDataIndex != -1) {
		int64_t divisor = $$sure($Long, $nc(this->divisors)->get(compactDataIndex))->longValue();
		...
		if (var$0 || !$nc(suffix)->isEmpty()) {
			...
			if (!$$nc($$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(compactDataIndex))->get((double)iPart))->isEmpty()) {
				roundedNumber = roundedNumber / divisor;
				$var($Number, var$1, $Double::valueOf(roundedNumber));
				this->decimalFormat->setDigitList(var$1, isNegative, getMaximumFractionDigits());
				int32_t var$2 = getMaximumIntegerDigits();
				int32_t var$3 = getMinimumIntegerDigits();
				int32_t var$4 = getMaximumFractionDigits();
				this->decimalFormat->subformatNumber(result, delegate, isNegative, false, var$2, var$3, var$4, getMinimumFractionDigits());
		...
		if (var$0 || !$nc(suffix)->isEmpty()) {
			...
			if (!$$nc($$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(compactDataIndex))->get((double)iPart))->isEmpty()) {
				if ($mod(number, divisor) == 0) {
					...
					int32_t var$1 = getMaximumIntegerDigits();
					int32_t var$2 = getMinimumIntegerDigits();
					int32_t var$3 = getMaximumFractionDigits();
					this->decimalFormat->subformatNumber(result, delegate, isNegative, true, var$1, var$2, var$3, getMinimumFractionDigits());
				} else {
					double dNumber = (double)number / divisor;
					$var($Number, var$4, $Double::valueOf(dNumber));
					$nc(this->decimalFormat)->setDigitList(var$4, isNegative, getMaximumFractionDigits());
					int32_t var$5 = getMaximumIntegerDigits();
					int32_t var$6 = getMinimumIntegerDigits();
					int32_t var$7 = getMaximumFractionDigits();
					$nc(this->decimalFormat)->subformatNumber(result, delegate, isNegative, false, var$5, var$6, var$7, getMinimumFractionDigits());
				}
				appendSuffix(result, suffix, delegate);
			}
		} else {
...
$StringBuffer* CompactNumberFormat::format($BigDecimal* number$renamed, $StringBuffer* result, $Format$FieldDelegate* delegate) {
	...
	if ($(number->toBigInteger())->bitLength() < 64) {
		int64_t longNumber = $(number->toBigInteger())->longValue();
	...
	if (compactDataIndex != -1) {
		...
		if (var$2 || !$nc(suffix)->isEmpty()) {
			appendPrefix(result, prefix, delegate);
			if (!$$nc($$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(compactDataIndex))->get((double)iPart))->isEmpty()) {
				$var($BigDecimal, var$3, $new($BigDecimal, $(divisor->toString())));
				...
				this->decimalFormat->subformatNumber(result, delegate, isNegative, false, var$4, var$5, var$6, getMinimumFractionDigits());
				appendSuffix(result, suffix, delegate);
			}
		} else {
		...
		$assign(number, isNegative ? $nc(number)->negate() : number);
		$nc(this->defaultDecimalFormat)->format(number, result, delegate);
	}
	return result;
}
		...
		if (var$1 || !$nc(suffix)->isEmpty()) {
			...
			if (!$$nc($$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(compactDataIndex))->get((double)iPart))->isEmpty()) {
				if ($(number->mod($$new($BigInteger, $(divisor->toString()))))->compareTo($BigInteger::ZERO) == 0) {
					$assign(number, number->divide($$new($BigInteger, $(divisor->toString()))));
					$nc(this->decimalFormat)->setDigitList(number, isNegative, 0);
					int32_t var$2 = getMaximumIntegerDigits();
					int32_t var$3 = getMinimumIntegerDigits();
					int32_t var$4 = getMaximumFractionDigits();
					this->decimalFormat->subformatNumber(result, delegate, isNegative, true, var$2, var$3, var$4, getMinimumFractionDigits());
				} else {
					$var($BigDecimal, var$5, $new($BigDecimal, $(divisor->toString())));
					$var($BigDecimal, nDecimal, $$new($BigDecimal, number)->divide(var$5, $(getRoundingMode())));
					...
					this->decimalFormat->subformatNumber(result, delegate, isNegative, false, var$6, var$7, var$8, getMinimumFractionDigits());
				}
				appendSuffix(result, suffix, delegate);
			}
		} else {
...
$String* CompactNumberFormat::expandAffix($String* pattern) {
	$useLocalObjectStack();
	if ($nc(pattern)->indexOf(CompactNumberFormat::QUOTE) < 0) {
		return pattern;
	}
	$var($StringBuilder, sb, $new($StringBuilder));
	for (int32_t index = 0; index < pattern->length();) {
...
$List* CompactNumberFormat::getFieldPositions($String* pattern, $NumberFormat$Field* field) {
	...
	for (int32_t index = 0; index < $nc(pattern)->length();) {
		...
		if (ch == CompactNumberFormat::QUOTE) {
			...
			if (ch == CompactNumberFormat::MINUS_SIGN) {
				...
				$init($NumberFormat$Field);
				$var($FieldPosition, fp, $new($FieldPosition, $NumberFormat$Field::SIGN));
	...
	if (affix->length() != 0) {
		$var($FieldPosition, fp, $new($FieldPosition, field));
		fp->setBeginIndex(0);
...
int32_t CompactNumberFormat::selectCompactPattern($BigInteger* number) {
	...
	for (int32_t index = 0; index < this->compactPatterns->length; ++index) {
		if ($nc(number)->compareTo(currentValue) > 0) {
			matchedIndex = index;
			$assign(currentValue, $nc(currentValue)->multiply($($BigInteger::valueOf(CompactNumberFormat::RANGE_MULTIPLIER))));
			continue;
		}
...
$Number* CompactNumberFormat::computeDivisor($String* minIntDigits, int32_t patternIndex) {
	...
	if (patternIndex < 19) {
		...
		$assign(matchedValue, $($BigInteger::valueOf(CompactNumberFormat::RANGE_MULTIPLIER))->pow(patternIndex));
	}
	...
	if (count > 0) {
		...
		if (var$0) {
			...
			$assign(divisor, bigValue->divide($($BigInteger::valueOf($cast(int64_t, $Math::pow((double)CompactNumberFormat::RANGE_MULTIPLIER, (double)(count - 1)))))));
		} else {
...
void CompactNumberFormat::processCompactPatterns() {
	...
	for (int32_t index = 0; index < size; ++index) {
		...
		if (m != nullptr && m->matches()) {
			...
			$$nc($$nc($nc(CompactNumberFormat::COUNT_PATTERN)->matcher(plurals))->results())->forEach($$new(CompactNumberFormat$$Lambda$lambda$processCompactPatterns$0, this, idx));
		} else {
...
$Map* CompactNumberFormat::buildPluralRulesMap() {
	...
	try {
		$var($Function, var$0, $new(CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$1$2));
		return $cast($Map, $$nc($$nc($Arrays::stream($(this->pluralRules->split(";"_s))))->map($$new(CompactNumberFormat$$Lambda$validateRule$1, this)))->collect($($Collectors::toMap(var$0, $$new(CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$2$3)))));
	} catch ($IllegalStateException& ise) {
		$throwNew($IllegalArgumentException, ise);
	}
	$shouldNotReachHere();
}
...
void CompactNumberFormat::applyPattern($String* count, $String* pattern, int32_t index) {
	...
	for (int32_t j = 1; j >= 0 && start < $nc(pattern)->length(); --j) {
		...
		if (!var$2) {
			bool var$3 = negativePrefix->equals(positivePrefix);
			var$2 = var$3 && negativeSuffix->equals(positiveSuffix);
		}
		if (var$2) {
			$assign(negativeSuffix, positiveSuffix);
	...
	bool var$4 = !positivePrefix->isEmpty();
	if (var$4 || !positiveSuffix->isEmpty()) {
		$$sure($CompactNumberFormat$Patterns, $nc(this->positivePrefixPatterns)->get(index))->put(count, positivePrefix);
		$$sure($CompactNumberFormat$Patterns, $nc(this->negativePrefixPatterns)->get(index))->put(count, negativePrefix);
		$$sure($CompactNumberFormat$Patterns, $nc(this->positiveSuffixPatterns)->get(index))->put(count, positiveSuffix);
		$$sure($CompactNumberFormat$Patterns, $nc(this->negativeSuffixPatterns)->get(index))->put(count, negativeSuffix);
		$$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(index))->put(count, zeros);
		if ($nc(this->divisors)->size() <= index) {
			this->divisors->add($(computeDivisor(zeros, index)));
		}
	} else {
		$$sure($CompactNumberFormat$Patterns, $nc(this->positivePrefixPatterns)->get(index))->put(count, ""_s);
		$$sure($CompactNumberFormat$Patterns, $nc(this->negativePrefixPatterns)->get(index))->put(count, ""_s);
		$$sure($CompactNumberFormat$Patterns, $nc(this->positiveSuffixPatterns)->get(index))->put(count, ""_s);
		$$sure($CompactNumberFormat$Patterns, $nc(this->negativeSuffixPatterns)->get(index))->put(count, ""_s);
		$$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(index))->put(count, ""_s);
		if ($nc(this->divisors)->size() <= index) {
			this->divisors->add($($Long::valueOf(1)));
		}
	}
}
...
void CompactNumberFormat::expandAffixPatterns() {
	...
	$set(this, negativePrefixes, $new($ArrayList, this->compactPatterns->length));
	$set(this, positiveSuffixes, $new($ArrayList, this->compactPatterns->length));
	$set(this, negativeSuffixes, $new($ArrayList, this->compactPatterns->length));
	for (int32_t index = 0; index < this->compactPatterns->length; ++index) {
		this->positivePrefixes->add($($$sure($CompactNumberFormat$Patterns, $nc(this->positivePrefixPatterns)->get(index))->expandAffix()));
		this->negativePrefixes->add($($$sure($CompactNumberFormat$Patterns, $nc(this->negativePrefixPatterns)->get(index))->expandAffix()));
		this->positiveSuffixes->add($($$sure($CompactNumberFormat$Patterns, $nc(this->positiveSuffixPatterns)->get(index))->expandAffix()));
		this->negativeSuffixes->add($($$sure($CompactNumberFormat$Patterns, $nc(this->negativeSuffixPatterns)->get(index))->expandAffix()));
	}
}
...
$Number* CompactNumberFormat::parse($String* text, $ParsePosition* pos) {
	...
	$var($Number, cnfMultiplier, $Long::valueOf(1));
	int32_t var$0 = pos->index;
	$var($String, var$1, $nc(this->symbols)->getNaN());
	if (text->regionMatches(var$0, var$1, 0, $$nc(this->symbols->getNaN())->length())) {
	...
	$var($String, defaultNegPrefix, this->defaultDecimalFormat->getNegativePrefix());
	...
	if (gotPositive && gotNegative) {
		...
		if (var$2 > $nc(matchedNegPrefix)->length()) {
			...
			int32_t var$3 = matchedPosPrefix->length();
			if (var$3 < matchedNegPrefix->length()) {
				gotPositive = false;
			}
		}
	}
	if (gotPositive || gotNegative) {
		...
		if (matchedIndex != -1) {
			...
			if ($$nc($$sure($CompactNumberFormat$Patterns, $nc(this->placeHolderPatterns)->get(matchedIndex))->get(num))->isEmpty()) {
				pos->index = position;
	...
	bool var$4 = isParseIntegerOnly();
	if (var$4) {
		char16_t var$5 = text->charAt(position);
		var$4 = var$5 == this->symbols->getDecimalSeparator();
	}
	if (var$4) {
		++position;
		for (; position < text->length(); ++position) {
			char16_t ch = text->charAt(position);
			int32_t digit = ch - this->symbols->getZeroDigit();
			if (digit < 0 || digit > 9) {
	...
	if ($nc(multiplier)->longValue() == -1) {
		return nullptr;
	} else if (multiplier->longValue() != 1) {
	...
	if (isParseBigDecimal()) {
		$var($BigDecimal, bigDecimalResult, this->digitList->getBigDecimal());
		if ($nc(cnfMultiplier)->longValue() != 1) {
			$assign(bigDecimalResult, $nc(bigDecimalResult)->multiply($$new($BigDecimal, $(cnfMultiplier->toString()))));
		}
		if (!status->get(CompactNumberFormat::STATUS_POSITIVE)) {
		...
		if (this->digitList->fitsIntoLong(status->get(CompactNumberFormat::STATUS_POSITIVE), isParseIntegerOnly())) {
			int64_t longResult = this->digitList->getLong();
			$assign(cnfResult, generateParseResult($($Long::valueOf(longResult)), false, longResult < 0, status, cnfMultiplier));
		} else {
			$assign(cnfResult, generateParseResult($($Double::valueOf(this->digitList->getDouble())), true, false, status, cnfMultiplier));
		}
		return cnfResult;
	}
}
...
double CompactNumberFormat::parseNumberPart($String* text, int32_t position) {
	...
	if ($nc(text)->startsWith($($nc(this->symbols)->getInfinity()), position)) {
	...
	} else if (!text->startsWith($(this->symbols->getNaN()), position)) {
		...
		if ($nc(m)->find(position)) {
			...
			if ($Character::isDigit(cp)) {
				return $Double::parseDouble($$cast($String, $$nc($$nc($(digits->codePoints())->map($$new(CompactNumberFormat$$Lambda$getNumericValue$4)))->mapToObj($$new(CompactNumberFormat$$Lambda$toString$5)))->collect($($Collectors::joining()))));
			}
		} else {
			return 1.0;
		}
...
$Number* CompactNumberFormat::generateParseResult($Number* number, bool gotDouble, bool gotLongMin, $booleans* status, $Number* cnfMultiplier) {
	...
	if (gotDouble) {
		if ($nc(cnfMultiplier)->longValue() != 1) {
			...
			doubleResult = $$sure($Double, convertIfNegative($($Double::valueOf(doubleResult)), status, gotLongMin))->doubleValue();
	...
	} else if ($nc(cnfMultiplier)->longValue() != 1) {
		$var($Number, result, nullptr);
		if (($instanceOf($Long, cnfMultiplier)) && !gotLongMin) {
			int64_t longMultiplier = $cast($Long, cnfMultiplier)->longValue();
			try {
...
$Number* CompactNumberFormat::convertIfNegative($Number* number, $booleans* status, bool gotLongMin) {
	if (!$nc(status)->get(CompactNumberFormat::STATUS_POSITIVE) && !gotLongMin) {
		if ($instanceOf($Long, number)) {
			return $Long::valueOf(-$cast($Long, number)->longValue());
		} else {
...
$Number* CompactNumberFormat::computeParseMultiplier($String* text, $ParsePosition* parsePosition, $String* matchedPrefix, $booleans* status, bool gotPositive, bool gotNegative, double num) {
	...
	for (int32_t compactIndex = 0; compactIndex < $nc(this->compactPatterns)->length; ++compactIndex) {
		...
		$var($String, var$0, $nc(this->defaultDecimalFormat)->getPositivePrefix());
		bool match = matchPrefixAndSuffix(text, position, positivePrefix, matchedPrefix, var$0, positiveSuffix, matchedPosSuffix, $(this->defaultDecimalFormat->getPositiveSuffix()));
		if (match) {
			matchedPosIndex = compactIndex;
			$assign(matchedPosSuffix, positiveSuffix);
			gotPos = true;
		}
		$var($String, var$1, this->defaultDecimalFormat->getNegativePrefix());
		match = matchPrefixAndSuffix(text, position, negativePrefix, matchedPrefix, var$1, negativeSuffix, matchedNegSuffix, $(this->defaultDecimalFormat->getNegativeSuffix()));
		if (match) {
			matchedNegIndex = compactIndex;
	...
	if (!gotPos && !gotNeg) {
		...
		$var($String, negativeSuffix, this->defaultDecimalFormat->getNegativeSuffix());
		if ($nc(text)->regionMatches(position, positiveSuffix, 0, $nc(positiveSuffix)->length())) {
			$assign(matchedPosSuffix, positiveSuffix);
			gotPos = true;
		}
		if (text->regionMatches(position, negativeSuffix, 0, $nc(negativeSuffix)->length())) {
			$assign(matchedNegSuffix, negativeSuffix);
			gotNeg = true;
		}
	}
	if (gotPos && gotNeg) {
		int32_t var$2 = $nc(matchedPosSuffix)->length();
		if (var$2 > $nc(matchedNegSuffix)->length()) {
			gotNeg = false;
		} else {
			int32_t var$3 = matchedPosSuffix->length();
			if (var$3 < matchedNegSuffix->length()) {
				gotPos = false;
			} else {
				gotPos = gotPositive;
				gotNeg = gotNegative;
	...
	if (gotPos) {
		...
		$assign(cnfMultiplier, matchedPosIndex != -1 ? $cast($Number, $nc(this->divisors)->get(matchedPosIndex)) : $cast($Number, $Long::valueOf(1)));
	} else {
		parsePosition->index = position + $nc(matchedNegSuffix)->length();
		$assign(cnfMultiplier, matchedNegIndex != -1 ? $cast($Number, $nc(this->divisors)->get(matchedNegIndex)) : $cast($Number, $Long::valueOf(1)));
	}
...
void CompactNumberFormat::setMaximumIntegerDigits(int32_t newValue) {
	...
	$NumberFormat::setMaximumIntegerDigits(this->decimalFormat->getMaximumIntegerDigits());
	int32_t var$0 = this->decimalFormat->getMinimumIntegerDigits();
	if (var$0 > this->decimalFormat->getMaximumIntegerDigits()) {
		this->decimalFormat->setMinimumIntegerDigits(this->decimalFormat->getMaximumIntegerDigits());
		$NumberFormat::setMinimumIntegerDigits(this->decimalFormat->getMinimumIntegerDigits());
	}
}
...
void CompactNumberFormat::setMinimumFractionDigits(int32_t newValue) {
	...
	$NumberFormat::setMinimumFractionDigits(this->decimalFormat->getMinimumFractionDigits());
	int32_t var$0 = this->decimalFormat->getMinimumFractionDigits();
	if (var$0 > this->decimalFormat->getMaximumFractionDigits()) {
		this->decimalFormat->setMaximumFractionDigits(this->decimalFormat->getMinimumFractionDigits());
		$NumberFormat::setMaximumFractionDigits(this->decimalFormat->getMaximumFractionDigits());
	}
}
...
bool CompactNumberFormat::equals(Object$* obj) {
	...
	bool var$2 = var$3 && $nc(this->symbols)->equals(other->symbols);
	bool var$1 = var$2 && $Arrays::equals(this->compactPatterns, other->compactPatterns);
	bool var$0 = var$1 && $nc(this->roundingMode)->equals(other->roundingMode);
	return var$0 && $nc(this->pluralRules)->equals(other->pluralRules) && this->groupingSize == other->groupingSize && this->parseBigDecimal == other->parseBigDecimal;
}
...
$String* CompactNumberFormat::getPluralCategory(double input) {
	...
	if (this->rulesMap != nullptr) {
		return $cast($String, $$nc($$nc($$nc($$nc($$nc(this->rulesMap->entrySet())->stream())->filter($$new(CompactNumberFormat$$Lambda$lambda$getPluralCategory$3$6, input)))->map($$new(CompactNumberFormat$$Lambda$getKey$7)))->findFirst())->orElse("other"_s));
	}
	return "other"_s;
}
...
bool CompactNumberFormat::matchPluralRule($String* condition, double input) {
	...
	$useLocalObjectStack();
	return $$nc($Arrays::stream($($nc(condition)->split("or"_s))))->anyMatch($$new(CompactNumberFormat$$Lambda$lambda$matchPluralRule$5$8, input));
}
	...
	if ($nc(expr)->find()) {
		...
		if ($nc(rel)->find(expr->end())) {
			...
			if ($Objects::equals($(rel->group("rel"_s)), "!="_s)) {
				return $nc(conditions)->noneMatch($$new(CompactNumberFormat$$Lambda$lambda$relationCheck$6$9, lop));
			} else {
				return $nc(conditions)->anyMatch($$new(CompactNumberFormat$$Lambda$lambda$relationCheck$6$9, lop));
			}
		}
	}
	return false;
...
bool CompactNumberFormat::lambda$matchPluralRule$5(double input, $String* and_condition) {
	$init(CompactNumberFormat);
	$useLocalObjectStack();
	return $$nc($Arrays::stream($($nc(and_condition)->split("and"_s))))->allMatch($$new(CompactNumberFormat$$Lambda$lambda$matchPluralRule$4$10, input));
}
...
void CompactNumberFormat::clinit$($Class* clazz) {
...
$Class* CompactNumberFormat::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$processCompactPatterns$0")) {
			return CompactNumberFormat$$Lambda$lambda$processCompactPatterns$0::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$validateRule$1")) {
			return CompactNumberFormat$$Lambda$validateRule$1::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$1$2")) {
			return CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$1$2::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$2$3")) {
			return CompactNumberFormat$$Lambda$lambda$buildPluralRulesMap$2$3::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$getNumericValue$4")) {
			return CompactNumberFormat$$Lambda$getNumericValue$4::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$toString$5")) {
			return CompactNumberFormat$$Lambda$toString$5::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$getPluralCategory$3$6")) {
			return CompactNumberFormat$$Lambda$lambda$getPluralCategory$3$6::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$getKey$7")) {
			return CompactNumberFormat$$Lambda$getKey$7::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$matchPluralRule$5$8")) {
			return CompactNumberFormat$$Lambda$lambda$matchPluralRule$5$8::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$relationCheck$6$9")) {
			return CompactNumberFormat$$Lambda$lambda$relationCheck$6$9::load$(name, initialize);
		}
		if (name->equals("java.text.CompactNumberFormat$$Lambda$lambda$matchPluralRule$4$10")) {
	...
	$loadClass(CompactNumberFormat, name, initialize, &classInfo$$, CompactNumberFormat::clinit$, []($Class* clazz) -> $Object* {
