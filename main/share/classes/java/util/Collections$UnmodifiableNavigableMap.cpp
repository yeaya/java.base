...
$MethodInfo _Collections$UnmodifiableNavigableMap_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/NavigableMap;)V", "(Ljava/util/NavigableMap<TK;+TV;>;)V", 0, $method(static_cast<void(Collections$UnmodifiableNavigableMap::*)($NavigableMap*)>(&Collections$UnmodifiableNavigableMap::init$))},
