...
$Spliterator* Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntrySetSpliterator::trySplit() {
	...
	return split == nullptr ? ($Spliterator*)nullptr : $cast($Spliterator, $new(Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntrySetSpliterator, split));
}
...
$Class* Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntrySetSpliterator::load$($String* name, bool initialize) {
	...
	$loadClass(Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntrySetSpliterator, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntrySetSpliterator);
	});
	return class$;
}
