...
$MethodInfo _Collections$SynchronizedList_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/List;)V", "(Ljava/util/List<TE;>;)V", 0, $method(static_cast<void(Collections$SynchronizedList::*)($List*)>(&Collections$SynchronizedList::init$))},
	{"<init>", "(Ljava/util/List;Ljava/lang/Object;)V", "(Ljava/util/List<TE;>;Ljava/lang/Object;)V", 0, $method(static_cast<void(Collections$SynchronizedList::*)($List*,Object$*)>(&Collections$SynchronizedList::init$))},
	...
	{"readResolve", "()Ljava/lang/Object;", nullptr, $PRIVATE, $method(static_cast<$Object*(Collections$SynchronizedList::*)()>(&Collections$SynchronizedList::readResolve))},
