...
$Class* Collections$AsLIFOQueue::load$($String* name, bool initialize) {
	...
	$loadClass(Collections$AsLIFOQueue, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
