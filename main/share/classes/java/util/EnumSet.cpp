...
$MethodInfo _EnumSet_MethodInfo_[] = {
	...
	{"of", "(Ljava/lang/Enum;[Ljava/lang/Enum;)Ljava/util/EnumSet;", "<E:Ljava/lang/Enum<TE;>;>(TE;[TE;)Ljava/util/EnumSet<TE;>;", $PUBLIC | $STATIC | $TRANSIENT, $staticMethod(EnumSet, of, EnumSet*, $Enum*, $EnumArray*), nullptr, nullptr, _EnumSet_MethodAnnotations_of16},
