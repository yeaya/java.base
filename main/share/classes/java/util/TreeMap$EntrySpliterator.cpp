...
$Class* TreeMap$EntrySpliterator$$Lambda$lambda$getComparator$d5a01062$1::load$($String* name, bool initialize) {
	...
	$loadClass(TreeMap$EntrySpliterator$$Lambda$lambda$getComparator$d5a01062$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
...
$Comparator* TreeMap$EntrySpliterator::getComparator() {
	if ($nc(this->tree)->comparator$ != nullptr) {
		...
		return $cast($Comparator, $cast($Serializable, $new(TreeMap$EntrySpliterator$$Lambda$lambda$getComparator$d5a01062$1)));
	}
}
		...
		case 0:
			{
				...
				bool var$0 = var$1 && $$nc(lambda->getImplClass())->equals("java/util/TreeMap$EntrySpliterator"_s);
				if (var$0 && $$nc(lambda->getImplMethodSignature())->equals("(Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I"_s)) {
					return $of($new(TreeMap$EntrySpliterator$$Lambda$lambda$getComparator$d5a01062$1));
				}
				break;
			}
		}
...
$Class* TreeMap$EntrySpliterator::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.TreeMap$EntrySpliterator$$Lambda$lambda$getComparator$d5a01062$1")) {
	...
	$loadClass(TreeMap$EntrySpliterator, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
