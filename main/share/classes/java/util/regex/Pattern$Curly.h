#ifndef _java_util_regex_Pattern$Curly_h_
#define _java_util_regex_Pattern$Curly_h_
...
class $export Pattern$Curly : public ::java::util::regex::Pattern$Node {
	$class(Pattern$Curly, $NO_CLASS_INIT, ::java::util::regex::Pattern$Node)
public:
	Pattern$Curly();
	void init$(::java::util::regex::Pattern$Node* node, int32_t cmin, int32_t cmax, ::java::util::regex::Pattern$Qtype* type);
...
#endif // _java_util_regex_Pattern$Curly_h_