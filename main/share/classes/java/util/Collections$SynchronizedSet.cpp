...
$MethodInfo _Collections$SynchronizedSet_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/Set;)V", "(Ljava/util/Set<TE;>;)V", 0, $method(static_cast<void(Collections$SynchronizedSet::*)($Set*)>(&Collections$SynchronizedSet::init$))},
	{"<init>", "(Ljava/util/Set;Ljava/lang/Object;)V", "(Ljava/util/Set<TE;>;Ljava/lang/Object;)V", 0, $method(static_cast<void(Collections$SynchronizedSet::*)($Set*,Object$*)>(&Collections$SynchronizedSet::init$))},
