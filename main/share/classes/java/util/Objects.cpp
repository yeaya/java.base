...
int32_t Objects::hashCode(Object$* o) {
	return o != nullptr ? $of(o)->hashCode() : 0;
}
...
$String* Objects::toString(Object$* o, $String* nullDefault) {
	return (o != nullptr) ? $of(o)->toString() : nullDefault;
}
...
$Object* Objects::requireNonNullElse(Object$* obj, Object$* defaultObj) {
	return (obj != nullptr) ? $of(obj) : requireNonNull(defaultObj, "defaultObj"_s);
}

$Object* Objects::requireNonNullElseGet(Object$* obj, $Supplier* supplier) {
	return (obj != nullptr) ? $of(obj) : requireNonNull($($sure($Supplier, requireNonNull(supplier, "supplier"_s))->get()), "supplier.get()"_s);
}

$Object* Objects::requireNonNull(Object$* obj, $Supplier* messageSupplier) {
	if (obj == nullptr) {
		$throwNew($NullPointerException, messageSupplier == nullptr ? ($String*)nullptr : $$cast($String, messageSupplier->get()));
	}
	return $of(obj);
}

int32_t Objects::checkIndex(int32_t index, int32_t length) {
	return $Preconditions::checkIndex(index, length, nullptr);
}

int32_t Objects::checkFromToIndex(int32_t fromIndex, int32_t toIndex, int32_t length) {
	return $Preconditions::checkFromToIndex(fromIndex, toIndex, length, nullptr);
}

int32_t Objects::checkFromIndexSize(int32_t fromIndex, int32_t size, int32_t length) {
	return $Preconditions::checkFromIndexSize(fromIndex, size, length, nullptr);
}
...
$Class* Objects::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"checkIndex", "(II)I", nullptr, $PUBLIC | $STATIC, $staticMethod(Objects, checkIndex, int32_t, int32_t, int32_t), nullptr, nullptr, checkIndexmethodAnnotations$$},
		{"checkIndex", "(JJ)J", nullptr, $PUBLIC | $STATIC, $staticMethod(Objects, checkIndex, int64_t, int64_t, int64_t), nullptr, nullptr, checkIndexmethodAnnotations$$$1},
	...
	$loadClass(Objects, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Objects);
	});
	return class$;
}
