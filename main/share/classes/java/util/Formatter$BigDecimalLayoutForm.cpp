...
void Formatter$BigDecimalLayoutForm::clinit$($Class* clazz) {
...
$Class* Formatter$BigDecimalLayoutForm::load$($String* name, bool initialize) {
	...
	$loadClass(Formatter$BigDecimalLayoutForm, name, initialize, &classInfo$$, Formatter$BigDecimalLayoutForm::clinit$, []($Class* clazz) -> $Object* {
