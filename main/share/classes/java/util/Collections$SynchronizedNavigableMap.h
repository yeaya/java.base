#ifndef _java_util_Collections$SynchronizedNavigableMap_h_
#define _java_util_Collections$SynchronizedNavigableMap_h_
//$ class java.util.Collections$SynchronizedNavigableMap
//$ extends java.util.Collections$SynchronizedSortedMap
...
class $export Collections$SynchronizedNavigableMap : public ::java::util::Collections$SynchronizedSortedMap, public ::java::util::NavigableMap {
...
public:
	...
	void init$(::java::util::NavigableMap* m, Object$* mutex);
	...
	static const int64_t serialVersionUID = (int64_t)0x09B4BD8B2CD84EF7;
...
#endif // _java_util_Collections$SynchronizedNavigableMap_h_