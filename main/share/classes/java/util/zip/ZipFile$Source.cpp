...
$MethodInfo _ZipFile$Source_MethodInfo_[] = {
	{"<init>", "(Ljava/util/zip/ZipFile$Source$Key;ZLjava/util/zip/ZipCoder;)V", nullptr, $PRIVATE, $method(static_cast<void(ZipFile$Source::*)($ZipFile$Source$Key*,bool,$ZipCoder*)>(&ZipFile$Source::init$)), "java.io.IOException"},
	{"checkAndAddEntry", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)(int32_t,int32_t)>(&ZipFile$Source::checkAndAddEntry)), "java.util.zip.ZipException"},
	{"close", "()V", nullptr, $PRIVATE, $method(static_cast<void(ZipFile$Source::*)()>(&ZipFile$Source::close)), "java.io.IOException"},
	{"countCENHeaders", "([BI)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($bytes*,int32_t)>(&ZipFile$Source::countCENHeaders))},
	{"findEND", "()Ljava/util/zip/ZipFile$Source$End;", nullptr, $PRIVATE, $method(static_cast<$ZipFile$Source$End*(ZipFile$Source::*)()>(&ZipFile$Source::findEND)), "java.io.IOException"},
	{"get", "(Ljava/io/File;ZLjava/util/zip/ZipCoder;)Ljava/util/zip/ZipFile$Source;", nullptr, $STATIC, $method(static_cast<ZipFile$Source*(*)($File*,bool,$ZipCoder*)>(&ZipFile$Source::get)), "java.io.IOException"},
	{"getEntryHash", "(I)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)(int32_t)>(&ZipFile$Source::getEntryHash))},
	{"getEntryNext", "(I)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)(int32_t)>(&ZipFile$Source::getEntryNext))},
	{"getEntryPos", "(I)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)(int32_t)>(&ZipFile$Source::getEntryPos))},
	{"getEntryPos", "(Ljava/lang/String;Z)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)($String*,bool)>(&ZipFile$Source::getEntryPos))},
	{"getMetaVersion", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)(int32_t,int32_t)>(&ZipFile$Source::getMetaVersion))},
	{"initCEN", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(ZipFile$Source::*)(int32_t)>(&ZipFile$Source::initCEN)), "java.io.IOException"},
	{"isManifestName", "(II)Z", nullptr, $PRIVATE, $method(static_cast<bool(ZipFile$Source::*)(int32_t,int32_t)>(&ZipFile$Source::isManifestName))},
	{"isMetaName", "([BII)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($bytes*,int32_t,int32_t)>(&ZipFile$Source::isMetaName))},
	{"isSignatureRelated", "(II)Z", nullptr, $PRIVATE, $method(static_cast<bool(ZipFile$Source::*)(int32_t,int32_t)>(&ZipFile$Source::isSignatureRelated))},
	{"nextEntryPos", "(III)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ZipFile$Source::*)(int32_t,int32_t,int32_t)>(&ZipFile$Source::nextEntryPos))},
	{"readAt", "([BIIJ)I", nullptr, $PRIVATE | $FINAL, $method(static_cast<int32_t(ZipFile$Source::*)($bytes*,int32_t,int32_t,int64_t)>(&ZipFile$Source::readAt)), "java.io.IOException"},
	{"readFullyAt", "([BIIJ)I", nullptr, $PRIVATE | $FINAL, $method(static_cast<int32_t(ZipFile$Source::*)($bytes*,int32_t,int32_t,int64_t)>(&ZipFile$Source::readFullyAt)), "java.io.IOException"},
	{"release", "(Ljava/util/zip/ZipFile$Source;)V", nullptr, $STATIC, $method(static_cast<void(*)(ZipFile$Source*)>(&ZipFile$Source::release)), "java.io.IOException"},
	{"zerror", "(Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*)>(&ZipFile$Source::zerror)), "java.util.zip.ZipException"},
	{"zipCoderForPos", "(I)Ljava/util/zip/ZipCoder;", nullptr, $PRIVATE, $method(static_cast<$ZipCoder*(ZipFile$Source::*)(int32_t)>(&ZipFile$Source::zipCoderForPos))},
	{}
};
