...
$MethodInfo _AbstractList_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(AbstractList::*)()>(&AbstractList::init$))},
	...
	{"outOfBoundsMsg", "(I)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(AbstractList::*)(int32_t)>(&AbstractList::outOfBoundsMsg))},
	{"*parallelStream", "()Ljava/util/stream/Stream;", nullptr, $PUBLIC | $ABSTRACT},
	{"rangeCheckForAdd", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(AbstractList::*)(int32_t)>(&AbstractList::rangeCheckForAdd))},
	...
	{"subListRangeCheck", "(III)V", nullptr, $STATIC, $method(static_cast<void(*)(int32_t,int32_t,int32_t)>(&AbstractList::subListRangeCheck))},
