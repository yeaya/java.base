#ifndef _java_util_ComparableTimSort_h_
#define _java_util_ComparableTimSort_h_
...
class ComparableTimSort : public ::java::lang::Object {
...
public:
	...
	static int32_t gallopLeft(::java::lang::Comparable* key, $ObjectArray* a, int32_t base, int32_t len, int32_t hint);
	static int32_t gallopRight(::java::lang::Comparable* key, $ObjectArray* a, int32_t base, int32_t len, int32_t hint);
	...
	static void sort($ObjectArray* a, int32_t lo, int32_t hi, $ObjectArray* work, int32_t workBase, int32_t workLen);
...
#endif // _java_util_ComparableTimSort_h_