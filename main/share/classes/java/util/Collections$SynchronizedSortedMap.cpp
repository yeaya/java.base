...
$MethodInfo _Collections$SynchronizedSortedMap_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/SortedMap;)V", "(Ljava/util/SortedMap<TK;TV;>;)V", 0, $method(static_cast<void(Collections$SynchronizedSortedMap::*)($SortedMap*)>(&Collections$SynchronizedSortedMap::init$))},
	{"<init>", "(Ljava/util/SortedMap;Ljava/lang/Object;)V", "(Ljava/util/SortedMap<TK;TV;>;Ljava/lang/Object;)V", 0, $method(static_cast<void(Collections$SynchronizedSortedMap::*)($SortedMap*,Object$*)>(&Collections$SynchronizedSortedMap::init$))},
