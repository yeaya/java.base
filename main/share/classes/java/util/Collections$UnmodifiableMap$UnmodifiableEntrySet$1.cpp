...
$Object* Collections$UnmodifiableMap$UnmodifiableEntrySet$1::next() {
	return $new($Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry, $$cast($Map$Entry, $nc(this->i)->next()));
}
...
$Class* Collections$UnmodifiableMap$UnmodifiableEntrySet$1::load$($String* name, bool initialize) {
	...
	$loadClass(Collections$UnmodifiableMap$UnmodifiableEntrySet$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Collections$UnmodifiableMap$UnmodifiableEntrySet$1);
	});
	return class$;
}
