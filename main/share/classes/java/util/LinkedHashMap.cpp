...
$MethodInfo _LinkedHashMap_MethodInfo_[] = {
	{"<init>", "(IF)V", nullptr, $PUBLIC, $method(static_cast<void(LinkedHashMap::*)(int32_t,float)>(&LinkedHashMap::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(LinkedHashMap::*)(int32_t)>(&LinkedHashMap::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LinkedHashMap::*)()>(&LinkedHashMap::init$))},
	{"<init>", "(Ljava/util/Map;)V", "(Ljava/util/Map<+TK;+TV;>;)V", $PUBLIC, $method(static_cast<void(LinkedHashMap::*)($Map*)>(&LinkedHashMap::init$))},
	{"<init>", "(IFZ)V", nullptr, $PUBLIC, $method(static_cast<void(LinkedHashMap::*)(int32_t,float,bool)>(&LinkedHashMap::init$))},
	...
	{"keysToArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", "<T:Ljava/lang/Object;>([TT;)[TT;", $FINAL},
	{"linkNodeLast", "(Ljava/util/LinkedHashMap$Entry;)V", "(Ljava/util/LinkedHashMap$Entry<TK;TV;>;)V", $PRIVATE, $method(static_cast<void(LinkedHashMap::*)($LinkedHashMap$Entry*)>(&LinkedHashMap::linkNodeLast))},
	...
	{"transferLinks", "(Ljava/util/LinkedHashMap$Entry;Ljava/util/LinkedHashMap$Entry;)V", "(Ljava/util/LinkedHashMap$Entry<TK;TV;>;Ljava/util/LinkedHashMap$Entry<TK;TV;>;)V", $PRIVATE, $method(static_cast<void(LinkedHashMap::*)($LinkedHashMap$Entry*,$LinkedHashMap$Entry*)>(&LinkedHashMap::transferLinks))},
	{"values", "()Ljava/util/Collection;", "()Ljava/util/Collection<TV;>;", $PUBLIC},
	{"valuesToArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", "<T:Ljava/lang/Object;>([TT;)[TT;", $FINAL},
	{}
};
