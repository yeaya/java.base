...
InputMismatchException::InputMismatchException(const InputMismatchException& e) {
}

InputMismatchException InputMismatchException::wrapper$() {
	$pendingException(this);
	return *this;
}

void InputMismatchException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
