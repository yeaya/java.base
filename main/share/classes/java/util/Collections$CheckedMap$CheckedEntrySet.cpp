...
$MethodInfo _Collections$CheckedMap$CheckedEntrySet_MethodInfo_[] = {
	{"<init>", "(Ljava/util/Set;Ljava/lang/Class;)V", "(Ljava/util/Set<Ljava/util/Map$Entry<TK;TV;>;>;Ljava/lang/Class<TV;>;)V", 0, $method(static_cast<void(Collections$CheckedMap$CheckedEntrySet::*)($Set*,$Class*)>(&Collections$CheckedMap$CheckedEntrySet::init$))},
	...
	{"batchRemove", "(Ljava/util/Collection;Z)Z", "(Ljava/util/Collection<*>;Z)Z", $PRIVATE, $method(static_cast<bool(Collections$CheckedMap$CheckedEntrySet::*)($Collection*,bool)>(&Collections$CheckedMap$CheckedEntrySet::batchRemove))},
	{"checkedEntry", "(Ljava/util/Map$Entry;Ljava/lang/Class;)Ljava/util/Collections$CheckedMap$CheckedEntrySet$CheckedEntry;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;T:Ljava/lang/Object;>(Ljava/util/Map$Entry<TK;TV;>;Ljava/lang/Class<TT;>;)Ljava/util/Collections$CheckedMap$CheckedEntrySet$CheckedEntry<TK;TV;TT;>;", $STATIC, $method(static_cast<$Collections$CheckedMap$CheckedEntrySet$CheckedEntry*(*)($Map$Entry*,$Class*)>(&Collections$CheckedMap$CheckedEntrySet::checkedEntry))},
