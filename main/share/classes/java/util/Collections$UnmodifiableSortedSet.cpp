...
$Class* Collections$UnmodifiableSortedSet::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/util/SortedSet;)V", "(Ljava/util/SortedSet<TE;>;)V", 0, $method(Collections$UnmodifiableSortedSet, init$, void, $SortedSet*)},
		{"comparator", "()Ljava/util/Comparator;", "()Ljava/util/Comparator<-TE;>;", $PUBLIC, $virtualMethod(Collections$UnmodifiableSortedSet, comparator, $Comparator*)},
		{"first", "()Ljava/lang/Object;", "()TE;", $PUBLIC, $virtualMethod(Collections$UnmodifiableSortedSet, first, $Object*)},
		{"headSet", "(Ljava/lang/Object;)Ljava/util/SortedSet;", "(TE;)Ljava/util/SortedSet<TE;>;", $PUBLIC, $virtualMethod(Collections$UnmodifiableSortedSet, headSet, $SortedSet*, Object$*)},
		{"*isEmpty", "()Z", nullptr, $PUBLIC},
		{"*iterator", "()Ljava/util/Iterator;", nullptr, $PUBLIC},
		{"last", "()Ljava/lang/Object;", "()TE;", $PUBLIC, $virtualMethod(Collections$UnmodifiableSortedSet, last, $Object*)},
		...
		{"subSet", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/SortedSet;", "(TE;TE;)Ljava/util/SortedSet<TE;>;", $PUBLIC, $virtualMethod(Collections$UnmodifiableSortedSet, subSet, $SortedSet*, Object$*, Object$*)},
		{"tailSet", "(Ljava/lang/Object;)Ljava/util/SortedSet;", "(TE;)Ljava/util/SortedSet<TE;>;", $PUBLIC, $virtualMethod(Collections$UnmodifiableSortedSet, tailSet, $SortedSet*, Object$*)},
	...
	$loadClass(Collections$UnmodifiableSortedSet, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
