...
$MethodInfo _Collections$CheckedNavigableSet_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/NavigableSet;Ljava/lang/Class;)V", "(Ljava/util/NavigableSet<TE;>;Ljava/lang/Class<TE;>;)V", 0, $method(static_cast<void(Collections$CheckedNavigableSet::*)($NavigableSet*,$Class*)>(&Collections$CheckedNavigableSet::init$))},
