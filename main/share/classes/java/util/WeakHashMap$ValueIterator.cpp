...
$Class* WeakHashMap$ValueIterator::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/util/WeakHashMap;)V", nullptr, $PRIVATE, $method(WeakHashMap$ValueIterator, init$, void, $WeakHashMap*)},
		{"next", "()Ljava/lang/Object;", "()TV;", $PUBLIC, $virtualMethod(WeakHashMap$ValueIterator, next, $Object*)},
		{}
	};
	...
	$loadClass(WeakHashMap$ValueIterator, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(WeakHashMap$ValueIterator);
	});
	return class$;
}
