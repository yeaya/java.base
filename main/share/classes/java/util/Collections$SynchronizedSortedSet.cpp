...
$MethodInfo _Collections$SynchronizedSortedSet_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/SortedSet;)V", "(Ljava/util/SortedSet<TE;>;)V", 0, $method(static_cast<void(Collections$SynchronizedSortedSet::*)($SortedSet*)>(&Collections$SynchronizedSortedSet::init$))},
	{"<init>", "(Ljava/util/SortedSet;Ljava/lang/Object;)V", "(Ljava/util/SortedSet<TE;>;Ljava/lang/Object;)V", 0, $method(static_cast<void(Collections$SynchronizedSortedSet::*)($SortedSet*,Object$*)>(&Collections$SynchronizedSortedSet::init$))},
