...
$MethodInfo _JumboEnumSet_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/Class;[Ljava/lang/Enum;)V", "(Ljava/lang/Class<TE;>;[Ljava/lang/Enum<*>;)V", 0, $method(static_cast<void(JumboEnumSet::*)($Class*,$EnumArray*)>(&JumboEnumSet::init$))},
	...
	{"recalculateSize", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(JumboEnumSet::*)()>(&JumboEnumSet::recalculateSize))},
