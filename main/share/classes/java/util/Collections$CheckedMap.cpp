...
$Class* Collections$CheckedMap$$Lambda$lambda$typeCheck$0::load$($String* name, bool initialize) {
	...
	$loadClass(Collections$CheckedMap$$Lambda$lambda$typeCheck$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Collections$CheckedMap$$Lambda$lambda$typeCheck$0);
	});
	return class$;
}
...
$Class* Collections$CheckedMap$$Lambda$lambda$computeIfAbsent$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(Collections$CheckedMap$$Lambda$lambda$computeIfAbsent$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Collections$CheckedMap$$Lambda$lambda$computeIfAbsent$1$1);
	});
	return class$;
}
...
$Class* Collections$CheckedMap$$Lambda$lambda$merge$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(Collections$CheckedMap$$Lambda$lambda$merge$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Collections$CheckedMap$$Lambda$lambda$merge$2$2);
	});
	return class$;
}
...
$BiFunction* Collections$CheckedMap::typeCheck($BiFunction* func) {
	...
	return $new(Collections$CheckedMap$$Lambda$lambda$typeCheck$0, this, func);
}
...
$Object* Collections$CheckedMap::put(Object$* key, Object$* value) {
	typeCheck(key, value);
	return $nc(this->m)->put(key, value);
}
...
$Object* Collections$CheckedMap::putIfAbsent(Object$* key, Object$* value) {
	typeCheck(key, value);
	return $nc(this->m)->putIfAbsent(key, value);
}
...
$Object* Collections$CheckedMap::replace(Object$* key, Object$* value) {
	typeCheck(key, value);
	return $nc(this->m)->replace(key, value);
}

$Object* Collections$CheckedMap::computeIfAbsent(Object$* key, $Function* mappingFunction) {
	$Objects::requireNonNull(mappingFunction);
	return $nc(this->m)->computeIfAbsent(key, $$new(Collections$CheckedMap$$Lambda$lambda$computeIfAbsent$1$1, this, mappingFunction));
}

$Object* Collections$CheckedMap::computeIfPresent(Object$* key, $BiFunction* remappingFunction) {
	return $nc(this->m)->computeIfPresent(key, $(typeCheck(remappingFunction)));
}

$Object* Collections$CheckedMap::compute(Object$* key, $BiFunction* remappingFunction) {
	return $nc(this->m)->compute(key, $(typeCheck(remappingFunction)));
}

$Object* Collections$CheckedMap::merge(Object$* key, Object$* value, $BiFunction* remappingFunction) {
	$Objects::requireNonNull(remappingFunction);
	return $nc(this->m)->merge(key, value, $$new(Collections$CheckedMap$$Lambda$lambda$merge$2$2, this, remappingFunction));
}
...
$Class* Collections$CheckedMap::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.Collections$CheckedMap$$Lambda$lambda$typeCheck$0")) {
			return Collections$CheckedMap$$Lambda$lambda$typeCheck$0::load$(name, initialize);
		}
		if (name->equals("java.util.Collections$CheckedMap$$Lambda$lambda$computeIfAbsent$1$1")) {
			return Collections$CheckedMap$$Lambda$lambda$computeIfAbsent$1$1::load$(name, initialize);
		}
		if (name->equals("java.util.Collections$CheckedMap$$Lambda$lambda$merge$2$2")) {
	...
	$loadClass(Collections$CheckedMap, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
