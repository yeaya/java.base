...
$Class* DoublePredicate$$Lambda$lambda$and$0::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePredicate$$Lambda$lambda$and$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePredicate$$Lambda$lambda$and$0);
	});
	return class$;
}
...
$Class* DoublePredicate$$Lambda$lambda$negate$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePredicate$$Lambda$lambda$negate$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePredicate$$Lambda$lambda$negate$1$1);
	});
	return class$;
}
...
$Class* DoublePredicate$$Lambda$lambda$or$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePredicate$$Lambda$lambda$or$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePredicate$$Lambda$lambda$or$2$2);
	});
	return class$;
}
...
DoublePredicate* DoublePredicate::and$(DoublePredicate* other) {
	...
	return $new(DoublePredicate$$Lambda$lambda$and$0, this, other);
}

DoublePredicate* DoublePredicate::negate() {
	return $new(DoublePredicate$$Lambda$lambda$negate$1$1, this);
}

DoublePredicate* DoublePredicate::or$(DoublePredicate* other) {
	$Objects::requireNonNull(other);
	return $new(DoublePredicate$$Lambda$lambda$or$2$2, this, other);
}
...
$Class* DoublePredicate::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.function.DoublePredicate$$Lambda$lambda$and$0")) {
			return DoublePredicate$$Lambda$lambda$and$0::load$(name, initialize);
		}
		if (name->equals("java.util.function.DoublePredicate$$Lambda$lambda$negate$1$1")) {
			return DoublePredicate$$Lambda$lambda$negate$1$1::load$(name, initialize);
		}
		if (name->equals("java.util.function.DoublePredicate$$Lambda$lambda$or$2$2")) {
	...
	$loadClass(DoublePredicate, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePredicate);
	});
	return class$;
}
