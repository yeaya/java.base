...
$Object* Collections$CheckedQueue::peek() {
	return $nc(this->queue)->peek();
}

$Object* Collections$CheckedQueue::poll() {
	return $nc(this->queue)->poll();
}

$Object* Collections$CheckedQueue::remove() {
	return $nc(this->queue)->remove();
}
...
$Class* Collections$CheckedQueue::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/util/Queue;Ljava/lang/Class;)V", "(Ljava/util/Queue<TE;>;Ljava/lang/Class<TE;>;)V", 0, $method(Collections$CheckedQueue, init$, void, $Queue*, $Class*)},
		{"element", "()Ljava/lang/Object;", "()TE;", $PUBLIC, $virtualMethod(Collections$CheckedQueue, element, $Object*)},
		{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC, $virtualMethod(Collections$CheckedQueue, equals, bool, Object$*)},
		{"hashCode", "()I", nullptr, $PUBLIC, $virtualMethod(Collections$CheckedQueue, hashCode, int32_t)},
		{"*isEmpty", "()Z", nullptr, $PUBLIC},
		{"*iterator", "()Ljava/util/Iterator;", nullptr, $PUBLIC},
		{"offer", "(Ljava/lang/Object;)Z", "(TE;)Z", $PUBLIC, $virtualMethod(Collections$CheckedQueue, offer, bool, Object$*)},
		{"*parallelStream", "()Ljava/util/stream/Stream;", nullptr, $PUBLIC},
		{"peek", "()Ljava/lang/Object;", "()TE;", $PUBLIC, $virtualMethod(Collections$CheckedQueue, peek, $Object*)},
		{"poll", "()Ljava/lang/Object;", "()TE;", $PUBLIC, $virtualMethod(Collections$CheckedQueue, poll, $Object*)},
		{"*remove", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
		{"remove", "()Ljava/lang/Object;", "()TE;", $PUBLIC, $virtualMethod(Collections$CheckedQueue, remove, $Object*)},
	...
	$loadClass(Collections$CheckedQueue, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
