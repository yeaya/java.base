#ifndef _java_util_TreeMap$AscendingSubMap_h_
#define _java_util_TreeMap$AscendingSubMap_h_
...
class $export TreeMap$AscendingSubMap : public ::java::util::TreeMap$NavigableSubMap {
	$class(TreeMap$AscendingSubMap, $NO_CLASS_INIT, ::java::util::TreeMap$NavigableSubMap)
public:
...
#endif // _java_util_TreeMap$AscendingSubMap_h_