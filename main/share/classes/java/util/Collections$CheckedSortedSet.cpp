...
$MethodInfo _Collections$CheckedSortedSet_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/SortedSet;Ljava/lang/Class;)V", "(Ljava/util/SortedSet<TE;>;Ljava/lang/Class<TE;>;)V", 0, $method(static_cast<void(Collections$CheckedSortedSet::*)($SortedSet*,$Class*)>(&Collections$CheckedSortedSet::init$))},
