...
$Object0* Streams$IntStreamBuilderImpl::MemberClass0$::toObject0$() const {
	return ($Object0*)(void*)((int8_t*)(void*)this - $offsetof(Streams$IntStreamBuilderImpl, memberClass0$));
}
