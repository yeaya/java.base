...
$Class* LongStream$$Lambda$lambda$mapMulti$0::load$($String* name, bool initialize) {
	...
	$loadClass(LongStream$$Lambda$lambda$mapMulti$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LongStream$$Lambda$lambda$mapMulti$0);
	});
	return class$;
}
...
$Class* LongStream$$Lambda$close$1::load$($String* name, bool initialize) {
	...
	$loadClass(LongStream$$Lambda$close$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LongStream$$Lambda$close$1);
	});
	return class$;
}
...
LongStream* LongStream::mapMulti($LongStream$LongMapMultiConsumer* mapper) {
	...
	return flatMap($$new(LongStream$$Lambda$lambda$mapMulti$0, mapper));
}
...
LongStream* LongStream::takeWhile($LongPredicate* predicate) {
	...
	return $cast(LongStream, $$nc($StreamSupport::longStream(var$0, isParallel()))->onClose($$new(LongStream$$Lambda$close$1, this)));
}
...
LongStream* LongStream::of(int64_t t) {
	$init(LongStream);
	return $StreamSupport::longStream($$cast($Spliterator$OfLong, $new($Streams$LongStreamBuilderImpl, t)), false);
}
...
LongStream* LongStream::generate($LongSupplier* s) {
	...
	return $StreamSupport::longStream($$cast($Spliterator$OfLong, $new($StreamSpliterators$InfiniteSupplyingSpliterator$OfLong, $Long::MAX_VALUE, s)), false);
}
...
$Class* LongStream::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.stream.LongStream$$Lambda$lambda$mapMulti$0")) {
			return LongStream$$Lambda$lambda$mapMulti$0::load$(name, initialize);
		}
		if (name->equals("java.util.stream.LongStream$$Lambda$close$1")) {
	...
	$loadClass(LongStream, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LongStream);
	});
	return class$;
}
