...
$Class* StreamSpliterators$SliceSpliterator$OfDouble$$Lambda$lambda$emptyConsumer$0::load$($String* name, bool initialize) {
	...
	$loadClass(StreamSpliterators$SliceSpliterator$OfDouble$$Lambda$lambda$emptyConsumer$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StreamSpliterators$SliceSpliterator$OfDouble$$Lambda$lambda$emptyConsumer$0);
	});
	return class$;
}
...
$Object* StreamSpliterators$SliceSpliterator$OfDouble::emptyConsumer() {
	return $new(StreamSpliterators$SliceSpliterator$OfDouble$$Lambda$lambda$emptyConsumer$0);
}
...
$Class* StreamSpliterators$SliceSpliterator$OfDouble::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.stream.StreamSpliterators$SliceSpliterator$OfDouble$$Lambda$lambda$emptyConsumer$0")) {
	...
	$loadClass(StreamSpliterators$SliceSpliterator$OfDouble, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
