...
$MethodInfo _Nodes$ConcNode$OfPrimitive_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/stream/Node$OfPrimitive;Ljava/util/stream/Node$OfPrimitive;)V", "(TT_NODE;TT_NODE;)V", 0, $method(static_cast<void(Nodes$ConcNode$OfPrimitive::*)($Node$OfPrimitive*,$Node$OfPrimitive*)>(&Nodes$ConcNode$OfPrimitive::init$))},
	...
	{"getChild", "(I)Ljava/util/stream/Node$OfPrimitive;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
