...
$Class* StreamSpliterators$WrappingSpliterator$$Lambda$accept::load$($String* name, bool initialize) {
	...
	$loadClass(StreamSpliterators$WrappingSpliterator$$Lambda$accept, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StreamSpliterators$WrappingSpliterator$$Lambda$accept);
	});
	return class$;
}
...
$Class* StreamSpliterators$WrappingSpliterator$$Lambda$lambda$initPartialTraversalState$0$1::load$($String* name, bool initialize) {
	...
	$loadClass(StreamSpliterators$WrappingSpliterator$$Lambda$lambda$initPartialTraversalState$0$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StreamSpliterators$WrappingSpliterator$$Lambda$lambda$initPartialTraversalState$0$1);
	});
	return class$;
}
...
$Class* StreamSpliterators$WrappingSpliterator$$Lambda$accept$2::load$($String* name, bool initialize) {
	...
	$loadClass(StreamSpliterators$WrappingSpliterator$$Lambda$accept$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StreamSpliterators$WrappingSpliterator$$Lambda$accept$2);
	});
	return class$;
}
...
void StreamSpliterators$WrappingSpliterator::initPartialTraversalState() {
	...
	$set(this, buffer, b);
	$set(this, bufferSink, $nc(this->ph)->wrapSink($$new(StreamSpliterators$WrappingSpliterator$$Lambda$accept, b)));
	$set(this, pusher, $new(StreamSpliterators$WrappingSpliterator$$Lambda$lambda$initPartialTraversalState$0$1, this));
}
...
void StreamSpliterators$WrappingSpliterator::forEachRemaining($Consumer* consumer) {
	if (this->buffer == nullptr && !this->finished) {
		$Objects::requireNonNull(consumer);
		init();
		$nc(this->ph)->wrapAndCopyInto($cast($Sink, $$new(StreamSpliterators$WrappingSpliterator$$Lambda$accept$2, consumer)), this->spliterator);
		this->finished = true;
	} else {
		do {
...
$Class* StreamSpliterators$WrappingSpliterator::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.stream.StreamSpliterators$WrappingSpliterator$$Lambda$accept")) {
			return StreamSpliterators$WrappingSpliterator$$Lambda$accept::load$(name, initialize);
		}
		if (name->equals("java.util.stream.StreamSpliterators$WrappingSpliterator$$Lambda$lambda$initPartialTraversalState$0$1")) {
			return StreamSpliterators$WrappingSpliterator$$Lambda$lambda$initPartialTraversalState$0$1::load$(name, initialize);
		}
		if (name->equals("java.util.stream.StreamSpliterators$WrappingSpliterator$$Lambda$accept$2")) {
	...
	$loadClass(StreamSpliterators$WrappingSpliterator, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StreamSpliterators$WrappingSpliterator);
	});
	return class$;
}
