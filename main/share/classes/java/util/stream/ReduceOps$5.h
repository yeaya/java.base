#ifndef _java_util_stream_ReduceOps$5_h_
#define _java_util_stream_ReduceOps$5_h_
//$ class java.util.stream.ReduceOps$5
...
class ReduceOps$5 : public ::java::util::stream::ReduceOps$ReduceOp {
	$class(ReduceOps$5, $NO_CLASS_INIT, ::java::util::stream::ReduceOps$ReduceOp)
public:
	ReduceOps$5();
...
#endif // _java_util_stream_ReduceOps$5_h_