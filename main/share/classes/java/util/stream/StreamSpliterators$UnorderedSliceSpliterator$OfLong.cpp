...
$MethodInfo _StreamSpliterators$UnorderedSliceSpliterator$OfLong_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/Spliterator$OfLong;JJ)V", nullptr, 0, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfLong::*)($Spliterator$OfLong*,int64_t,int64_t)>(&StreamSpliterators$UnorderedSliceSpliterator$OfLong::init$))},
	{"<init>", "(Ljava/util/Spliterator$OfLong;Ljava/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfLong;)V", nullptr, 0, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfLong::*)($Spliterator$OfLong*,StreamSpliterators$UnorderedSliceSpliterator$OfLong*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfLong::init$))},
	{"accept", "(J)V", nullptr, $PUBLIC},
	{"acceptConsumed", "(Ljava/util/function/LongConsumer;)V", nullptr, $PROTECTED, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfLong::*)($LongConsumer*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfLong::acceptConsumed))},
	{"acceptConsumed", "(Ljava/lang/Object;)V", nullptr, $PROTECTED | $VOLATILE | $SYNTHETIC},
	{"bufferCreate", "(I)Ljava/util/stream/StreamSpliterators$ArrayBuffer$OfLong;", nullptr, $PROTECTED},
	{"forEachRemaining", "(Ljava/util/function/LongConsumer;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfLong::*)($LongConsumer*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfLong::forEachRemaining))},
	{"makeSpliterator", "(Ljava/util/Spliterator$OfLong;)Ljava/util/Spliterator$OfLong;", nullptr, $PROTECTED, $method(static_cast<$Spliterator$OfLong*(StreamSpliterators$UnorderedSliceSpliterator$OfLong::*)($Spliterator$OfLong*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfLong::makeSpliterator))},
	...
	{"tryAdvance", "(Ljava/util/function/LongConsumer;)Z", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $method(static_cast<bool(StreamSpliterators$UnorderedSliceSpliterator$OfLong::*)($LongConsumer*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfLong::tryAdvance))},
