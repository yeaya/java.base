...
$MethodInfo _IntPipeline$5$1_MethodInfo_[] = {
	{"<init>", "(Ljava/util/stream/IntPipeline$5;Ljava/util/stream/Sink;)V", nullptr, 0, $method(static_cast<void(IntPipeline$5$1::*)($IntPipeline$5*,$Sink*)>(&IntPipeline$5$1::init$))},
