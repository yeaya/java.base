...
$MethodInfo _DoublePipeline$2_MethodInfo_[] = {
	{"<init>", "(Ljava/util/stream/DoublePipeline;Ljava/util/stream/AbstractPipeline;Ljava/util/stream/StreamShape;ILjava/util/function/DoubleUnaryOperator;)V", nullptr, 0, $method(static_cast<void(DoublePipeline$2::*)($DoublePipeline*,$AbstractPipeline*,$StreamShape*,int32_t,$DoubleUnaryOperator*)>(&DoublePipeline$2::init$))},
