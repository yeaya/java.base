#ifndef _java_util_stream_Nodes$InternalNodeSpliterator$OfInt_h_
#define _java_util_stream_Nodes$InternalNodeSpliterator$OfInt_h_
//$ class java.util.stream.Nodes$InternalNodeSpliterator$OfInt
...
class Nodes$InternalNodeSpliterator$OfInt : public ::java::util::stream::Nodes$InternalNodeSpliterator$OfPrimitive {
	$class(Nodes$InternalNodeSpliterator$OfInt, $NO_CLASS_INIT, ::java::util::stream::Nodes$InternalNodeSpliterator$OfPrimitive, ::java::util::Spliterator$OfInt)
public:
	...
	void init$(::java::util::stream::Node$OfInt* cur);
...
#endif // _java_util_stream_Nodes$InternalNodeSpliterator$OfInt_h_