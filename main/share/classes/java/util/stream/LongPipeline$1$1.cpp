...
$FieldInfo _LongPipeline$1$1_FieldInfo_[] = {
	{"this$1", "Ljava/util/stream/LongPipeline$1;", nullptr, $FINAL | $SYNTHETIC, $field(LongPipeline$1$1, this$1)},
	{}
};

$MethodInfo _LongPipeline$1$1_MethodInfo_[] = {
	{"<init>", "(Ljava/util/stream/LongPipeline$1;Ljava/util/stream/Sink;)V", nullptr, 0, $method(static_cast<void(LongPipeline$1$1::*)($LongPipeline$1*,$Sink*)>(&LongPipeline$1$1::init$))},
	{"accept", "(J)V", nullptr, $PUBLIC},
	{}
};

$EnclosingMethodInfo _LongPipeline$1$1_EnclosingMethodInfo_ = {
	"java.util.stream.LongPipeline$1",
	"opWrapSink",
	"(ILjava/util/stream/Sink;)Ljava/util/stream/Sink;"
};

$InnerClassInfo _LongPipeline$1$1_InnerClassesInfo_[] = {
...
$ClassInfo _LongPipeline$1$1_ClassInfo_ = {
	$ACC_SUPER,
	"java.util.stream.LongPipeline$1$1",
	"java.util.stream.Sink$ChainedLong",
	nullptr,
	_LongPipeline$1$1_FieldInfo_,
	_LongPipeline$1$1_MethodInfo_,
	"Ljava/util/stream/Sink$ChainedLong<TU;>;",
	&_LongPipeline$1$1_EnclosingMethodInfo_,
	_LongPipeline$1$1_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$LongPipeline$1$1($Class* clazz) {
...
$Class* LongPipeline$1$1::load$($String* name, bool initialize) {
	$loadClass(LongPipeline$1$1, name, initialize, &_LongPipeline$1$1_ClassInfo_, allocate$LongPipeline$1$1);
	return class$;
}
