...
$Spliterator* StreamSpliterators$InfiniteSupplyingSpliterator$OfInt::trySplit() {
	...
	return $cast($StreamSpliterators$InfiniteSupplyingSpliterator, $new(StreamSpliterators$InfiniteSupplyingSpliterator$OfInt, this->estimate = (int64_t)((uint64_t)this->estimate >> 1), this->s));
}
...
$Class* StreamSpliterators$InfiniteSupplyingSpliterator$OfInt::load$($String* name, bool initialize) {
	...
	$loadClass(StreamSpliterators$InfiniteSupplyingSpliterator$OfInt, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
