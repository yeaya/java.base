#ifndef _java_util_stream_SliceOps$4_h_
#define _java_util_stream_SliceOps$4_h_
//$ class java.util.stream.SliceOps$4
...
class SliceOps$4 : public ::java::util::stream::DoublePipeline$StatefulOp {
	$class(SliceOps$4, $NO_CLASS_INIT, ::java::util::stream::DoublePipeline$StatefulOp)
public:
	SliceOps$4();
	...
	virtual ::java::util::Spliterator$OfDouble* unorderedSkipLimitSpliterator(::java::util::Spliterator$OfDouble* s, int64_t skip, int64_t limit, int64_t sizeIfKnown);
	int64_t val$limit = 0;
...
#endif // _java_util_stream_SliceOps$4_h_