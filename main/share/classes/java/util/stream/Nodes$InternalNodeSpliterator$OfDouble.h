#ifndef _java_util_stream_Nodes$InternalNodeSpliterator$OfDouble_h_
#define _java_util_stream_Nodes$InternalNodeSpliterator$OfDouble_h_
//$ class java.util.stream.Nodes$InternalNodeSpliterator$OfDouble
...
class Nodes$InternalNodeSpliterator$OfDouble : public ::java::util::stream::Nodes$InternalNodeSpliterator$OfPrimitive {
	$class(Nodes$InternalNodeSpliterator$OfDouble, $NO_CLASS_INIT, ::java::util::stream::Nodes$InternalNodeSpliterator$OfPrimitive, ::java::util::Spliterator$OfDouble)
public:
	...
	void init$(::java::util::stream::Node$OfDouble* cur);
...
#endif // _java_util_stream_Nodes$InternalNodeSpliterator$OfDouble_h_