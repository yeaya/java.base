...
$MethodInfo _Nodes$DoubleSpinedNodeBuilder_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(Nodes$DoubleSpinedNodeBuilder::*)()>(&Nodes$DoubleSpinedNodeBuilder::init$))},
	{"accept", "(D)V", nullptr, $PUBLIC},
	{"asPrimitiveArray", "()[D", nullptr, $PUBLIC},
	{"begin", "(J)V", nullptr, $PUBLIC},
	{"build", "()Ljava/util/stream/Node$OfDouble;", nullptr, $PUBLIC},
	{"copyInto", "([DI)V", nullptr, $PUBLIC, $method(static_cast<void(Nodes$DoubleSpinedNodeBuilder::*)($doubles*,int32_t)>(&Nodes$DoubleSpinedNodeBuilder::copyInto))},
	{"copyInto", "(Ljava/lang/Object;I)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"end", "()V", nullptr, $PUBLIC},
	{"forEach", "(Ljava/util/function/DoubleConsumer;)V", nullptr, $PUBLIC, $method(static_cast<void(Nodes$DoubleSpinedNodeBuilder::*)($DoubleConsumer*)>(&Nodes$DoubleSpinedNodeBuilder::forEach))},
