...
$Spliterator$OfPrimitive* SpinedBuffer$OfDouble$1Splitr::newSpliterator(int32_t firstSpineIndex, int32_t lastSpineIndex, int32_t firstSpineElementIndex, int32_t lastSpineElementFence) {
	return $cast($SpinedBuffer$OfPrimitive$BaseSpliterator, $new(SpinedBuffer$OfDouble$1Splitr, this->this$0, firstSpineIndex, lastSpineIndex, firstSpineElementIndex, lastSpineElementFence));
}
...
$Class* SpinedBuffer$OfDouble$1Splitr::load$($String* name, bool initialize) {
	...
	$loadClass(SpinedBuffer$OfDouble$1Splitr, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
