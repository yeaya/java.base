...
$MethodInfo _SpinedBuffer$OfDouble$1Splitr_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/stream/SpinedBuffer$OfDouble;IIII)V", nullptr, 0, $method(static_cast<void(SpinedBuffer$OfDouble$1Splitr::*)($SpinedBuffer$OfDouble*,int32_t,int32_t,int32_t,int32_t)>(&SpinedBuffer$OfDouble$1Splitr::init$))},
	{"arrayForOne", "([DILjava/util/function/DoubleConsumer;)V", nullptr, 0},
	{"arrayForOne", "(Ljava/lang/Object;ILjava/lang/Object;)V", nullptr, $VOLATILE | $SYNTHETIC},
	{"arraySpliterator", "([DII)Ljava/util/Spliterator$OfDouble;", nullptr, 0},
	...
	{"newSpliterator", "(IIII)Ljava/util/stream/SpinedBuffer$OfDouble$1Splitr;", nullptr, 0},
