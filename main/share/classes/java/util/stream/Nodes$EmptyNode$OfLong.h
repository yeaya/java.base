#ifndef _java_util_stream_Nodes$EmptyNode$OfLong_h_
#define _java_util_stream_Nodes$EmptyNode$OfLong_h_
...
class Nodes$EmptyNode$OfLong : public ::java::util::stream::Nodes$EmptyNode {
	$class(Nodes$EmptyNode$OfLong, $NO_CLASS_INIT, ::java::util::stream::Nodes$EmptyNode, ::java::util::stream::Node$OfLong)
public:
...
#endif // _java_util_stream_Nodes$EmptyNode$OfLong_h_