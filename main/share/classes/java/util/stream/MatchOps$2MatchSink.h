#ifndef _java_util_stream_MatchOps$2MatchSink_h_
#define _java_util_stream_MatchOps$2MatchSink_h_
//$ class java.util.stream.MatchOps$2MatchSink
...
class MatchOps$2MatchSink : public ::java::util::stream::MatchOps$BooleanTerminalSink, public ::java::util::stream::Sink$OfInt {
...
public:
	...
	void init$(::java::util::stream::MatchOps$MatchKind* val$matchKind, ::java::util::function::IntPredicate* val$predicate);
...
#endif // _java_util_stream_MatchOps$2MatchSink_h_