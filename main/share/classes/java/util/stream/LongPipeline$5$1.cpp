...
$MethodInfo _LongPipeline$5$1_MethodInfo_[] = {
	{"<init>", "(Ljava/util/stream/LongPipeline$5;Ljava/util/stream/Sink;)V", nullptr, 0, $method(static_cast<void(LongPipeline$5$1::*)($LongPipeline$5*,$Sink*)>(&LongPipeline$5$1::init$))},
