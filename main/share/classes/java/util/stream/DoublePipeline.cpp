...
$Class* DoublePipeline$$Lambda$accept::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$accept, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$accept);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$valueOf$1::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$valueOf$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$valueOf$1);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$distinct$0$2::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$distinct$0$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$distinct$0$2);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$sum$1$3::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$sum$1$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$sum$1$3);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$sum$2$4::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$sum$2$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$sum$2$4);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$sum$3$5::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$sum$3$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$sum$3$5);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$min$6::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$min$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$min$6);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$max$7::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$max$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$max$7);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$average$4$8::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$average$4$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$average$4$8);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$average$5$9::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$average$5$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$average$5$9);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$average$6$10::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$average$6$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$average$6$10);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$DoubleSummaryStatistics$11::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$DoubleSummaryStatistics$11, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$DoubleSummaryStatistics$11);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$accept$12::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$accept$12, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$accept$12);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$combine$13::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$combine$13, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$combine$13);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$collect$7$14::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$collect$7$14, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$collect$7$14);
	});
	return class$;
}
...
$Class* DoublePipeline$$Lambda$lambda$toArray$8$15::load$($String* name, bool initialize) {
	...
	$loadClass(DoublePipeline$$Lambda$lambda$toArray$8$15, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DoublePipeline$$Lambda$lambda$toArray$8$15);
	});
	return class$;
}
...
$DoubleConsumer* DoublePipeline::adapt($Sink* sink) {
	...
	if ($instanceOf($DoubleConsumer, sink)) {
		...
		return $new(DoublePipeline$$Lambda$accept, $nc(sink));
	}
}
...
$Spliterator* DoublePipeline::wrap($PipelineHelper* ph, $Supplier* supplier, bool isParallel) {
	return $cast($StreamSpliterators$AbstractWrappingSpliterator, $new($StreamSpliterators$DoubleWrappingSpliterator, ph, supplier, isParallel));
}

$Spliterator* DoublePipeline::lazySpliterator($Supplier* supplier) {
	return $cast($StreamSpliterators$DelegatingSpliterator, $new($StreamSpliterators$DelegatingSpliterator$OfDouble, supplier));
}
...
$Stream* DoublePipeline::boxed() {
	return mapToObj($$new(DoublePipeline$$Lambda$valueOf$1), 0);
}
...
$BaseStream* DoublePipeline::unordered() {
	...
	$init($StreamShape);
	$init($StreamOpFlag);
	return $cast($AbstractPipeline, $new($DoublePipeline$7, this, this, $StreamShape::DOUBLE_VALUE, $StreamOpFlag::NOT_ORDERED));
}
...
$DoubleStream* DoublePipeline::distinct() {
	$useLocalObjectStack();
	return $$nc($$nc(boxed())->distinct())->mapToDouble($$new(DoublePipeline$$Lambda$lambda$distinct$0$2));
}
...
double DoublePipeline::sum() {
	$useLocalObjectStack();
	$var($Supplier, var$0, $new(DoublePipeline$$Lambda$lambda$sum$1$3));
	$var($ObjDoubleConsumer, var$1, $new(DoublePipeline$$Lambda$lambda$sum$2$4));
	$var($doubles, summation, $cast($doubles, collect(var$0, var$1, $$new(DoublePipeline$$Lambda$lambda$sum$3$5))));
	return $Collectors::computeFinalSum(summation);
}

$OptionalDouble* DoublePipeline::min() {
	return reduce($$new(DoublePipeline$$Lambda$min$6));
}

$OptionalDouble* DoublePipeline::max() {
	return reduce($$new(DoublePipeline$$Lambda$max$7));
}

$OptionalDouble* DoublePipeline::average() {
	$useLocalObjectStack();
	$var($Supplier, var$0, $new(DoublePipeline$$Lambda$lambda$average$4$8));
	$var($ObjDoubleConsumer, var$1, $new(DoublePipeline$$Lambda$lambda$average$5$9));
	$var($doubles, avg, $cast($doubles, collect(var$0, var$1, $$new(DoublePipeline$$Lambda$lambda$average$6$10))));
	return $nc(avg)->get(2) > 0 ? $OptionalDouble::of($Collectors::computeFinalSum(avg) / avg->get(2)) : $OptionalDouble::empty();
}

int64_t DoublePipeline::count() {
	$useLocalObjectStack();
	return $$sure($Long, evaluate($($ReduceOps::makeDoubleCounting())))->longValue();
}

$DoubleSummaryStatistics* DoublePipeline::summaryStatistics() {
	$useLocalObjectStack();
	$var($Supplier, var$0, $new(DoublePipeline$$Lambda$DoubleSummaryStatistics$11));
	$var($ObjDoubleConsumer, var$1, $new(DoublePipeline$$Lambda$accept$12));
	return $cast($DoubleSummaryStatistics, collect(var$0, var$1, $$new(DoublePipeline$$Lambda$combine$13)));
}

double DoublePipeline::reduce(double identity, $DoubleBinaryOperator* op) {
	$useLocalObjectStack();
	return $$sure($Double, evaluate($($ReduceOps::makeDouble(identity, op))))->doubleValue();
}
...
$Object* DoublePipeline::collect($Supplier* supplier, $ObjDoubleConsumer* accumulator, $BiConsumer* combiner) {
	...
	$var($BinaryOperator, operator$, $new(DoublePipeline$$Lambda$lambda$collect$7$14, combiner));
...
bool DoublePipeline::anyMatch($DoublePredicate* predicate) {
	...
	return $$sure($Boolean, evaluate($($MatchOps::makeDouble(predicate, $MatchOps$MatchKind::ANY))))->booleanValue();
}

bool DoublePipeline::allMatch($DoublePredicate* predicate) {
	$useLocalObjectStack();
	$init($MatchOps$MatchKind);
	return $$sure($Boolean, evaluate($($MatchOps::makeDouble(predicate, $MatchOps$MatchKind::ALL))))->booleanValue();
}

bool DoublePipeline::noneMatch($DoublePredicate* predicate) {
	$useLocalObjectStack();
	$init($MatchOps$MatchKind);
	return $$sure($Boolean, evaluate($($MatchOps::makeDouble(predicate, $MatchOps$MatchKind::NONE))))->booleanValue();
}
...
$doubles* DoublePipeline::toArray() {
	$useLocalObjectStack();
	return $cast($doubles, $$nc($Nodes::flattenDouble($$cast($Node$OfDouble, evaluateToArrayNode($$new(DoublePipeline$$Lambda$lambda$toArray$8$15)))))->asPrimitiveArray());
}
...
void DoublePipeline::lambda$average$6($doubles* ll, $doubles* rr) {
	...
	$Collectors::sumWithCompensation(ll, rr->get(1));
	(*$nc(ll))[2] += rr->get(2);
	(*ll)[3] += rr->get(3);
}
...
$Class* DoublePipeline::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$accept")) {
			return DoublePipeline$$Lambda$accept::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$valueOf$1")) {
			return DoublePipeline$$Lambda$valueOf$1::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$distinct$0$2")) {
			return DoublePipeline$$Lambda$lambda$distinct$0$2::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$sum$1$3")) {
			return DoublePipeline$$Lambda$lambda$sum$1$3::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$sum$2$4")) {
			return DoublePipeline$$Lambda$lambda$sum$2$4::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$sum$3$5")) {
			return DoublePipeline$$Lambda$lambda$sum$3$5::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$min$6")) {
			return DoublePipeline$$Lambda$min$6::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$max$7")) {
			return DoublePipeline$$Lambda$max$7::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$average$4$8")) {
			return DoublePipeline$$Lambda$lambda$average$4$8::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$average$5$9")) {
			return DoublePipeline$$Lambda$lambda$average$5$9::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$average$6$10")) {
			return DoublePipeline$$Lambda$lambda$average$6$10::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$DoubleSummaryStatistics$11")) {
			return DoublePipeline$$Lambda$DoubleSummaryStatistics$11::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$accept$12")) {
			return DoublePipeline$$Lambda$accept$12::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$combine$13")) {
			return DoublePipeline$$Lambda$combine$13::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$collect$7$14")) {
			return DoublePipeline$$Lambda$lambda$collect$7$14::load$(name, initialize);
		}
		if (name->equals("java.util.stream.DoublePipeline$$Lambda$lambda$toArray$8$15")) {
	...
	$loadClass(DoublePipeline, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
