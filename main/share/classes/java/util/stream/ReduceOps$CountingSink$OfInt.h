#ifndef _java_util_stream_ReduceOps$CountingSink$OfInt_h_
#define _java_util_stream_ReduceOps$CountingSink$OfInt_h_
//$ class java.util.stream.ReduceOps$CountingSink$OfInt
...
class ReduceOps$CountingSink$OfInt : public ::java::util::stream::ReduceOps$CountingSink, public ::java::util::stream::Sink$OfInt {
	$class(ReduceOps$CountingSink$OfInt, $NO_CLASS_INIT, ::java::util::stream::ReduceOps$CountingSink, ::java::util::stream::Sink$OfInt)
public:
	ReduceOps$CountingSink$OfInt();
...
#endif // _java_util_stream_ReduceOps$CountingSink$OfInt_h_