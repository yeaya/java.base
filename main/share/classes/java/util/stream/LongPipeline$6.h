#ifndef _java_util_stream_LongPipeline$6_h_
#define _java_util_stream_LongPipeline$6_h_
//$ class java.util.stream.LongPipeline$6
...
class LongPipeline$6 : public ::java::util::stream::LongPipeline$StatelessOp {
	$class(LongPipeline$6, $NO_CLASS_INIT, ::java::util::stream::LongPipeline$StatelessOp)
public:
	LongPipeline$6();
...
#endif // _java_util_stream_LongPipeline$6_h_