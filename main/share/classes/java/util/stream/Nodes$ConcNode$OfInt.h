#ifndef _java_util_stream_Nodes$ConcNode$OfInt_h_
#define _java_util_stream_Nodes$ConcNode$OfInt_h_
//$ class java.util.stream.Nodes$ConcNode$OfInt
...
class Nodes$ConcNode$OfInt : public ::java::util::stream::Nodes$ConcNode$OfPrimitive {
	$class(Nodes$ConcNode$OfInt, $NO_CLASS_INIT, ::java::util::stream::Nodes$ConcNode$OfPrimitive, ::java::util::stream::Node$OfInt)
public:
	...
	void init$(::java::util::stream::Node$OfInt* left, ::java::util::stream::Node$OfInt* right);
...
#endif // _java_util_stream_Nodes$ConcNode$OfInt_h_