#ifndef _java_util_stream_WhileOps$UnorderedWhileSpliterator$OfInt$Dropping_h_
#define _java_util_stream_WhileOps$UnorderedWhileSpliterator$OfInt$Dropping_h_
//$ class java.util.stream.WhileOps$UnorderedWhileSpliterator$OfInt$Dropping
...
class WhileOps$UnorderedWhileSpliterator$OfInt$Dropping : public ::java::util::stream::WhileOps$UnorderedWhileSpliterator$OfInt {
	$class(WhileOps$UnorderedWhileSpliterator$OfInt$Dropping, $NO_CLASS_INIT, ::java::util::stream::WhileOps$UnorderedWhileSpliterator$OfInt)
public:
	WhileOps$UnorderedWhileSpliterator$OfInt$Dropping();
...
#endif // _java_util_stream_WhileOps$UnorderedWhileSpliterator$OfInt$Dropping_h_