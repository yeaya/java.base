#ifndef _java_util_stream_ReferencePipeline$7_h_
#define _java_util_stream_ReferencePipeline$7_h_
//$ class java.util.stream.ReferencePipeline$7
...
class ReferencePipeline$7 : public ::java::util::stream::ReferencePipeline$StatelessOp {
	$class(ReferencePipeline$7, $NO_CLASS_INIT, ::java::util::stream::ReferencePipeline$StatelessOp)
public:
	ReferencePipeline$7();
...
#endif // _java_util_stream_ReferencePipeline$7_h_