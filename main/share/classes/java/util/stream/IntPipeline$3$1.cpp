...
$MethodInfo _IntPipeline$3$1_MethodInfo_[] = {
	{"<init>", "(Ljava/util/stream/IntPipeline$3;Ljava/util/stream/Sink;)V", nullptr, 0, $method(static_cast<void(IntPipeline$3$1::*)($IntPipeline$3*,$Sink*)>(&IntPipeline$3$1::init$))},
