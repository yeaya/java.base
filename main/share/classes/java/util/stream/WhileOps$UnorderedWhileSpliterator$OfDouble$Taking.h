#ifndef _java_util_stream_WhileOps$UnorderedWhileSpliterator$OfDouble$Taking_h_
#define _java_util_stream_WhileOps$UnorderedWhileSpliterator$OfDouble$Taking_h_
//$ class java.util.stream.WhileOps$UnorderedWhileSpliterator$OfDouble$Taking
...
class WhileOps$UnorderedWhileSpliterator$OfDouble$Taking : public ::java::util::stream::WhileOps$UnorderedWhileSpliterator$OfDouble {
	$class(WhileOps$UnorderedWhileSpliterator$OfDouble$Taking, $NO_CLASS_INIT, ::java::util::stream::WhileOps$UnorderedWhileSpliterator$OfDouble)
public:
	WhileOps$UnorderedWhileSpliterator$OfDouble$Taking();
...
#endif // _java_util_stream_WhileOps$UnorderedWhileSpliterator$OfDouble$Taking_h_