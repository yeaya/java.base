...
$MethodInfo _WhileOps_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(WhileOps::*)()>(&WhileOps::init$))},
	{"makeDropWhileDouble", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/DoublePredicate;)Ljava/util/stream/DoubleStream;", "(Ljava/util/stream/AbstractPipeline<*Ljava/lang/Double;*>;Ljava/util/function/DoublePredicate;)Ljava/util/stream/DoubleStream;", $STATIC, $method(static_cast<$DoubleStream*(*)($AbstractPipeline*,$DoublePredicate*)>(&WhileOps::makeDropWhileDouble))},
	{"makeDropWhileInt", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/IntPredicate;)Ljava/util/stream/IntStream;", "(Ljava/util/stream/AbstractPipeline<*Ljava/lang/Integer;*>;Ljava/util/function/IntPredicate;)Ljava/util/stream/IntStream;", $STATIC, $method(static_cast<$IntStream*(*)($AbstractPipeline*,$IntPredicate*)>(&WhileOps::makeDropWhileInt))},
	{"makeDropWhileLong", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;", "(Ljava/util/stream/AbstractPipeline<*Ljava/lang/Long;*>;Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;", $STATIC, $method(static_cast<$LongStream*(*)($AbstractPipeline*,$LongPredicate*)>(&WhileOps::makeDropWhileLong))},
	{"makeDropWhileRef", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/Predicate;)Ljava/util/stream/Stream;", "<T:Ljava/lang/Object;>(Ljava/util/stream/AbstractPipeline<*TT;*>;Ljava/util/function/Predicate<-TT;>;)Ljava/util/stream/Stream<TT;>;", $STATIC, $method(static_cast<$Stream*(*)($AbstractPipeline*,$Predicate*)>(&WhileOps::makeDropWhileRef))},
	{"makeTakeWhileDouble", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/DoublePredicate;)Ljava/util/stream/DoubleStream;", "(Ljava/util/stream/AbstractPipeline<*Ljava/lang/Double;*>;Ljava/util/function/DoublePredicate;)Ljava/util/stream/DoubleStream;", $STATIC, $method(static_cast<$DoubleStream*(*)($AbstractPipeline*,$DoublePredicate*)>(&WhileOps::makeTakeWhileDouble))},
	{"makeTakeWhileInt", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/IntPredicate;)Ljava/util/stream/IntStream;", "(Ljava/util/stream/AbstractPipeline<*Ljava/lang/Integer;*>;Ljava/util/function/IntPredicate;)Ljava/util/stream/IntStream;", $STATIC, $method(static_cast<$IntStream*(*)($AbstractPipeline*,$IntPredicate*)>(&WhileOps::makeTakeWhileInt))},
	{"makeTakeWhileLong", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;", "(Ljava/util/stream/AbstractPipeline<*Ljava/lang/Long;*>;Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;", $STATIC, $method(static_cast<$LongStream*(*)($AbstractPipeline*,$LongPredicate*)>(&WhileOps::makeTakeWhileLong))},
	{"makeTakeWhileRef", "(Ljava/util/stream/AbstractPipeline;Ljava/util/function/Predicate;)Ljava/util/stream/Stream;", "<T:Ljava/lang/Object;>(Ljava/util/stream/AbstractPipeline<*TT;*>;Ljava/util/function/Predicate<-TT;>;)Ljava/util/stream/Stream<TT;>;", $STATIC, $method(static_cast<$Stream*(*)($AbstractPipeline*,$Predicate*)>(&WhileOps::makeTakeWhileRef))},
	{}
};
