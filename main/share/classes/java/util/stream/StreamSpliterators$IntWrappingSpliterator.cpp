...
$Object0* StreamSpliterators$IntWrappingSpliterator::MemberClass0$::toObject0$() const {
	return ($Object0*)(void*)((int8_t*)(void*)this - $offsetof(StreamSpliterators$IntWrappingSpliterator, memberClass0$));
}
