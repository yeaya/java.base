#ifndef _java_util_stream_WhileOps$3Op$1OpSink_h_
#define _java_util_stream_WhileOps$3Op$1OpSink_h_
//$ class java.util.stream.WhileOps$3Op$1OpSink
...
class WhileOps$3Op$1OpSink : public ::java::util::stream::Sink$ChainedLong, public ::java::util::stream::WhileOps$DropWhileSink {
...
public:
	...
	void init$(::java::util::stream::WhileOps$3Op* this$0, ::java::util::stream::Sink* val$sink, bool val$retainAndCountDroppedElements);
	virtual void accept(int64_t t) override;
	virtual int64_t getDropCount() override;
	virtual $String* toString() override;
	::java::util::stream::WhileOps$3Op* this$0 = nullptr;
...
#endif // _java_util_stream_WhileOps$3Op$1OpSink_h_