#ifndef _java_util_stream_ReduceOps$5ReducingSink_h_
#define _java_util_stream_ReduceOps$5ReducingSink_h_
//$ class java.util.stream.ReduceOps$5ReducingSink
...
class ReduceOps$5ReducingSink : public ::java::util::stream::ReduceOps$AccumulatingSink, public ::java::util::stream::Sink$OfInt {
	$class(ReduceOps$5ReducingSink, $NO_CLASS_INIT, ::java::util::stream::ReduceOps$AccumulatingSink, ::java::util::stream::Sink$OfInt)
public:
	...
	void init$(int32_t val$identity, ::java::util::function::IntBinaryOperator* val$operator);
	virtual void accept(int32_t t) override;
	virtual void begin(int64_t size) override;
	virtual void combine(::java::util::stream::ReduceOps$5ReducingSink* other);
...
#endif // _java_util_stream_ReduceOps$5ReducingSink_h_