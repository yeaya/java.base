#ifndef _java_util_stream_DoublePipeline$5_h_
#define _java_util_stream_DoublePipeline$5_h_
//$ class java.util.stream.DoublePipeline$5
...
class DoublePipeline$5 : public ::java::util::stream::DoublePipeline$StatelessOp {
	$class(DoublePipeline$5, $NO_CLASS_INIT, ::java::util::stream::DoublePipeline$StatelessOp)
public:
	DoublePipeline$5();
...
#endif // _java_util_stream_DoublePipeline$5_h_