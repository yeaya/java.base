...
Collectors$1PairBox* Collectors$1PairBox::combine(Collectors$1PairBox* other) {
	...
	$set(this, right, $nc(this->val$c2Combiner)->apply(this->right, other->right));
	return this;
}
...
$Object* Collectors$1PairBox::get() {
	...
	return $nc(this->val$merger)->apply(r1, r2);
}
...
$Class* Collectors$1PairBox::load$($String* name, bool initialize) {
	...
	$loadClass(Collectors$1PairBox, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Collectors$1PairBox);
	});
	return class$;
}
