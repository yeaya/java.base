...
$MethodInfo _StreamSpliterators$UnorderedSliceSpliterator$OfDouble_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/Spliterator$OfDouble;JJ)V", nullptr, 0, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfDouble::*)($Spliterator$OfDouble*,int64_t,int64_t)>(&StreamSpliterators$UnorderedSliceSpliterator$OfDouble::init$))},
	{"<init>", "(Ljava/util/Spliterator$OfDouble;Ljava/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfDouble;)V", nullptr, 0, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfDouble::*)($Spliterator$OfDouble*,StreamSpliterators$UnorderedSliceSpliterator$OfDouble*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfDouble::init$))},
	{"accept", "(D)V", nullptr, $PUBLIC},
	{"acceptConsumed", "(Ljava/util/function/DoubleConsumer;)V", nullptr, $PROTECTED, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfDouble::*)($DoubleConsumer*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfDouble::acceptConsumed))},
	{"acceptConsumed", "(Ljava/lang/Object;)V", nullptr, $PROTECTED | $VOLATILE | $SYNTHETIC},
	{"bufferCreate", "(I)Ljava/util/stream/StreamSpliterators$ArrayBuffer$OfDouble;", nullptr, $PROTECTED},
	{"forEachRemaining", "(Ljava/util/function/DoubleConsumer;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfDouble::*)($DoubleConsumer*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfDouble::forEachRemaining))},
	{"makeSpliterator", "(Ljava/util/Spliterator$OfDouble;)Ljava/util/Spliterator$OfDouble;", nullptr, $PROTECTED, $method(static_cast<$Spliterator$OfDouble*(StreamSpliterators$UnorderedSliceSpliterator$OfDouble::*)($Spliterator$OfDouble*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfDouble::makeSpliterator))},
	...
	{"tryAdvance", "(Ljava/util/function/DoubleConsumer;)Z", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $method(static_cast<bool(StreamSpliterators$UnorderedSliceSpliterator$OfDouble::*)($DoubleConsumer*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfDouble::tryAdvance))},
...
$Object0* StreamSpliterators$UnorderedSliceSpliterator$OfDouble::MemberClass0$::toObject0$() const {
	return ($Object0*)(void*)((int8_t*)(void*)this - $offsetof(StreamSpliterators$UnorderedSliceSpliterator$OfDouble, memberClass0$));
}
