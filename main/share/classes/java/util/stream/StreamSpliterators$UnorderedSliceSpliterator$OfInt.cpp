...
StreamSpliterators$UnorderedSliceSpliterator$OfInt::MemberClass0$::MemberClass0$() {
	$patchMemberClass(StreamSpliterators$UnorderedSliceSpliterator$OfInt, $Spliterator$OfInt, memberClass0$);
}
