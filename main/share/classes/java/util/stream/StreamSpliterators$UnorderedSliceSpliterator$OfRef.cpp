...
$MethodInfo _StreamSpliterators$UnorderedSliceSpliterator$OfRef_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/Spliterator;JJ)V", "(Ljava/util/Spliterator<TT;>;JJ)V", 0, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfRef::*)($Spliterator*,int64_t,int64_t)>(&StreamSpliterators$UnorderedSliceSpliterator$OfRef::init$))},
	{"<init>", "(Ljava/util/Spliterator;Ljava/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfRef;)V", "(Ljava/util/Spliterator<TT;>;Ljava/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfRef<TT;>;)V", 0, $method(static_cast<void(StreamSpliterators$UnorderedSliceSpliterator$OfRef::*)($Spliterator*,StreamSpliterators$UnorderedSliceSpliterator$OfRef*)>(&StreamSpliterators$UnorderedSliceSpliterator$OfRef::init$))},
	{"accept", "(Ljava/lang/Object;)V", "(TT;)V", $PUBLIC | $FINAL},
	{"forEachRemaining", "(Ljava/util/function/Consumer;)V", "(Ljava/util/function/Consumer<-TT;>;)V", $PUBLIC},
	{"makeSpliterator", "(Ljava/util/Spliterator;)Ljava/util/Spliterator;", "(Ljava/util/Spliterator<TT;>;)Ljava/util/Spliterator<TT;>;", $PROTECTED},
