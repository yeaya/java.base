...
$MethodInfo Collections$CheckedList$$Lambda$lambda$replaceAll$0::methodInfos[3] = {
	{"<init>", "(Ljava/util/Collections$CheckedList;Ljava/util/function/UnaryOperator;)V", nullptr, $PUBLIC, $method(static_cast<void(Collections$CheckedList$$Lambda$lambda$replaceAll$0::*)(Collections$CheckedList*,$UnaryOperator*)>(&Collections$CheckedList$$Lambda$lambda$replaceAll$0::init$))},
...
$MethodInfo _Collections$CheckedList_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/List;Ljava/lang/Class;)V", "(Ljava/util/List<TE;>;Ljava/lang/Class<TE;>;)V", 0, $method(static_cast<void(Collections$CheckedList::*)($List*,$Class*)>(&Collections$CheckedList::init$))},
	...
	{"lambda$replaceAll$0", "(Ljava/util/function/UnaryOperator;Ljava/lang/Object;)Ljava/lang/Object;", nullptr, $PRIVATE | $SYNTHETIC, $method(static_cast<$Object*(Collections$CheckedList::*)($UnaryOperator*,Object$*)>(&Collections$CheckedList::lambda$replaceAll$0))},
