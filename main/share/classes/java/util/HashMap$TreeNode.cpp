...
$MethodInfo _HashMap$TreeNode_MethodInfo_[] = {
	{"<init>", "(ILjava/lang/Object;Ljava/lang/Object;Ljava/util/HashMap$Node;)V", "(ITK;TV;Ljava/util/HashMap$Node<TK;TV;>;)V", 0, $method(static_cast<void(HashMap$TreeNode::*)(int32_t,Object$*,Object$*,$HashMap$Node*)>(&HashMap$TreeNode::init$))},
	{"balanceDeletion", "(Ljava/util/HashMap$TreeNode;Ljava/util/HashMap$TreeNode;)Ljava/util/HashMap$TreeNode;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/HashMap$TreeNode<TK;TV;>;Ljava/util/HashMap$TreeNode<TK;TV;>;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $STATIC, $method(static_cast<HashMap$TreeNode*(*)(HashMap$TreeNode*,HashMap$TreeNode*)>(&HashMap$TreeNode::balanceDeletion))},
	{"balanceInsertion", "(Ljava/util/HashMap$TreeNode;Ljava/util/HashMap$TreeNode;)Ljava/util/HashMap$TreeNode;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/HashMap$TreeNode<TK;TV;>;Ljava/util/HashMap$TreeNode<TK;TV;>;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $STATIC, $method(static_cast<HashMap$TreeNode*(*)(HashMap$TreeNode*,HashMap$TreeNode*)>(&HashMap$TreeNode::balanceInsertion))},
	{"checkInvariants", "(Ljava/util/HashMap$TreeNode;)Z", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/HashMap$TreeNode<TK;TV;>;)Z", $STATIC, $method(static_cast<bool(*)(HashMap$TreeNode*)>(&HashMap$TreeNode::checkInvariants))},
	{"find", "(ILjava/lang/Object;Ljava/lang/Class;)Ljava/util/HashMap$TreeNode;", "(ILjava/lang/Object;Ljava/lang/Class<*>;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $FINAL, $method(static_cast<HashMap$TreeNode*(HashMap$TreeNode::*)(int32_t,Object$*,$Class*)>(&HashMap$TreeNode::find))},
	{"getTreeNode", "(ILjava/lang/Object;)Ljava/util/HashMap$TreeNode;", "(ILjava/lang/Object;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $FINAL, $method(static_cast<HashMap$TreeNode*(HashMap$TreeNode::*)(int32_t,Object$*)>(&HashMap$TreeNode::getTreeNode))},
	{"moveRootToFront", "([Ljava/util/HashMap$Node;Ljava/util/HashMap$TreeNode;)V", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>([Ljava/util/HashMap$Node<TK;TV;>;Ljava/util/HashMap$TreeNode<TK;TV;>;)V", $STATIC, $method(static_cast<void(*)($HashMap$NodeArray*,HashMap$TreeNode*)>(&HashMap$TreeNode::moveRootToFront))},
	{"putTreeVal", "(Ljava/util/HashMap;[Ljava/util/HashMap$Node;ILjava/lang/Object;Ljava/lang/Object;)Ljava/util/HashMap$TreeNode;", "(Ljava/util/HashMap<TK;TV;>;[Ljava/util/HashMap$Node<TK;TV;>;ITK;TV;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $FINAL, $method(static_cast<HashMap$TreeNode*(HashMap$TreeNode::*)($HashMap*,$HashMap$NodeArray*,int32_t,Object$*,Object$*)>(&HashMap$TreeNode::putTreeVal))},
	{"removeTreeNode", "(Ljava/util/HashMap;[Ljava/util/HashMap$Node;Z)V", "(Ljava/util/HashMap<TK;TV;>;[Ljava/util/HashMap$Node<TK;TV;>;Z)V", $FINAL, $method(static_cast<void(HashMap$TreeNode::*)($HashMap*,$HashMap$NodeArray*,bool)>(&HashMap$TreeNode::removeTreeNode))},
	{"root", "()Ljava/util/HashMap$TreeNode;", "()Ljava/util/HashMap$TreeNode<TK;TV;>;", $FINAL, $method(static_cast<HashMap$TreeNode*(HashMap$TreeNode::*)()>(&HashMap$TreeNode::root))},
	{"rotateLeft", "(Ljava/util/HashMap$TreeNode;Ljava/util/HashMap$TreeNode;)Ljava/util/HashMap$TreeNode;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/HashMap$TreeNode<TK;TV;>;Ljava/util/HashMap$TreeNode<TK;TV;>;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $STATIC, $method(static_cast<HashMap$TreeNode*(*)(HashMap$TreeNode*,HashMap$TreeNode*)>(&HashMap$TreeNode::rotateLeft))},
	{"rotateRight", "(Ljava/util/HashMap$TreeNode;Ljava/util/HashMap$TreeNode;)Ljava/util/HashMap$TreeNode;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/HashMap$TreeNode<TK;TV;>;Ljava/util/HashMap$TreeNode<TK;TV;>;)Ljava/util/HashMap$TreeNode<TK;TV;>;", $STATIC, $method(static_cast<HashMap$TreeNode*(*)(HashMap$TreeNode*,HashMap$TreeNode*)>(&HashMap$TreeNode::rotateRight))},
	{"split", "(Ljava/util/HashMap;[Ljava/util/HashMap$Node;II)V", "(Ljava/util/HashMap<TK;TV;>;[Ljava/util/HashMap$Node<TK;TV;>;II)V", $FINAL, $method(static_cast<void(HashMap$TreeNode::*)($HashMap*,$HashMap$NodeArray*,int32_t,int32_t)>(&HashMap$TreeNode::split))},
	{"tieBreakOrder", "(Ljava/lang/Object;Ljava/lang/Object;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(Object$*,Object$*)>(&HashMap$TreeNode::tieBreakOrder))},
	{"treeify", "([Ljava/util/HashMap$Node;)V", "([Ljava/util/HashMap$Node<TK;TV;>;)V", $FINAL, $method(static_cast<void(HashMap$TreeNode::*)($HashMap$NodeArray*)>(&HashMap$TreeNode::treeify))},
	{"untreeify", "(Ljava/util/HashMap;)Ljava/util/HashMap$Node;", "(Ljava/util/HashMap<TK;TV;>;)Ljava/util/HashMap$Node<TK;TV;>;", $FINAL, $method(static_cast<$HashMap$Node*(HashMap$TreeNode::*)($HashMap*)>(&HashMap$TreeNode::untreeify))},
	{}
};
