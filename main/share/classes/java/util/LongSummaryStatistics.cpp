...
$Class* LongSummaryStatistics::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "()V", nullptr, $PUBLIC, $method(LongSummaryStatistics, init$, void)},
		{"<init>", "(JJJJ)V", nullptr, $PUBLIC, $method(LongSummaryStatistics, init$, void, int64_t, int64_t, int64_t, int64_t), "java.lang.IllegalArgumentException"},
		{"accept", "(I)V", nullptr, $PUBLIC, $virtualMethod(LongSummaryStatistics, accept, void, int32_t)},
		{"accept", "(J)V", nullptr, $PUBLIC, $virtualMethod(LongSummaryStatistics, accept, void, int64_t)},
		{"combine", "(Ljava/util/LongSummaryStatistics;)V", nullptr, $PUBLIC, $virtualMethod(LongSummaryStatistics, combine, void, LongSummaryStatistics*)},
		{"getAverage", "()D", nullptr, $PUBLIC | $FINAL, $method(LongSummaryStatistics, getAverage, double)},
		{"getCount", "()J", nullptr, $PUBLIC | $FINAL, $method(LongSummaryStatistics, getCount, int64_t)},
		{"getMax", "()J", nullptr, $PUBLIC | $FINAL, $method(LongSummaryStatistics, getMax, int64_t)},
		{"getMin", "()J", nullptr, $PUBLIC | $FINAL, $method(LongSummaryStatistics, getMin, int64_t)},
		{"getSum", "()J", nullptr, $PUBLIC | $FINAL, $method(LongSummaryStatistics, getSum, int64_t)},
		{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(LongSummaryStatistics, toString, $String*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$PUBLIC | $ACC_SUPER,
	...
	$loadClass(LongSummaryStatistics, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
