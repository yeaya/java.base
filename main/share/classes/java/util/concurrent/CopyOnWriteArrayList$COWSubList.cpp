...
$MethodInfo CopyOnWriteArrayList$COWSubList$$Lambda$lambda$removeAll$0::methodInfos[3] = {
	{"<init>", "(Ljava/util/Collection;)V", nullptr, $PUBLIC, $method(static_cast<void(CopyOnWriteArrayList$COWSubList$$Lambda$lambda$removeAll$0::*)($Collection*)>(&CopyOnWriteArrayList$COWSubList$$Lambda$lambda$removeAll$0::init$))},
...
$MethodInfo CopyOnWriteArrayList$COWSubList$$Lambda$lambda$retainAll$1$1::methodInfos[3] = {
	{"<init>", "(Ljava/util/Collection;)V", nullptr, $PUBLIC, $method(static_cast<void(CopyOnWriteArrayList$COWSubList$$Lambda$lambda$retainAll$1$1::*)($Collection*)>(&CopyOnWriteArrayList$COWSubList$$Lambda$lambda$retainAll$1$1::init$))},
	{"test", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{}
};
...
$MethodInfo _CopyOnWriteArrayList$COWSubList_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/concurrent/CopyOnWriteArrayList;[Ljava/lang/Object;II)V", nullptr, 0, $method(static_cast<void(CopyOnWriteArrayList$COWSubList::*)($CopyOnWriteArrayList*,$ObjectArray*,int32_t,int32_t)>(&CopyOnWriteArrayList$COWSubList::init$))},
	...
	{"bulkRemove", "(Ljava/util/function/Predicate;)Z", "(Ljava/util/function/Predicate<-TE;>;)Z", $PRIVATE, $method(static_cast<bool(CopyOnWriteArrayList$COWSubList::*)($Predicate*)>(&CopyOnWriteArrayList$COWSubList::bulkRemove))},
	{"checkForComodification", "()V", nullptr, $PRIVATE, $method(static_cast<void(CopyOnWriteArrayList$COWSubList::*)()>(&CopyOnWriteArrayList$COWSubList::checkForComodification))},
	...
	{"getArrayChecked", "()[Ljava/lang/Object;", nullptr, $PRIVATE, $method(static_cast<$ObjectArray*(CopyOnWriteArrayList$COWSubList::*)()>(&CopyOnWriteArrayList$COWSubList::getArrayChecked))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"indexOf", "(Ljava/lang/Object;)I", nullptr, $PUBLIC},
	{"isEmpty", "()Z", nullptr, $PUBLIC},
	{"iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<TE;>;", $PUBLIC},
	{"lambda$removeAll$0", "(Ljava/util/Collection;Ljava/lang/Object;)Z", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<bool(*)($Collection*,Object$*)>(&CopyOnWriteArrayList$COWSubList::lambda$removeAll$0))},
	{"lambda$retainAll$1", "(Ljava/util/Collection;Ljava/lang/Object;)Z", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<bool(*)($Collection*,Object$*)>(&CopyOnWriteArrayList$COWSubList::lambda$retainAll$1))},
	...
	{"rangeCheck", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(CopyOnWriteArrayList$COWSubList::*)(int32_t)>(&CopyOnWriteArrayList$COWSubList::rangeCheck))},
	{"rangeCheckForAdd", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(CopyOnWriteArrayList$COWSubList::*)(int32_t)>(&CopyOnWriteArrayList$COWSubList::rangeCheckForAdd))},
