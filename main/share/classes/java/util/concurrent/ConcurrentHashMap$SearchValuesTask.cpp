...
$Class* ConcurrentHashMap$SearchValuesTask::load$($String* name, bool initialize) {
	...
	$loadClass(ConcurrentHashMap$SearchValuesTask, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
