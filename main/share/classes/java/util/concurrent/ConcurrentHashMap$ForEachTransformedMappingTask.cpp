...
$Class* ConcurrentHashMap$ForEachTransformedMappingTask::load$($String* name, bool initialize) {
	...
	$loadClass(ConcurrentHashMap$ForEachTransformedMappingTask, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
