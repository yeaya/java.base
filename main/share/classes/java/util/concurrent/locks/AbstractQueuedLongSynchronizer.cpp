...
$MethodInfo _AbstractQueuedLongSynchronizer_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::init$))},
	{"acquire", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;JZZZJ)I", nullptr, $FINAL, $method(static_cast<int32_t(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$Node*,int64_t,bool,bool,bool,int64_t)>(&AbstractQueuedLongSynchronizer::acquire))},
	{"acquire", "(J)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::acquire))},
	{"acquireInterruptibly", "(J)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::acquireInterruptibly)), "java.lang.InterruptedException"},
	{"acquireShared", "(J)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::acquireShared))},
	{"acquireSharedInterruptibly", "(J)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::acquireSharedInterruptibly)), "java.lang.InterruptedException"},
	{"apparentlyFirstQueuedIsExclusive", "()Z", nullptr, $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::apparentlyFirstQueuedIsExclusive))},
	{"cancelAcquire", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;ZZ)I", nullptr, $PRIVATE, $method(static_cast<int32_t(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$Node*,bool,bool)>(&AbstractQueuedLongSynchronizer::cancelAcquire))},
	{"casTail", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;)Z", nullptr, $PRIVATE, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$Node*,$AbstractQueuedLongSynchronizer$Node*)>(&AbstractQueuedLongSynchronizer::casTail))},
	{"cleanQueue", "()V", nullptr, $PRIVATE, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::cleanQueue))},
	{"compareAndSetState", "(JJ)Z", nullptr, $PROTECTED | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)(int64_t,int64_t)>(&AbstractQueuedLongSynchronizer::compareAndSetState))},
	{"enqueue", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;)V", nullptr, $FINAL, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$Node*)>(&AbstractQueuedLongSynchronizer::enqueue))},
	{"getExclusiveQueuedThreads", "()Ljava/util/Collection;", "()Ljava/util/Collection<Ljava/lang/Thread;>;", $PUBLIC | $FINAL, $method(static_cast<$Collection*(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::getExclusiveQueuedThreads))},
	{"getFirstQueuedThread", "()Ljava/lang/Thread;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$Thread*(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::getFirstQueuedThread))},
	{"getQueueLength", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::getQueueLength))},
	{"getQueuedThreads", "()Ljava/util/Collection;", "()Ljava/util/Collection<Ljava/lang/Thread;>;", $PUBLIC | $FINAL, $method(static_cast<$Collection*(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::getQueuedThreads))},
	{"getSharedQueuedThreads", "()Ljava/util/Collection;", "()Ljava/util/Collection<Ljava/lang/Thread;>;", $PUBLIC | $FINAL, $method(static_cast<$Collection*(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::getSharedQueuedThreads))},
	{"getState", "()J", nullptr, $PROTECTED | $FINAL, $method(static_cast<int64_t(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::getState))},
	{"getWaitQueueLength", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$ConditionObject*)>(&AbstractQueuedLongSynchronizer::getWaitQueueLength))},
	{"getWaitingThreads", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Ljava/util/Collection;", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Ljava/util/Collection<Ljava/lang/Thread;>;", $PUBLIC | $FINAL, $method(static_cast<$Collection*(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$ConditionObject*)>(&AbstractQueuedLongSynchronizer::getWaitingThreads))},
	{"hasContended", "()Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::hasContended))},
	{"hasQueuedPredecessors", "()Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::hasQueuedPredecessors))},
	{"hasQueuedThreads", "()Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::hasQueuedThreads))},
	{"hasWaiters", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$ConditionObject*)>(&AbstractQueuedLongSynchronizer::hasWaiters))},
	{"isEnqueued", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;)Z", nullptr, $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$Node*)>(&AbstractQueuedLongSynchronizer::isEnqueued))},
	{"isHeldExclusively", "()Z", nullptr, $PROTECTED},
	{"isQueued", "(Ljava/lang/Thread;)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)($Thread*)>(&AbstractQueuedLongSynchronizer::isQueued))},
	{"owns", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)($AbstractQueuedLongSynchronizer$ConditionObject*)>(&AbstractQueuedLongSynchronizer::owns))},
	{"release", "(J)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::release))},
	{"releaseShared", "(J)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::releaseShared))},
	{"setState", "(J)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)(int64_t)>(&AbstractQueuedLongSynchronizer::setState))},
	{"signalNext", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($AbstractQueuedLongSynchronizer$Node*)>(&AbstractQueuedLongSynchronizer::signalNext))},
	{"signalNextIfShared", "(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$Node;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($AbstractQueuedLongSynchronizer$Node*)>(&AbstractQueuedLongSynchronizer::signalNextIfShared))},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"tryAcquire", "(J)Z", nullptr, $PROTECTED},
	{"tryAcquireNanos", "(JJ)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)(int64_t,int64_t)>(&AbstractQueuedLongSynchronizer::tryAcquireNanos)), "java.lang.InterruptedException"},
	{"tryAcquireShared", "(J)J", nullptr, $PROTECTED},
	{"tryAcquireSharedNanos", "(JJ)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(AbstractQueuedLongSynchronizer::*)(int64_t,int64_t)>(&AbstractQueuedLongSynchronizer::tryAcquireSharedNanos)), "java.lang.InterruptedException"},
	{"tryInitializeHead", "()V", nullptr, $PRIVATE, $method(static_cast<void(AbstractQueuedLongSynchronizer::*)()>(&AbstractQueuedLongSynchronizer::tryInitializeHead))},
	{"tryRelease", "(J)Z", nullptr, $PROTECTED},
	{"tryReleaseShared", "(J)Z", nullptr, $PROTECTED},
	{}
};
