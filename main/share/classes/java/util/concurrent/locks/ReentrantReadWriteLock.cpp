...
void ReentrantReadWriteLock::init$(bool fair) {
	$set(this, sync, fair ? $cast($ReentrantReadWriteLock$Sync, $new($ReentrantReadWriteLock$FairSync)) : $cast($ReentrantReadWriteLock$Sync, $new($ReentrantReadWriteLock$NonfairSync)));
...
$Class* ReentrantReadWriteLock::load$($String* name, bool initialize) {
	...
	$loadClass(ReentrantReadWriteLock, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
