...
$MethodInfo ConcurrentSkipListSet$$Lambda$lambda$setMap$0::methodInfos[3] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ConcurrentSkipListSet$$Lambda$lambda$setMap$0::*)()>(&ConcurrentSkipListSet$$Lambda$lambda$setMap$0::init$))},
...
$MethodInfo _ConcurrentSkipListSet_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ConcurrentSkipListSet::*)()>(&ConcurrentSkipListSet::init$))},
	{"<init>", "(Ljava/util/Comparator;)V", "(Ljava/util/Comparator<-TE;>;)V", $PUBLIC, $method(static_cast<void(ConcurrentSkipListSet::*)($Comparator*)>(&ConcurrentSkipListSet::init$))},
	{"<init>", "(Ljava/util/Collection;)V", "(Ljava/util/Collection<+TE;>;)V", $PUBLIC, $method(static_cast<void(ConcurrentSkipListSet::*)($Collection*)>(&ConcurrentSkipListSet::init$))},
	{"<init>", "(Ljava/util/SortedSet;)V", "(Ljava/util/SortedSet<TE;>;)V", $PUBLIC, $method(static_cast<void(ConcurrentSkipListSet::*)($SortedSet*)>(&ConcurrentSkipListSet::init$))},
	{"<init>", "(Ljava/util/concurrent/ConcurrentNavigableMap;)V", "(Ljava/util/concurrent/ConcurrentNavigableMap<TE;Ljava/lang/Object;>;)V", 0, $method(static_cast<void(ConcurrentSkipListSet::*)($ConcurrentNavigableMap*)>(&ConcurrentSkipListSet::init$))},
	{"add", "(Ljava/lang/Object;)Z", "(TE;)Z", $PUBLIC},
	{"ceiling", "(Ljava/lang/Object;)Ljava/lang/Object;", "(TE;)TE;", $PUBLIC},
	{"clear", "()V", nullptr, $PUBLIC},
	{"clone", "()Ljava/util/concurrent/ConcurrentSkipListSet;", "()Ljava/util/concurrent/ConcurrentSkipListSet<TE;>;", $PUBLIC},
	...
	{"lambda$setMap$0", "()Ljava/lang/reflect/Field;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$Field*(*)()>(&ConcurrentSkipListSet::lambda$setMap$0))},
	...
	{"setMap", "(Ljava/util/concurrent/ConcurrentNavigableMap;)V", "(Ljava/util/concurrent/ConcurrentNavigableMap<TE;Ljava/lang/Object;>;)V", $PRIVATE, $method(static_cast<void(ConcurrentSkipListSet::*)($ConcurrentNavigableMap*)>(&ConcurrentSkipListSet::setMap))},
