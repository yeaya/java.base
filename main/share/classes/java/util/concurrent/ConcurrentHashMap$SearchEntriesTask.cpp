...
$Class* ConcurrentHashMap$SearchEntriesTask::load$($String* name, bool initialize) {
	...
	$loadClass(ConcurrentHashMap$SearchEntriesTask, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
