...
$MethodInfo _SynchronousQueue_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SynchronousQueue::*)()>(&SynchronousQueue::init$))},
	{"<init>", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(SynchronousQueue::*)(bool)>(&SynchronousQueue::init$))},
	...
	{"readObject", "(Ljava/io/ObjectInputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(SynchronousQueue::*)($ObjectInputStream*)>(&SynchronousQueue::readObject)), "java.io.IOException,java.lang.ClassNotFoundException"},
	...
	{"writeObject", "(Ljava/io/ObjectOutputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(SynchronousQueue::*)($ObjectOutputStream*)>(&SynchronousQueue::writeObject)), "java.io.IOException"},
	{}
};
