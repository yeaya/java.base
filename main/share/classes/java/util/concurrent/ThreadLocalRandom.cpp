...
$MethodInfo _ThreadLocalRandom_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(ThreadLocalRandom::*)()>(&ThreadLocalRandom::init$))},
	{"advanceProbe", "(I)I", nullptr, $STATIC | $FINAL, $method(static_cast<int32_t(*)(int32_t)>(&ThreadLocalRandom::advanceProbe))},
	{"current", "()Ljava/util/concurrent/ThreadLocalRandom;", nullptr, $PUBLIC | $STATIC, $method(static_cast<ThreadLocalRandom*(*)()>(&ThreadLocalRandom::current))},
	...
	{"eraseThreadLocals", "(Ljava/lang/Thread;)V", nullptr, $STATIC | $FINAL, $method(static_cast<void(*)($Thread*)>(&ThreadLocalRandom::eraseThreadLocals))},
	{"getProbe", "()I", nullptr, $STATIC | $FINAL, $method(static_cast<int32_t(*)()>(&ThreadLocalRandom::getProbe))},
	...
	{"localInit", "()V", nullptr, $STATIC | $FINAL, $method(static_cast<void(*)()>(&ThreadLocalRandom::localInit))},
	...
	{"mix32", "(J)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&ThreadLocalRandom::mix32))},
	...
	{"nextSecondarySeed", "()I", nullptr, $STATIC | $FINAL, $method(static_cast<int32_t(*)()>(&ThreadLocalRandom::nextSecondarySeed))},
	{"nextSeed", "()J", nullptr, $FINAL, $method(static_cast<int64_t(ThreadLocalRandom::*)()>(&ThreadLocalRandom::nextSeed))},
	{"readResolve", "()Ljava/lang/Object;", nullptr, $PRIVATE, $method(static_cast<$Object*(ThreadLocalRandom::*)()>(&ThreadLocalRandom::readResolve))},
	{"setInheritedAccessControlContext", "(Ljava/lang/Thread;Ljava/security/AccessControlContext;)V", nullptr, $STATIC | $FINAL, $method(static_cast<void(*)($Thread*,$AccessControlContext*)>(&ThreadLocalRandom::setInheritedAccessControlContext))},
	{"setSeed", "(J)V", nullptr, $PUBLIC},
	{"writeObject", "(Ljava/io/ObjectOutputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(ThreadLocalRandom::*)($ObjectOutputStream*)>(&ThreadLocalRandom::writeObject)), "java.io.IOException"},
	{}
};
