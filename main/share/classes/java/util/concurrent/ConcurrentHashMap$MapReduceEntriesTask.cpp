...
$Class* ConcurrentHashMap$MapReduceEntriesTask::load$($String* name, bool initialize) {
	...
	$loadClass(ConcurrentHashMap$MapReduceEntriesTask, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
