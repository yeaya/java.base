...
$Class* CompletionStage$$Lambda$lambda$exceptionallyAsync$1::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyAsync$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyAsync$1);
	});
	return class$;
}
...
$Class* CompletionStage$$Lambda$lambda$exceptionallyAsync$3$1::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyAsync$3$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyAsync$3$1);
	});
	return class$;
}
...
$Class* CompletionStage$$Lambda$lambda$exceptionallyCompose$4$2::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyCompose$4$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyCompose$4$2);
	});
	return class$;
}
...
$Class* CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$6$3::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$6$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$6$3);
	});
	return class$;
}
...
$Class* CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$8$4::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$8$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$8$4);
	});
	return class$;
}
...
$Class* CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5);
	});
	return class$;
}
...
$Class* CompletionStage$$Lambda$lambda$exceptionallyAsync$0$6::load$($String* name, bool initialize) {
	...
	$loadClass(CompletionStage$$Lambda$lambda$exceptionallyAsync$0$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage$$Lambda$lambda$exceptionallyAsync$0$6);
	});
	return class$;
}
...
CompletionStage* CompletionStage::exceptionallyAsync($Function* fn) {
	$useLocalObjectStack();
	return $$nc(handle($$new(CompletionStage$$Lambda$lambda$exceptionallyAsync$1, this, fn)))->thenCompose($($Function::identity()));
}

CompletionStage* CompletionStage::exceptionallyAsync($Function* fn, $Executor* executor) {
	$useLocalObjectStack();
	return $$nc(handle($$new(CompletionStage$$Lambda$lambda$exceptionallyAsync$3$1, this, fn, executor)))->thenCompose($($Function::identity()));
}

CompletionStage* CompletionStage::exceptionallyCompose($Function* fn) {
	$useLocalObjectStack();
	return $$nc(handle($$new(CompletionStage$$Lambda$lambda$exceptionallyCompose$4$2, this, fn)))->thenCompose($($Function::identity()));
}

CompletionStage* CompletionStage::exceptionallyComposeAsync($Function* fn) {
	$useLocalObjectStack();
	return $$nc(handle($$new(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$6$3, this, fn)))->thenCompose($($Function::identity()));
}

CompletionStage* CompletionStage::exceptionallyComposeAsync($Function* fn, $Executor* executor) {
	$useLocalObjectStack();
	return $$nc(handle($$new(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$8$4, this, fn, executor)))->thenCompose($($Function::identity()));
}

CompletionStage* CompletionStage::lambda$exceptionallyComposeAsync$8($Function* fn, $Executor* executor, Object$* r, $Throwable* ex) {
	$useLocalObjectStack();
	return (ex == nullptr) ? this : $$nc(this->handleAsync($$new(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5, fn), executor))->thenCompose($($Function::identity()));
}

CompletionStage* CompletionStage::lambda$exceptionallyComposeAsync$6($Function* fn, Object$* r, $Throwable* ex) {
	$useLocalObjectStack();
	return (ex == nullptr) ? this : $$nc(this->handleAsync($$new(CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5, fn)))->thenCompose($($Function::identity()));
}
...
CompletionStage* CompletionStage::lambda$exceptionallyAsync$3($Function* fn, $Executor* executor, Object$* r, $Throwable* ex) {
	return (ex == nullptr) ? this : this->handleAsync($$new(CompletionStage$$Lambda$lambda$exceptionallyAsync$0$6, fn), executor);
}

CompletionStage* CompletionStage::lambda$exceptionallyAsync$1($Function* fn, Object$* r, $Throwable* ex) {
	return (ex == nullptr) ? this : this->handleAsync($$new(CompletionStage$$Lambda$lambda$exceptionallyAsync$0$6, fn));
}

$Object* CompletionStage::lambda$exceptionallyAsync$0($Function* fn, Object$* r1, $Throwable* ex1) {
	return $nc(fn)->apply(ex1);
}

$Class* CompletionStage::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyAsync$1")) {
			return CompletionStage$$Lambda$lambda$exceptionallyAsync$1::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyAsync$3$1")) {
			return CompletionStage$$Lambda$lambda$exceptionallyAsync$3$1::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyCompose$4$2")) {
			return CompletionStage$$Lambda$lambda$exceptionallyCompose$4$2::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$6$3")) {
			return CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$6$3::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$8$4")) {
			return CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$8$4::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5")) {
			return CompletionStage$$Lambda$lambda$exceptionallyComposeAsync$5$5::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.CompletionStage$$Lambda$lambda$exceptionallyAsync$0$6")) {
	...
	$loadClass(CompletionStage, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CompletionStage);
	});
	return class$;
}
