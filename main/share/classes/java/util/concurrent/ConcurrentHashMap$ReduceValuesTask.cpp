...
$Class* ConcurrentHashMap$ReduceValuesTask::load$($String* name, bool initialize) {
	...
	$loadClass(ConcurrentHashMap$ReduceValuesTask, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
