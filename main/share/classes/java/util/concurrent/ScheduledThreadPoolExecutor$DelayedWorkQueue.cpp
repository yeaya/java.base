...
$MethodInfo _ScheduledThreadPoolExecutor$DelayedWorkQueue_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(ScheduledThreadPoolExecutor$DelayedWorkQueue::*)()>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::init$))},
	{"add", "(Ljava/lang/Runnable;)Z", nullptr, $PUBLIC},
	{"add", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"clear", "()V", nullptr, $PUBLIC},
	{"contains", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"drainTo", "(Ljava/util/Collection;)I", "(Ljava/util/Collection<-Ljava/lang/Runnable;>;)I", $PUBLIC},
	{"drainTo", "(Ljava/util/Collection;I)I", "(Ljava/util/Collection<-Ljava/lang/Runnable;>;I)I", $PUBLIC},
	{"finishPoll", "(Ljava/util/concurrent/RunnableScheduledFuture;)Ljava/util/concurrent/RunnableScheduledFuture;", "(Ljava/util/concurrent/RunnableScheduledFuture<*>;)Ljava/util/concurrent/RunnableScheduledFuture<*>;", $PRIVATE, $method(static_cast<$RunnableScheduledFuture*(ScheduledThreadPoolExecutor$DelayedWorkQueue::*)($RunnableScheduledFuture*)>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::finishPoll))},
	{"grow", "()V", nullptr, $PRIVATE, $method(static_cast<void(ScheduledThreadPoolExecutor$DelayedWorkQueue::*)()>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::grow))},
	{"indexOf", "(Ljava/lang/Object;)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ScheduledThreadPoolExecutor$DelayedWorkQueue::*)(Object$*)>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::indexOf))},
	{"isEmpty", "()Z", nullptr, $PUBLIC},
	{"iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Ljava/lang/Runnable;>;", $PUBLIC},
	{"offer", "(Ljava/lang/Runnable;)Z", nullptr, $PUBLIC},
	{"offer", "(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Z", nullptr, $PUBLIC},
	...
	{"peek", "()Ljava/util/concurrent/RunnableScheduledFuture;", "()Ljava/util/concurrent/RunnableScheduledFuture<*>;", $PUBLIC},
	{"poll", "()Ljava/util/concurrent/RunnableScheduledFuture;", "()Ljava/util/concurrent/RunnableScheduledFuture<*>;", $PUBLIC},
	{"poll", "(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/RunnableScheduledFuture;", "(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/RunnableScheduledFuture<*>;", $PUBLIC, nullptr, "java.lang.InterruptedException"},
	{"put", "(Ljava/lang/Runnable;)V", nullptr, $PUBLIC},
	...
	{"setIndex", "(Ljava/util/concurrent/RunnableScheduledFuture;I)V", "(Ljava/util/concurrent/RunnableScheduledFuture<*>;I)V", $PRIVATE | $STATIC, $method(static_cast<void(*)($RunnableScheduledFuture*,int32_t)>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::setIndex))},
	{"siftDown", "(ILjava/util/concurrent/RunnableScheduledFuture;)V", "(ILjava/util/concurrent/RunnableScheduledFuture<*>;)V", $PRIVATE, $method(static_cast<void(ScheduledThreadPoolExecutor$DelayedWorkQueue::*)(int32_t,$RunnableScheduledFuture*)>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::siftDown))},
	{"siftUp", "(ILjava/util/concurrent/RunnableScheduledFuture;)V", "(ILjava/util/concurrent/RunnableScheduledFuture<*>;)V", $PRIVATE, $method(static_cast<void(ScheduledThreadPoolExecutor$DelayedWorkQueue::*)(int32_t,$RunnableScheduledFuture*)>(&ScheduledThreadPoolExecutor$DelayedWorkQueue::siftUp))},
	{"size", "()I", nullptr, $PUBLIC},
	{"*spliterator", "()Ljava/util/Spliterator;", nullptr, $PUBLIC | $ABSTRACT},
	{"*stream", "()Ljava/util/stream/Stream;", nullptr, $PUBLIC | $ABSTRACT},
	{"take", "()Ljava/util/concurrent/RunnableScheduledFuture;", "()Ljava/util/concurrent/RunnableScheduledFuture<*>;", $PUBLIC, nullptr, "java.lang.InterruptedException"},
