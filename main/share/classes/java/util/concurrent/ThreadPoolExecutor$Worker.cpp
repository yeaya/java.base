...
$MethodInfo _ThreadPoolExecutor$Worker_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/concurrent/ThreadPoolExecutor;Ljava/lang/Runnable;)V", nullptr, 0, $method(static_cast<void(ThreadPoolExecutor$Worker::*)($ThreadPoolExecutor*,$Runnable*)>(&ThreadPoolExecutor$Worker::init$))},
	{"interruptIfStarted", "()V", nullptr, 0, $method(static_cast<void(ThreadPoolExecutor$Worker::*)()>(&ThreadPoolExecutor$Worker::interruptIfStarted))},
	{"isHeldExclusively", "()Z", nullptr, $PROTECTED},
	{"isLocked", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(ThreadPoolExecutor$Worker::*)()>(&ThreadPoolExecutor$Worker::isLocked))},
	{"lock", "()V", nullptr, $PUBLIC, $method(static_cast<void(ThreadPoolExecutor$Worker::*)()>(&ThreadPoolExecutor$Worker::lock))},
	{"run", "()V", nullptr, $PUBLIC},
	{"*toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"tryAcquire", "(I)Z", nullptr, $PROTECTED},
	{"tryLock", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(ThreadPoolExecutor$Worker::*)()>(&ThreadPoolExecutor$Worker::tryLock))},
	{"tryRelease", "(I)Z", nullptr, $PROTECTED},
	{"unlock", "()V", nullptr, $PUBLIC, $method(static_cast<void(ThreadPoolExecutor$Worker::*)()>(&ThreadPoolExecutor$Worker::unlock))},
	{}
};
