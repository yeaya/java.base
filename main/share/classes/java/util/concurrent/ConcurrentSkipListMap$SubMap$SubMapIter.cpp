...
$MethodInfo _ConcurrentSkipListMap$SubMap$SubMapIter_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/concurrent/ConcurrentSkipListMap$SubMap;)V", nullptr, 0, $method(static_cast<void(ConcurrentSkipListMap$SubMap$SubMapIter::*)($ConcurrentSkipListMap$SubMap*)>(&ConcurrentSkipListMap$SubMap$SubMapIter::init$))},
	{"advance", "()V", nullptr, $FINAL, $method(static_cast<void(ConcurrentSkipListMap$SubMap$SubMapIter::*)()>(&ConcurrentSkipListMap$SubMap$SubMapIter::advance))},
	{"ascend", "()V", nullptr, $PRIVATE, $method(static_cast<void(ConcurrentSkipListMap$SubMap$SubMapIter::*)()>(&ConcurrentSkipListMap$SubMap$SubMapIter::ascend))},
	{"descend", "()V", nullptr, $PRIVATE, $method(static_cast<void(ConcurrentSkipListMap$SubMap$SubMapIter::*)()>(&ConcurrentSkipListMap$SubMap$SubMapIter::descend))},
