...
$Class* LinkedBlockingDeque$$Lambda$lambda$removeAll$0::load$($String* name, bool initialize) {
	...
	$loadClass(LinkedBlockingDeque$$Lambda$lambda$removeAll$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LinkedBlockingDeque$$Lambda$lambda$removeAll$0);
	});
	return class$;
}
...
$Class* LinkedBlockingDeque$$Lambda$lambda$retainAll$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(LinkedBlockingDeque$$Lambda$lambda$retainAll$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LinkedBlockingDeque$$Lambda$lambda$retainAll$1$1);
	});
	return class$;
}
...
$Object* LinkedBlockingDeque::peekFirst() {
	...
	bool return$1 = false;
	try {
		$assign(var$2, (this->first == nullptr) ? ($Object*)nullptr : this->first->item);
		return$1 = true;
		goto $finally;
	} catch ($Throwable& var$3) {
		$assign(var$0, var$3);
...
$Object* LinkedBlockingDeque::peekLast() {
	...
	bool return$1 = false;
	try {
		$assign(var$2, (this->last == nullptr) ? ($Object*)nullptr : this->last->item);
		return$1 = true;
		goto $finally;
	} catch ($Throwable& var$3) {
		$assign(var$0, var$3);
...
bool LinkedBlockingDeque::removeAll($Collection* c) {
	$Objects::requireNonNull(c);
	return bulkRemove($$new(LinkedBlockingDeque$$Lambda$lambda$removeAll$0, c));
}

bool LinkedBlockingDeque::retainAll($Collection* c) {
	$Objects::requireNonNull(c);
	return bulkRemove($$new(LinkedBlockingDeque$$Lambda$lambda$retainAll$1$1, c));
}
...
$Class* LinkedBlockingDeque::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.util.concurrent.LinkedBlockingDeque$$Lambda$lambda$removeAll$0")) {
			return LinkedBlockingDeque$$Lambda$lambda$removeAll$0::load$(name, initialize);
		}
		if (name->equals("java.util.concurrent.LinkedBlockingDeque$$Lambda$lambda$retainAll$1$1")) {
	...
	$loadClass(LinkedBlockingDeque, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
