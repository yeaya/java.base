...
int64_t AtomicLongArray::get(int32_t i) {
	return $longValue($nc(AtomicLongArray::AA)->getVolatile($$new($ObjectArray, {this->array, $$of(i)})));
}

void AtomicLongArray::set(int32_t i, int64_t newValue) {
	$nc(AtomicLongArray::AA)->setVolatile($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

void AtomicLongArray::lazySet(int32_t i, int64_t newValue) {
	$nc(AtomicLongArray::AA)->setRelease($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

int64_t AtomicLongArray::getAndSet(int32_t i, int64_t newValue) {
	return $longValue($nc(AtomicLongArray::AA)->getAndSet($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)})));
}

bool AtomicLongArray::compareAndSet(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $nc(AtomicLongArray::AA)->compareAndSet($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

bool AtomicLongArray::weakCompareAndSet(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $nc(AtomicLongArray::AA)->weakCompareAndSetPlain($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}
...
int64_t AtomicLongArray::getAndIncrement(int32_t i) {
	return $longValue($nc(AtomicLongArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(1)})));
}
...
int64_t AtomicLongArray::getAndAdd(int32_t i, int64_t delta) {
	return $longValue($nc(AtomicLongArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(delta)})));
}

int64_t AtomicLongArray::incrementAndGet(int32_t i) {
	return $longValue($nc(AtomicLongArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(1)}))) + (int64_t)1;
}
...
int64_t AtomicLongArray::addAndGet(int32_t i, int64_t delta) {
	return $longValue($nc(AtomicLongArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(delta)}))) + delta;
}
...
int64_t AtomicLongArray::getPlain(int32_t i) {
	return $longValue($nc(AtomicLongArray::AA)->get($$new($ObjectArray, {this->array, $$of(i)})));
}

void AtomicLongArray::setPlain(int32_t i, int64_t newValue) {
	$nc(AtomicLongArray::AA)->set($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

int64_t AtomicLongArray::getOpaque(int32_t i) {
	return $longValue($nc(AtomicLongArray::AA)->getOpaque($$new($ObjectArray, {this->array, $$of(i)})));
}

void AtomicLongArray::setOpaque(int32_t i, int64_t newValue) {
	$nc(AtomicLongArray::AA)->setOpaque($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

int64_t AtomicLongArray::getAcquire(int32_t i) {
	return $longValue($nc(AtomicLongArray::AA)->getAcquire($$new($ObjectArray, {this->array, $$of(i)})));
}
...
int64_t AtomicLongArray::compareAndExchange(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $longValue($nc(AtomicLongArray::AA)->compareAndExchange($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)})));
}

int64_t AtomicLongArray::compareAndExchangeAcquire(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $longValue($nc(AtomicLongArray::AA)->compareAndExchangeAcquire($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)})));
}

int64_t AtomicLongArray::compareAndExchangeRelease(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $longValue($nc(AtomicLongArray::AA)->compareAndExchangeRelease($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)})));
}

bool AtomicLongArray::weakCompareAndSetVolatile(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $nc(AtomicLongArray::AA)->weakCompareAndSet($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

bool AtomicLongArray::weakCompareAndSetAcquire(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $nc(AtomicLongArray::AA)->weakCompareAndSetAcquire($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

bool AtomicLongArray::weakCompareAndSetRelease(int32_t i, int64_t expectedValue, int64_t newValue) {
	return $nc(AtomicLongArray::AA)->weakCompareAndSetRelease($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

void AtomicLongArray::clinit$($Class* clazz) {
...
$Class* AtomicLongArray::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"weakCompareAndSet", "(IJJ)Z", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(AtomicLongArray, weakCompareAndSet, bool, int32_t, int64_t, int64_t), nullptr, nullptr, weakCompareAndSetmethodAnnotations$$},
	...
	$loadClass(AtomicLongArray, name, initialize, &classInfo$$, AtomicLongArray::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(AtomicLongArray);
	});
	return class$;
}
