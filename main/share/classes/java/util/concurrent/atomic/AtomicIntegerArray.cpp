...
int32_t AtomicIntegerArray::get(int32_t i) {
	return $intValue($nc(AtomicIntegerArray::AA)->getVolatile($$new($ObjectArray, {this->array, $$of(i)})));
}

void AtomicIntegerArray::set(int32_t i, int32_t newValue) {
	$nc(AtomicIntegerArray::AA)->setVolatile($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

void AtomicIntegerArray::lazySet(int32_t i, int32_t newValue) {
	$nc(AtomicIntegerArray::AA)->setRelease($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

int32_t AtomicIntegerArray::getAndSet(int32_t i, int32_t newValue) {
	return $intValue($nc(AtomicIntegerArray::AA)->getAndSet($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)})));
}

bool AtomicIntegerArray::compareAndSet(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $nc(AtomicIntegerArray::AA)->compareAndSet($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

bool AtomicIntegerArray::weakCompareAndSet(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $nc(AtomicIntegerArray::AA)->weakCompareAndSetPlain($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}
...
int32_t AtomicIntegerArray::getAndIncrement(int32_t i) {
	return $intValue($nc(AtomicIntegerArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(1)})));
}
...
int32_t AtomicIntegerArray::getAndAdd(int32_t i, int32_t delta) {
	return $intValue($nc(AtomicIntegerArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(delta)})));
}

int32_t AtomicIntegerArray::incrementAndGet(int32_t i) {
	return $intValue($nc(AtomicIntegerArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(1)}))) + 1;
}
...
int32_t AtomicIntegerArray::addAndGet(int32_t i, int32_t delta) {
	return $intValue($nc(AtomicIntegerArray::AA)->getAndAdd($$new($ObjectArray, {this->array, $$of(i), $$of(delta)}))) + delta;
}
...
int32_t AtomicIntegerArray::getPlain(int32_t i) {
	return $intValue($nc(AtomicIntegerArray::AA)->get($$new($ObjectArray, {this->array, $$of(i)})));
}

void AtomicIntegerArray::setPlain(int32_t i, int32_t newValue) {
	$nc(AtomicIntegerArray::AA)->set($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

int32_t AtomicIntegerArray::getOpaque(int32_t i) {
	return $intValue($nc(AtomicIntegerArray::AA)->getOpaque($$new($ObjectArray, {this->array, $$of(i)})));
}

void AtomicIntegerArray::setOpaque(int32_t i, int32_t newValue) {
	$nc(AtomicIntegerArray::AA)->setOpaque($$new($ObjectArray, {this->array, $$of(i), $$of(newValue)}));
}

int32_t AtomicIntegerArray::getAcquire(int32_t i) {
	return $intValue($nc(AtomicIntegerArray::AA)->getAcquire($$new($ObjectArray, {this->array, $$of(i)})));
}
...
int32_t AtomicIntegerArray::compareAndExchange(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $intValue($nc(AtomicIntegerArray::AA)->compareAndExchange($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)})));
}

int32_t AtomicIntegerArray::compareAndExchangeAcquire(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $intValue($nc(AtomicIntegerArray::AA)->compareAndExchangeAcquire($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)})));
}

int32_t AtomicIntegerArray::compareAndExchangeRelease(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $intValue($nc(AtomicIntegerArray::AA)->compareAndExchangeRelease($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)})));
}

bool AtomicIntegerArray::weakCompareAndSetVolatile(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $nc(AtomicIntegerArray::AA)->weakCompareAndSet($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

bool AtomicIntegerArray::weakCompareAndSetAcquire(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $nc(AtomicIntegerArray::AA)->weakCompareAndSetAcquire($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

bool AtomicIntegerArray::weakCompareAndSetRelease(int32_t i, int32_t expectedValue, int32_t newValue) {
	return $nc(AtomicIntegerArray::AA)->weakCompareAndSetRelease($$new($ObjectArray, {this->array, $$of(i), $$of(expectedValue), $$of(newValue)}));
}

void AtomicIntegerArray::clinit$($Class* clazz) {
...
$Class* AtomicIntegerArray::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"weakCompareAndSet", "(III)Z", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(AtomicIntegerArray, weakCompareAndSet, bool, int32_t, int32_t, int32_t), nullptr, nullptr, weakCompareAndSetmethodAnnotations$$},
	...
	$loadClass(AtomicIntegerArray, name, initialize, &classInfo$$, AtomicIntegerArray::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(AtomicIntegerArray);
	});
	return class$;
}
