#ifndef _java_lang_CharSequence$1CharIterator_h_
#define _java_lang_CharSequence$1CharIterator_h_
...
class CharSequence$1CharIterator : public ::java::util::PrimitiveIterator$OfInt {
	$class(CharSequence$1CharIterator, $NO_CLASS_INIT, ::java::util::PrimitiveIterator$OfInt)
public:
...
#endif // _java_lang_CharSequence$1CharIterator_h_