...
$MethodInfo _Long_MethodInfo_[] = {
	...
	{"<init>", "(J)V", nullptr, $PUBLIC | $DEPRECATED, $method(static_cast<void(Long::*)(int64_t)>(&Long::init$)), nullptr, nullptr, _Long_MethodAnnotations_init$0},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $DEPRECATED, $method(static_cast<void(Long::*)($String*)>(&Long::init$)), "java.lang.NumberFormatException", nullptr, _Long_MethodAnnotations_init$1},
	{"bitCount", "(J)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&Long::bitCount)), nullptr, nullptr, _Long_MethodAnnotations_bitCount2},
	{"byteValue", "()B", nullptr, $PUBLIC},
	{"compare", "(JJ)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t,int64_t)>(&Long::compare))},
	{"compareTo", "(Ljava/lang/Long;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(Long::*)(Long*)>(&Long::compareTo))},
	{"compareTo", "(Ljava/lang/Object;)I", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"compareUnsigned", "(JJ)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t,int64_t)>(&Long::compareUnsigned))},
	{"decode", "(Ljava/lang/String;)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)($String*)>(&Long::decode)), "java.lang.NumberFormatException"},
	{"describeConstable", "()Ljava/util/Optional;", "()Ljava/util/Optional<Ljava/lang/Long;>;", $PUBLIC},
	{"divideUnsigned", "(JJ)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int64_t)>(&Long::divideUnsigned))},
	{"doubleValue", "()D", nullptr, $PUBLIC},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"fastUUID", "(JJ)Ljava/lang/String;", nullptr, $STATIC, $method(static_cast<$String*(*)(int64_t,int64_t)>(&Long::fastUUID))},
	{"floatValue", "()F", nullptr, $PUBLIC},
	{"formatUnsignedLong0", "(JI[BII)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)(int64_t,int32_t,$bytes*,int32_t,int32_t)>(&Long::formatUnsignedLong0))},
	{"formatUnsignedLong0UTF16", "(JI[BII)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)(int64_t,int32_t,$bytes*,int32_t,int32_t)>(&Long::formatUnsignedLong0UTF16))},
	{"getChars", "(JI[B)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int64_t,int32_t,$bytes*)>(&Long::getChars))},
	{"getLong", "(Ljava/lang/String;)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)($String*)>(&Long::getLong))},
	{"getLong", "(Ljava/lang/String;J)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)($String*,int64_t)>(&Long::getLong))},
	{"getLong", "(Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)($String*,Long*)>(&Long::getLong))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"hashCode", "(J)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&Long::hashCode))},
	{"highestOneBit", "(J)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t)>(&Long::highestOneBit))},
	{"intValue", "()I", nullptr, $PUBLIC},
	{"longValue", "()J", nullptr, $PUBLIC, nullptr, nullptr, nullptr, _Long_MethodAnnotations_longValue25},
	{"lowestOneBit", "(J)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t)>(&Long::lowestOneBit))},
	{"max", "(JJ)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int64_t)>(&Long::max))},
	{"min", "(JJ)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int64_t)>(&Long::min))},
	{"numberOfLeadingZeros", "(J)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&Long::numberOfLeadingZeros)), nullptr, nullptr, _Long_MethodAnnotations_numberOfLeadingZeros29},
	{"numberOfTrailingZeros", "(J)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&Long::numberOfTrailingZeros)), nullptr, nullptr, _Long_MethodAnnotations_numberOfTrailingZeros30},
	{"parseLong", "(Ljava/lang/String;I)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)($String*,int32_t)>(&Long::parseLong)), "java.lang.NumberFormatException"},
	{"parseLong", "(Ljava/lang/CharSequence;III)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)($CharSequence*,int32_t,int32_t,int32_t)>(&Long::parseLong)), "java.lang.NumberFormatException"},
	{"parseLong", "(Ljava/lang/String;)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)($String*)>(&Long::parseLong)), "java.lang.NumberFormatException"},
	{"parseUnsignedLong", "(Ljava/lang/String;I)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)($String*,int32_t)>(&Long::parseUnsignedLong)), "java.lang.NumberFormatException"},
	{"parseUnsignedLong", "(Ljava/lang/CharSequence;III)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)($CharSequence*,int32_t,int32_t,int32_t)>(&Long::parseUnsignedLong)), "java.lang.NumberFormatException"},
	{"parseUnsignedLong", "(Ljava/lang/String;)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)($String*)>(&Long::parseUnsignedLong)), "java.lang.NumberFormatException"},
	{"remainderUnsigned", "(JJ)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int64_t)>(&Long::remainderUnsigned))},
	{"resolveConstantDesc", "(Ljava/lang/invoke/MethodHandles$Lookup;)Ljava/lang/Long;", nullptr, $PUBLIC},
	{"reverse", "(J)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t)>(&Long::reverse))},
	{"reverseBytes", "(J)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t)>(&Long::reverseBytes)), nullptr, nullptr, _Long_MethodAnnotations_reverseBytes40},
	{"rotateLeft", "(JI)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int32_t)>(&Long::rotateLeft))},
	{"rotateRight", "(JI)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int32_t)>(&Long::rotateRight))},
	{"shortValue", "()S", nullptr, $PUBLIC},
	{"signum", "(J)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&Long::signum))},
	{"stringSize", "(J)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int64_t)>(&Long::stringSize))},
	{"sum", "(JJ)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int64_t,int64_t)>(&Long::sum))},
	{"toBinaryString", "(J)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t)>(&Long::toBinaryString))},
	{"toHexString", "(J)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t)>(&Long::toHexString))},
	{"toOctalString", "(J)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t)>(&Long::toOctalString))},
	{"toString", "(JI)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t,int32_t)>(&Long::toString))},
	{"toString", "(J)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t)>(&Long::toString))},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"toStringUTF16", "(JI)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(int64_t,int32_t)>(&Long::toStringUTF16))},
	{"toUnsignedBigInteger", "(J)Ljava/math/BigInteger;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$BigInteger*(*)(int64_t)>(&Long::toUnsignedBigInteger))},
	{"toUnsignedString", "(JI)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t,int32_t)>(&Long::toUnsignedString))},
	{"toUnsignedString", "(J)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int64_t)>(&Long::toUnsignedString))},
	{"toUnsignedString0", "(JI)Ljava/lang/String;", nullptr, $STATIC, $method(static_cast<$String*(*)(int64_t,int32_t)>(&Long::toUnsignedString0))},
	{"valueOf", "(Ljava/lang/String;I)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)($String*,int32_t)>(&Long::valueOf)), "java.lang.NumberFormatException"},
	{"valueOf", "(Ljava/lang/String;)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)($String*)>(&Long::valueOf)), "java.lang.NumberFormatException"},
	{"valueOf", "(J)Ljava/lang/Long;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Long*(*)(int64_t)>(&Long::valueOf)), nullptr, nullptr, _Long_MethodAnnotations_valueOf60},
	{}
};
