#ifndef _java_lang_StringUTF16$CharsSpliterator_h_
#define _java_lang_StringUTF16$CharsSpliterator_h_
...
class StringUTF16$CharsSpliterator : public ::java::util::Spliterator$OfInt {
	$class(StringUTF16$CharsSpliterator, $NO_CLASS_INIT, ::java::util::Spliterator$OfInt)
public:
	StringUTF16$CharsSpliterator();
...
#endif // _java_lang_StringUTF16$CharsSpliterator_h_