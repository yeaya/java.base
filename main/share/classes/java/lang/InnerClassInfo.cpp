...
bool InnerClassInfo::isEnd() {
	return innerClass == nullptr;
}

void InnerClassInfo::encode(DataOutputStream* os, ::jdk::internal::reflect::ConstantPool* cp) {

}

void InnerClassInfo::visit(::jdk::internal::reflect::ConstantPool* cp) {
