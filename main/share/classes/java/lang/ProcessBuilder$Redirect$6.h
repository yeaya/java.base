#ifndef _java_lang_ProcessBuilder$Redirect$6_h_
#define _java_lang_ProcessBuilder$Redirect$6_h_
...
class ProcessBuilder$Redirect$6 : public ::java::lang::ProcessBuilder$Redirect {
	$class(ProcessBuilder$Redirect$6, $NO_CLASS_INIT, ::java::lang::ProcessBuilder$Redirect)
public:
...
#endif // _java_lang_ProcessBuilder$Redirect$6_h_