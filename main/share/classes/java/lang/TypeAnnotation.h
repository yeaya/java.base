...
#ifndef _java_lang_TypeAnnotation_h_
#define _java_lang_TypeAnnotation_h_
...
class $export TypeAnnotation : public CompoundAttribute {
public:
	...
	static TypeAnnotation* cloneArray(TypeAnnotation* array);
};
