...
$MethodInfo _ObjectMethods_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(ObjectMethods::*)()>(&ObjectMethods::init$))},
	{"bootstrap", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/TypeDescriptor;Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/invoke/MethodHandle;)Ljava/lang/Object;", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/TypeDescriptor;Ljava/lang/Class<*>;Ljava/lang/String;[Ljava/lang/invoke/MethodHandle;)Ljava/lang/Object;", $PUBLIC | $STATIC | $TRANSIENT, $method(static_cast<$Object*(*)($MethodHandles$Lookup*,$String*,$TypeDescriptor*,$Class*,$String*,$MethodHandleArray*)>(&ObjectMethods::bootstrap)), "java.lang.Throwable"},
	{"eq", "(Ljava/lang/Object;Ljava/lang/Object;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(Object$*,Object$*)>(&ObjectMethods::eq))},
	{"eq", "(BB)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(int8_t,int8_t)>(&ObjectMethods::eq))},
	{"eq", "(SS)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(int16_t,int16_t)>(&ObjectMethods::eq))},
	{"eq", "(CC)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(char16_t,char16_t)>(&ObjectMethods::eq))},
	{"eq", "(II)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(int32_t,int32_t)>(&ObjectMethods::eq))},
	{"eq", "(JJ)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(int64_t,int64_t)>(&ObjectMethods::eq))},
	{"eq", "(FF)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(float,float)>(&ObjectMethods::eq))},
	{"eq", "(DD)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(double,double)>(&ObjectMethods::eq))},
	{"eq", "(ZZ)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(bool,bool)>(&ObjectMethods::eq))},
	{"equalator", "(Ljava/lang/Class;)Ljava/lang/invoke/MethodHandle;", "(Ljava/lang/Class<*>;)Ljava/lang/invoke/MethodHandle;", $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)($Class*)>(&ObjectMethods::equalator))},
	{"hashCombiner", "(II)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&ObjectMethods::hashCombiner))},
	{"hasher", "(Ljava/lang/Class;)Ljava/lang/invoke/MethodHandle;", "(Ljava/lang/Class<*>;)Ljava/lang/invoke/MethodHandle;", $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)($Class*)>(&ObjectMethods::hasher))},
	{"makeEquals", "(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/invoke/MethodHandle;", "(Ljava/lang/Class<*>;Ljava/util/List<Ljava/lang/invoke/MethodHandle;>;)Ljava/lang/invoke/MethodHandle;", $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)($Class*,$List*)>(&ObjectMethods::makeEquals))},
	{"makeHashCode", "(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/invoke/MethodHandle;", "(Ljava/lang/Class<*>;Ljava/util/List<Ljava/lang/invoke/MethodHandle;>;)Ljava/lang/invoke/MethodHandle;", $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)($Class*,$List*)>(&ObjectMethods::makeHashCode))},
	{"makeToString", "(Ljava/lang/Class;Ljava/util/List;Ljava/util/List;)Ljava/lang/invoke/MethodHandle;", "(Ljava/lang/Class<*>;Ljava/util/List<Ljava/lang/invoke/MethodHandle;>;Ljava/util/List<Ljava/lang/String;>;)Ljava/lang/invoke/MethodHandle;", $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)($Class*,$List*,$List*)>(&ObjectMethods::makeToString))},
	{"stringifier", "(Ljava/lang/Class;)Ljava/lang/invoke/MethodHandle;", "(Ljava/lang/Class<*>;)Ljava/lang/invoke/MethodHandle;", $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)($Class*)>(&ObjectMethods::stringifier))},
	{}
};
