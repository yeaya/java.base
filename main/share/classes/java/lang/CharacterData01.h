#ifndef _java_lang_CharacterData01_h_
#define _java_lang_CharacterData01_h_
...
class CharacterData01 : public ::java::lang::CharacterData {
	$class(CharacterData01, 0, ::java::lang::CharacterData)
public:
	CharacterData01();
	void init$();
