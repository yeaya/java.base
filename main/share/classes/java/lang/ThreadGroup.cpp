...
$MethodInfo _ThreadGroup_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::init$))},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ThreadGroup::*)($String*)>(&ThreadGroup::init$))},
	{"<init>", "(Ljava/lang/ThreadGroup;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ThreadGroup::*)(ThreadGroup*,$String*)>(&ThreadGroup::init$))},
	{"<init>", "(Ljava/lang/Void;Ljava/lang/ThreadGroup;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(ThreadGroup::*)($Void*,ThreadGroup*,$String*)>(&ThreadGroup::init$))},
	{"activeCount", "()I", nullptr, $PUBLIC},
	{"activeGroupCount", "()I", nullptr, $PUBLIC},
	{"add", "(Ljava/lang/ThreadGroup;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(ThreadGroup::*)(ThreadGroup*)>(&ThreadGroup::add))},
	{"add", "(Ljava/lang/Thread;)V", nullptr, 0},
	{"addUnstarted", "()V", nullptr, 0},
	{"allowThreadSuspension", "(Z)Z", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _ThreadGroup_MethodAnnotations_allowThreadSuspension9},
	{"checkAccess", "()V", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::checkAccess)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_checkAccess10},
	{"checkParentAccess", "(Ljava/lang/ThreadGroup;)Ljava/lang/Void;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$Void*(*)(ThreadGroup*)>(&ThreadGroup::checkParentAccess))},
	{"destroy", "()V", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::destroy)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_destroy12},
	{"enumerate", "([Ljava/lang/Thread;)I", nullptr, $PUBLIC},
	{"enumerate", "([Ljava/lang/Thread;Z)I", nullptr, $PUBLIC},
	{"enumerate", "([Ljava/lang/Thread;IZ)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ThreadGroup::*)($ThreadArray*,int32_t,bool)>(&ThreadGroup::enumerate))},
	{"enumerate", "([Ljava/lang/ThreadGroup;)I", nullptr, $PUBLIC},
	{"enumerate", "([Ljava/lang/ThreadGroup;Z)I", nullptr, $PUBLIC},
	{"enumerate", "([Ljava/lang/ThreadGroup;IZ)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ThreadGroup::*)($ThreadGroupArray*,int32_t,bool)>(&ThreadGroup::enumerate))},
	{"getMaxPriority", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(ThreadGroup::*)()>(&ThreadGroup::getMaxPriority))},
	{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(ThreadGroup::*)()>(&ThreadGroup::getName))},
	{"getParent", "()Ljava/lang/ThreadGroup;", nullptr, $PUBLIC | $FINAL, $method(static_cast<ThreadGroup*(ThreadGroup::*)()>(&ThreadGroup::getParent))},
	{"interrupt", "()V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::interrupt))},
	{"isDaemon", "()Z", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<bool(ThreadGroup::*)()>(&ThreadGroup::isDaemon)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_isDaemon23},
	{"isDestroyed", "()Z", nullptr, $PUBLIC | $SYNCHRONIZED | $DEPRECATED, nullptr, nullptr, nullptr, _ThreadGroup_MethodAnnotations_isDestroyed24},
	{"list", "()V", nullptr, $PUBLIC},
	{"list", "(Ljava/io/PrintStream;I)V", nullptr, 0},
	{"parentOf", "(Ljava/lang/ThreadGroup;)Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(ThreadGroup::*)(ThreadGroup*)>(&ThreadGroup::parentOf))},
	{"remove", "(Ljava/lang/ThreadGroup;)V", nullptr, $PRIVATE, $method(static_cast<void(ThreadGroup::*)(ThreadGroup*)>(&ThreadGroup::remove))},
	{"remove", "(Ljava/lang/Thread;)V", nullptr, $PRIVATE, $method(static_cast<void(ThreadGroup::*)($Thread*)>(&ThreadGroup::remove))},
	{"resume", "()V", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::resume)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_resume30},
	{"setDaemon", "(Z)V", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<void(ThreadGroup::*)(bool)>(&ThreadGroup::setDaemon)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_setDaemon31},
	{"setMaxPriority", "(I)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(ThreadGroup::*)(int32_t)>(&ThreadGroup::setMaxPriority))},
	{"stop", "()V", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::stop)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_stop33},
	{"stopOrSuspend", "(Z)Z", nullptr, $PRIVATE, $method(static_cast<bool(ThreadGroup::*)(bool)>(&ThreadGroup::stopOrSuspend))},
	{"suspend", "()V", nullptr, $PUBLIC | $FINAL | $DEPRECATED, $method(static_cast<void(ThreadGroup::*)()>(&ThreadGroup::suspend)), nullptr, nullptr, _ThreadGroup_MethodAnnotations_suspend35},
	{"threadStartFailed", "(Ljava/lang/Thread;)V", nullptr, 0},
	{"threadTerminated", "(Ljava/lang/Thread;)V", nullptr, 0},
