...
void StackStreamFactory$WalkerState::clinit$($Class* clazz) {
...
$Class* StackStreamFactory$WalkerState::load$($String* name, bool initialize) {
	...
	$loadClass(StackStreamFactory$WalkerState, name, initialize, &classInfo$$, StackStreamFactory$WalkerState::clinit$, []($Class* clazz) -> $Object* {
