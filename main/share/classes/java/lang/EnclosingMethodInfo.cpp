...
void EnclosingMethodInfo::encode(::java::io::DataOutputStream* os, ::jdk::internal::reflect::ConstantPool* cp) {

}

void EnclosingMethodInfo::visit(::jdk::internal::reflect::ConstantPool* cp) {
