...
ParameterAnnotation::ParameterAnnotation(const char* descriptor, NamedAttribute* attributes, int16_t index)
	: CompoundAttribute(descriptor, attributes) {
	this->index = index;
}

void ParameterAnnotation::encode(::java::io::DataOutputStream* os, ::jdk::internal::reflect::ConstantPool* cp) {
