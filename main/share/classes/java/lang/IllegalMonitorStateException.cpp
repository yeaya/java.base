...
IllegalMonitorStateException::IllegalMonitorStateException(const IllegalMonitorStateException& e) {
}

IllegalMonitorStateException IllegalMonitorStateException::wrapper$() {
	$pendingException(this);
	return *this;
}

void IllegalMonitorStateException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
