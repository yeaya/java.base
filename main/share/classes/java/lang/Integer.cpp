...
$MethodInfo _Integer_MethodInfo_[] = {
	...
	{"<init>", "(I)V", nullptr, $PUBLIC | $DEPRECATED, $method(static_cast<void(Integer::*)(int32_t)>(&Integer::init$)), nullptr, nullptr, _Integer_MethodAnnotations_init$0},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $DEPRECATED, $method(static_cast<void(Integer::*)($String*)>(&Integer::init$)), "java.lang.NumberFormatException", nullptr, _Integer_MethodAnnotations_init$1},
	{"bitCount", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::bitCount)), nullptr, nullptr, _Integer_MethodAnnotations_bitCount2},
	{"byteValue", "()B", nullptr, $PUBLIC},
	{"compare", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::compare))},
	{"compareTo", "(Ljava/lang/Integer;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(Integer::*)(Integer*)>(&Integer::compareTo))},
	{"compareTo", "(Ljava/lang/Object;)I", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"compareUnsigned", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::compareUnsigned))},
	{"decode", "(Ljava/lang/String;)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)($String*)>(&Integer::decode)), "java.lang.NumberFormatException"},
	{"describeConstable", "()Ljava/util/Optional;", "()Ljava/util/Optional<Ljava/lang/Integer;>;", $PUBLIC},
	{"divideUnsigned", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::divideUnsigned))},
	{"doubleValue", "()D", nullptr, $PUBLIC},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"floatValue", "()F", nullptr, $PUBLIC},
	{"formatUnsignedInt", "(II[BI)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)(int32_t,int32_t,$bytes*,int32_t)>(&Integer::formatUnsignedInt))},
	{"formatUnsignedIntUTF16", "(II[BI)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)(int32_t,int32_t,$bytes*,int32_t)>(&Integer::formatUnsignedIntUTF16))},
	{"getChars", "(II[B)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t,$bytes*)>(&Integer::getChars))},
	{"getInteger", "(Ljava/lang/String;)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)($String*)>(&Integer::getInteger))},
	{"getInteger", "(Ljava/lang/String;I)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)($String*,int32_t)>(&Integer::getInteger))},
	{"getInteger", "(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)($String*,Integer*)>(&Integer::getInteger))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"hashCode", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::hashCode))},
	{"highestOneBit", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::highestOneBit))},
	{"intValue", "()I", nullptr, $PUBLIC, nullptr, nullptr, nullptr, _Integer_MethodAnnotations_intValue23},
	{"longValue", "()J", nullptr, $PUBLIC},
	{"lowestOneBit", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::lowestOneBit))},
	{"max", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::max))},
	{"min", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::min))},
	{"numberOfLeadingZeros", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::numberOfLeadingZeros)), nullptr, nullptr, _Integer_MethodAnnotations_numberOfLeadingZeros28},
	{"numberOfTrailingZeros", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::numberOfTrailingZeros)), nullptr, nullptr, _Integer_MethodAnnotations_numberOfTrailingZeros29},
	{"parseInt", "(Ljava/lang/String;I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($String*,int32_t)>(&Integer::parseInt)), "java.lang.NumberFormatException"},
	{"parseInt", "(Ljava/lang/CharSequence;III)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($CharSequence*,int32_t,int32_t,int32_t)>(&Integer::parseInt)), "java.lang.NumberFormatException"},
	{"parseInt", "(Ljava/lang/String;)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($String*)>(&Integer::parseInt)), "java.lang.NumberFormatException"},
	{"parseUnsignedInt", "(Ljava/lang/String;I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($String*,int32_t)>(&Integer::parseUnsignedInt)), "java.lang.NumberFormatException"},
	{"parseUnsignedInt", "(Ljava/lang/CharSequence;III)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($CharSequence*,int32_t,int32_t,int32_t)>(&Integer::parseUnsignedInt)), "java.lang.NumberFormatException"},
	{"parseUnsignedInt", "(Ljava/lang/String;)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($String*)>(&Integer::parseUnsignedInt)), "java.lang.NumberFormatException"},
	{"remainderUnsigned", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::remainderUnsigned))},
	{"resolveConstantDesc", "(Ljava/lang/invoke/MethodHandles$Lookup;)Ljava/lang/Integer;", nullptr, $PUBLIC},
	{"reverse", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::reverse))},
	{"reverseBytes", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::reverseBytes)), nullptr, nullptr, _Integer_MethodAnnotations_reverseBytes39},
	{"rotateLeft", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::rotateLeft))},
	{"rotateRight", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::rotateRight))},
	{"shortValue", "()S", nullptr, $PUBLIC},
	{"signum", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::signum))},
	{"stringSize", "(I)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Integer::stringSize))},
	{"sum", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Integer::sum))},
	{"toBinaryString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Integer::toBinaryString))},
	{"toHexString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Integer::toHexString))},
	{"toOctalString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Integer::toOctalString))},
	{"toString", "(II)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t,int32_t)>(&Integer::toString))},
	{"toString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Integer::toString)), nullptr, nullptr, _Integer_MethodAnnotations_toString50},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"toStringUTF16", "(II)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(int32_t,int32_t)>(&Integer::toStringUTF16))},
	{"toUnsignedLong", "(I)J", nullptr, $PUBLIC | $STATIC, $method(static_cast<int64_t(*)(int32_t)>(&Integer::toUnsignedLong))},
	{"toUnsignedString", "(II)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t,int32_t)>(&Integer::toUnsignedString))},
	{"toUnsignedString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Integer::toUnsignedString))},
	{"toUnsignedString0", "(II)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(int32_t,int32_t)>(&Integer::toUnsignedString0))},
	{"valueOf", "(Ljava/lang/String;I)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)($String*,int32_t)>(&Integer::valueOf)), "java.lang.NumberFormatException"},
	{"valueOf", "(Ljava/lang/String;)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)($String*)>(&Integer::valueOf)), "java.lang.NumberFormatException"},
	{"valueOf", "(I)Ljava/lang/Integer;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Integer*(*)(int32_t)>(&Integer::valueOf)), nullptr, nullptr, _Integer_MethodAnnotations_valueOf59},
	{}
};
