...
$MethodInfo _Throwable_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(Throwable::*)()>(&Throwable::init$))},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(Throwable::*)($String*)>(&Throwable::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $method(static_cast<void(Throwable::*)($String*,Throwable*)>(&Throwable::init$))},
	{"<init>", "(Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $method(static_cast<void(Throwable::*)(Throwable*)>(&Throwable::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Throwable;ZZ)V", nullptr, $PROTECTED, $method(static_cast<void(Throwable::*)($String*,Throwable*,bool,bool)>(&Throwable::init$))},
	{"addSuppressed", "(Ljava/lang/Throwable;)V", nullptr, $PUBLIC | $FINAL | $SYNCHRONIZED, $method(static_cast<void(Throwable::*)(Throwable*)>(&Throwable::addSuppressed))},
	{"fillInStackTrace", "()Ljava/lang/Throwable;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"fillInStackTrace", "(I)Ljava/lang/Throwable;", nullptr, $PRIVATE | $NATIVE, $method(static_cast<Throwable*(Throwable::*)(int32_t)>(&Throwable::fillInStackTrace))},
	{"getCause", "()Ljava/lang/Throwable;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"getLocalizedMessage", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getMessage", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getOurStackTrace", "()[Ljava/lang/StackTraceElement;", nullptr, $PRIVATE | $SYNCHRONIZED, $method(static_cast<$StackTraceElementArray*(Throwable::*)()>(&Throwable::getOurStackTrace))},
	{"getStackTrace", "()[Ljava/lang/StackTraceElement;", nullptr, $PUBLIC},
	{"getSuppressed", "()[Ljava/lang/Throwable;", nullptr, $PUBLIC | $FINAL | $SYNCHRONIZED, $method(static_cast<$ThrowableArray*(Throwable::*)()>(&Throwable::getSuppressed))},
	{"initCause", "(Ljava/lang/Throwable;)Ljava/lang/Throwable;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"printEnclosedStackTrace", "(Ljava/lang/Throwable$PrintStreamOrWriter;[Ljava/lang/StackTraceElement;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)V", "(Ljava/lang/Throwable$PrintStreamOrWriter;[Ljava/lang/StackTraceElement;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set<Ljava/lang/Throwable;>;)V", $PRIVATE, $method(static_cast<void(Throwable::*)($Throwable$PrintStreamOrWriter*,$StackTraceElementArray*,$String*,$String*,$Set*)>(&Throwable::printEnclosedStackTrace))},
	{"printStackTrace", "()V", nullptr, $PUBLIC},
	{"printStackTrace", "(Ljava/io/PrintStream;)V", nullptr, $PUBLIC},
	{"printStackTrace", "(Ljava/lang/Throwable$PrintStreamOrWriter;)V", nullptr, $PRIVATE, $method(static_cast<void(Throwable::*)($Throwable$PrintStreamOrWriter*)>(&Throwable::printStackTrace))},
	{"printStackTrace", "(Ljava/io/PrintWriter;)V", nullptr, $PUBLIC},
	{"readObject", "(Ljava/io/ObjectInputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(Throwable::*)($ObjectInputStream*)>(&Throwable::readObject)), "java.io.IOException,java.lang.ClassNotFoundException"},
	{"setCause", "(Ljava/lang/Throwable;)V", nullptr, $FINAL, $method(static_cast<void(Throwable::*)(Throwable*)>(&Throwable::setCause))},
	{"setStackTrace", "([Ljava/lang/StackTraceElement;)V", nullptr, $PUBLIC},
