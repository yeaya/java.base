...
$MethodInfo _VarHandleInts$FieldStaticReadOnly_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/Object;J)V", nullptr, 0, $method(static_cast<void(VarHandleInts$FieldStaticReadOnly::*)(Object$*,int64_t)>(&VarHandleInts$FieldStaticReadOnly::init$))},
	{"<init>", "(Ljava/lang/Object;JLjava/lang/invoke/VarForm;Z)V", nullptr, $PROTECTED, $method(static_cast<void(VarHandleInts$FieldStaticReadOnly::*)(Object$*,int64_t,$VarForm*,bool)>(&VarHandleInts$FieldStaticReadOnly::init$))},
	...
	{"get", "(Ljava/lang/invoke/VarHandle;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($VarHandle*)>(&VarHandleInts$FieldStaticReadOnly::get)), nullptr, nullptr, _VarHandleInts$FieldStaticReadOnly_MethodAnnotations_get4},
	{"getAcquire", "(Ljava/lang/invoke/VarHandle;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($VarHandle*)>(&VarHandleInts$FieldStaticReadOnly::getAcquire)), nullptr, nullptr, _VarHandleInts$FieldStaticReadOnly_MethodAnnotations_getAcquire5},
	{"getOpaque", "(Ljava/lang/invoke/VarHandle;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($VarHandle*)>(&VarHandleInts$FieldStaticReadOnly::getOpaque)), nullptr, nullptr, _VarHandleInts$FieldStaticReadOnly_MethodAnnotations_getOpaque6},
	{"getVolatile", "(Ljava/lang/invoke/VarHandle;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($VarHandle*)>(&VarHandleInts$FieldStaticReadOnly::getVolatile)), nullptr, nullptr, _VarHandleInts$FieldStaticReadOnly_MethodAnnotations_getVolatile7},
	{"withInvokeBehavior", "()Ljava/lang/invoke/VarHandleInts$FieldStaticReadOnly;", nullptr, $PUBLIC},
	{"withInvokeExactBehavior", "()Ljava/lang/invoke/VarHandleInts$FieldStaticReadOnly;", nullptr, $PUBLIC},
	{}
};
