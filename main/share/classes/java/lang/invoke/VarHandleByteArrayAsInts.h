#ifndef _java_lang_invoke_VarHandleByteArrayAsInts_h_
#define _java_lang_invoke_VarHandleByteArrayAsInts_h_
//$ class java.lang.invoke.VarHandleByteArrayAsInts
...
class VarHandleByteArrayAsInts : public ::java::lang::invoke::VarHandleByteArrayBase {
	$class(VarHandleByteArrayAsInts, 0, ::java::lang::invoke::VarHandleByteArrayBase)
public:
	VarHandleByteArrayAsInts();
	void init$();
	static int32_t convEndian(bool big, int32_t n);
	static ::jdk::internal::access::JavaNioAccess* NIO_ACCESS;
	static const int32_t ALIGN = 3; // ::java::lang::Integer::BYTES - 1
...
#endif // _java_lang_invoke_VarHandleByteArrayAsInts_h_