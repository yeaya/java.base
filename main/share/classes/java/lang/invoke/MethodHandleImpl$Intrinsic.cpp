...
void MethodHandleImpl$Intrinsic::clinit$($Class* clazz) {
...
$Class* MethodHandleImpl$Intrinsic::load$($String* name, bool initialize) {
	...
	$loadClass(MethodHandleImpl$Intrinsic, name, initialize, &classInfo$$, MethodHandleImpl$Intrinsic::clinit$, []($Class* clazz) -> $Object* {
