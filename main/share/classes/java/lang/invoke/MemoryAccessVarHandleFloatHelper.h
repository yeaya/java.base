#ifndef _java_lang_invoke_MemoryAccessVarHandleFloatHelper_h_
#define _java_lang_invoke_MemoryAccessVarHandleFloatHelper_h_
...
class MemoryAccessVarHandleFloatHelper : public ::java::lang::invoke::MemoryAccessVarHandleBase {
	$class(MemoryAccessVarHandleFloatHelper, 0, ::java::lang::invoke::MemoryAccessVarHandleBase)
public:
	...
	static float compareAndExchange(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	static float compareAndExchangeAcquire(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	static float compareAndExchangeRelease(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	static bool compareAndSet(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	static int32_t convEndian(bool big, float v);
	static float convEndian(bool big, int32_t rv);
	static float get(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	static float getAcquire(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	static float getAndSet(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	static float getAndSetAcquire(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	static float getAndSetRelease(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	static float getOpaque(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	static float getVolatile(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	...
	static void set(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::setOpaque;
	static void setOpaque(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::setRelease;
	static void setRelease(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::setVolatile;
	static void setVolatile(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::weakCompareAndSet;
	static bool weakCompareAndSet(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::weakCompareAndSetAcquire;
	static bool weakCompareAndSetAcquire(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::weakCompareAndSetPlain;
	static bool weakCompareAndSetPlain(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::weakCompareAndSetRelease;
	static bool weakCompareAndSetRelease(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, float expected, float value);
	virtual ::java::lang::invoke::MemoryAccessVarHandleFloatHelper* withInvokeBehavior() override;
...
#endif // _java_lang_invoke_MemoryAccessVarHandleFloatHelper_h_