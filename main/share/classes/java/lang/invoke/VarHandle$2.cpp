...
void VarHandle$2::clinit$($Class* clazz) {
	$useLocalObjectStack();
	...
	{
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$VarHandleDesc$Kind->set($VarHandle$VarHandleDesc$Kind::FIELD->ordinal(), 1);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$VarHandleDesc$Kind->set($VarHandle$VarHandleDesc$Kind::STATIC_FIELD->ordinal(), 2);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$VarHandleDesc$Kind->set($VarHandle$VarHandleDesc$Kind::ARRAY->ordinal(), 3);
		} catch ($NoSuchFieldError& ex) {
		}
	}
	...
	{
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$AccessType->set($VarHandle$AccessType::GET->ordinal(), 1);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$AccessType->set($VarHandle$AccessType::SET->ordinal(), 2);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$AccessType->set($VarHandle$AccessType::COMPARE_AND_SET->ordinal(), 3);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$AccessType->set($VarHandle$AccessType::COMPARE_AND_EXCHANGE->ordinal(), 4);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			VarHandle$2::$SwitchMap$java$lang$invoke$VarHandle$AccessType->set($VarHandle$AccessType::GET_AND_UPDATE->ordinal(), 5);
		} catch ($NoSuchFieldError& ex) {
		}
	}
}
...
$Class* VarHandle$2::load$($String* name, bool initialize) {
	...
	$loadClass(VarHandle$2, name, initialize, &classInfo$$, VarHandle$2::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(VarHandle$2);
	});
	return class$;
}
