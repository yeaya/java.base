#ifndef _java_lang_invoke_MemoryAccessVarHandleCharHelper_h_
#define _java_lang_invoke_MemoryAccessVarHandleCharHelper_h_
//$ class java.lang.invoke.MemoryAccessVarHandleCharHelper
...
class MemoryAccessVarHandleCharHelper : public ::java::lang::invoke::MemoryAccessVarHandleBase {
	$class(MemoryAccessVarHandleCharHelper, 0, ::java::lang::invoke::MemoryAccessVarHandleBase)
public:
	...
	static char16_t get(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	static char16_t getAcquire(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	static char16_t getOpaque(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	static char16_t getVolatile(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base);
	...
	static void set(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, char16_t value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::setOpaque;
	static void setOpaque(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, char16_t value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::setRelease;
	static void setRelease(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, char16_t value);
	using ::java::lang::invoke::MemoryAccessVarHandleBase::setVolatile;
	static void setVolatile(::java::lang::invoke::VarHandle* ob, Object$* obb, int64_t base, char16_t value);
	virtual ::java::lang::invoke::MemoryAccessVarHandleCharHelper* withInvokeBehavior() override;
	virtual ::java::lang::invoke::MemoryAccessVarHandleCharHelper* withInvokeExactBehavior() override;
	static bool BE;
	static ::jdk::internal::misc::ScopedMemoryAccess* SCOPED_MEMORY_ACCESS;
	static const int32_t VM_ALIGN = 1; // ::java::lang::Character::BYTES - 1
...
#endif // _java_lang_invoke_MemoryAccessVarHandleCharHelper_h_