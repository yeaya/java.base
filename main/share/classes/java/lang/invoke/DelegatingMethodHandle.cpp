...
$MethodInfo _DelegatingMethodHandle_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/lang/invoke/MethodHandle;)V", nullptr, $PROTECTED, $method(static_cast<void(DelegatingMethodHandle::*)($MethodHandle*)>(&DelegatingMethodHandle::init$))},
	{"<init>", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;)V", nullptr, $PROTECTED, $method(static_cast<void(DelegatingMethodHandle::*)($MethodType*,$MethodHandle*)>(&DelegatingMethodHandle::init$))},
	{"<init>", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;)V", nullptr, $PROTECTED, $method(static_cast<void(DelegatingMethodHandle::*)($MethodType*,$LambdaForm*)>(&DelegatingMethodHandle::init$))},
	{"chooseDelegatingForm", "(Ljava/lang/invoke/MethodHandle;)Ljava/lang/invoke/LambdaForm;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$LambdaForm*(*)($MethodHandle*)>(&DelegatingMethodHandle::chooseDelegatingForm))},
	{"copyWith", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;)Ljava/lang/invoke/MethodHandle;", nullptr, 0},
	{"getTarget", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PROTECTED | $ABSTRACT},
	...
	{"makeReinvokerForm", "(Ljava/lang/invoke/MethodHandle;ILjava/lang/Object;Ljava/lang/invoke/LambdaForm$NamedFunction;)Ljava/lang/invoke/LambdaForm;", nullptr, $STATIC, $method(static_cast<$LambdaForm*(*)($MethodHandle*,int32_t,Object$*,$LambdaForm$NamedFunction*)>(&DelegatingMethodHandle::makeReinvokerForm))},
	{"makeReinvokerForm", "(Ljava/lang/invoke/MethodHandle;ILjava/lang/Object;ZLjava/lang/invoke/LambdaForm$NamedFunction;Ljava/lang/invoke/LambdaForm$NamedFunction;)Ljava/lang/invoke/LambdaForm;", nullptr, $STATIC, $method(static_cast<$LambdaForm*(*)($MethodHandle*,int32_t,Object$*,bool,$LambdaForm$NamedFunction*,$LambdaForm$NamedFunction*)>(&DelegatingMethodHandle::makeReinvokerForm))},
	...
	{"whichKind", "(I)Ljava/lang/invoke/LambdaForm$Kind;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$LambdaForm$Kind*(*)(int32_t)>(&DelegatingMethodHandle::whichKind))},
	{}
};
