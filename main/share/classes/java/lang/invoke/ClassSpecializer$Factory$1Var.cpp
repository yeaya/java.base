...
void ClassSpecializer$Factory$1Var::clinit$($Class* clazz) {
...
$Class* ClassSpecializer$Factory$1Var::load$($String* name, bool initialize) {
	...
	$loadClass(ClassSpecializer$Factory$1Var, name, initialize, &classInfo$$, ClassSpecializer$Factory$1Var::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ClassSpecializer$Factory$1Var);
	});
	return class$;
}
