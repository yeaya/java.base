...
$MethodInfo _BoundMethodHandle_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;)V", nullptr, 0, $method(static_cast<void(BoundMethodHandle::*)($MethodType*,$LambdaForm*)>(&BoundMethodHandle::init$))},
	{"arg", "(I)Ljava/lang/Object;", nullptr, $FINAL, $method(static_cast<$Object*(BoundMethodHandle::*)(int32_t)>(&BoundMethodHandle::arg))},
	{"bindArgumentD", "(ID)Ljava/lang/invoke/BoundMethodHandle;", nullptr, 0},
	{"bindArgumentF", "(IF)Ljava/lang/invoke/BoundMethodHandle;", nullptr, 0},
	{"bindArgumentI", "(II)Ljava/lang/invoke/BoundMethodHandle;", nullptr, 0},
	{"bindArgumentJ", "(IJ)Ljava/lang/invoke/BoundMethodHandle;", nullptr, 0},
	{"bindArgumentL", "(ILjava/lang/Object;)Ljava/lang/invoke/BoundMethodHandle;", nullptr, 0},
	{"bindSingle", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;Ljava/lang/invoke/LambdaForm$BasicType;Ljava/lang/Object;)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $STATIC, $method(static_cast<BoundMethodHandle*(*)($MethodType*,$LambdaForm*,$LambdaForm$BasicType*,Object$*)>(&BoundMethodHandle::bindSingle))},
	{"bindSingle", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;Ljava/lang/Object;)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $STATIC, $method(static_cast<BoundMethodHandle*(*)($MethodType*,$LambdaForm*,Object$*)>(&BoundMethodHandle::bindSingle))},
	{"copyWithExtendD", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;D)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $ABSTRACT},
	{"copyWithExtendF", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;F)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $ABSTRACT},
	{"copyWithExtendI", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;I)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $ABSTRACT},
	{"copyWithExtendJ", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;J)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $ABSTRACT},
	{"copyWithExtendL", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/LambdaForm;Ljava/lang/Object;)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $ABSTRACT},
	{"editor", "()Ljava/lang/invoke/LambdaFormEditor;", nullptr, 0},
	{"fieldCount", "()I", nullptr, $FINAL, $method(static_cast<int32_t(BoundMethodHandle::*)()>(&BoundMethodHandle::fieldCount))},
	{"internalProperties", "()Ljava/lang/Object;", nullptr, 0},
	{"internalValues", "()Ljava/lang/String;", nullptr, $FINAL},
	{"makeReinvoker", "(Ljava/lang/invoke/MethodHandle;)Ljava/lang/invoke/BoundMethodHandle;", nullptr, $STATIC, $method(static_cast<BoundMethodHandle*(*)($MethodHandle*)>(&BoundMethodHandle::makeReinvoker))},
	{"rebind", "()Ljava/lang/invoke/BoundMethodHandle;", nullptr, 0},
	{"speciesData", "()Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $ABSTRACT},
	{"speciesDataFor", "(Ljava/lang/invoke/LambdaForm;)Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $STATIC, $method(static_cast<$BoundMethodHandle$SpeciesData*(*)($LambdaForm*)>(&BoundMethodHandle::speciesDataFor))},
	{"speciesData_L", "()Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $STATIC, $method(static_cast<$BoundMethodHandle$SpeciesData*(*)()>(&BoundMethodHandle::speciesData_L))},
	{"speciesData_LL", "()Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $STATIC, $method(static_cast<$BoundMethodHandle$SpeciesData*(*)()>(&BoundMethodHandle::speciesData_LL))},
	{"speciesData_LLL", "()Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $STATIC, $method(static_cast<$BoundMethodHandle$SpeciesData*(*)()>(&BoundMethodHandle::speciesData_LLL))},
	{"speciesData_LLLL", "()Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $STATIC, $method(static_cast<$BoundMethodHandle$SpeciesData*(*)()>(&BoundMethodHandle::speciesData_LLLL))},
	{"speciesData_LLLLL", "()Ljava/lang/invoke/BoundMethodHandle$SpeciesData;", nullptr, $STATIC, $method(static_cast<$BoundMethodHandle$SpeciesData*(*)()>(&BoundMethodHandle::speciesData_LLLLL))},
	{"tooComplex", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(BoundMethodHandle::*)()>(&BoundMethodHandle::tooComplex))},
	{}
};
