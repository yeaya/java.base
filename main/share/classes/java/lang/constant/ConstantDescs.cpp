...
void ConstantDescs::clinit$($Class* clazz) {
	$useLocalObjectStack();
	...
	$assignStatic(ConstantDescs::TRUE, $DynamicConstantDesc::ofNamed(ConstantDescs::BSM_GET_STATIC_FINAL, "TRUE"_s, ConstantDescs::CD_Boolean, $$new($ConstantDescArray, {ConstantDescs::CD_Boolean})));
	$assignStatic(ConstantDescs::FALSE, $DynamicConstantDesc::ofNamed(ConstantDescs::BSM_GET_STATIC_FINAL, "FALSE"_s, ConstantDescs::CD_Boolean, $$new($ConstantDescArray, {ConstantDescs::CD_Boolean})));
	$init($DirectMethodHandleDesc$Kind);
...
$Class* ConstantDescs::load$($String* name, bool initialize) {
	...
	$loadClass(ConstantDescs, name, initialize, &classInfo$$, ConstantDescs::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ConstantDescs);
	});
	return class$;
}
