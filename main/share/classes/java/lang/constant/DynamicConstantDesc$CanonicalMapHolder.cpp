...
$Class* DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizePrimitiveClass::load$($String* name, bool initialize) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizePrimitiveClass, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizePrimitiveClass);
	});
	return class$;
}
...
$Class* DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeEnum$1::load$($String* name, bool initialize) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeEnum$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeEnum$1);
	});
	return class$;
}
...
$Class* DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeNull$2::load$($String* name, bool initialize) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeNull$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeNull$2);
	});
	return class$;
}
...
$Class* DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeStaticFieldVarHandle$3::load$($String* name, bool initialize) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeStaticFieldVarHandle$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeStaticFieldVarHandle$3);
	});
	return class$;
}
...
$Class* DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeFieldVarHandle$4::load$($String* name, bool initialize) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeFieldVarHandle$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeFieldVarHandle$4);
	});
	return class$;
}
...
$Class* DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeArrayVarHandle$5::load$($String* name, bool initialize) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeArrayVarHandle$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeArrayVarHandle$5);
	});
	return class$;
}
...
void DynamicConstantDesc$CanonicalMapHolder::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$init($ConstantDescs);
	$assignStatic(DynamicConstantDesc$CanonicalMapHolder::CANONICAL_MAP, $Map::ofEntries($$new($Map$EntryArray, {
		$($Map::entry($ConstantDescs::BSM_PRIMITIVE_CLASS, $$new(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizePrimitiveClass))),
		$($Map::entry($ConstantDescs::BSM_ENUM_CONSTANT, $$new(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeEnum$1))),
		$($Map::entry($ConstantDescs::BSM_NULL_CONSTANT, $$new(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeNull$2))),
		$($Map::entry($ConstantDescs::BSM_VARHANDLE_STATIC_FIELD, $$new(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeStaticFieldVarHandle$3))),
		$($Map::entry($ConstantDescs::BSM_VARHANDLE_FIELD, $$new(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeFieldVarHandle$4))),
		$($Map::entry($ConstantDescs::BSM_VARHANDLE_ARRAY, $$new(DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeArrayVarHandle$5)))
	})));
}
...
$Class* DynamicConstantDesc$CanonicalMapHolder::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.lang.constant.DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizePrimitiveClass")) {
			return DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizePrimitiveClass::load$(name, initialize);
		}
		if (name->equals("java.lang.constant.DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeEnum$1")) {
			return DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeEnum$1::load$(name, initialize);
		}
		if (name->equals("java.lang.constant.DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeNull$2")) {
			return DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeNull$2::load$(name, initialize);
		}
		if (name->equals("java.lang.constant.DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeStaticFieldVarHandle$3")) {
			return DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeStaticFieldVarHandle$3::load$(name, initialize);
		}
		if (name->equals("java.lang.constant.DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeFieldVarHandle$4")) {
			return DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeFieldVarHandle$4::load$(name, initialize);
		}
		if (name->equals("java.lang.constant.DynamicConstantDesc$CanonicalMapHolder$$Lambda$canonicalizeArrayVarHandle$5")) {
	...
	$loadClass(DynamicConstantDesc$CanonicalMapHolder, name, initialize, &classInfo$$, DynamicConstantDesc$CanonicalMapHolder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(DynamicConstantDesc$CanonicalMapHolder);
	});
	return class$;
}
