...
void CharacterDataPrivateUse::clinit$($Class* clazz) {
...
$Class* CharacterDataPrivateUse::load$($String* name, bool initialize) {
	...
	$loadClass(CharacterDataPrivateUse, name, initialize, &classInfo$$, CharacterDataPrivateUse::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CharacterDataPrivateUse);
	});
	return class$;
}
