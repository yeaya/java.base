...
ClassCircularityError::ClassCircularityError(const ClassCircularityError& e) {
}

ClassCircularityError ClassCircularityError::wrapper$() {
	$pendingException(this);
	return *this;
}

void ClassCircularityError::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
