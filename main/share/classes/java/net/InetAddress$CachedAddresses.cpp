...
void InetAddress$CachedAddresses::init$($String* host, $InetAddressArray* inetAddresses, int64_t expiryTime) {
	this->id = InetAddress$CachedAddresses::seq->incrementAndGet();
	$set(this, host, host);
...
void InetAddress$CachedAddresses::clinit$($Class* clazz) {
...
$Class* InetAddress$CachedAddresses::load$($String* name, bool initialize) {
	...
	$loadClass(InetAddress$CachedAddresses, name, initialize, &classInfo$$, InetAddress$CachedAddresses::clinit$, []($Class* clazz) -> $Object* {
