...
$MethodInfo _MulticastSocket_MethodInfo_[] = {
	...
	{"getInterface", "()Ljava/net/InetAddress;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, getInterface, $InetAddress*), "java.net.SocketException", nullptr, _MulticastSocket_MethodAnnotations_getInterface5},
	{"getLoopbackMode", "()Z", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, getLoopbackMode, bool), "java.net.SocketException", nullptr, _MulticastSocket_MethodAnnotations_getLoopbackMode6},
	...
	{"getTTL", "()B", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, getTTL, int8_t), "java.io.IOException", nullptr, _MulticastSocket_MethodAnnotations_getTTL8},
	{"getTimeToLive", "()I", nullptr, $PUBLIC, $virtualMethod(MulticastSocket, getTimeToLive, int32_t), "java.io.IOException"},
	{"joinGroup", "(Ljava/net/InetAddress;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, joinGroup, void, $InetAddress*), "java.io.IOException", nullptr, _MulticastSocket_MethodAnnotations_joinGroup10},
	...
	{"leaveGroup", "(Ljava/net/InetAddress;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, leaveGroup, void, $InetAddress*), "java.io.IOException", nullptr, _MulticastSocket_MethodAnnotations_leaveGroup12},
	...
	{"send", "(Ljava/net/DatagramPacket;B)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, send, void, $DatagramPacket*, int8_t), "java.io.IOException", nullptr, _MulticastSocket_MethodAnnotations_send14},
	{"setInterface", "(Ljava/net/InetAddress;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, setInterface, void, $InetAddress*), "java.net.SocketException", nullptr, _MulticastSocket_MethodAnnotations_setInterface15},
	{"setLoopbackMode", "(Z)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, setLoopbackMode, void, bool), "java.net.SocketException", nullptr, _MulticastSocket_MethodAnnotations_setLoopbackMode16},
	...
	{"setTTL", "(B)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MulticastSocket, setTTL, void, int8_t), "java.io.IOException", nullptr, _MulticastSocket_MethodAnnotations_setTTL18},
