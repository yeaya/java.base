#ifndef _java_net_SocksConsts_h_
#define _java_net_SocksConsts_h_
//$ interface java.net.SocksConsts
...
class SocksConsts : public ::java::lang::Object {
	$interface(SocksConsts, $NO_CLASS_INIT, ::java::lang::Object)
public:
