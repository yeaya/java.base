...
void URLDecoder::clinit$($Class* clazz) {
	$init($URLEncoder);
...
$Class* URLDecoder::load$($String* name, bool initialize) {
	...
	$CompoundAttribute decodemethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(URLDecoder, init$, void)},
		{"decode", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC | $DEPRECATED, $staticMethod(URLDecoder, decode, $String*, $String*), nullptr, nullptr, decodemethodAnnotations$$},
	...
	$loadClass(URLDecoder, name, initialize, &classInfo$$, URLDecoder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(URLDecoder);
	});
	return class$;
}
