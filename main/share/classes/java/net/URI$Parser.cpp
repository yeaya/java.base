...
$MethodInfo _URI$Parser_MethodInfo_[] = {
	{"<init>", "(Ljava/net/URI;Ljava/lang/String;)V", nullptr, 0, $method(static_cast<void(URI$Parser::*)($URI*,$String*)>(&URI$Parser::init$))},
	{"at", "(IIC)Z", nullptr, $PRIVATE, $method(static_cast<bool(URI$Parser::*)(int32_t,int32_t,char16_t)>(&URI$Parser::at))},
	{"at", "(IILjava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(URI$Parser::*)(int32_t,int32_t,$String*)>(&URI$Parser::at))},
	{"checkChar", "(IJJLjava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(URI$Parser::*)(int32_t,int64_t,int64_t,$String*)>(&URI$Parser::checkChar)), "java.net.URISyntaxException"},
	{"checkChars", "(IIJJLjava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(URI$Parser::*)(int32_t,int32_t,int64_t,int64_t,$String*)>(&URI$Parser::checkChars)), "java.net.URISyntaxException"},
	{"fail", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(URI$Parser::*)($String*)>(&URI$Parser::fail)), "java.net.URISyntaxException"},
	{"fail", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(static_cast<void(URI$Parser::*)($String*,int32_t)>(&URI$Parser::fail)), "java.net.URISyntaxException"},
	{"failExpecting", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(static_cast<void(URI$Parser::*)($String*,int32_t)>(&URI$Parser::failExpecting)), "java.net.URISyntaxException"},
	{"parse", "(Z)V", nullptr, 0, nullptr, "java.net.URISyntaxException"},
	{"parseAuthority", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::parseAuthority)), "java.net.URISyntaxException"},
	{"parseHierarchical", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::parseHierarchical)), "java.net.URISyntaxException"},
	{"parseHostname", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::parseHostname)), "java.net.URISyntaxException"},
	{"parseIPv4Address", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::parseIPv4Address))},
	{"parseIPv6Reference", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::parseIPv6Reference)), "java.net.URISyntaxException"},
	{"parseServer", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::parseServer)), "java.net.URISyntaxException"},
	{"scan", "(IIC)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,char16_t)>(&URI$Parser::scan))},
	{"scan", "(IILjava/lang/String;Ljava/lang/String;)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,$String*,$String*)>(&URI$Parser::scan))},
	{"scan", "(IILjava/lang/String;)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,$String*)>(&URI$Parser::scan))},
	{"scan", "(IIJJ)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,int64_t,int64_t)>(&URI$Parser::scan)), "java.net.URISyntaxException"},
	{"scanByte", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::scanByte)), "java.net.URISyntaxException"},
	{"scanEscape", "(IIC)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,char16_t)>(&URI$Parser::scanEscape)), "java.net.URISyntaxException"},
	{"scanHexPost", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::scanHexPost)), "java.net.URISyntaxException"},
	{"scanHexSeq", "(II)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t)>(&URI$Parser::scanHexSeq)), "java.net.URISyntaxException"},
	{"scanIPv4Address", "(IIZ)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,bool)>(&URI$Parser::scanIPv4Address)), "java.net.URISyntaxException"},
	{"takeIPv4Address", "(IILjava/lang/String;)I", nullptr, $PRIVATE, $method(static_cast<int32_t(URI$Parser::*)(int32_t,int32_t,$String*)>(&URI$Parser::takeIPv4Address)), "java.net.URISyntaxException"},
	{}
};
