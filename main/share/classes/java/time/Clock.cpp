...
$MethodInfo _Clock_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(Clock::*)()>(&Clock::init$))},
	{"currentInstant", "()Ljava/time/Instant;", nullptr, $STATIC, $method(static_cast<$Instant*(*)()>(&Clock::currentInstant))},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"fixed", "(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)($Instant*,$ZoneId*)>(&Clock::fixed))},
	...
	{"offset", "(Ljava/time/Clock;Ljava/time/Duration;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)(Clock*,$Duration*)>(&Clock::offset))},
	{"system", "(Ljava/time/ZoneId;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)($ZoneId*)>(&Clock::system))},
	{"systemDefaultZone", "()Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)()>(&Clock::systemDefaultZone))},
	{"systemUTC", "()Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)()>(&Clock::systemUTC))},
	{"tick", "(Ljava/time/Clock;Ljava/time/Duration;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)(Clock*,$Duration*)>(&Clock::tick))},
	{"tickMillis", "(Ljava/time/ZoneId;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)($ZoneId*)>(&Clock::tickMillis))},
	{"tickMinutes", "(Ljava/time/ZoneId;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)($ZoneId*)>(&Clock::tickMinutes))},
	{"tickSeconds", "(Ljava/time/ZoneId;)Ljava/time/Clock;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Clock*(*)($ZoneId*)>(&Clock::tickSeconds))},
	{"withZone", "(Ljava/time/ZoneId;)Ljava/time/Clock;", nullptr, $PUBLIC | $ABSTRACT},
	{}
};
