...
int32_t Clock$SystemInstantSource::hashCode() {
	return Clock$SystemInstantSource::class$->hashCode();
}
...
void Clock$SystemInstantSource::clinit$($Class* clazz) {
...
$Class* Clock$SystemInstantSource::load$($String* name, bool initialize) {
	...
	$loadClass(Clock$SystemInstantSource, name, initialize, &classInfo$$, Clock$SystemInstantSource::clinit$, []($Class* clazz) -> $Object* {
