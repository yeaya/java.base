...
$MethodInfo _ChronoLocalDateTimeImpl_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/time/chrono/ChronoLocalDate;Ljava/time/LocalTime;)V", "(TD;Ljava/time/LocalTime;)V", $PRIVATE, $method(static_cast<void(ChronoLocalDateTimeImpl::*)($ChronoLocalDate*,$LocalTime*)>(&ChronoLocalDateTimeImpl::init$))},
	{"atZone", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC},
	{"ensureValid", "(Ljava/time/chrono/Chronology;Ljava/time/temporal/Temporal;)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "<R::Ljava/time/chrono/ChronoLocalDate;>(Ljava/time/chrono/Chronology;Ljava/time/temporal/Temporal;)Ljava/time/chrono/ChronoLocalDateTimeImpl<TR;>;", $STATIC, $method(static_cast<ChronoLocalDateTimeImpl*(*)($Chronology*,$Temporal*)>(&ChronoLocalDateTimeImpl::ensureValid))},
	...
	{"of", "(Ljava/time/chrono/ChronoLocalDate;Ljava/time/LocalTime;)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "<R::Ljava/time/chrono/ChronoLocalDate;>(TR;Ljava/time/LocalTime;)Ljava/time/chrono/ChronoLocalDateTimeImpl<TR;>;", $STATIC, $method(static_cast<ChronoLocalDateTimeImpl*(*)($ChronoLocalDate*,$LocalTime*)>(&ChronoLocalDateTimeImpl::of))},
	{"plus", "(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PUBLIC},
	{"plusDays", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PRIVATE, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)(int64_t)>(&ChronoLocalDateTimeImpl::plusDays))},
	{"plusHours", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PRIVATE, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)(int64_t)>(&ChronoLocalDateTimeImpl::plusHours))},
	{"plusMinutes", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PRIVATE, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)(int64_t)>(&ChronoLocalDateTimeImpl::plusMinutes))},
	{"plusNanos", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PRIVATE, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)(int64_t)>(&ChronoLocalDateTimeImpl::plusNanos))},
	{"plusSeconds", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(J)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", 0, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)(int64_t)>(&ChronoLocalDateTimeImpl::plusSeconds))},
	{"plusWithOverflow", "(Ljava/time/chrono/ChronoLocalDate;JJJJ)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(TD;JJJJ)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PRIVATE, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)($ChronoLocalDate*,int64_t,int64_t,int64_t,int64_t)>(&ChronoLocalDateTimeImpl::plusWithOverflow))},
	{"range", "(Ljava/time/temporal/TemporalField;)Ljava/time/temporal/ValueRange;", nullptr, $PUBLIC},
	{"readExternal", "(Ljava/io/ObjectInput;)Ljava/time/chrono/ChronoLocalDateTime;", "(Ljava/io/ObjectInput;)Ljava/time/chrono/ChronoLocalDateTime<*>;", $STATIC, $method(static_cast<$ChronoLocalDateTime*(*)($ObjectInput*)>(&ChronoLocalDateTimeImpl::readExternal)), "java.io.IOException,java.lang.ClassNotFoundException"},
	{"readObject", "(Ljava/io/ObjectInputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(ChronoLocalDateTimeImpl::*)($ObjectInputStream*)>(&ChronoLocalDateTimeImpl::readObject)), "java.io.InvalidObjectException"},
	{"toLocalDate", "()Ljava/time/chrono/ChronoLocalDate;", "()TD;", $PUBLIC},
	...
	{"with", "(Ljava/time/temporal/Temporal;Ljava/time/LocalTime;)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(Ljava/time/temporal/Temporal;Ljava/time/LocalTime;)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PRIVATE, $method(static_cast<ChronoLocalDateTimeImpl*(ChronoLocalDateTimeImpl::*)($Temporal*,$LocalTime*)>(&ChronoLocalDateTimeImpl::with))},
	{"with", "(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PUBLIC},
	{"with", "(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/ChronoLocalDateTimeImpl;", "(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/ChronoLocalDateTimeImpl<TD;>;", $PUBLIC},
	{"writeExternal", "(Ljava/io/ObjectOutput;)V", nullptr, 0, $method(static_cast<void(ChronoLocalDateTimeImpl::*)($ObjectOutput*)>(&ChronoLocalDateTimeImpl::writeExternal)), "java.io.IOException"},
	{"writeReplace", "()Ljava/lang/Object;", nullptr, $PRIVATE, $method(static_cast<$Object*(ChronoLocalDateTimeImpl::*)()>(&ChronoLocalDateTimeImpl::writeReplace))},
	{}
};
