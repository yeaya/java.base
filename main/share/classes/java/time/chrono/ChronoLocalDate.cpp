...
$Class* ChronoLocalDate$$Lambda$lambda$timeLineOrder$493d4938$1::load$($String* name, bool initialize) {
	...
	$loadClass(ChronoLocalDate$$Lambda$lambda$timeLineOrder$493d4938$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
...
$Comparator* ChronoLocalDate::timeLineOrder() {
	...
	return $cast($Comparator, $cast($Serializable, $new(ChronoLocalDate$$Lambda$lambda$timeLineOrder$493d4938$1)));
}
		...
		case 0:
			{
				...
				bool var$0 = var$1 && $$nc(lambda->getImplClass())->equals("java/time/chrono/ChronoLocalDate"_s);
				if (var$0 && $$nc(lambda->getImplMethodSignature())->equals("(Ljava/time/chrono/ChronoLocalDate;Ljava/time/chrono/ChronoLocalDate;)I"_s)) {
					return $of($new(ChronoLocalDate$$Lambda$lambda$timeLineOrder$493d4938$1));
				}
				break;
			}
		}
...
$Class* ChronoLocalDate::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.time.chrono.ChronoLocalDate$$Lambda$lambda$timeLineOrder$493d4938$1")) {
	...
	$loadClass(ChronoLocalDate, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
