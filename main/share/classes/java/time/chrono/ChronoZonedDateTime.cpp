...
$MethodInfo ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1::methodInfos[3] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1::*)()>(&ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1::init$))},
...
$MethodInfo _ChronoZonedDateTime_MethodInfo_[] = {
	{"$deserializeLambda$", "(Ljava/lang/invoke/SerializedLambda;)Ljava/lang/Object;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$Object*(*)($SerializedLambda*)>(&ChronoZonedDateTime::$deserializeLambda$))},
	{"*clone", "()Ljava/lang/Object;", nullptr, $PROTECTED | $NATIVE},
	{"compareTo", "(Ljava/time/chrono/ChronoZonedDateTime;)I", "(Ljava/time/chrono/ChronoZonedDateTime<*>;)I", $PUBLIC},
	{"compareTo", "(Ljava/lang/Object;)I", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC | $ABSTRACT},
	{"*finalize", "()V", nullptr, $PROTECTED | $DEPRECATED},
	{"format", "(Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;", nullptr, $PUBLIC},
	{"from", "(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoZonedDateTime<*>;", $PUBLIC | $STATIC, $method(static_cast<ChronoZonedDateTime*(*)($TemporalAccessor*)>(&ChronoZonedDateTime::from))},
	...
	{"getOffset", "()Ljava/time/ZoneOffset;", nullptr, $PUBLIC | $ABSTRACT},
	{"getZone", "()Ljava/time/ZoneId;", nullptr, $PUBLIC | $ABSTRACT},
	{"hashCode", "()I", nullptr, $PUBLIC | $ABSTRACT},
	{"isAfter", "(Ljava/time/chrono/ChronoZonedDateTime;)Z", "(Ljava/time/chrono/ChronoZonedDateTime<*>;)Z", $PUBLIC},
	{"isBefore", "(Ljava/time/chrono/ChronoZonedDateTime;)Z", "(Ljava/time/chrono/ChronoZonedDateTime<*>;)Z", $PUBLIC},
	{"isEqual", "(Ljava/time/chrono/ChronoZonedDateTime;)Z", "(Ljava/time/chrono/ChronoZonedDateTime<*>;)Z", $PUBLIC},
	...
	{"lambda$timeLineOrder$f56e6d02$1", "(Ljava/time/chrono/ChronoZonedDateTime;Ljava/time/chrono/ChronoZonedDateTime;)I", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<int32_t(*)(ChronoZonedDateTime*,ChronoZonedDateTime*)>(&ChronoZonedDateTime::lambda$timeLineOrder$f56e6d02$1))},
	{"minus", "(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC},
	{"minus", "(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoZonedDateTime;", "(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC},
	{"plus", "(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoZonedDateTime;", nullptr, $PUBLIC | $ABSTRACT},
	{"plus", "(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC},
	...
	{"timeLineOrder", "()Ljava/util/Comparator;", "()Ljava/util/Comparator<Ljava/time/chrono/ChronoZonedDateTime<*>;>;", $PUBLIC | $STATIC, $method(static_cast<$Comparator*(*)()>(&ChronoZonedDateTime::timeLineOrder))},
	{"toEpochSecond", "()J", nullptr, $PUBLIC},
	{"toInstant", "()Ljava/time/Instant;", nullptr, $PUBLIC},
	{"toLocalDate", "()Ljava/time/chrono/ChronoLocalDate;", "()TD;", $PUBLIC},
	{"toLocalDateTime", "()Ljava/time/chrono/ChronoLocalDateTime;", "()Ljava/time/chrono/ChronoLocalDateTime<TD;>;", $PUBLIC | $ABSTRACT},
	...
	{"with", "(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC},
	{"withEarlierOffsetAtOverlap", "()Ljava/time/chrono/ChronoZonedDateTime;", "()Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC | $ABSTRACT},
	{"withLaterOffsetAtOverlap", "()Ljava/time/chrono/ChronoZonedDateTime;", "()Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC | $ABSTRACT},
	{"withZoneSameInstant", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC | $ABSTRACT},
	{"withZoneSameLocal", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime;", "(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime<TD;>;", $PUBLIC | $ABSTRACT},
	{}
};
