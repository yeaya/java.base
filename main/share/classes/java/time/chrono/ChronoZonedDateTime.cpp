...
$Class* ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1::load$($String* name, bool initialize) {
	...
	$loadClass(ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
...
$Comparator* ChronoZonedDateTime::timeLineOrder() {
	...
	return $cast($Comparator, $cast($Serializable, $new(ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1)));
}
...
int32_t ChronoZonedDateTime::compareTo(ChronoZonedDateTime* other) {
	...
	if (cmp == 0) {
		...
		cmp = var$1 - $$nc(other->toLocalTime())->getNano();
		if (cmp == 0) {
		...
		case 0:
			{
				...
				bool var$0 = var$1 && $$nc(lambda->getImplClass())->equals("java/time/chrono/ChronoZonedDateTime"_s);
				if (var$0 && $$nc(lambda->getImplMethodSignature())->equals("(Ljava/time/chrono/ChronoZonedDateTime;Ljava/time/chrono/ChronoZonedDateTime;)I"_s)) {
					return $of($new(ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1));
				}
				break;
			}
		}
...
int32_t ChronoZonedDateTime::lambda$timeLineOrder$f56e6d02$1(ChronoZonedDateTime* dateTime1, ChronoZonedDateTime* dateTime2) {
	...
	if (cmp == 0) {
		int64_t var$1 = $$nc(dateTime1->toLocalTime())->getNano();
		cmp = $Long::compare(var$1, $$nc(dateTime2->toLocalTime())->getNano());
	}
	return cmp;
}
...
$Class* ChronoZonedDateTime::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.time.chrono.ChronoZonedDateTime$$Lambda$lambda$timeLineOrder$f56e6d02$1")) {
	...
	$loadClass(ChronoZonedDateTime, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
