...
$MethodInfo _DayOfWeek_MethodInfo_[] = {
	{"$values", "()[Ljava/time/DayOfWeek;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$DayOfWeekArray*(*)()>(&DayOfWeek::$values))},
	{"*clone", "()Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{"*equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC | $FINAL},
	{"*finalize", "()V", nullptr, $PROTECTED | $FINAL},
	{"*hashCode", "()I", nullptr, $PUBLIC | $FINAL},
	{"<init>", "(Ljava/lang/String;I)V", "()V", $PRIVATE, $method(static_cast<void(DayOfWeek::*)($String*,int32_t)>(&DayOfWeek::init$))},
	{"adjustInto", "(Ljava/time/temporal/Temporal;)Ljava/time/temporal/Temporal;", nullptr, $PUBLIC},
	{"from", "(Ljava/time/temporal/TemporalAccessor;)Ljava/time/DayOfWeek;", nullptr, $PUBLIC | $STATIC, $method(static_cast<DayOfWeek*(*)($TemporalAccessor*)>(&DayOfWeek::from))},
	{"get", "(Ljava/time/temporal/TemporalField;)I", nullptr, $PUBLIC},
	{"getDisplayName", "(Ljava/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(DayOfWeek::*)($TextStyle*,$Locale*)>(&DayOfWeek::getDisplayName))},
	{"getLong", "(Ljava/time/temporal/TemporalField;)J", nullptr, $PUBLIC},
	{"getValue", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(DayOfWeek::*)()>(&DayOfWeek::getValue))},
	{"isSupported", "(Ljava/time/temporal/TemporalField;)Z", nullptr, $PUBLIC},
	{"minus", "(J)Ljava/time/DayOfWeek;", nullptr, $PUBLIC, $method(static_cast<DayOfWeek*(DayOfWeek::*)(int64_t)>(&DayOfWeek::minus))},
	{"of", "(I)Ljava/time/DayOfWeek;", nullptr, $PUBLIC | $STATIC, $method(static_cast<DayOfWeek*(*)(int32_t)>(&DayOfWeek::of))},
	{"plus", "(J)Ljava/time/DayOfWeek;", nullptr, $PUBLIC, $method(static_cast<DayOfWeek*(DayOfWeek::*)(int64_t)>(&DayOfWeek::plus))},
	...
	{"valueOf", "(Ljava/lang/String;)Ljava/time/DayOfWeek;", nullptr, $PUBLIC | $STATIC, $method(static_cast<DayOfWeek*(*)($String*)>(&DayOfWeek::valueOf))},
	{"values", "()[Ljava/time/DayOfWeek;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$DayOfWeekArray*(*)()>(&DayOfWeek::values))},
	{}
};
