...
class $export ZoneOffset : public ::java::time::ZoneId, public ::java::time::temporal::TemporalAccessor, public ::java::time::temporal::TemporalAdjuster, public ::java::lang::Comparable {
