...
$Class* TemporalAdjusters$$Lambda$lambda$ofDateAdjuster$0::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$ofDateAdjuster$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$ofDateAdjuster$0);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$firstDayOfMonth$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$firstDayOfMonth$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$firstDayOfMonth$1$1);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$lastDayOfMonth$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$lastDayOfMonth$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$lastDayOfMonth$2$2);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$firstDayOfNextMonth$3$3::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$firstDayOfNextMonth$3$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$firstDayOfNextMonth$3$3);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$firstDayOfYear$4$4::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$firstDayOfYear$4$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$firstDayOfYear$4$4);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$lastDayOfYear$5$5::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$lastDayOfYear$5$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$lastDayOfYear$5$5);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$firstDayOfNextYear$6$6::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$firstDayOfNextYear$6$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$firstDayOfNextYear$6$6);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$7$7::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$7$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$7$7);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$8$8::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$8$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$8$8);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$next$9$9::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$next$9$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$next$9$9);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$nextOrSame$10$10::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$nextOrSame$10$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$nextOrSame$10$10);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$previous$11$11::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$previous$11$11, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$previous$11$11);
	});
	return class$;
}
...
$Class* TemporalAdjusters$$Lambda$lambda$previousOrSame$12$12::load$($String* name, bool initialize) {
	...
	$loadClass(TemporalAdjusters$$Lambda$lambda$previousOrSame$12$12, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters$$Lambda$lambda$previousOrSame$12$12);
	});
	return class$;
}
...
$TemporalAdjuster* TemporalAdjusters::ofDateAdjuster($UnaryOperator* dateBasedAdjuster) {
	$Objects::requireNonNull(dateBasedAdjuster, "dateBasedAdjuster"_s);
	return $new(TemporalAdjusters$$Lambda$lambda$ofDateAdjuster$0, dateBasedAdjuster);
}

$TemporalAdjuster* TemporalAdjusters::firstDayOfMonth() {
	return $new(TemporalAdjusters$$Lambda$lambda$firstDayOfMonth$1$1);
}

$TemporalAdjuster* TemporalAdjusters::lastDayOfMonth() {
	return $new(TemporalAdjusters$$Lambda$lambda$lastDayOfMonth$2$2);
}

$TemporalAdjuster* TemporalAdjusters::firstDayOfNextMonth() {
	return $new(TemporalAdjusters$$Lambda$lambda$firstDayOfNextMonth$3$3);
}

$TemporalAdjuster* TemporalAdjusters::firstDayOfYear() {
	return $new(TemporalAdjusters$$Lambda$lambda$firstDayOfYear$4$4);
}

$TemporalAdjuster* TemporalAdjusters::lastDayOfYear() {
	return $new(TemporalAdjusters$$Lambda$lambda$lastDayOfYear$5$5);
}

$TemporalAdjuster* TemporalAdjusters::firstDayOfNextYear() {
	return $new(TemporalAdjusters$$Lambda$lambda$firstDayOfNextYear$6$6);
}
...
$TemporalAdjuster* TemporalAdjusters::dayOfWeekInMonth(int32_t ordinal, $DayOfWeek* dayOfWeek) {
	$Objects::requireNonNull(dayOfWeek, "dayOfWeek"_s);
	int32_t dowValue = $nc(dayOfWeek)->getValue();
	if (ordinal >= 0) {
		return $new(TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$7$7, dowValue, ordinal);
	} else {
		return $new(TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$8$8, dowValue, ordinal);
	}
}

$TemporalAdjuster* TemporalAdjusters::next($DayOfWeek* dayOfWeek) {
	int32_t dowValue = $nc(dayOfWeek)->getValue();
	return $new(TemporalAdjusters$$Lambda$lambda$next$9$9, dowValue);
}

$TemporalAdjuster* TemporalAdjusters::nextOrSame($DayOfWeek* dayOfWeek) {
	int32_t dowValue = $nc(dayOfWeek)->getValue();
	return $new(TemporalAdjusters$$Lambda$lambda$nextOrSame$10$10, dowValue);
}

$TemporalAdjuster* TemporalAdjusters::previous($DayOfWeek* dayOfWeek) {
	int32_t dowValue = $nc(dayOfWeek)->getValue();
	return $new(TemporalAdjusters$$Lambda$lambda$previous$11$11, dowValue);
}

$TemporalAdjuster* TemporalAdjusters::previousOrSame($DayOfWeek* dayOfWeek) {
	int32_t dowValue = $nc(dayOfWeek)->getValue();
	return $new(TemporalAdjusters$$Lambda$lambda$previousOrSame$12$12, dowValue);
}
...
$Temporal* TemporalAdjusters::lambda$dayOfWeekInMonth$8(int32_t dowValue, int32_t ordinal, $Temporal* temporal) {
	$useLocalObjectStack();
	$init($ChronoField);
	$var($Temporal, temp, $nc(temporal)->with($ChronoField::DAY_OF_MONTH, $$nc($nc(temporal)->range($ChronoField::DAY_OF_MONTH))->getMaximum()));
...
$Temporal* TemporalAdjusters::lambda$lastDayOfYear$5($Temporal* temporal) {
	$init($ChronoField);
	return $nc(temporal)->with($ChronoField::DAY_OF_YEAR, $$nc($nc(temporal)->range($ChronoField::DAY_OF_YEAR))->getMaximum());
}
...
$Temporal* TemporalAdjusters::lambda$lastDayOfMonth$2($Temporal* temporal) {
	$init($ChronoField);
	return $nc(temporal)->with($ChronoField::DAY_OF_MONTH, $$nc($nc(temporal)->range($ChronoField::DAY_OF_MONTH))->getMaximum());
}
...
$Class* TemporalAdjusters::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$ofDateAdjuster$0")) {
			return TemporalAdjusters$$Lambda$lambda$ofDateAdjuster$0::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$firstDayOfMonth$1$1")) {
			return TemporalAdjusters$$Lambda$lambda$firstDayOfMonth$1$1::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$lastDayOfMonth$2$2")) {
			return TemporalAdjusters$$Lambda$lambda$lastDayOfMonth$2$2::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$firstDayOfNextMonth$3$3")) {
			return TemporalAdjusters$$Lambda$lambda$firstDayOfNextMonth$3$3::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$firstDayOfYear$4$4")) {
			return TemporalAdjusters$$Lambda$lambda$firstDayOfYear$4$4::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$lastDayOfYear$5$5")) {
			return TemporalAdjusters$$Lambda$lambda$lastDayOfYear$5$5::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$firstDayOfNextYear$6$6")) {
			return TemporalAdjusters$$Lambda$lambda$firstDayOfNextYear$6$6::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$7$7")) {
			return TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$7$7::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$8$8")) {
			return TemporalAdjusters$$Lambda$lambda$dayOfWeekInMonth$8$8::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$next$9$9")) {
			return TemporalAdjusters$$Lambda$lambda$next$9$9::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$nextOrSame$10$10")) {
			return TemporalAdjusters$$Lambda$lambda$nextOrSame$10$10::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$previous$11$11")) {
			return TemporalAdjusters$$Lambda$lambda$previous$11$11::load$(name, initialize);
		}
		if (name->equals("java.time.temporal.TemporalAdjusters$$Lambda$lambda$previousOrSame$12$12")) {
	...
	$loadClass(TemporalAdjusters, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TemporalAdjusters);
	});
	return class$;
}
