...
void ChronoUnit::clinit$($Class* clazz) {
	$useLocalObjectStack();
	...
	$assignStatic(ChronoUnit::MILLIS, $new(ChronoUnit, "MILLIS"_s, 2, "Millis"_s, $($Duration::ofNanos(1000000))));
	...
	$assignStatic(ChronoUnit::FOREVER, $new(ChronoUnit, "FOREVER"_s, 15, "Forever"_s, $($Duration::ofSeconds($Long::MAX_VALUE, 999999999))));
...
$Class* ChronoUnit::load$($String* name, bool initialize) {
	...
	$loadClass(ChronoUnit, name, initialize, &classInfo$$, ChronoUnit::clinit$, []($Class* clazz) -> $Object* {
