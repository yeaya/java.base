...
$MethodInfo _ZoneOffsetTransitionRule_MethodInfo_[] = {
	{"<init>", "(Ljava/time/Month;ILjava/time/DayOfWeek;Ljava/time/LocalTime;ZLjava/time/zone/ZoneOffsetTransitionRule$TimeDefinition;Ljava/time/ZoneOffset;Ljava/time/ZoneOffset;Ljava/time/ZoneOffset;)V", nullptr, 0, $method(static_cast<void(ZoneOffsetTransitionRule::*)($Month*,int32_t,$DayOfWeek*,$LocalTime*,bool,$ZoneOffsetTransitionRule$TimeDefinition*,$ZoneOffset*,$ZoneOffset*,$ZoneOffset*)>(&ZoneOffsetTransitionRule::init$))},
	{"createTransition", "(I)Ljava/time/zone/ZoneOffsetTransition;", nullptr, $PUBLIC, $method(static_cast<$ZoneOffsetTransition*(ZoneOffsetTransitionRule::*)(int32_t)>(&ZoneOffsetTransitionRule::createTransition))},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getDayOfMonthIndicator", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getDayOfMonthIndicator))},
	{"getDayOfWeek", "()Ljava/time/DayOfWeek;", nullptr, $PUBLIC, $method(static_cast<$DayOfWeek*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getDayOfWeek))},
	{"getLocalTime", "()Ljava/time/LocalTime;", nullptr, $PUBLIC, $method(static_cast<$LocalTime*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getLocalTime))},
	{"getMonth", "()Ljava/time/Month;", nullptr, $PUBLIC, $method(static_cast<$Month*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getMonth))},
	{"getOffsetAfter", "()Ljava/time/ZoneOffset;", nullptr, $PUBLIC, $method(static_cast<$ZoneOffset*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getOffsetAfter))},
	{"getOffsetBefore", "()Ljava/time/ZoneOffset;", nullptr, $PUBLIC, $method(static_cast<$ZoneOffset*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getOffsetBefore))},
	{"getStandardOffset", "()Ljava/time/ZoneOffset;", nullptr, $PUBLIC, $method(static_cast<$ZoneOffset*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getStandardOffset))},
	{"getTimeDefinition", "()Ljava/time/zone/ZoneOffsetTransitionRule$TimeDefinition;", nullptr, $PUBLIC, $method(static_cast<$ZoneOffsetTransitionRule$TimeDefinition*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::getTimeDefinition))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"isMidnightEndOfDay", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::isMidnightEndOfDay))},
	{"of", "(Ljava/time/Month;ILjava/time/DayOfWeek;Ljava/time/LocalTime;ZLjava/time/zone/ZoneOffsetTransitionRule$TimeDefinition;Ljava/time/ZoneOffset;Ljava/time/ZoneOffset;Ljava/time/ZoneOffset;)Ljava/time/zone/ZoneOffsetTransitionRule;", nullptr, $PUBLIC | $STATIC, $method(static_cast<ZoneOffsetTransitionRule*(*)($Month*,int32_t,$DayOfWeek*,$LocalTime*,bool,$ZoneOffsetTransitionRule$TimeDefinition*,$ZoneOffset*,$ZoneOffset*,$ZoneOffset*)>(&ZoneOffsetTransitionRule::of))},
	{"readExternal", "(Ljava/io/DataInput;)Ljava/time/zone/ZoneOffsetTransitionRule;", nullptr, $STATIC, $method(static_cast<ZoneOffsetTransitionRule*(*)($DataInput*)>(&ZoneOffsetTransitionRule::readExternal)), "java.io.IOException"},
	{"readObject", "(Ljava/io/ObjectInputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(ZoneOffsetTransitionRule::*)($ObjectInputStream*)>(&ZoneOffsetTransitionRule::readObject)), "java.io.InvalidObjectException"},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"writeExternal", "(Ljava/io/DataOutput;)V", nullptr, 0, $method(static_cast<void(ZoneOffsetTransitionRule::*)($DataOutput*)>(&ZoneOffsetTransitionRule::writeExternal)), "java.io.IOException"},
	{"writeReplace", "()Ljava/lang/Object;", nullptr, $PRIVATE, $method(static_cast<$Object*(ZoneOffsetTransitionRule::*)()>(&ZoneOffsetTransitionRule::writeReplace))},
	{}
};
