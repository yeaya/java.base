...
class $export AbstractLoggerWrapper : public ::java::lang::System$Logger, public ::sun::util::logging::PlatformLogger$Bridge, public ::sun::util::logging::PlatformLogger$ConfigurableBridge {
