...
$Class* AbstractLoggerWrapper$$Lambda$lambda$logp$0::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/util/function/Supplier;)V", nullptr, $PUBLIC, $method(AbstractLoggerWrapper$$Lambda$lambda$logp$0, init$, void, $String*, $String*, $Supplier*)},
		{"get", "()Ljava/lang/Object;", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper$$Lambda$lambda$logp$0, get, $Object*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
	...
	$loadClass(AbstractLoggerWrapper$$Lambda$lambda$logp$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AbstractLoggerWrapper$$Lambda$lambda$logp$0);
	});
	return class$;
}
...
bool AbstractLoggerWrapper::isEnabled() {
	$var($PlatformLogger$Bridge, platformProxy, this->platformProxy());
	return platformProxy == nullptr || platformProxy->isEnabled();
}
	...
	if (platformProxy == nullptr) {
		if (sourceClass == nullptr && sourceMethod == nullptr) {
			...
			if ($nc(wrapped)->isLoggable(systemLevel)) {
				...
				wrapped->log(systemLevel, $$new(AbstractLoggerWrapper$$Lambda$lambda$logp$0, sClass, sMethod, msgSupplier));
			}
		}
	} else {
	...
	if (platformProxy == nullptr) {
		if (sourceClass == nullptr && sourceMethod == nullptr) {
			...
			if ($nc(wrapped)->isLoggable(systemLevel)) {
				$var($String, sClass, sourceClass == nullptr ? ""_s : sourceClass);
				$var($String, sMethod, sourceMethod == nullptr ? ""_s : sourceMethod);
				wrapped->log(systemLevel, $$new(AbstractLoggerWrapper$$Lambda$lambda$logp$0, sClass, sMethod, msgSupplier), thrown);
			}
		}
	} else {
...
$Class* AbstractLoggerWrapper::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("jdk.internal.logger.AbstractLoggerWrapper$$Lambda$lambda$logp$0")) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "()V", nullptr, 0, $method(AbstractLoggerWrapper, init$, void)},
		{"getLoggerConfiguration", "()Lsun/util/logging/PlatformLogger$ConfigurableBridge$LoggerConfiguration;", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, getLoggerConfiguration, $PlatformLogger$ConfigurableBridge$LoggerConfiguration*)},
		{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $virtualMethod(AbstractLoggerWrapper, getName, $String*)},
		{"getWrapped", "()Ljava/lang/System$Logger;", "()TL;", 0, $virtualMethod(AbstractLoggerWrapper, getWrapped, $System$Logger*)},
		{"isEnabled", "()Z", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, isEnabled, bool)},
		{"isLoggable", "(Ljava/lang/System$Logger$Level;)Z", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, isLoggable, bool, $System$Logger$Level*)},
		{"isLoggable", "(Lsun/util/logging/PlatformLogger$Level;)Z", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, isLoggable, bool, $PlatformLogger$Level*)},
		{"lambda$logp$0", "(Ljava/lang/String;Ljava/lang/String;Ljava/util/function/Supplier;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(AbstractLoggerWrapper, lambda$logp$0, $String*, $String*, $String*, $Supplier*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/lang/String;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $String*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/util/function/Supplier;)V", "(Ljava/lang/System$Logger$Level;Ljava/util/function/Supplier<Ljava/lang/String;>;)V", $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $Supplier*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/lang/Object;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, Object$*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $String*, $Throwable*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/util/function/Supplier;Ljava/lang/Throwable;)V", "(Ljava/lang/System$Logger$Level;Ljava/util/function/Supplier<Ljava/lang/String;>;Ljava/lang/Throwable;)V", $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $Supplier*, $Throwable*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $TRANSIENT, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $String*, $ObjectArray*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/util/ResourceBundle;Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $ResourceBundle*, $String*, $Throwable*)},
		{"log", "(Ljava/lang/System$Logger$Level;Ljava/util/ResourceBundle;Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $TRANSIENT, $virtualMethod(AbstractLoggerWrapper, log, void, $System$Logger$Level*, $ResourceBundle*, $String*, $ObjectArray*)},
		{"log", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $PlatformLogger$Level*, $String*)},
		{"log", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $PlatformLogger$Level*, $String*, $Throwable*)},
		{"log", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $TRANSIENT, $virtualMethod(AbstractLoggerWrapper, log, void, $PlatformLogger$Level*, $String*, $ObjectArray*)},
		{"log", "(Lsun/util/logging/PlatformLogger$Level;Ljava/util/function/Supplier;)V", "(Lsun/util/logging/PlatformLogger$Level;Ljava/util/function/Supplier<Ljava/lang/String;>;)V", $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $PlatformLogger$Level*, $Supplier*)},
		{"log", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/Throwable;Ljava/util/function/Supplier;)V", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/Throwable;Ljava/util/function/Supplier<Ljava/lang/String;>;)V", $PUBLIC, $virtualMethod(AbstractLoggerWrapper, log, void, $PlatformLogger$Level*, $Throwable*, $Supplier*)},
		{"logp", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, logp, void, $PlatformLogger$Level*, $String*, $String*, $String*)},
		{"logp", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/util/function/Supplier;)V", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/util/function/Supplier<Ljava/lang/String;>;)V", $PUBLIC, $virtualMethod(AbstractLoggerWrapper, logp, void, $PlatformLogger$Level*, $String*, $String*, $Supplier*)},
		{"logp", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $TRANSIENT, $virtualMethod(AbstractLoggerWrapper, logp, void, $PlatformLogger$Level*, $String*, $String*, $String*, $ObjectArray*)},
		{"logp", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, logp, void, $PlatformLogger$Level*, $String*, $String*, $String*, $Throwable*)},
		{"logp", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;Ljava/util/function/Supplier;)V", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;Ljava/util/function/Supplier<Ljava/lang/String;>;)V", $PUBLIC, $virtualMethod(AbstractLoggerWrapper, logp, void, $PlatformLogger$Level*, $String*, $String*, $Throwable*, $Supplier*)},
		{"logrb", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/util/ResourceBundle;Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $TRANSIENT, $virtualMethod(AbstractLoggerWrapper, logrb, void, $PlatformLogger$Level*, $String*, $String*, $ResourceBundle*, $String*, $ObjectArray*)},
		{"logrb", "(Lsun/util/logging/PlatformLogger$Level;Ljava/lang/String;Ljava/lang/String;Ljava/util/ResourceBundle;Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, logrb, void, $PlatformLogger$Level*, $String*, $String*, $ResourceBundle*, $String*, $Throwable*)},
		{"logrb", "(Lsun/util/logging/PlatformLogger$Level;Ljava/util/ResourceBundle;Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $virtualMethod(AbstractLoggerWrapper, logrb, void, $PlatformLogger$Level*, $ResourceBundle*, $String*, $Throwable*)},
		{"logrb", "(Lsun/util/logging/PlatformLogger$Level;Ljava/util/ResourceBundle;Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $TRANSIENT, $virtualMethod(AbstractLoggerWrapper, logrb, void, $PlatformLogger$Level*, $ResourceBundle*, $String*, $ObjectArray*)},
		{"platformProxy", "()Lsun/util/logging/PlatformLogger$Bridge;", nullptr, $ABSTRACT, $virtualMethod(AbstractLoggerWrapper, platformProxy, $PlatformLogger$Bridge*)},
		{"*toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
		{"wrapped", "()Ljava/lang/System$Logger;", "()TL;", $ABSTRACT, $virtualMethod(AbstractLoggerWrapper, wrapped, $System$Logger*)},
		{}
	};
	...
	$loadClass(AbstractLoggerWrapper, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
