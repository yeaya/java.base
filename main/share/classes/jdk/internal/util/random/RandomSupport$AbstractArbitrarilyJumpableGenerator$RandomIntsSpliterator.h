...
class $export RandomSupport$AbstractArbitrarilyJumpableGenerator$RandomIntsSpliterator : public ::jdk::internal::util::random::RandomSupport$RandomSpliterator, public ::java::util::Spliterator$OfInt {
