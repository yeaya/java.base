...
class $export RandomSupport$AbstractArbitrarilyJumpableGenerator$RandomLeapsSpliterator : public ::jdk::internal::util::random::RandomSupport$RandomSpliterator, public ::java::util::Spliterator {
