...
class $export RandomSupport$AbstractSplittableGenerator : public ::jdk::internal::util::random::RandomSupport$AbstractSpliteratorGenerator, public ::java::util::random::RandomGenerator$SplittableGenerator {
