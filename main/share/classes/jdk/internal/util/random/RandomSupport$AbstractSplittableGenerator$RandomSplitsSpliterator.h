...
class $export RandomSupport$AbstractSplittableGenerator$RandomSplitsSpliterator : public ::jdk::internal::util::random::RandomSupport$RandomSpliterator, public ::java::util::Spliterator {
