...
class $export RandomSupport$AbstractSplittableGenerator$RandomDoublesSpliterator : public ::jdk::internal::util::random::RandomSupport$RandomSpliterator, public ::java::util::Spliterator$OfDouble {
