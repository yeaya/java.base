...
$Object* URLClassPath$JarLoader$3::run() {
	return $new($URLClassPath$JarLoader, this->val$url, this->this$0->handler, this->this$0->lmap, this->this$0->acc);
}
...
$Class* URLClassPath$JarLoader$3::load$($String* name, bool initialize) {
	...
	$loadClass(URLClassPath$JarLoader$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(URLClassPath$JarLoader$3);
	});
	return class$;
}
