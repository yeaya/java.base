...
$MethodInfo _URLClassPath$JarLoader_MethodInfo_[] = {
	{"<init>", "(Ljava/net/URL;Ljava/net/URLStreamHandler;Ljava/util/HashMap;Ljava/security/AccessControlContext;)V", "(Ljava/net/URL;Ljava/net/URLStreamHandler;Ljava/util/HashMap<Ljava/lang/String;Ljdk/internal/loader/URLClassPath$Loader;>;Ljava/security/AccessControlContext;)V", $PRIVATE, $method(static_cast<void(URLClassPath$JarLoader::*)($URL*,$URLStreamHandler*,$HashMap*,$AccessControlContext*)>(&URLClassPath$JarLoader::init$)), "java.io.IOException"},
	{"checkJar", "(Ljava/util/jar/JarFile;)Ljava/util/jar/JarFile;", nullptr, $STATIC, $method(static_cast<$JarFile*(*)($JarFile*)>(&URLClassPath$JarLoader::checkJar)), "java.io.IOException"},
	{"checkResource", "(Ljava/lang/String;ZLjava/util/jar/JarEntry;)Ljdk/internal/loader/Resource;", nullptr, 0},
	{"close", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"ensureOpen", "()V", nullptr, $PRIVATE, $method(static_cast<void(URLClassPath$JarLoader::*)()>(&URLClassPath$JarLoader::ensureOpen)), "java.io.IOException"},
	{"findResource", "(Ljava/lang/String;Z)Ljava/net/URL;", nullptr, 0},
	{"getClassPath", "()[Ljava/net/URL;", nullptr, 0, nullptr, "java.io.IOException"},
	{"getIndex", "()Ljdk/internal/util/jar/JarIndex;", nullptr, 0},
	{"getJarFile", "()Ljava/util/jar/JarFile;", nullptr, 0},
	{"getJarFile", "(Ljava/net/URL;)Ljava/util/jar/JarFile;", nullptr, $PRIVATE, $method(static_cast<$JarFile*(URLClassPath$JarLoader::*)($URL*)>(&URLClassPath$JarLoader::getJarFile)), "java.io.IOException"},
	{"getResource", "(Ljava/lang/String;Z)Ljdk/internal/loader/Resource;", nullptr, 0},
	{"getResource", "(Ljava/lang/String;ZLjava/util/Set;)Ljdk/internal/loader/Resource;", "(Ljava/lang/String;ZLjava/util/Set<Ljava/lang/String;>;)Ljdk/internal/loader/Resource;", 0},
	{"isOptimizable", "(Ljava/net/URL;)Z", nullptr, $PRIVATE, $method(static_cast<bool(URLClassPath$JarLoader::*)($URL*)>(&URLClassPath$JarLoader::isOptimizable))},
	{"isRelative", "(Ljava/lang/String;)Z", nullptr, $STATIC, $method(static_cast<bool(*)($String*)>(&URLClassPath$JarLoader::isRelative))},
	{"parseClassPath", "(Ljava/net/URL;Ljava/lang/String;)[Ljava/net/URL;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$URLArray*(*)($URL*,$String*)>(&URLClassPath$JarLoader::parseClassPath)), "java.net.MalformedURLException"},
	{"tryResolve", "(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;", nullptr, $STATIC, $method(static_cast<$URL*(*)($URL*,$String*)>(&URLClassPath$JarLoader::tryResolve)), "java.net.MalformedURLException"},
	{"tryResolveFile", "(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;", nullptr, $STATIC, $method(static_cast<$URL*(*)($URL*,$String*)>(&URLClassPath$JarLoader::tryResolveFile)), "java.net.MalformedURLException"},
	{"tryResolveNonFile", "(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;", nullptr, $STATIC, $method(static_cast<$URL*(*)($URL*,$String*)>(&URLClassPath$JarLoader::tryResolveNonFile)), "java.net.MalformedURLException"},
	{"validIndex", "(Ljava/lang/String;)Z", nullptr, 0},
	{}
};
