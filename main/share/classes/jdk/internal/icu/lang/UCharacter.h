...
public:
	...
	static const int32_t MIN_VALUE = ::jdk::internal::icu::text::UTF16::CODEPOINT_MIN_VALUE;
	static const int32_t MAX_VALUE = ::jdk::internal::icu::text::UTF16::CODEPOINT_MAX_VALUE;
