...
void CodePointTrie$Fast16::clinit$($Class* clazz) {
	$load($CodePointTrie);
...
$Class* CodePointTrie$Fast16::load$($String* name, bool initialize) {
	...
	$loadClass(CodePointTrie$Fast16, name, initialize, &classInfo$$, CodePointTrie$Fast16::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CodePointTrie$Fast16);
	});
	return class$;
}
