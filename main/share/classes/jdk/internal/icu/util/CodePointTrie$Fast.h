#ifndef _jdk_internal_icu_util_CodePointTrie$Fast_h_
#define _jdk_internal_icu_util_CodePointTrie$Fast_h_
//$ class jdk.internal.icu.util.CodePointTrie$Fast
...
class CodePointTrie$Fast : public ::jdk::internal::icu::util::CodePointTrie {
	$class(CodePointTrie$Fast, $NO_CLASS_INIT, ::jdk::internal::icu::util::CodePointTrie)
public:
	CodePointTrie$Fast();
	...
	virtual int32_t bmpGet(int32_t c) {return 0;}
	virtual int32_t cpIndex(int32_t c) override;
	static ::jdk::internal::icu::util::CodePointTrie$Fast* fromBinary(::jdk::internal::icu::util::CodePointTrie$ValueWidth* valueWidth, ::java::nio::ByteBuffer* bytes);
	...
	virtual int32_t suppGet(int32_t c) {return 0;}
};
...
#endif // _jdk_internal_icu_util_CodePointTrie$Fast_h_