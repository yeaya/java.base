...
void CodePointTrie$ValueWidth::clinit$($Class* clazz) {
...
$Class* CodePointTrie$ValueWidth::load$($String* name, bool initialize) {
	...
	$loadClass(CodePointTrie$ValueWidth, name, initialize, &classInfo$$, CodePointTrie$ValueWidth::clinit$, []($Class* clazz) -> $Object* {
