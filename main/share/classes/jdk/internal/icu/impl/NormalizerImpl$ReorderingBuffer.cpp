...
$MethodInfo _NormalizerImpl$ReorderingBuffer_MethodInfo_[] = {
	{"<init>", "(Ljdk/internal/icu/impl/NormalizerImpl;Ljava/lang/Appendable;I)V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)($NormalizerImpl*,$Appendable*,int32_t)>(&NormalizerImpl$ReorderingBuffer::init$))},
	{"append", "(II)V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)(int32_t,int32_t)>(&NormalizerImpl$ReorderingBuffer::append))},
	{"append", "(Ljava/lang/CharSequence;IIZII)V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)($CharSequence*,int32_t,int32_t,bool,int32_t,int32_t)>(&NormalizerImpl$ReorderingBuffer::append))},
	{"append", "(C)Ljdk/internal/icu/impl/NormalizerImpl$ReorderingBuffer;", nullptr, $PUBLIC},
	{"append", "(Ljava/lang/CharSequence;)Ljdk/internal/icu/impl/NormalizerImpl$ReorderingBuffer;", nullptr, $PUBLIC},
	{"append", "(Ljava/lang/CharSequence;II)Ljdk/internal/icu/impl/NormalizerImpl$ReorderingBuffer;", nullptr, $PUBLIC},
	{"appendZeroCC", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)(int32_t)>(&NormalizerImpl$ReorderingBuffer::appendZeroCC))},
	{"equals", "(Ljava/lang/CharSequence;II)Z", nullptr, $PUBLIC, $method(static_cast<bool(NormalizerImpl$ReorderingBuffer::*)($CharSequence*,int32_t,int32_t)>(&NormalizerImpl$ReorderingBuffer::equals))},
	{"flush", "()V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::flush))},
	{"flushAndAppendZeroCC", "(Ljava/lang/CharSequence;II)Ljdk/internal/icu/impl/NormalizerImpl$ReorderingBuffer;", nullptr, $PUBLIC, $method(static_cast<NormalizerImpl$ReorderingBuffer*(NormalizerImpl$ReorderingBuffer::*)($CharSequence*,int32_t,int32_t)>(&NormalizerImpl$ReorderingBuffer::flushAndAppendZeroCC))},
	{"getLastCC", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::getLastCC))},
	{"getStringBuilder", "()Ljava/lang/StringBuilder;", nullptr, $PUBLIC, $method(static_cast<$StringBuilder*(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::getStringBuilder))},
	{"insert", "(II)V", nullptr, $PRIVATE, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)(int32_t,int32_t)>(&NormalizerImpl$ReorderingBuffer::insert))},
	{"isEmpty", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::isEmpty))},
	{"length", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::length))},
	{"previousCC", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::previousCC))},
	{"remove", "()V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::remove))},
	{"removeSuffix", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)(int32_t)>(&NormalizerImpl$ReorderingBuffer::removeSuffix))},
	{"setIterator", "()V", nullptr, $PRIVATE, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::setIterator))},
	{"skipPrevious", "()V", nullptr, $PRIVATE, $method(static_cast<void(NormalizerImpl$ReorderingBuffer::*)()>(&NormalizerImpl$ReorderingBuffer::skipPrevious))},
	{}
};
