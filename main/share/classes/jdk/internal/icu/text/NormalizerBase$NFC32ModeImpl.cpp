...
void NormalizerBase$NFC32ModeImpl::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* NormalizerBase$NFC32ModeImpl::load$($String* name, bool initialize) {
	...
	$loadClass(NormalizerBase$NFC32ModeImpl, name, initialize, &classInfo$$, NormalizerBase$NFC32ModeImpl::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(NormalizerBase$NFC32ModeImpl);
	});
	return class$;
}
