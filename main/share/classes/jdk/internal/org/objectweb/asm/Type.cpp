...
$MethodInfo _Type_MethodInfo_[] = {
	{"<init>", "(ILjava/lang/String;II)V", nullptr, $PRIVATE, $method(static_cast<void(Type::*)(int32_t,$String*,int32_t,int32_t)>(&Type::init$))},
	{"appendDescriptor", "(Ljava/lang/StringBuilder;)V", nullptr, $PRIVATE, $method(static_cast<void(Type::*)($StringBuilder*)>(&Type::appendDescriptor))},
	{"appendDescriptor", "(Ljava/lang/Class;Ljava/lang/StringBuilder;)V", "(Ljava/lang/Class<*>;Ljava/lang/StringBuilder;)V", $PRIVATE | $STATIC, $method(static_cast<void(*)($Class*,$StringBuilder*)>(&Type::appendDescriptor))},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getArgumentTypes", "()[Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC, $method(static_cast<$TypeArray*(Type::*)()>(&Type::getArgumentTypes))},
	{"getArgumentTypes", "(Ljava/lang/String;)[Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$TypeArray*(*)($String*)>(&Type::getArgumentTypes))},
	{"getArgumentTypes", "(Ljava/lang/reflect/Method;)[Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$TypeArray*(*)($Method*)>(&Type::getArgumentTypes))},
	{"getArgumentsAndReturnSizes", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Type::*)()>(&Type::getArgumentsAndReturnSizes))},
	{"getArgumentsAndReturnSizes", "(Ljava/lang/String;)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($String*)>(&Type::getArgumentsAndReturnSizes))},
	{"getClassName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Type::*)()>(&Type::getClassName))},
	{"getConstructorDescriptor", "(Ljava/lang/reflect/Constructor;)Ljava/lang/String;", "(Ljava/lang/reflect/Constructor<*>;)Ljava/lang/String;", $PUBLIC | $STATIC, $method(static_cast<$String*(*)($Constructor*)>(&Type::getConstructorDescriptor))},
	{"getDescriptor", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Type::*)()>(&Type::getDescriptor))},
	{"getDescriptor", "(Ljava/lang/Class;)Ljava/lang/String;", "(Ljava/lang/Class<*>;)Ljava/lang/String;", $PUBLIC | $STATIC, $method(static_cast<$String*(*)($Class*)>(&Type::getDescriptor))},
	{"getDimensions", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Type::*)()>(&Type::getDimensions))},
	{"getElementType", "()Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC, $method(static_cast<Type*(Type::*)()>(&Type::getElementType))},
	{"getInternalName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Type::*)()>(&Type::getInternalName))},
	{"getInternalName", "(Ljava/lang/Class;)Ljava/lang/String;", "(Ljava/lang/Class<*>;)Ljava/lang/String;", $PUBLIC | $STATIC, $method(static_cast<$String*(*)($Class*)>(&Type::getInternalName))},
	{"getMethodDescriptor", "(Ljdk/internal/org/objectweb/asm/Type;[Ljdk/internal/org/objectweb/asm/Type;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC | $TRANSIENT, $method(static_cast<$String*(*)(Type*,$TypeArray*)>(&Type::getMethodDescriptor))},
	{"getMethodDescriptor", "(Ljava/lang/reflect/Method;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($Method*)>(&Type::getMethodDescriptor))},
	{"getMethodType", "(Ljava/lang/String;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::getMethodType))},
	{"getMethodType", "(Ljdk/internal/org/objectweb/asm/Type;[Ljdk/internal/org/objectweb/asm/Type;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC | $TRANSIENT, $method(static_cast<Type*(*)(Type*,$TypeArray*)>(&Type::getMethodType))},
	{"getObjectType", "(Ljava/lang/String;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::getObjectType))},
	{"getOpcode", "(I)I", nullptr, $PUBLIC, $method(static_cast<int32_t(Type::*)(int32_t)>(&Type::getOpcode))},
	{"getReturnType", "()Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC, $method(static_cast<Type*(Type::*)()>(&Type::getReturnType))},
	{"getReturnType", "(Ljava/lang/String;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::getReturnType))},
	{"getReturnType", "(Ljava/lang/reflect/Method;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($Method*)>(&Type::getReturnType))},
	{"getReturnTypeOffset", "(Ljava/lang/String;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($String*)>(&Type::getReturnTypeOffset))},
	{"getSize", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Type::*)()>(&Type::getSize))},
	{"getSort", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Type::*)()>(&Type::getSort))},
	{"getType", "(Ljava/lang/String;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::getType))},
	{"getType", "(Ljava/lang/Class;)Ljdk/internal/org/objectweb/asm/Type;", "(Ljava/lang/Class<*>;)Ljdk/internal/org/objectweb/asm/Type;", $PUBLIC | $STATIC, $method(static_cast<Type*(*)($Class*)>(&Type::getType))},
	{"getType", "(Ljava/lang/reflect/Constructor;)Ljdk/internal/org/objectweb/asm/Type;", "(Ljava/lang/reflect/Constructor<*>;)Ljdk/internal/org/objectweb/asm/Type;", $PUBLIC | $STATIC, $method(static_cast<Type*(*)($Constructor*)>(&Type::getType))},
	{"getType", "(Ljava/lang/reflect/Method;)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($Method*)>(&Type::getType))},
	{"getTypeInternal", "(Ljava/lang/String;II)Ljdk/internal/org/objectweb/asm/Type;", nullptr, $PRIVATE | $STATIC, $method(static_cast<Type*(*)($String*,int32_t,int32_t)>(&Type::getTypeInternal))},
