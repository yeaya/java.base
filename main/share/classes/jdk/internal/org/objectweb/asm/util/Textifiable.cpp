...
$MethodInfo _Textifiable_MethodInfo_[] = {
	{"textify", "(Ljava/lang/StringBuffer;Ljava/util/Map;)V", "(Ljava/lang/StringBuffer;Ljava/util/Map<Ljdk/internal/org/objectweb/asm/Label;Ljava/lang/String;>;)V", $PUBLIC | $ABSTRACT},
	{}
};
