...
$MethodInfo _CheckSignatureAdapter_MethodInfo_[] = {
	{"<init>", "(ILjdk/internal/org/objectweb/asm/signature/SignatureVisitor;)V", nullptr, $PUBLIC, $method(static_cast<void(CheckSignatureAdapter::*)(int32_t,$SignatureVisitor*)>(&CheckSignatureAdapter::init$))},
	{"<init>", "(IILjdk/internal/org/objectweb/asm/signature/SignatureVisitor;)V", nullptr, $PROTECTED, $method(static_cast<void(CheckSignatureAdapter::*)(int32_t,int32_t,$SignatureVisitor*)>(&CheckSignatureAdapter::init$))},
	{"checkClassName", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(CheckSignatureAdapter::*)($String*,$String*)>(&CheckSignatureAdapter::checkClassName))},
	{"checkIdentifier", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(CheckSignatureAdapter::*)($String*,$String*)>(&CheckSignatureAdapter::checkIdentifier))},
