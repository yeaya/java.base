...
$MethodInfo _CodeSizeEvaluator_MethodInfo_[] = {
	...
	{"<init>", "(Ljdk/internal/org/objectweb/asm/MethodVisitor;)V", nullptr, $PUBLIC, $method(static_cast<void(CodeSizeEvaluator::*)($MethodVisitor*)>(&CodeSizeEvaluator::init$))},
	{"<init>", "(ILjdk/internal/org/objectweb/asm/MethodVisitor;)V", nullptr, $PROTECTED, $method(static_cast<void(CodeSizeEvaluator::*)(int32_t,$MethodVisitor*)>(&CodeSizeEvaluator::init$))},
	{"getMaxSize", "()I", nullptr, $PUBLIC},
	{"getMinSize", "()I", nullptr, $PUBLIC},
