#ifndef _jdk_internal_org_objectweb_asm$_commons_SignatureRemapper_h_
#define _jdk_internal_org_objectweb_asm$_commons_SignatureRemapper_h_
//$ class jdk.internal.org.objectweb.asm.commons.SignatureRemapper
...
class $export SignatureRemapper : public ::jdk::internal::org::objectweb::asm$::signature::SignatureVisitor {
	$class(SignatureRemapper, $NO_CLASS_INIT, ::jdk::internal::org::objectweb::asm$::signature::SignatureVisitor)
public:
	SignatureRemapper();
	...
	::java::util::ArrayList* classNames = nullptr;
};
...
#endif // _jdk_internal_org_objectweb_asm$_commons_SignatureRemapper_h_