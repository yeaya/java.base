...
void Opcodes::clinit$($Class* clazz) {
...
$Class* Opcodes::load$($String* name, bool initialize) {
	$CompoundAttribute ASM9_EXPERIMENTALfieldAnnotations$$[] = {
	...
	$FieldInfo fieldInfos$$[] = {
		...
		{"ASM9_EXPERIMENTAL", "I", nullptr, $PUBLIC | $STATIC | $FINAL | $DEPRECATED, $constField(Opcodes, ASM9_EXPERIMENTAL), ASM9_EXPERIMENTALfieldAnnotations$$},
	...
	$loadClass(Opcodes, name, initialize, &classInfo$$, Opcodes::clinit$, []($Class* clazz) -> $Object* {
