...
void ClassVisitor::visitPermittedSubclassExperimental($String* permittedSubclass) {
	...
	if (this->cv != nullptr) {
		this->cv->visitPermittedSubclassExperimental(permittedSubclass);
	}
}
...
$Class* ClassVisitor::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"visitPermittedSubclassExperimental", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(ClassVisitor, visitPermittedSubclassExperimental, void, $String*), nullptr, nullptr, visitPermittedSubclassExperimentalmethodAnnotations$$},
	...
	$loadClass(ClassVisitor, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ClassVisitor);
	});
	return class$;
}
