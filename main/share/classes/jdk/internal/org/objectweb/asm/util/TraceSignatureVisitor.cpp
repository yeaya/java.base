...
$MethodInfo _TraceSignatureVisitor_MethodInfo_[] = {
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(TraceSignatureVisitor::*)(int32_t)>(&TraceSignatureVisitor::init$))},
	{"<init>", "(Ljava/lang/StringBuilder;)V", nullptr, $PRIVATE, $method(static_cast<void(TraceSignatureVisitor::*)($StringBuilder*)>(&TraceSignatureVisitor::init$))},
	{"endFormals", "()V", nullptr, $PRIVATE, $method(static_cast<void(TraceSignatureVisitor::*)()>(&TraceSignatureVisitor::endFormals))},
	{"endType", "()V", nullptr, $PRIVATE, $method(static_cast<void(TraceSignatureVisitor::*)()>(&TraceSignatureVisitor::endType))},
	{"getDeclaration", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(TraceSignatureVisitor::*)()>(&TraceSignatureVisitor::getDeclaration))},
	{"getExceptions", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(TraceSignatureVisitor::*)()>(&TraceSignatureVisitor::getExceptions))},
	{"getReturnType", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(TraceSignatureVisitor::*)()>(&TraceSignatureVisitor::getReturnType))},
	{"startType", "()V", nullptr, $PRIVATE, $method(static_cast<void(TraceSignatureVisitor::*)()>(&TraceSignatureVisitor::startType))},
