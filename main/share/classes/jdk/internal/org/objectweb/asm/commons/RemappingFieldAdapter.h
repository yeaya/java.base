#ifndef _jdk_internal_org_objectweb_asm$_commons_RemappingFieldAdapter_h_
#define _jdk_internal_org_objectweb_asm$_commons_RemappingFieldAdapter_h_
//$ class jdk.internal.org.objectweb.asm.commons.RemappingFieldAdapter
...
class $export RemappingFieldAdapter : public ::jdk::internal::org::objectweb::asm$::FieldVisitor {
	$class(RemappingFieldAdapter, $NO_CLASS_INIT, ::jdk::internal::org::objectweb::asm$::FieldVisitor)
public:
...
#endif // _jdk_internal_org_objectweb_asm$_commons_RemappingFieldAdapter_h_