...
$Class* SignatureWriter::load$($String* name, bool initialize) {
	...
	$loadClass(SignatureWriter, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SignatureWriter);
	});
	return class$;
}
