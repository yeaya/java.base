...
$MethodInfo _RemappingMethodAdapter_MethodInfo_[] = {
	{"<init>", "(ILjava/lang/String;Ljdk/internal/org/objectweb/asm/MethodVisitor;Ljdk/internal/org/objectweb/asm/commons/Remapper;)V", nullptr, $PUBLIC, $method(static_cast<void(RemappingMethodAdapter::*)(int32_t,$String*,$MethodVisitor*,$Remapper*)>(&RemappingMethodAdapter::init$))},
	{"<init>", "(IILjava/lang/String;Ljdk/internal/org/objectweb/asm/MethodVisitor;Ljdk/internal/org/objectweb/asm/commons/Remapper;)V", nullptr, $PROTECTED, $method(static_cast<void(RemappingMethodAdapter::*)(int32_t,int32_t,$String*,$MethodVisitor*,$Remapper*)>(&RemappingMethodAdapter::init$))},
	{"doVisitMethodInsn", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V", nullptr, $PRIVATE, $method(static_cast<void(RemappingMethodAdapter::*)(int32_t,$String*,$String*,$String*,bool)>(&RemappingMethodAdapter::doVisitMethodInsn))},
	{"remapEntries", "(I[Ljava/lang/Object;)[Ljava/lang/Object;", nullptr, $PRIVATE, $method(static_cast<$ObjectArray*(RemappingMethodAdapter::*)(int32_t,$ObjectArray*)>(&RemappingMethodAdapter::remapEntries))},
	...
	{"visitMethodInsn", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _RemappingMethodAdapter_MethodAnnotations_visitMethodInsn13},
