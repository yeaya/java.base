#ifndef _jdk_internal_reflect_UnsafeShortFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeShortFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeShortFieldAccessorImpl
...
class UnsafeShortFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeShortFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeShortFieldAccessorImpl_h_