#ifndef _jdk_internal_reflect_UnsafeQualifiedObjectFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedObjectFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedObjectFieldAccessorImpl
...
class UnsafeQualifiedObjectFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedObjectFieldAccessorImpl, $PRELOAD | $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedObjectFieldAccessorImpl_h_