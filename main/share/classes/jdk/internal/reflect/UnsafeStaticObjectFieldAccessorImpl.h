#ifndef _jdk_internal_reflect_UnsafeStaticObjectFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticObjectFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticObjectFieldAccessorImpl
...
class UnsafeStaticObjectFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticObjectFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticObjectFieldAccessorImpl_h_