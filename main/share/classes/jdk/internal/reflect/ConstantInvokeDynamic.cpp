...
void ConstantInvokeDynamic::init$(int32_t index, int32_t bootstrapMethodAttrIndex, int32_t nameAndTypeIndex) {
	ConstantBase::init$(Tag_InvokeDynamic, index);
	this->bootstrapMethodAttrIndex = bootstrapMethodAttrIndex;
	this->nameAndTypeIndex = nameAndTypeIndex;
}

void ConstantInvokeDynamic::init(ConstantPool* cp) {
