#ifndef _jdk_internal_reflect_UnsafeIntegerFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeIntegerFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeIntegerFieldAccessorImpl
...
class UnsafeIntegerFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeIntegerFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeIntegerFieldAccessorImpl_h_