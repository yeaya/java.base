#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticByteFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticByteFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticByteFieldAccessorImpl
...
class UnsafeQualifiedStaticByteFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticByteFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticByteFieldAccessorImpl_h_