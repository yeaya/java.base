#ifndef _jdk_internal_reflect_UnsafeStaticShortFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticShortFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticShortFieldAccessorImpl
...
class UnsafeStaticShortFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticShortFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticShortFieldAccessorImpl_h_