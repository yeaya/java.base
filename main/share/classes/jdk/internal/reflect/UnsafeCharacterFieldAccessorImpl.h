#ifndef _jdk_internal_reflect_UnsafeCharacterFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeCharacterFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeCharacterFieldAccessorImpl
...
class UnsafeCharacterFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeCharacterFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeCharacterFieldAccessorImpl_h_