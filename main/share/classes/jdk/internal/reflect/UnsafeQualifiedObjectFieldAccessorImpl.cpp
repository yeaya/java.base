...
$Object* UnsafeQualifiedObjectFieldAccessorImpl::get(Object$* obj) {
	...
	return $nc($UnsafeFieldAccessorImpl::unsafe)->getReferenceVolatile(obj, this->fieldOffset);
}
...
$Class* UnsafeQualifiedObjectFieldAccessorImpl::load$($String* name, bool initialize) {
	...
	$loadClass(UnsafeQualifiedObjectFieldAccessorImpl, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
