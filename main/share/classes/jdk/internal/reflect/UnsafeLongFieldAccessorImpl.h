#ifndef _jdk_internal_reflect_UnsafeLongFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeLongFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeLongFieldAccessorImpl
...
class UnsafeLongFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeLongFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeLongFieldAccessorImpl_h_