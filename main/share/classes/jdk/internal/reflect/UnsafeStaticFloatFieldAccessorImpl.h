#ifndef _jdk_internal_reflect_UnsafeStaticFloatFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticFloatFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticFloatFieldAccessorImpl
...
class UnsafeStaticFloatFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticFloatFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticFloatFieldAccessorImpl_h_