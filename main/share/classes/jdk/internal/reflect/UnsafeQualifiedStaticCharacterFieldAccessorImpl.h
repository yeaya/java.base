#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticCharacterFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticCharacterFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticCharacterFieldAccessorImpl
//$ extends jdk.internal.reflect.UnsafeQualifiedStaticFieldAccessorImpl
...
class UnsafeQualifiedStaticCharacterFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticCharacterFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticCharacterFieldAccessorImpl_h_