...
void ConstantDynamic::init$(int32_t index, int32_t bootstrapMethodAttrIndex, int32_t nameAndTypeIndex) {
	ConstantBase::init$(Tag_Dynamic, index);
	this->bootstrapMethodAttrIndex = bootstrapMethodAttrIndex;
	this->nameAndTypeIndex = nameAndTypeIndex;
}

void ConstantDynamic::init(ConstantPool* cp) {
