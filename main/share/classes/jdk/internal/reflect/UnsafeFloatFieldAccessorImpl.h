#ifndef _jdk_internal_reflect_UnsafeFloatFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeFloatFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeFloatFieldAccessorImpl
...
class UnsafeFloatFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeFloatFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeFloatFieldAccessorImpl_h_