#ifndef _jdk_internal_reflect_UnsafeQualifiedLongFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedLongFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedLongFieldAccessorImpl
...
class UnsafeQualifiedLongFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedLongFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedLongFieldAccessorImpl_h_