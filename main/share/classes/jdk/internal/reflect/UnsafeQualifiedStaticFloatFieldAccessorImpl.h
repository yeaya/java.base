#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticFloatFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticFloatFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticFloatFieldAccessorImpl
...
class UnsafeQualifiedStaticFloatFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticFloatFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticFloatFieldAccessorImpl_h_