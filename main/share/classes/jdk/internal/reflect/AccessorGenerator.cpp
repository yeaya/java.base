...
$MethodInfo _AccessorGenerator_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(AccessorGenerator::*)()>(&AccessorGenerator::init$))},
	{"add", "(SS)S", nullptr, $PROTECTED | $STATIC, $method(static_cast<int16_t(*)(int16_t,int16_t)>(&AccessorGenerator::add))},
	{"boxingMethodForPrimitiveType", "(Ljava/lang/Class;)S", "(Ljava/lang/Class<*>;)S", $PROTECTED},
	{"canWidenTo", "(Ljava/lang/Class;Ljava/lang/Class;)Z", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;)Z", $PROTECTED | $STATIC, $method(static_cast<bool(*)($Class*,$Class*)>(&AccessorGenerator::canWidenTo))},
	{"emitBoxingContantPoolEntries", "()V", nullptr, $PROTECTED},
	{"emitCommonConstantPoolEntries", "()V", nullptr, $PROTECTED},
	{"emitConstructor", "()V", nullptr, $PROTECTED},
	{"emitMethod", "(SILjdk/internal/reflect/ClassFileAssembler;Ljdk/internal/reflect/ClassFileAssembler;[S)V", nullptr, $PROTECTED},
	{"emitWideningBytecodeForPrimitiveConversion", "(Ljdk/internal/reflect/ClassFileAssembler;Ljava/lang/Class;Ljava/lang/Class;)V", "(Ljdk/internal/reflect/ClassFileAssembler;Ljava/lang/Class<*>;Ljava/lang/Class<*>;)V", $PROTECTED | $STATIC, $method(static_cast<void(*)($ClassFileAssembler*,$Class*,$Class*)>(&AccessorGenerator::emitWideningBytecodeForPrimitiveConversion))},
	{"getClassName", "(Ljava/lang/Class;Z)Ljava/lang/String;", "(Ljava/lang/Class<*>;Z)Ljava/lang/String;", $PROTECTED | $STATIC, $method(static_cast<$String*(*)($Class*,bool)>(&AccessorGenerator::getClassName))},
	{"illegalArgumentCodeBuffer", "()Ljdk/internal/reflect/ClassFileAssembler;", nullptr, $PROTECTED},
	{"indexForPrimitiveType", "(Ljava/lang/Class;)S", "(Ljava/lang/Class<*>;)S", $PROTECTED},
	{"internalize", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&AccessorGenerator::internalize))},
	{"isPrimitive", "(Ljava/lang/Class;)Z", "(Ljava/lang/Class<*>;)Z", $PROTECTED | $STATIC, $method(static_cast<bool(*)($Class*)>(&AccessorGenerator::isPrimitive))},
	{"isPrivate", "()Z", nullptr, $PROTECTED},
	{"isStatic", "()Z", nullptr, $PROTECTED},
	{"sub", "(SS)S", nullptr, $PROTECTED | $STATIC, $method(static_cast<int16_t(*)(int16_t,int16_t)>(&AccessorGenerator::sub))},
	{"typeSizeInStackSlots", "(Ljava/lang/Class;)I", "(Ljava/lang/Class<*>;)I", $PROTECTED},
	{"unboxingMethodForPrimitiveType", "(Ljava/lang/Class;)S", "(Ljava/lang/Class<*>;)S", $PROTECTED},
	{}
};
