#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticShortFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticShortFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticShortFieldAccessorImpl
...
class UnsafeQualifiedStaticShortFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticShortFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticShortFieldAccessorImpl_h_