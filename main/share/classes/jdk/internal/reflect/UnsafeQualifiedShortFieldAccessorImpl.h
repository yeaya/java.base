#ifndef _jdk_internal_reflect_UnsafeQualifiedShortFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedShortFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedShortFieldAccessorImpl
...
class UnsafeQualifiedShortFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedShortFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedShortFieldAccessorImpl_h_