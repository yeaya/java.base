...
void ConstantMethodRef::init$(int32_t index, int32_t classIndex, int32_t nameAndTypeIndex) {
	ConstantBase::init$(Tag_MethodRef, index);
	this->classIndex = classIndex;
	this->nameAndTypeIndex = nameAndTypeIndex;
}

void ConstantMethodRef::init(ConstantPool* cp) {
