#ifndef _jdk_internal_reflect_UnsafeStaticCharacterFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticCharacterFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticCharacterFieldAccessorImpl
...
class UnsafeStaticCharacterFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticCharacterFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticCharacterFieldAccessorImpl_h_