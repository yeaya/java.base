#ifndef _jdk_internal_reflect_UnsafeObjectFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeObjectFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeObjectFieldAccessorImpl
...
class UnsafeObjectFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeObjectFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeObjectFieldAccessorImpl_h_