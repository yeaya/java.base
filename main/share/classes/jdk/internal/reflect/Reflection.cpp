...
$MethodInfo _Reflection_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(Reflection::*)()>(&Reflection::init$))},
	{"areNestMates", "(Ljava/lang/Class;Ljava/lang/Class;)Z", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;)Z", $PUBLIC | $STATIC | $NATIVE, $method(static_cast<bool(*)($Class*,$Class*)>(&Reflection::areNestMates))},
	{"ensureMemberAccess", "(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;I)V", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;Ljava/lang/Class<*>;I)V", $PUBLIC | $STATIC, $method(static_cast<void(*)($Class*,$Class*,$Class*,int32_t)>(&Reflection::ensureMemberAccess)), "java.lang.IllegalAccessException"},
	{"ensureNativeAccess", "(Ljava/lang/Class;)V", "(Ljava/lang/Class<*>;)V", $PUBLIC | $STATIC, $method(static_cast<void(*)($Class*)>(&Reflection::ensureNativeAccess))},
	{"filter", "([Ljava/lang/reflect/Member;Ljava/util/Set;)[Ljava/lang/reflect/Member;", "([Ljava/lang/reflect/Member;Ljava/util/Set<Ljava/lang/String;>;)[Ljava/lang/reflect/Member;", $PRIVATE | $STATIC, $method(static_cast<$MemberArray*(*)($MemberArray*,$Set*)>(&Reflection::filter))},
	{"filterFields", "(Ljava/lang/Class;[Ljava/lang/reflect/Field;)[Ljava/lang/reflect/Field;", "(Ljava/lang/Class<*>;[Ljava/lang/reflect/Field;)[Ljava/lang/reflect/Field;", $PUBLIC | $STATIC, $method(static_cast<$FieldArray*(*)($Class*,$FieldArray*)>(&Reflection::filterFields))},
	{"filterMethods", "(Ljava/lang/Class;[Ljava/lang/reflect/Method;)[Ljava/lang/reflect/Method;", "(Ljava/lang/Class<*>;[Ljava/lang/reflect/Method;)[Ljava/lang/reflect/Method;", $PUBLIC | $STATIC, $method(static_cast<$MethodArray*(*)($Class*,$MethodArray*)>(&Reflection::filterMethods))},
	{"getCallerClass", "()Ljava/lang/Class;", "()Ljava/lang/Class<*>;", $PUBLIC | $STATIC | $NATIVE, $method(static_cast<$Class*(*)()>(&Reflection::getCallerClass)), nullptr, nullptr, _Reflection_MethodAnnotations_getCallerClass7},
	{"getClassAccessFlags", "(Ljava/lang/Class;)I", "(Ljava/lang/Class<*>;)I", $PUBLIC | $STATIC | $NATIVE, $method(static_cast<int32_t(*)($Class*)>(&Reflection::getClassAccessFlags)), nullptr, nullptr, _Reflection_MethodAnnotations_getClassAccessFlags8},
	{"isCallerSensitive", "(Ljava/lang/reflect/Method;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($Method*)>(&Reflection::isCallerSensitive))},
	{"isSameClassPackage", "(Ljava/lang/Class;Ljava/lang/Class;)Z", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;)Z", $PRIVATE | $STATIC, $method(static_cast<bool(*)($Class*,$Class*)>(&Reflection::isSameClassPackage))},
	{"isSubclassOf", "(Ljava/lang/Class;Ljava/lang/Class;)Z", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;)Z", $STATIC, $method(static_cast<bool(*)($Class*,$Class*)>(&Reflection::isSubclassOf))},
	{"isTrustedFinalField", "(Ljava/lang/reflect/Field;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($Field*)>(&Reflection::isTrustedFinalField))},
	{"newIllegalAccessException", "(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;I)Ljava/lang/IllegalAccessException;", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;Ljava/lang/Class<*>;I)Ljava/lang/IllegalAccessException;", $PUBLIC | $STATIC, $method(static_cast<$IllegalAccessException*(*)($Class*,$Class*,$Class*,int32_t)>(&Reflection::newIllegalAccessException))},
	{"newIllegalAccessException", "(Ljava/lang/Class;I)Ljava/lang/IllegalAccessException;", "(Ljava/lang/Class<*>;I)Ljava/lang/IllegalAccessException;", $PRIVATE | $STATIC, $method(static_cast<$IllegalAccessException*(*)($Class*,int32_t)>(&Reflection::newIllegalAccessException))},
	{"registerFieldsToFilter", "(Ljava/lang/Class;Ljava/util/Set;)V", "(Ljava/lang/Class<*>;Ljava/util/Set<Ljava/lang/String;>;)V", $PUBLIC | $STATIC | $SYNCHRONIZED, $method(static_cast<void(*)($Class*,$Set*)>(&Reflection::registerFieldsToFilter))},
	{"registerFilter", "(Ljava/util/Map;Ljava/lang/Class;Ljava/util/Set;)Ljava/util/Map;", "(Ljava/util/Map<Ljava/lang/Class<*>;Ljava/util/Set<Ljava/lang/String;>;>;Ljava/lang/Class<*>;Ljava/util/Set<Ljava/lang/String;>;)Ljava/util/Map<Ljava/lang/Class<*>;Ljava/util/Set<Ljava/lang/String;>;>;", $PRIVATE | $STATIC, $method(static_cast<$Map*(*)($Map*,$Class*,$Set*)>(&Reflection::registerFilter))},
	{"registerMethodsToFilter", "(Ljava/lang/Class;Ljava/util/Set;)V", "(Ljava/lang/Class<*>;Ljava/util/Set<Ljava/lang/String;>;)V", $PUBLIC | $STATIC | $SYNCHRONIZED, $method(static_cast<void(*)($Class*,$Set*)>(&Reflection::registerMethodsToFilter))},
	{"verifyMemberAccess", "(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;I)Z", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;Ljava/lang/Class<*>;I)Z", $PUBLIC | $STATIC, $method(static_cast<bool(*)($Class*,$Class*,$Class*,int32_t)>(&Reflection::verifyMemberAccess))},
	{"verifyModuleAccess", "(Ljava/lang/Module;Ljava/lang/Class;)Z", "(Ljava/lang/Module;Ljava/lang/Class<*>;)Z", $PUBLIC | $STATIC, $method(static_cast<bool(*)($Module*,$Class*)>(&Reflection::verifyModuleAccess))},
	{"verifyPublicMemberAccess", "(Ljava/lang/Class;I)Z", "(Ljava/lang/Class<*>;I)Z", $PUBLIC | $STATIC, $method(static_cast<bool(*)($Class*,int32_t)>(&Reflection::verifyPublicMemberAccess))},
	{}
};
