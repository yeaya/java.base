#ifndef _jdk_internal_reflect_UnsafeBooleanFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeBooleanFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeBooleanFieldAccessorImpl
...
class UnsafeBooleanFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeBooleanFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeBooleanFieldAccessorImpl_h_