#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticIntegerFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticIntegerFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticIntegerFieldAccessorImpl
...
class UnsafeQualifiedStaticIntegerFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticIntegerFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticIntegerFieldAccessorImpl_h_