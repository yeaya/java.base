#ifndef _jdk_internal_reflect_UnsafeStaticDoubleFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticDoubleFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticDoubleFieldAccessorImpl
...
class UnsafeStaticDoubleFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticDoubleFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticDoubleFieldAccessorImpl_h_