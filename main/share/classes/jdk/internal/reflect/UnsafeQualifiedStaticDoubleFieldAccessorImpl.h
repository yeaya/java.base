#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticDoubleFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticDoubleFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticDoubleFieldAccessorImpl
...
class UnsafeQualifiedStaticDoubleFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticDoubleFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticDoubleFieldAccessorImpl_h_