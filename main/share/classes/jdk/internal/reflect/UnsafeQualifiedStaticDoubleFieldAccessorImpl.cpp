...
$MethodInfo _UnsafeQualifiedStaticDoubleFieldAccessorImpl_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/reflect/Field;Z)V", nullptr, 0, $method(static_cast<void(UnsafeQualifiedStaticDoubleFieldAccessorImpl::*)($Field*,bool)>(&UnsafeQualifiedStaticDoubleFieldAccessorImpl::init$))},
