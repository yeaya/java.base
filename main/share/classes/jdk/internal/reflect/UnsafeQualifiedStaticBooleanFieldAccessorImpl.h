#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticBooleanFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticBooleanFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticBooleanFieldAccessorImpl
...
class UnsafeQualifiedStaticBooleanFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticBooleanFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticBooleanFieldAccessorImpl_h_