#ifndef _jdk_internal_reflect_UnsafeStaticByteFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticByteFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticByteFieldAccessorImpl
...
class UnsafeStaticByteFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticByteFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticByteFieldAccessorImpl_h_