#ifndef _jdk_internal_reflect_UnsafeStaticBooleanFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeStaticBooleanFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeStaticBooleanFieldAccessorImpl
...
class UnsafeStaticBooleanFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl {
	$class(UnsafeStaticBooleanFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeStaticBooleanFieldAccessorImpl_h_