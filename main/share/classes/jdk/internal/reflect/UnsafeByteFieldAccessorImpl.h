#ifndef _jdk_internal_reflect_UnsafeByteFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeByteFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeByteFieldAccessorImpl
...
class UnsafeByteFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeByteFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeByteFieldAccessorImpl_h_