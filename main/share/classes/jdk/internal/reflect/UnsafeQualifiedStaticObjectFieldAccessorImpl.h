#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticObjectFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticObjectFieldAccessorImpl_h_
...
class UnsafeQualifiedStaticObjectFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticObjectFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticObjectFieldAccessorImpl_h_