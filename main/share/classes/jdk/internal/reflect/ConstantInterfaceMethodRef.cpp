...
void ConstantInterfaceMethodRef::init$(int32_t index, int32_t classIndex, int32_t nameAndTypeIndex) {
	ConstantBase::init$(Tag_InterfaceMethodRef, index);
	this->classIndex = classIndex;
	this->nameAndTypeIndex = nameAndTypeIndex;
}

void ConstantInterfaceMethodRef::init(ConstantPool* cp) {
