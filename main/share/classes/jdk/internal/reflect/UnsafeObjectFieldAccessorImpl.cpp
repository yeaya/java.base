...
$Object* UnsafeObjectFieldAccessorImpl::get(Object$* obj) {
	...
	return $nc($UnsafeFieldAccessorImpl::unsafe)->getReference(obj, this->fieldOffset);
}
...
$Class* UnsafeObjectFieldAccessorImpl::load$($String* name, bool initialize) {
	...
	$loadClass(UnsafeObjectFieldAccessorImpl, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
