#ifndef _jdk_internal_reflect_UnsafeQualifiedByteFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedByteFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedByteFieldAccessorImpl
...
class UnsafeQualifiedByteFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedByteFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedByteFieldAccessorImpl_h_