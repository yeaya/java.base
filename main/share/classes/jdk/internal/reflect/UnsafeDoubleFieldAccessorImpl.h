#ifndef _jdk_internal_reflect_UnsafeDoubleFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeDoubleFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeDoubleFieldAccessorImpl
...
class UnsafeDoubleFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeFieldAccessorImpl {
	$class(UnsafeDoubleFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeDoubleFieldAccessorImpl_h_