#ifndef _jdk_internal_reflect_UnsafeQualifiedFloatFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedFloatFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedFloatFieldAccessorImpl
...
class UnsafeQualifiedFloatFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedFloatFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedFloatFieldAccessorImpl_h_