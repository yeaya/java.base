#ifndef _jdk_internal_reflect_UnsafeQualifiedStaticLongFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedStaticLongFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedStaticLongFieldAccessorImpl
...
class UnsafeQualifiedStaticLongFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl {
	$class(UnsafeQualifiedStaticLongFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedStaticLongFieldAccessorImpl_h_