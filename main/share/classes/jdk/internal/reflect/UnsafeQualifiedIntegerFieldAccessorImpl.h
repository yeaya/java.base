#ifndef _jdk_internal_reflect_UnsafeQualifiedIntegerFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedIntegerFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedIntegerFieldAccessorImpl
...
class UnsafeQualifiedIntegerFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedIntegerFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedIntegerFieldAccessorImpl_h_