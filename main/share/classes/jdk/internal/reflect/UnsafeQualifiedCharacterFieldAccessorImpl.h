#ifndef _jdk_internal_reflect_UnsafeQualifiedCharacterFieldAccessorImpl_h_
#define _jdk_internal_reflect_UnsafeQualifiedCharacterFieldAccessorImpl_h_
//$ class jdk.internal.reflect.UnsafeQualifiedCharacterFieldAccessorImpl
...
class UnsafeQualifiedCharacterFieldAccessorImpl : public ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl {
	$class(UnsafeQualifiedCharacterFieldAccessorImpl, $NO_CLASS_INIT, ::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl)
public:
...
#endif // _jdk_internal_reflect_UnsafeQualifiedCharacterFieldAccessorImpl_h_