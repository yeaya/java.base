...
$MethodInfo _ResourceDecompressorFactory_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PROTECTED, $method(static_cast<void(ResourceDecompressorFactory::*)($String*)>(&ResourceDecompressorFactory::init$))},
	{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"newDecompressor", "(Ljava/util/Properties;)Ljdk/internal/jimage/decompressor/ResourceDecompressor;", nullptr, $PUBLIC | $ABSTRACT, nullptr, "java.io.IOException"},
	{}
};
