...
void SecretKeySpec::init$($bytes* key, $String* algorithm) {
	...
	$set(this, key, $cast($bytes, key->clone()));
...
void SecretKeySpec::clinit$($Class* clazz) {
	{
...
$Class* SecretKeySpec::load$($String* name, bool initialize) {
	...
	$loadClass(SecretKeySpec, name, initialize, &classInfo$$, SecretKeySpec::clinit$, []($Class* clazz) -> $Object* {
