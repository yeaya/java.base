...
$MethodInfo _ConfirmationCallback_MethodInfo_[] = {
	...
	{"<init>", "(III)V", nullptr, $PUBLIC, $method(static_cast<void(ConfirmationCallback::*)(int32_t,int32_t,int32_t)>(&ConfirmationCallback::init$))},
	{"<init>", "(I[Ljava/lang/String;I)V", nullptr, $PUBLIC, $method(static_cast<void(ConfirmationCallback::*)(int32_t,$StringArray*,int32_t)>(&ConfirmationCallback::init$))},
	{"<init>", "(Ljava/lang/String;III)V", nullptr, $PUBLIC, $method(static_cast<void(ConfirmationCallback::*)($String*,int32_t,int32_t,int32_t)>(&ConfirmationCallback::init$))},
	{"<init>", "(Ljava/lang/String;I[Ljava/lang/String;I)V", nullptr, $PUBLIC, $method(static_cast<void(ConfirmationCallback::*)($String*,int32_t,$StringArray*,int32_t)>(&ConfirmationCallback::init$))},
	{"getDefaultOption", "()I", nullptr, $PUBLIC},
	{"getMessageType", "()I", nullptr, $PUBLIC},
	{"getOptionType", "()I", nullptr, $PUBLIC},
	{"getOptions", "()[Ljava/lang/String;", nullptr, $PUBLIC},
