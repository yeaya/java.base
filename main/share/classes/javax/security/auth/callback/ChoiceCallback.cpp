...
$MethodInfo _ChoiceCallback_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/lang/String;[Ljava/lang/String;IZ)V", nullptr, $PUBLIC, $method(static_cast<void(ChoiceCallback::*)($String*,$StringArray*,int32_t,bool)>(&ChoiceCallback::init$))},
	{"allowMultipleSelections", "()Z", nullptr, $PUBLIC},
	{"getChoices", "()[Ljava/lang/String;", nullptr, $PUBLIC},
	{"getDefaultChoice", "()I", nullptr, $PUBLIC},
	{"getPrompt", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getSelectedIndexes", "()[I", nullptr, $PUBLIC},
	{"setSelectedIndex", "(I)V", nullptr, $PUBLIC},
	{"setSelectedIndexes", "([I)V", nullptr, $PUBLIC},
