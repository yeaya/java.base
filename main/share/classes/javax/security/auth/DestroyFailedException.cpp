...
DestroyFailedException::DestroyFailedException(const DestroyFailedException& e) {
}

DestroyFailedException DestroyFailedException::wrapper$() {
	$pendingException(this);
	return *this;
}

void DestroyFailedException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
