...
$Class* HandshakeCompletedEvent::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"getPeerCertificateChain", "()[Ljavax/security/cert/X509Certificate;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(HandshakeCompletedEvent, getPeerCertificateChain, $X509CertificateArray*), "javax.net.ssl.SSLPeerUnverifiedException", nullptr, getPeerCertificateChainmethodAnnotations$$},
	...
	$loadClass(HandshakeCompletedEvent, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HandshakeCompletedEvent);
	});
	return class$;
}
