...
void Cancellable::init$() {
	...
	Cancellable::unsafe->putIntVolatile(nullptr, this->pollingAddress, 0);
}
...
void Cancellable::clinit$($Class* clazz) {
...
$Class* Cancellable::load$($String* name, bool initialize) {
	...
	$loadClass(Cancellable, name, initialize, &classInfo$$, Cancellable::clinit$, []($Class* clazz) -> $Object* {
