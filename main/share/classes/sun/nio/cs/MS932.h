#ifndef _sun_nio_cs_MS932_h_
#define _sun_nio_cs_MS932_h_
...
class $export MS932 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(MS932, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	MS932();
