#ifndef _sun_nio_cs_IBM874_h_
#define _sun_nio_cs_IBM874_h_
...
class $export IBM874 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM874, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM874();
