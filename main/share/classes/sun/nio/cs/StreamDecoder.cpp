...
$MethodInfo _StreamDecoder_MethodInfo_[] = {
	{"<init>", "(Ljava/io/InputStream;Ljava/lang/Object;Ljava/nio/charset/Charset;)V", nullptr, 0, $method(static_cast<void(StreamDecoder::*)($InputStream*,Object$*,$Charset*)>(&StreamDecoder::init$))},
	{"<init>", "(Ljava/io/InputStream;Ljava/lang/Object;Ljava/nio/charset/CharsetDecoder;)V", nullptr, 0, $method(static_cast<void(StreamDecoder::*)($InputStream*,Object$*,$CharsetDecoder*)>(&StreamDecoder::init$))},
	{"<init>", "(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/charset/CharsetDecoder;I)V", nullptr, 0, $method(static_cast<void(StreamDecoder::*)($ReadableByteChannel*,$CharsetDecoder*,int32_t)>(&StreamDecoder::init$))},
	{"close", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"encodingName", "()Ljava/lang/String;", nullptr, 0},
	{"ensureOpen", "()V", nullptr, $PRIVATE, $method(static_cast<void(StreamDecoder::*)()>(&StreamDecoder::ensureOpen)), "java.io.IOException"},
	{"forDecoder", "(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/charset/CharsetDecoder;I)Lsun/nio/cs/StreamDecoder;", nullptr, $PUBLIC | $STATIC, $method(static_cast<StreamDecoder*(*)($ReadableByteChannel*,$CharsetDecoder*,int32_t)>(&StreamDecoder::forDecoder))},
	{"forInputStreamReader", "(Ljava/io/InputStream;Ljava/lang/Object;Ljava/lang/String;)Lsun/nio/cs/StreamDecoder;", nullptr, $PUBLIC | $STATIC, $method(static_cast<StreamDecoder*(*)($InputStream*,Object$*,$String*)>(&StreamDecoder::forInputStreamReader)), "java.io.UnsupportedEncodingException"},
	{"forInputStreamReader", "(Ljava/io/InputStream;Ljava/lang/Object;Ljava/nio/charset/Charset;)Lsun/nio/cs/StreamDecoder;", nullptr, $PUBLIC | $STATIC, $method(static_cast<StreamDecoder*(*)($InputStream*,Object$*,$Charset*)>(&StreamDecoder::forInputStreamReader))},
	{"forInputStreamReader", "(Ljava/io/InputStream;Ljava/lang/Object;Ljava/nio/charset/CharsetDecoder;)Lsun/nio/cs/StreamDecoder;", nullptr, $PUBLIC | $STATIC, $method(static_cast<StreamDecoder*(*)($InputStream*,Object$*,$CharsetDecoder*)>(&StreamDecoder::forInputStreamReader))},
	{"getEncoding", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"implClose", "()V", nullptr, 0, nullptr, "java.io.IOException"},
	{"implRead", "([CII)I", nullptr, 0, nullptr, "java.io.IOException"},
	{"implReady", "()Z", nullptr, 0},
	{"inReady", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(StreamDecoder::*)()>(&StreamDecoder::inReady))},
	{"isOpen", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(StreamDecoder::*)()>(&StreamDecoder::isOpen))},
	{"read", "()I", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"read", "([CII)I", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"read0", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(StreamDecoder::*)()>(&StreamDecoder::read0)), "java.io.IOException"},
	{"readBytes", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(StreamDecoder::*)()>(&StreamDecoder::readBytes)), "java.io.IOException"},
