...
$Class* IBM850$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM850$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM850$Holder, name, initialize, &classInfo$$, IBM850$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM850$Holder);
	});
	return class$;
}
