...
$Class* KOI8_U$Holder::load$($String* name, bool initialize) {
	...
	$loadClass(KOI8_U$Holder, name, initialize, &classInfo$$, KOI8_U$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(KOI8_U$Holder);
	});
	return class$;
}
