#ifndef _sun_nio_cs_MS950_HKSCS_h_
#define _sun_nio_cs_MS950_HKSCS_h_
//$ class sun.nio.cs.MS950_HKSCS
...
class $export MS950_HKSCS : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
