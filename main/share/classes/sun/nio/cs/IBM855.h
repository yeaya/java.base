#ifndef _sun_nio_cs_IBM855_h_
#define _sun_nio_cs_IBM855_h_
//$ class sun.nio.cs.IBM855
...
class $export IBM855 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM855, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM855();
