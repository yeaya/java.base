...
using $KOI8_R = ::sun::nio::cs::KOI8_R;
...
$FieldInfo _KOI8_R$Holder_FieldInfo_[] = {
...
$InnerClassInfo _KOI8_R$Holder_InnerClassesInfo_[] = {
	{"sun.nio.cs.KOI8_R$Holder", "sun.nio.cs.KOI8_R", "Holder", $PRIVATE | $STATIC},
	{}
};

$ClassInfo _KOI8_R$Holder_ClassInfo_ = {
	$ACC_SUPER,
	"sun.nio.cs.KOI8_R$Holder",
	"java.lang.Object",
	nullptr,
	_KOI8_R$Holder_FieldInfo_,
	_KOI8_R$Holder_MethodInfo_,
	nullptr,
	nullptr,
	_KOI8_R$Holder_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"sun.nio.cs.KOI8_R"
...
$Object* allocate$KOI8_R$Holder($Class* clazz) {
	return $of($alloc(KOI8_R$Holder));
}
...
void clinit$KOI8_R$Holder($Class* class$) {
	...
	$assignStatic(KOI8_R$Holder::b2c, $nc(KOI8_R$Holder::b2cTable)->toCharArray());
...
$Class* KOI8_R$Holder::load$($String* name, bool initialize) {
	$loadClass(KOI8_R$Holder, name, initialize, &_KOI8_R$Holder_ClassInfo_, clinit$KOI8_R$Holder, allocate$KOI8_R$Holder);
	return class$;
}
