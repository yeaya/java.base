...
$MethodInfo _SingleByte$Encoder_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/nio/charset/Charset;[C[CZ)V", nullptr, $PUBLIC, $method(static_cast<void(SingleByte$Encoder::*)($Charset*,$chars*,$chars*,bool)>(&SingleByte$Encoder::init$))},
	{"canEncode", "(C)Z", nullptr, $PUBLIC},
	{"encode", "(C)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SingleByte$Encoder::*)(char16_t)>(&SingleByte$Encoder::encode))},
	{"encode", "([CII[B)I", nullptr, $PUBLIC},
	{"encodeArrayLoop", "(Ljava/nio/CharBuffer;Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PRIVATE, $method(static_cast<$CoderResult*(SingleByte$Encoder::*)($CharBuffer*,$ByteBuffer*)>(&SingleByte$Encoder::encodeArrayLoop))},
	{"encodeBufferLoop", "(Ljava/nio/CharBuffer;Ljava/nio/ByteBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PRIVATE, $method(static_cast<$CoderResult*(SingleByte$Encoder::*)($CharBuffer*,$ByteBuffer*)>(&SingleByte$Encoder::encodeBufferLoop))},
