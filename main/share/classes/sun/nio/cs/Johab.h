#ifndef _sun_nio_cs_Johab_h_
#define _sun_nio_cs_Johab_h_
//$ class sun.nio.cs.Johab
...
class $export Johab : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(Johab, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	Johab();
