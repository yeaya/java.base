#ifndef _sun_nio_cs_UTF_32BE_BOM_h_
#define _sun_nio_cs_UTF_32BE_BOM_h_
//$ class sun.nio.cs.UTF_32BE_BOM
...
class $export UTF_32BE_BOM : public ::sun::nio::cs::Unicode {
	$class(UTF_32BE_BOM, $NO_CLASS_INIT, ::sun::nio::cs::Unicode)
public:
	UTF_32BE_BOM();
	void init$();
