...
$CoderResult* DoubleByte$Decoder::crMalformedOrUnmappable(int32_t b1, int32_t b2) {
	$init($DoubleByte);
	if ($nc(this->b2c)->get(b1) == $DoubleByte::B2C_UNMAPPABLE || this->b2c->get(b2) != $DoubleByte::B2C_UNMAPPABLE || decodeSingle(b2) != (char16_t)0xfffd) {
...
void DoubleByte$Decoder::clinit$($Class* clazz) {
...
$Class* DoubleByte$Decoder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/nio/charset/Charset;FF[[C[CIIZ)V", nullptr, $PUBLIC, $method(DoubleByte$Decoder, init$, void, $Charset*, float, float, $charArray2*, $chars*, int32_t, int32_t, bool)},
		{"<init>", "(Ljava/nio/charset/Charset;[[C[CIIZ)V", nullptr, $PUBLIC, $method(DoubleByte$Decoder, init$, void, $Charset*, $charArray2*, $chars*, int32_t, int32_t, bool)},
		{"<init>", "(Ljava/nio/charset/Charset;[[C[CII)V", nullptr, $PUBLIC, $method(DoubleByte$Decoder, init$, void, $Charset*, $charArray2*, $chars*, int32_t, int32_t)},
		{"crMalformedOrUnderFlow", "(I)Ljava/nio/charset/CoderResult;", nullptr, $PROTECTED, $virtualMethod(DoubleByte$Decoder, crMalformedOrUnderFlow, $CoderResult*, int32_t)},
		{"crMalformedOrUnmappable", "(II)Ljava/nio/charset/CoderResult;", nullptr, $PROTECTED, $virtualMethod(DoubleByte$Decoder, crMalformedOrUnmappable, $CoderResult*, int32_t, int32_t)},
		{"decode", "([BII[C)I", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, decode, int32_t, $bytes*, int32_t, int32_t, $chars*)},
		{"decodeArrayLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PROTECTED, $virtualMethod(DoubleByte$Decoder, decodeArrayLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeBufferLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PROTECTED, $virtualMethod(DoubleByte$Decoder, decodeBufferLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeDouble", "(II)C", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, decodeDouble, char16_t, int32_t, int32_t)},
		{"decodeLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, decodeLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeSingle", "(I)C", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, decodeSingle, char16_t, int32_t)},
		{"implFlush", "(Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, implFlush, $CoderResult*, $CharBuffer*)},
		{"implReset", "()V", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, implReset, void)},
		{"isASCIICompatible", "()Z", nullptr, $PUBLIC, $virtualMethod(DoubleByte$Decoder, isASCIICompatible, bool)},
	...
	$loadClass(DoubleByte$Decoder, name, initialize, &classInfo$$, DoubleByte$Decoder::clinit$, []($Class* clazz) -> $Object* {
