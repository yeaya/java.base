#ifndef _sun_nio_cs_KOI8_R_h_
#define _sun_nio_cs_KOI8_R_h_
//$ class sun.nio.cs.KOI8_R
...
class $export KOI8_R : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(KOI8_R, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	KOI8_R();
