#ifndef _sun_nio_cs_MS1257_h_
#define _sun_nio_cs_MS1257_h_
...
class $export MS1257 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(MS1257, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	MS1257();
