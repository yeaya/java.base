#ifndef _sun_nio_cs_IBM437_h_
#define _sun_nio_cs_IBM437_h_
//$ class sun.nio.cs.IBM437
...
class $export IBM437 : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
	$class(IBM437, $NO_CLASS_INIT, ::java::nio::charset::Charset, ::sun::nio::cs::HistoricallyNamedCharset)
public:
	IBM437();
