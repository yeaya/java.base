...
$MethodInfo _AsynchronousFileChannelImpl_MethodInfo_[] = {
	{"<init>", "(Ljava/io/FileDescriptor;ZZLjava/util/concurrent/ExecutorService;)V", nullptr, $PROTECTED, $method(static_cast<void(AsynchronousFileChannelImpl::*)($FileDescriptor*,bool,bool,$ExecutorService*)>(&AsynchronousFileChannelImpl::init$))},
	{"addToFileLockTable", "(JJZ)Lsun/nio/ch/FileLockImpl;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$FileLockImpl*(AsynchronousFileChannelImpl::*)(int64_t,int64_t,bool)>(&AsynchronousFileChannelImpl::addToFileLockTable))},
	{"begin", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)()>(&AsynchronousFileChannelImpl::begin)), "java.io.IOException"},
	{"end", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)()>(&AsynchronousFileChannelImpl::end))},
	{"end", "(Z)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)(bool)>(&AsynchronousFileChannelImpl::end)), "java.io.IOException"},
	{"ensureFileLockTableInitialized", "()V", nullptr, $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)()>(&AsynchronousFileChannelImpl::ensureFileLockTableInitialized)), "java.io.IOException"},
	{"executor", "()Ljava/util/concurrent/ExecutorService;", nullptr, $FINAL, $method(static_cast<$ExecutorService*(AsynchronousFileChannelImpl::*)()>(&AsynchronousFileChannelImpl::executor))},
	{"implLock", "(JJZLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)Ljava/util/concurrent/Future;", "<A:Ljava/lang/Object;>(JJZTA;Ljava/nio/channels/CompletionHandler<Ljava/nio/channels/FileLock;-TA;>;)Ljava/util/concurrent/Future<Ljava/nio/channels/FileLock;>;", $ABSTRACT},
	{"implRead", "(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)Ljava/util/concurrent/Future;", "<A:Ljava/lang/Object;>(Ljava/nio/ByteBuffer;JTA;Ljava/nio/channels/CompletionHandler<Ljava/lang/Integer;-TA;>;)Ljava/util/concurrent/Future<Ljava/lang/Integer;>;", $ABSTRACT},
	{"implRelease", "(Lsun/nio/ch/FileLockImpl;)V", nullptr, $PROTECTED | $ABSTRACT, nullptr, "java.io.IOException"},
	{"implWrite", "(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)Ljava/util/concurrent/Future;", "<A:Ljava/lang/Object;>(Ljava/nio/ByteBuffer;JTA;Ljava/nio/channels/CompletionHandler<Ljava/lang/Integer;-TA;>;)Ljava/util/concurrent/Future<Ljava/lang/Integer;>;", $ABSTRACT},
	{"invalidateAllLocks", "()V", nullptr, $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)()>(&AsynchronousFileChannelImpl::invalidateAllLocks)), "java.io.IOException"},
	{"isOpen", "()Z", nullptr, $PUBLIC | $FINAL},
	{"lock", "(JJZ)Ljava/util/concurrent/Future;", "(JJZ)Ljava/util/concurrent/Future<Ljava/nio/channels/FileLock;>;", $PUBLIC | $FINAL},
	{"lock", "(JJZLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V", "<A:Ljava/lang/Object;>(JJZTA;Ljava/nio/channels/CompletionHandler<Ljava/nio/channels/FileLock;-TA;>;)V", $PUBLIC | $FINAL},
	{"read", "(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;", "(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future<Ljava/lang/Integer;>;", $PUBLIC | $FINAL},
	{"read", "(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V", "<A:Ljava/lang/Object;>(Ljava/nio/ByteBuffer;JTA;Ljava/nio/channels/CompletionHandler<Ljava/lang/Integer;-TA;>;)V", $PUBLIC | $FINAL},
	{"release", "(Lsun/nio/ch/FileLockImpl;)V", nullptr, $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)($FileLockImpl*)>(&AsynchronousFileChannelImpl::release)), "java.io.IOException"},
	{"removeFromFileLockTable", "(Lsun/nio/ch/FileLockImpl;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AsynchronousFileChannelImpl::*)($FileLockImpl*)>(&AsynchronousFileChannelImpl::removeFromFileLockTable))},
	{"write", "(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;", "(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future<Ljava/lang/Integer;>;", $PUBLIC | $FINAL},
	{"write", "(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V", "<A:Ljava/lang/Object;>(Ljava/nio/ByteBuffer;JTA;Ljava/nio/channels/CompletionHandler<Ljava/lang/Integer;-TA;>;)V", $PUBLIC | $FINAL},
	{}
};
