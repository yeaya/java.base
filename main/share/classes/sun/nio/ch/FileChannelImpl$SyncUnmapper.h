#ifndef _sun_nio_ch_FileChannelImpl$SyncUnmapper_h_
#define _sun_nio_ch_FileChannelImpl$SyncUnmapper_h_
//$ class sun.nio.ch.FileChannelImpl$SyncUnmapper
...
class FileChannelImpl$SyncUnmapper : public ::sun::nio::ch::FileChannelImpl$Unmapper {
	$class(FileChannelImpl$SyncUnmapper, $NO_CLASS_INIT, ::sun::nio::ch::FileChannelImpl$Unmapper)
public:
	FileChannelImpl$SyncUnmapper();
...
#endif // _sun_nio_ch_FileChannelImpl$SyncUnmapper_h_