...
$MethodInfo NioSocketImpl$$Lambda$lambda$closerFor$0::methodInfos[3] = {
	{"<init>", "(Ljava/io/FileDescriptor;)V", nullptr, $PUBLIC, $method(static_cast<void(NioSocketImpl$$Lambda$lambda$closerFor$0::*)($FileDescriptor*)>(&NioSocketImpl$$Lambda$lambda$closerFor$0::init$))},
...
$MethodInfo NioSocketImpl$$Lambda$lambda$closerFor$1$1::methodInfos[3] = {
	{"<init>", "(Ljava/io/FileDescriptor;)V", nullptr, $PUBLIC, $method(static_cast<void(NioSocketImpl$$Lambda$lambda$closerFor$1$1::*)($FileDescriptor*)>(&NioSocketImpl$$Lambda$lambda$closerFor$1$1::init$))},
	{"run", "()V", nullptr, $PUBLIC},
	{}
};
...
$MethodInfo _NioSocketImpl_MethodInfo_[] = {
	...
	{"<init>", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(NioSocketImpl::*)(bool)>(&NioSocketImpl::init$))},
	...
	{"beginAccept", "()Ljava/io/FileDescriptor;", nullptr, $PRIVATE, $method(static_cast<$FileDescriptor*(NioSocketImpl::*)()>(&NioSocketImpl::beginAccept)), "java.net.SocketException"},
	{"beginConnect", "(Ljava/net/InetAddress;I)Ljava/io/FileDescriptor;", nullptr, $PRIVATE, $method(static_cast<$FileDescriptor*(NioSocketImpl::*)($InetAddress*,int32_t)>(&NioSocketImpl::beginConnect)), "java.io.IOException"},
	{"beginRead", "()Ljava/io/FileDescriptor;", nullptr, $PRIVATE, $method(static_cast<$FileDescriptor*(NioSocketImpl::*)()>(&NioSocketImpl::beginRead)), "java.net.SocketException"},
	{"beginWrite", "()Ljava/io/FileDescriptor;", nullptr, $PRIVATE, $method(static_cast<$FileDescriptor*(NioSocketImpl::*)()>(&NioSocketImpl::beginWrite)), "java.net.SocketException"},
	{"bind", "(Ljava/net/InetAddress;I)V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"booleanValue", "(Ljava/lang/Object;Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(NioSocketImpl::*)(Object$*,$String*)>(&NioSocketImpl::booleanValue)), "java.net.SocketException"},
	{"close", "()V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"closerFor", "(Ljava/io/FileDescriptor;Z)Ljava/lang/Runnable;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$Runnable*(*)($FileDescriptor*,bool)>(&NioSocketImpl::closerFor))},
	{"configureBlocking", "(Ljava/io/FileDescriptor;)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)($FileDescriptor*)>(&NioSocketImpl::configureBlocking)), "java.io.IOException"},
	{"configureNonBlocking", "(Ljava/io/FileDescriptor;)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)($FileDescriptor*)>(&NioSocketImpl::configureNonBlocking)), "java.io.IOException"},
	...
	{"endAccept", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)(bool)>(&NioSocketImpl::endAccept)), "java.net.SocketException"},
	{"endConnect", "(Ljava/io/FileDescriptor;Z)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)($FileDescriptor*,bool)>(&NioSocketImpl::endConnect)), "java.io.IOException"},
	{"endRead", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)(bool)>(&NioSocketImpl::endRead)), "java.net.SocketException"},
	{"endWrite", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)(bool)>(&NioSocketImpl::endWrite)), "java.net.SocketException"},
	{"ensureOpen", "()V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)()>(&NioSocketImpl::ensureOpen)), "java.net.SocketException"},
	{"ensureOpenAndConnected", "()V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)()>(&NioSocketImpl::ensureOpenAndConnected)), "java.net.SocketException"},
	{"family", "()Ljava/net/ProtocolFamily;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$ProtocolFamily*(*)()>(&NioSocketImpl::family))},
	...
	{"implRead", "([BII)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($bytes*,int32_t,int32_t)>(&NioSocketImpl::implRead)), "java.io.IOException"},
	{"implWrite", "([BII)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($bytes*,int32_t,int32_t)>(&NioSocketImpl::implWrite)), "java.io.IOException"},
	{"intValue", "(Ljava/lang/Object;Ljava/lang/String;)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)(Object$*,$String*)>(&NioSocketImpl::intValue)), "java.net.SocketException"},
	{"isOpen", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(NioSocketImpl::*)()>(&NioSocketImpl::isOpen))},
	{"lambda$closerFor$0", "(Ljava/io/FileDescriptor;)V", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<void(*)($FileDescriptor*)>(&NioSocketImpl::lambda$closerFor$0))},
	{"lambda$closerFor$1", "(Ljava/io/FileDescriptor;)V", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<void(*)($FileDescriptor*)>(&NioSocketImpl::lambda$closerFor$1))},
	{"listen", "(I)V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"park", "(Ljava/io/FileDescriptor;IJ)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)($FileDescriptor*,int32_t,int64_t)>(&NioSocketImpl::park)), "java.io.IOException"},
	{"park", "(Ljava/io/FileDescriptor;I)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)($FileDescriptor*,int32_t)>(&NioSocketImpl::park)), "java.io.IOException"},
	{"read", "([BII)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($bytes*,int32_t,int32_t)>(&NioSocketImpl::read)), "java.io.IOException"},
	...
	{"timedAccept", "(Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;[Ljava/net/InetSocketAddress;J)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($FileDescriptor*,$FileDescriptor*,$InetSocketAddressArray*,int64_t)>(&NioSocketImpl::timedAccept)), "java.io.IOException"},
	{"timedFinishConnect", "(Ljava/io/FileDescriptor;J)Z", nullptr, $PRIVATE, $method(static_cast<bool(NioSocketImpl::*)($FileDescriptor*,int64_t)>(&NioSocketImpl::timedFinishConnect)), "java.io.IOException"},
	{"timedRead", "(Ljava/io/FileDescriptor;[BIIJ)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($FileDescriptor*,$bytes*,int32_t,int32_t,int64_t)>(&NioSocketImpl::timedRead)), "java.io.IOException"},
	{"*toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"tryClose", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(NioSocketImpl::*)()>(&NioSocketImpl::tryClose)), "java.io.IOException"},
	{"tryFinishClose", "()V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)()>(&NioSocketImpl::tryFinishClose))},
	{"tryLock", "(Ljava/util/concurrent/locks/ReentrantLock;JLjava/util/concurrent/TimeUnit;)J", nullptr, $PRIVATE | $STATIC, $method(static_cast<int64_t(*)($ReentrantLock*,int64_t,$TimeUnit*)>(&NioSocketImpl::tryLock))},
	{"tryRead", "(Ljava/io/FileDescriptor;[BII)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($FileDescriptor*,$bytes*,int32_t,int32_t)>(&NioSocketImpl::tryRead)), "java.io.IOException"},
	{"tryWrite", "(Ljava/io/FileDescriptor;[BII)I", nullptr, $PRIVATE, $method(static_cast<int32_t(NioSocketImpl::*)($FileDescriptor*,$bytes*,int32_t,int32_t)>(&NioSocketImpl::tryWrite)), "java.io.IOException"},
	{"write", "([BII)V", nullptr, $PRIVATE, $method(static_cast<void(NioSocketImpl::*)($bytes*,int32_t,int32_t)>(&NioSocketImpl::write)), "java.io.IOException"},
	{}
};
