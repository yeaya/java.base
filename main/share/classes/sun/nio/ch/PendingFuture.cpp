...
$MethodInfo _PendingFuture_MethodInfo_[] = {
	{"<init>", "(Ljava/nio/channels/AsynchronousChannel;Ljava/nio/channels/CompletionHandler;Ljava/lang/Object;Ljava/lang/Object;)V", "(Ljava/nio/channels/AsynchronousChannel;Ljava/nio/channels/CompletionHandler<TV;-TA;>;TA;Ljava/lang/Object;)V", 0, $method(static_cast<void(PendingFuture::*)($AsynchronousChannel*,$CompletionHandler*,Object$*,Object$*)>(&PendingFuture::init$))},
	{"<init>", "(Ljava/nio/channels/AsynchronousChannel;Ljava/nio/channels/CompletionHandler;Ljava/lang/Object;)V", "(Ljava/nio/channels/AsynchronousChannel;Ljava/nio/channels/CompletionHandler<TV;-TA;>;TA;)V", 0, $method(static_cast<void(PendingFuture::*)($AsynchronousChannel*,$CompletionHandler*,Object$*)>(&PendingFuture::init$))},
	{"<init>", "(Ljava/nio/channels/AsynchronousChannel;)V", nullptr, 0, $method(static_cast<void(PendingFuture::*)($AsynchronousChannel*)>(&PendingFuture::init$))},
	{"<init>", "(Ljava/nio/channels/AsynchronousChannel;Ljava/lang/Object;)V", nullptr, 0, $method(static_cast<void(PendingFuture::*)($AsynchronousChannel*,Object$*)>(&PendingFuture::init$))},
	{"attachment", "()Ljava/lang/Object;", "()TA;", 0, $method(static_cast<$Object*(PendingFuture::*)()>(&PendingFuture::attachment))},
	{"cancel", "(Z)Z", nullptr, $PUBLIC},
	{"channel", "()Ljava/nio/channels/AsynchronousChannel;", nullptr, 0, $method(static_cast<$AsynchronousChannel*(PendingFuture::*)()>(&PendingFuture::channel))},
	{"exception", "()Ljava/lang/Throwable;", nullptr, 0, $method(static_cast<$Throwable*(PendingFuture::*)()>(&PendingFuture::exception))},
	{"get", "()Ljava/lang/Object;", "()TV;", $PUBLIC, nullptr, "java.util.concurrent.ExecutionException,java.lang.InterruptedException"},
	{"get", "(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;", "(JLjava/util/concurrent/TimeUnit;)TV;", $PUBLIC, nullptr, "java.util.concurrent.ExecutionException,java.lang.InterruptedException,java.util.concurrent.TimeoutException"},
	{"getContext", "()Ljava/lang/Object;", nullptr, 0, $method(static_cast<$Object*(PendingFuture::*)()>(&PendingFuture::getContext))},
	{"handler", "()Ljava/nio/channels/CompletionHandler;", "()Ljava/nio/channels/CompletionHandler<TV;-TA;>;", 0, $method(static_cast<$CompletionHandler*(PendingFuture::*)()>(&PendingFuture::handler))},
	{"isCancelled", "()Z", nullptr, $PUBLIC},
	{"isDone", "()Z", nullptr, $PUBLIC},
	{"prepareForWait", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(PendingFuture::*)()>(&PendingFuture::prepareForWait))},
	{"setContext", "(Ljava/lang/Object;)V", nullptr, 0, $method(static_cast<void(PendingFuture::*)(Object$*)>(&PendingFuture::setContext))},
	{"setFailure", "(Ljava/lang/Throwable;)V", nullptr, 0, $method(static_cast<void(PendingFuture::*)($Throwable*)>(&PendingFuture::setFailure))},
	{"setResult", "(Ljava/lang/Object;)V", "(TV;)V", 0, $method(static_cast<void(PendingFuture::*)(Object$*)>(&PendingFuture::setResult))},
	{"setResult", "(Ljava/lang/Object;Ljava/lang/Throwable;)V", "(TV;Ljava/lang/Throwable;)V", 0, $method(static_cast<void(PendingFuture::*)(Object$*,$Throwable*)>(&PendingFuture::setResult))},
	{"setTimeoutTask", "(Ljava/util/concurrent/Future;)V", "(Ljava/util/concurrent/Future<*>;)V", 0, $method(static_cast<void(PendingFuture::*)($Future*)>(&PendingFuture::setTimeoutTask))},
	{"value", "()Ljava/lang/Object;", "()TV;", 0, $method(static_cast<$Object*(PendingFuture::*)()>(&PendingFuture::value))},
	{}
};
