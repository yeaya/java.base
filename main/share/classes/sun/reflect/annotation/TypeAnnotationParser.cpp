...
$MethodInfo _TypeAnnotationParser_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TypeAnnotationParser::*)()>(&TypeAnnotationParser::init$))},
	{"buildAnnotatedInterfaces", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/Class;)[Ljava/lang/reflect/AnnotatedType;", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/Class<*>;)[Ljava/lang/reflect/AnnotatedType;", $PUBLIC | $STATIC, $method(static_cast<$AnnotatedTypeArray*(*)($bytes*,$ConstantPool*,$Class*)>(&TypeAnnotationParser::buildAnnotatedInterfaces))},
	{"buildAnnotatedSuperclass", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/Class;)Ljava/lang/reflect/AnnotatedType;", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/Class<*>;)Ljava/lang/reflect/AnnotatedType;", $PUBLIC | $STATIC, $method(static_cast<$AnnotatedType*(*)($bytes*,$ConstantPool*,$Class*)>(&TypeAnnotationParser::buildAnnotatedSuperclass))},
	{"buildAnnotatedType", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class;Ljava/lang/reflect/Type;Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTarget;)Ljava/lang/reflect/AnnotatedType;", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class<*>;Ljava/lang/reflect/Type;Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTarget;)Ljava/lang/reflect/AnnotatedType;", $PUBLIC | $STATIC, $method(static_cast<$AnnotatedType*(*)($bytes*,$ConstantPool*,$AnnotatedElement*,$Class*,$Type*,$TypeAnnotation$TypeAnnotationTarget*)>(&TypeAnnotationParser::buildAnnotatedType))},
	{"buildAnnotatedTypes", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class;[Ljava/lang/reflect/Type;Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTarget;)[Ljava/lang/reflect/AnnotatedType;", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class<*>;[Ljava/lang/reflect/Type;Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTarget;)[Ljava/lang/reflect/AnnotatedType;", $PUBLIC | $STATIC, $method(static_cast<$AnnotatedTypeArray*(*)($bytes*,$ConstantPool*,$AnnotatedElement*,$Class*,$TypeArray*,$TypeAnnotation$TypeAnnotationTarget*)>(&TypeAnnotationParser::buildAnnotatedTypes))},
	{"fetchBounds", "(Ljava/lang/reflect/GenericDeclaration;)Ljava/util/List;", "<D::Ljava/lang/reflect/GenericDeclaration;>(TD;)Ljava/util/List<Lsun/reflect/annotation/TypeAnnotation;>;", $PRIVATE | $STATIC, $method(static_cast<$List*(*)($GenericDeclaration*)>(&TypeAnnotationParser::fetchBounds))},
	{"mapTypeAnnotations", "([Lsun/reflect/annotation/TypeAnnotation;)Ljava/util/Map;", "([Lsun/reflect/annotation/TypeAnnotation;)Ljava/util/Map<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;Ljava/lang/annotation/Annotation;>;", $STATIC, $method(static_cast<$Map*(*)($TypeAnnotationArray*)>(&TypeAnnotationParser::mapTypeAnnotations))},
	{"parse2ByteTarget", "(Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTarget;Ljava/nio/ByteBuffer;)Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTargetInfo;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$TypeAnnotation$TypeAnnotationTargetInfo*(*)($TypeAnnotation$TypeAnnotationTarget*,$ByteBuffer*)>(&TypeAnnotationParser::parse2ByteTarget))},
	{"parseAllTypeAnnotations", "(Ljava/lang/reflect/AnnotatedElement;)[Lsun/reflect/annotation/TypeAnnotation;", nullptr, $STATIC, $method(static_cast<$TypeAnnotationArray*(*)($AnnotatedElement*)>(&TypeAnnotationParser::parseAllTypeAnnotations))},
	{"parseAnnotatedBounds", "([Ljava/lang/reflect/Type;Ljava/lang/reflect/GenericDeclaration;I)[Ljava/lang/reflect/AnnotatedType;", "<D::Ljava/lang/reflect/GenericDeclaration;>([Ljava/lang/reflect/Type;TD;I)[Ljava/lang/reflect/AnnotatedType;", $PUBLIC | $STATIC, $method(static_cast<$AnnotatedTypeArray*(*)($TypeArray*,$GenericDeclaration*,int32_t)>(&TypeAnnotationParser::parseAnnotatedBounds))},
	{"parseAnnotatedBounds", "([Ljava/lang/reflect/Type;Ljava/lang/reflect/GenericDeclaration;ILsun/reflect/annotation/TypeAnnotation$LocationInfo;)[Ljava/lang/reflect/AnnotatedType;", "<D::Ljava/lang/reflect/GenericDeclaration;>([Ljava/lang/reflect/Type;TD;ILsun/reflect/annotation/TypeAnnotation$LocationInfo;)[Ljava/lang/reflect/AnnotatedType;", $PRIVATE | $STATIC, $method(static_cast<$AnnotatedTypeArray*(*)($TypeArray*,$GenericDeclaration*,int32_t,$TypeAnnotation$LocationInfo*)>(&TypeAnnotationParser::parseAnnotatedBounds))},
	{"parseShortTarget", "(Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTarget;Ljava/nio/ByteBuffer;)Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTargetInfo;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$TypeAnnotation$TypeAnnotationTargetInfo*(*)($TypeAnnotation$TypeAnnotationTarget*,$ByteBuffer*)>(&TypeAnnotationParser::parseShortTarget))},
	{"parseTargetInfo", "(Ljava/nio/ByteBuffer;)Lsun/reflect/annotation/TypeAnnotation$TypeAnnotationTargetInfo;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$TypeAnnotation$TypeAnnotationTargetInfo*(*)($ByteBuffer*)>(&TypeAnnotationParser::parseTargetInfo))},
	{"parseTypeAnnotation", "(Ljava/nio/ByteBuffer;Ljdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class;)Lsun/reflect/annotation/TypeAnnotation;", "(Ljava/nio/ByteBuffer;Ljdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class<*>;)Lsun/reflect/annotation/TypeAnnotation;", $PRIVATE | $STATIC, $method(static_cast<$TypeAnnotation*(*)($ByteBuffer*,$ConstantPool*,$AnnotatedElement*,$Class*)>(&TypeAnnotationParser::parseTypeAnnotation))},
	{"parseTypeAnnotations", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class;)[Lsun/reflect/annotation/TypeAnnotation;", "([BLjdk/internal/reflect/ConstantPool;Ljava/lang/reflect/AnnotatedElement;Ljava/lang/Class<*>;)[Lsun/reflect/annotation/TypeAnnotation;", $PRIVATE | $STATIC, $method(static_cast<$TypeAnnotationArray*(*)($bytes*,$ConstantPool*,$AnnotatedElement*,$Class*)>(&TypeAnnotationParser::parseTypeAnnotations))},
	{"parseTypeVariableAnnotations", "(Ljava/lang/reflect/GenericDeclaration;I)[Ljava/lang/annotation/Annotation;", "<D::Ljava/lang/reflect/GenericDeclaration;>(TD;I)[Ljava/lang/annotation/Annotation;", $PUBLIC | $STATIC, $method(static_cast<$AnnotationArray*(*)($GenericDeclaration*,int32_t)>(&TypeAnnotationParser::parseTypeVariableAnnotations))},
	{}
};
