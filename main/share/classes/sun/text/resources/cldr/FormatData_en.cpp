...
$ObjectArray2* FormatData_en::getContents() {
	...
	$var($StringArray, metaValue_japanese_QuarterNarrows, $new($StringArray, {
		"1"_s,
		"2"_s,
		"3"_s,
		"4"_s
	...
	$var($String, metaValue_calendarname_gregorian, "Gregorian Calendar"_s);
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of(metaValue_japanese_QuarterNarrows)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of($$new($StringArray, {
				...
				""_s,
				""_s,
				"{one:0\' \'thousand other:0\' \'thousand}"_s,
				"{one:00\' \'thousand other:00\' \'thousand}"_s,
				"{one:000\' \'thousand other:000\' \'thousand}"_s,
				"{one:0\' \'million other:0\' \'million}"_s,
				"{one:00\' \'million other:00\' \'million}"_s,
				"{one:000\' \'million other:000\' \'million}"_s,
				"{one:0\' \'billion other:0\' \'billion}"_s,
				"{one:00\' \'billion other:00\' \'billion}"_s,
				"{one:000\' \'billion other:000\' \'billion}"_s,
