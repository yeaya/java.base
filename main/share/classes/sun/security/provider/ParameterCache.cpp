...
void ParameterCache::clinit$($Class* clazz) {
	$useLocalObjectStack();
	{
		$assignStatic(ParameterCache::dhCache, $cast($AbstractMap, $new($ConcurrentHashMap)));
		$assignStatic(ParameterCache::dsaCache, $cast($AbstractMap, $new($ConcurrentHashMap)));
		...
		$var($Object, var$0, $Integer::valueOf(512 + 160));
		ParameterCache::dsaCache->put(var$0, $$new($DSAParameterSpec, p512, q512, g512));
		$var($Object, var$1, $Integer::valueOf(768 + 160));
		ParameterCache::dsaCache->put(var$1, $$new($DSAParameterSpec, p768, q768, g768));
		$var($Object, var$2, $Integer::valueOf(1024 + 160));
		ParameterCache::dsaCache->put(var$2, $$new($DSAParameterSpec, p1024, q1024, g1024));
		...
		$var($Object, var$3, $Integer::valueOf(2048 + 224));
		ParameterCache::dsaCache->put(var$3, $$new($DSAParameterSpec, p2048_224, q2048_224, g2048_224));
		...
		$var($Object, var$4, $Integer::valueOf(2048 + 256));
		ParameterCache::dsaCache->put(var$4, $$new($DSAParameterSpec, p2048_256, q2048_256, g2048_256));
		...
		$var($Object, var$5, $Integer::valueOf(3072 + 256));
		ParameterCache::dsaCache->put(var$5, $$new($DSAParameterSpec, p3072_256, q3072_256, g3072_256));
		...
		$var($Object, var$6, $Integer::valueOf(512));
		ParameterCache::dhCache->put(var$6, $$new($DHParameterSpec, p512, g512));
		$var($Object, var$7, $Integer::valueOf(768));
		ParameterCache::dhCache->put(var$7, $$new($DHParameterSpec, dhP768, dhG));
		$var($Object, var$8, $Integer::valueOf(1024));
		ParameterCache::dhCache->put(var$8, $$new($DHParameterSpec, dhP1024, dhG));
		$var($Object, var$9, $Integer::valueOf(1536));
		ParameterCache::dhCache->put(var$9, $$new($DHParameterSpec, dhP1536, dhG));
		$var($Object, var$10, $Integer::valueOf(2048));
		ParameterCache::dhCache->put(var$10, $$new($DHParameterSpec, dhP2048, dhG));
		$var($Object, var$11, $Integer::valueOf(3072));
		ParameterCache::dhCache->put(var$11, $$new($DHParameterSpec, dhP3072, dhG));
		$var($Object, var$12, $Integer::valueOf(4096));
		ParameterCache::dhCache->put(var$12, $$new($DHParameterSpec, dhP4096, dhG));
		$var($Object, var$13, $Integer::valueOf(6144));
		ParameterCache::dhCache->put(var$13, $$new($DHParameterSpec, dhP6144, dhG));
		$var($Object, var$14, $Integer::valueOf(8192));
		ParameterCache::dhCache->put(var$14, $$new($DHParameterSpec, dhP8192, dhG));
	}
}
...
$Class* ParameterCache::load$($String* name, bool initialize) {
	...
	$loadClass(ParameterCache, name, initialize, &classInfo$$, ParameterCache::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ParameterCache);
	});
	return class$;
}
