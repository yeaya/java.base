...
$MethodInfo _RevocationChecker_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(RevocationChecker::*)()>(&RevocationChecker::init$))},
	{"<init>", "(Ljava/security/cert/TrustAnchor;Lsun/security/provider/certpath/PKIX$ValidatorParams;)V", nullptr, 0, $method(static_cast<void(RevocationChecker::*)($TrustAnchor*,$PKIX$ValidatorParams*)>(&RevocationChecker::init$)), "java.security.cert.CertPathValidatorException"},
	{"buildToNewKey", "(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Set;)V", "(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Set<Ljava/security/cert/X509Certificate;>;)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$PublicKey*,$Set*)>(&RevocationChecker::buildToNewKey)), "java.security.cert.CertPathValidatorException"},
	{"certCanSignCrl", "(Ljava/security/cert/X509Certificate;)Z", nullptr, $STATIC, $method(static_cast<bool(*)($X509Certificate*)>(&RevocationChecker::certCanSignCrl))},
	...
	{"check", "(Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/PublicKey;Z)V", "(Ljava/security/cert/X509Certificate;Ljava/util/Collection<Ljava/lang/String;>;Ljava/security/PublicKey;Z)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$Collection*,$PublicKey*,bool)>(&RevocationChecker::check)), "java.security.cert.CertPathValidatorException"},
	{"checkApprovedCRLs", "(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V", "(Ljava/security/cert/X509Certificate;Ljava/util/Set<Ljava/security/cert/X509CRL;>;)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$Set*)>(&RevocationChecker::checkApprovedCRLs)), "java.security.cert.CertPathValidatorException"},
	{"checkCRLs", "(Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/util/Set;Ljava/security/PublicKey;Z)V", "(Ljava/security/cert/X509Certificate;Ljava/util/Collection<Ljava/lang/String;>;Ljava/util/Set<Ljava/security/cert/X509Certificate;>;Ljava/security/PublicKey;Z)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$Collection*,$Set*,$PublicKey*,bool)>(&RevocationChecker::checkCRLs)), "java.security.cert.CertPathValidatorException"},
	{"checkCRLs", "(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/security/cert/X509Certificate;ZZLjava/util/Set;Ljava/util/Set;)V", "(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/security/cert/X509Certificate;ZZLjava/util/Set<Ljava/security/cert/X509Certificate;>;Ljava/util/Set<Ljava/security/cert/TrustAnchor;>;)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$PublicKey*,$X509Certificate*,bool,bool,$Set*,$Set*)>(&RevocationChecker::checkCRLs)), "java.security.cert.CertPathValidatorException"},
	{"checkOCSP", "(Ljava/security/cert/X509Certificate;Ljava/util/Collection;)V", "(Ljava/security/cert/X509Certificate;Ljava/util/Collection<Ljava/lang/String;>;)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$Collection*)>(&RevocationChecker::checkOCSP)), "java.security.cert.CertPathValidatorException"},
	{"getResponderCert", "(Lsun/security/provider/certpath/RevocationChecker$RevocationProperties;Ljava/util/Set;Ljava/util/List;)Ljava/security/cert/X509Certificate;", "(Lsun/security/provider/certpath/RevocationChecker$RevocationProperties;Ljava/util/Set<Ljava/security/cert/TrustAnchor;>;Ljava/util/List<Ljava/security/cert/CertStore;>;)Ljava/security/cert/X509Certificate;", $PRIVATE | $STATIC, $method(static_cast<$X509Certificate*(*)($RevocationChecker$RevocationProperties*,$Set*,$List*)>(&RevocationChecker::getResponderCert)), "java.security.cert.CertPathValidatorException"},
	{"getResponderCert", "(Ljava/lang/String;Ljava/util/Set;Ljava/util/List;)Ljava/security/cert/X509Certificate;", "(Ljava/lang/String;Ljava/util/Set<Ljava/security/cert/TrustAnchor;>;Ljava/util/List<Ljava/security/cert/CertStore;>;)Ljava/security/cert/X509Certificate;", $PRIVATE | $STATIC, $method(static_cast<$X509Certificate*(*)($String*,$Set*,$List*)>(&RevocationChecker::getResponderCert)), "java.security.cert.CertPathValidatorException"},
	{"getResponderCert", "(Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Ljava/util/List;)Ljava/security/cert/X509Certificate;", "(Ljava/lang/String;Ljava/lang/String;Ljava/util/Set<Ljava/security/cert/TrustAnchor;>;Ljava/util/List<Ljava/security/cert/CertStore;>;)Ljava/security/cert/X509Certificate;", $PRIVATE | $STATIC, $method(static_cast<$X509Certificate*(*)($String*,$String*,$Set*,$List*)>(&RevocationChecker::getResponderCert)), "java.security.cert.CertPathValidatorException"},
	{"getResponderCert", "(Ljava/security/cert/X509CertSelector;Ljava/util/Set;Ljava/util/List;)Ljava/security/cert/X509Certificate;", "(Ljava/security/cert/X509CertSelector;Ljava/util/Set<Ljava/security/cert/TrustAnchor;>;Ljava/util/List<Ljava/security/cert/CertStore;>;)Ljava/security/cert/X509Certificate;", $PRIVATE | $STATIC, $method(static_cast<$X509Certificate*(*)($X509CertSelector*,$Set*,$List*)>(&RevocationChecker::getResponderCert)), "java.security.cert.CertPathValidatorException"},
	{"getRevocationProperties", "()Lsun/security/provider/certpath/RevocationChecker$RevocationProperties;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$RevocationChecker$RevocationProperties*(*)()>(&RevocationChecker::getRevocationProperties))},
	{"getSoftFailExceptions", "()Ljava/util/List;", "()Ljava/util/List<Ljava/security/cert/CertPathValidatorException;>;", $PUBLIC},
	{"getSupportedExtensions", "()Ljava/util/Set;", "()Ljava/util/Set<Ljava/lang/String;>;", $PUBLIC},
	{"init", "(Ljava/security/cert/TrustAnchor;Lsun/security/provider/certpath/PKIX$ValidatorParams;)V", nullptr, 0, nullptr, "java.security.cert.CertPathValidatorException"},
	{"init", "(Z)V", nullptr, $PUBLIC, nullptr, "java.security.cert.CertPathValidatorException"},
	{"isCausedByNetworkIssue", "(Ljava/lang/String;Ljava/security/cert/CertStoreException;)Z", nullptr, $STATIC, $method(static_cast<bool(*)($String*,$CertStoreException*)>(&RevocationChecker::isCausedByNetworkIssue))},
	{"isForwardCheckingSupported", "()Z", nullptr, $PUBLIC},
	{"isSoftFailException", "(Ljava/security/cert/CertPathValidatorException;)Z", nullptr, $PRIVATE, $method(static_cast<bool(RevocationChecker::*)($CertPathValidatorException*)>(&RevocationChecker::isSoftFailException))},
	{"stripOutSeparators", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&RevocationChecker::stripOutSeparators))},
	{"toURI", "(Ljava/lang/String;)Ljava/net/URI;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$URI*(*)($String*)>(&RevocationChecker::toURI)), "java.security.cert.CertPathValidatorException"},
	{"updateState", "(Ljava/security/cert/X509Certificate;)V", nullptr, $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*)>(&RevocationChecker::updateState)), "java.security.cert.CertPathValidatorException"},
	{"verifyPossibleCRLs", "(Ljava/util/Set;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Z[ZLjava/util/Set;)Ljava/util/Collection;", "(Ljava/util/Set<Ljava/security/cert/X509CRL;>;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Z[ZLjava/util/Set<Ljava/security/cert/TrustAnchor;>;)Ljava/util/Collection<Ljava/security/cert/X509CRL;>;", $PRIVATE, $method(static_cast<$Collection*(RevocationChecker::*)($Set*,$X509Certificate*,$PublicKey*,bool,$booleans*,$Set*)>(&RevocationChecker::verifyPossibleCRLs)), "java.security.cert.CertPathValidatorException"},
	{"verifyWithSeparateSigningKey", "(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;ZLjava/util/Set;)V", "(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;ZLjava/util/Set<Ljava/security/cert/X509Certificate;>;)V", $PRIVATE, $method(static_cast<void(RevocationChecker::*)($X509Certificate*,$PublicKey*,bool,$Set*)>(&RevocationChecker::verifyWithSeparateSigningKey)), "java.security.cert.CertPathValidatorException"},
	{}
};
