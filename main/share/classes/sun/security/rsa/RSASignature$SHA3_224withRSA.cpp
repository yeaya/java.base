...
$Class* RSASignature$SHA3_224withRSA::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(RSASignature$SHA3_224withRSA, init$, void)},
		{}
	};
	...
	$loadClass(RSASignature$SHA3_224withRSA, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(RSASignature$SHA3_224withRSA);
	});
	return class$;
}
