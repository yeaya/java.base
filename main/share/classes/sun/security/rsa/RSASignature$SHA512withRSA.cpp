...
$Class* RSASignature$SHA512withRSA::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(RSASignature$SHA512withRSA, init$, void)},
		{}
	};
	...
	$loadClass(RSASignature$SHA512withRSA, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(RSASignature$SHA512withRSA);
	});
	return class$;
}
