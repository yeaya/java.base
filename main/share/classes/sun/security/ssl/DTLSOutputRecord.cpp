...
$MethodInfo _DTLSOutputRecord_MethodInfo_[] = {
	...
	{"<init>", "(Lsun/security/ssl/HandshakeHash;)V", nullptr, 0, $method(static_cast<void(DTLSOutputRecord::*)($HandshakeHash*)>(&DTLSOutputRecord::init$))},
	{"acquireCiphertext", "(Ljava/nio/ByteBuffer;)Lsun/security/ssl/Ciphertext;", nullptr, $PRIVATE, $method(static_cast<$Ciphertext*(DTLSOutputRecord::*)($ByteBuffer*)>(&DTLSOutputRecord::acquireCiphertext)), "java.io.IOException"},
	...
	{"encode", "([Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;)Lsun/security/ssl/Ciphertext;", nullptr, $PRIVATE, $method(static_cast<$Ciphertext*(DTLSOutputRecord::*)($ByteBufferArray*,int32_t,int32_t,$ByteBuffer*)>(&DTLSOutputRecord::encode)), "java.io.IOException"},
