#ifndef _sun_security_ssl_SSLCipher$T13GcmReadCipherGenerator$GcmReadCipher_h_
#define _sun_security_ssl_SSLCipher$T13GcmReadCipherGenerator$GcmReadCipher_h_
//$ class sun.security.ssl.SSLCipher$T13GcmReadCipherGenerator$GcmReadCipher
...
class SSLCipher$T13GcmReadCipherGenerator$GcmReadCipher : public ::sun::security::ssl::SSLCipher$SSLReadCipher {
	$class(SSLCipher$T13GcmReadCipherGenerator$GcmReadCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLReadCipher)
public:
...
#endif // _sun_security_ssl_SSLCipher$T13GcmReadCipherGenerator$GcmReadCipher_h_