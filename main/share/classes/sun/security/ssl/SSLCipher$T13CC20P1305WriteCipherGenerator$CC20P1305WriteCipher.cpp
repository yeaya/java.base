...
$Class* SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher::load$($String* name, bool initialize) {
	...
	$loadClass(SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher);
	});
	return class$;
}
