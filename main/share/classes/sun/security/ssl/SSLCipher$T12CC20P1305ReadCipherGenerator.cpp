...
using $SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher = ::sun::security::ssl::SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher;
...
$SSLCipher$SSLReadCipher* SSLCipher$T12CC20P1305ReadCipherGenerator::createCipher($SSLCipher* sslCipher, $Authenticator* authenticator, $ProtocolVersion* protocolVersion, $String* algorithm, $Key* key, $AlgorithmParameterSpec* params, $SecureRandom* random) {
	return $new($SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher, authenticator, protocolVersion, sslCipher, algorithm, key, params, random);
}

SSLCipher$T12CC20P1305ReadCipherGenerator::SSLCipher$T12CC20P1305ReadCipherGenerator() {
}
...
$Class* SSLCipher$T12CC20P1305ReadCipherGenerator::class$ = nullptr;
