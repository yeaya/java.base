#ifndef _sun_security_ssl_SSLCipher$T11BlockReadCipherGenerator_h_
#define _sun_security_ssl_SSLCipher$T11BlockReadCipherGenerator_h_
//$ class sun.security.ssl.SSLCipher$T11BlockReadCipherGenerator
...
class SSLCipher$T11BlockReadCipherGenerator : public ::sun::security::ssl::SSLCipher$ReadCipherGenerator {
	$class(SSLCipher$T11BlockReadCipherGenerator, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$ReadCipherGenerator)
public:
...
#endif // _sun_security_ssl_SSLCipher$T11BlockReadCipherGenerator_h_