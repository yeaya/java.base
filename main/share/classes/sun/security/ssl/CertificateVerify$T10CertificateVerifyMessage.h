#ifndef _sun_security_ssl_CertificateVerify$T10CertificateVerifyMessage_h_
#define _sun_security_ssl_CertificateVerify$T10CertificateVerifyMessage_h_
//$ class sun.security.ssl.CertificateVerify$T10CertificateVerifyMessage
...
class CertificateVerify$T10CertificateVerifyMessage : public ::sun::security::ssl::SSLHandshake$HandshakeMessage {
	$class(CertificateVerify$T10CertificateVerifyMessage, $NO_CLASS_INIT, ::sun::security::ssl::SSLHandshake$HandshakeMessage)
public:
...
#endif // _sun_security_ssl_CertificateVerify$T10CertificateVerifyMessage_h_