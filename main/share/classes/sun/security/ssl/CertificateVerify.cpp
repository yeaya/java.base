...
void CertificateVerify::clinit$($Class* clazz) {
...
$Class* CertificateVerify::load$($String* name, bool initialize) {
	...
	$loadClass(CertificateVerify, name, initialize, &classInfo$$, CertificateVerify::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CertificateVerify);
	});
	return class$;
}
