#ifndef _sun_security_ssl_SSLCipher$T12GcmReadCipherGenerator_h_
#define _sun_security_ssl_SSLCipher$T12GcmReadCipherGenerator_h_
//$ class sun.security.ssl.SSLCipher$T12GcmReadCipherGenerator
...
class SSLCipher$T12GcmReadCipherGenerator : public ::sun::security::ssl::SSLCipher$ReadCipherGenerator {
	$class(SSLCipher$T12GcmReadCipherGenerator, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$ReadCipherGenerator)
public:
...
#endif // _sun_security_ssl_SSLCipher$T12GcmReadCipherGenerator_h_