#ifndef _sun_security_ssl_NamedGroup$XDHScheme_h_
#define _sun_security_ssl_NamedGroup$XDHScheme_h_
//$ class sun.security.ssl.NamedGroup$XDHScheme
...
class NamedGroup$XDHScheme : public ::sun::security::ssl::NamedGroup$NamedGroupScheme {
...
public:
	...
	virtual $bytes* encodePossessionPublicKey(::sun::security::ssl::NamedGroupPossession* poss) override;
	static ::sun::security::ssl::NamedGroup$XDHScheme* instance;
};
...
#endif // _sun_security_ssl_NamedGroup$XDHScheme_h_