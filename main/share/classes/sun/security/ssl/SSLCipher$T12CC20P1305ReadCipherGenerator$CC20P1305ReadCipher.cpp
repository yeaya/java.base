...
$FieldInfo _SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_FieldInfo_[] = {
...
$MethodInfo _SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_MethodInfo_[] = {
	{"<init>", "(Lsun/security/ssl/Authenticator;Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/SSLCipher;Ljava/lang/String;Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V", nullptr, 0, $method(static_cast<void(SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher::*)($Authenticator*,$ProtocolVersion*,$SSLCipher*,$String*,$Key*,$AlgorithmParameterSpec*,$SecureRandom*)>(&SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher::init$)), "java.security.GeneralSecurityException"},
...
$InnerClassInfo _SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_InnerClassesInfo_[] = {
...
$ClassInfo _SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_ClassInfo_ = {
	$FINAL | $ACC_SUPER,
	"sun.security.ssl.SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher",
	"sun.security.ssl.SSLCipher$SSLReadCipher",
	nullptr,
	_SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_FieldInfo_,
	_SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_MethodInfo_,
	nullptr,
	nullptr,
	_SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher($Class* clazz) {
	return $of($alloc(SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher));
}
...
$Plaintext* SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher::decrypt(int8_t contentType, $ByteBuffer* bb, $bytes* sequence) {
	...
	$var($bytes, aad, $nc(this->authenticator)->acquireAuthenticationBytes(contentType, $nc(bb)->remaining() - this->tagSize, sequence));
...
$Class* SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher::load$($String* name, bool initialize) {
	$loadClass(SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher, name, initialize, &_SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_ClassInfo_, allocate$SSLCipher$T12CC20P1305ReadCipherGenerator$CC20P1305ReadCipher);
	return class$;
}
