#ifndef _sun_security_ssl_SSLCipher$StreamReadCipherGenerator$StreamReadCipher_h_
#define _sun_security_ssl_SSLCipher$StreamReadCipherGenerator$StreamReadCipher_h_
//$ class sun.security.ssl.SSLCipher$StreamReadCipherGenerator$StreamReadCipher
...
class SSLCipher$StreamReadCipherGenerator$StreamReadCipher : public ::sun::security::ssl::SSLCipher$SSLReadCipher {
	$class(SSLCipher$StreamReadCipherGenerator$StreamReadCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLReadCipher)
public:
...
#endif // _sun_security_ssl_SSLCipher$StreamReadCipherGenerator$StreamReadCipher_h_