...
$MethodInfo _OutputRecord_MethodInfo_[] = {
	...
	{"<init>", "(Lsun/security/ssl/HandshakeHash;Lsun/security/ssl/SSLCipher$SSLWriteCipher;)V", nullptr, 0, $method(static_cast<void(OutputRecord::*)($HandshakeHash*,$SSLCipher$SSLWriteCipher*)>(&OutputRecord::init$))},
	{"V3toV2CipherSuite", "(Ljava/nio/ByteBuffer;BB)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($ByteBuffer*,int8_t,int8_t)>(&OutputRecord::V3toV2CipherSuite))},
	{"calculateFragmentSize", "(I)I", nullptr, 0},
	{"changeFragmentSize", "(I)V", nullptr, 0},
	{"changePacketSize", "(I)V", nullptr, 0},
	{"changeWriteCiphers", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;Z)V", nullptr, 0, nullptr, "java.io.IOException"},
	{"changeWriteCiphers", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;B)V", nullptr, 0, nullptr, "java.io.IOException"},
	{"close", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"d10Encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BLjava/nio/ByteBuffer;IIILsun/security/ssl/ProtocolVersion;)J", nullptr, $PRIVATE | $STATIC, $method(static_cast<int64_t(*)($SSLCipher$SSLWriteCipher*,int8_t,$ByteBuffer*,int32_t,int32_t,int32_t,$ProtocolVersion*)>(&OutputRecord::d10Encrypt))},
	{"d13Encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BLjava/nio/ByteBuffer;IIILsun/security/ssl/ProtocolVersion;)J", nullptr, $PRIVATE | $STATIC, $method(static_cast<int64_t(*)($SSLCipher$SSLWriteCipher*,int8_t,$ByteBuffer*,int32_t,int32_t,int32_t,$ProtocolVersion*)>(&OutputRecord::d13Encrypt))},
	...
	{"encodeAlert", "(BB)V", nullptr, $ABSTRACT, nullptr, "java.io.IOException"},
	{"encodeChangeCipherSpec", "()V", nullptr, $ABSTRACT, nullptr, "java.io.IOException"},
	{"encodeHandshake", "([BII)V", nullptr, $ABSTRACT, nullptr, "java.io.IOException"},
	{"encodeV2ClientHello", "([BII)Ljava/nio/ByteBuffer;", nullptr, $STATIC, $method(static_cast<$ByteBuffer*(*)($bytes*,int32_t,int32_t)>(&OutputRecord::encodeV2ClientHello)), "java.io.IOException"},
	{"encodeV2NoCipher", "()V", nullptr, 0, nullptr, "java.io.IOException"},
	{"encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BLjava/nio/ByteBuffer;IIILsun/security/ssl/ProtocolVersion;)J", nullptr, $STATIC, $method(static_cast<int64_t(*)($SSLCipher$SSLWriteCipher*,int8_t,$ByteBuffer*,int32_t,int32_t,int32_t,$ProtocolVersion*)>(&OutputRecord::encrypt))},
	{"encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BI)J", nullptr, 0},
	{"finishHandshake", "()V", nullptr, 0},
	{"getMaxPacketSize", "()I", nullptr, 0},
	{"initHandshaker", "()V", nullptr, 0},
	{"isClosed", "()Z", nullptr, 0},
	{"isEmpty", "()Z", nullptr, 0},
	{"launchRetransmission", "()V", nullptr, 0},
	...
	{"t10Encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BLjava/nio/ByteBuffer;IIILsun/security/ssl/ProtocolVersion;)J", nullptr, $PRIVATE | $STATIC, $method(static_cast<int64_t(*)($SSLCipher$SSLWriteCipher*,int8_t,$ByteBuffer*,int32_t,int32_t,int32_t,$ProtocolVersion*)>(&OutputRecord::t10Encrypt))},
	{"t10Encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BI)J", nullptr, $PRIVATE, $method(static_cast<int64_t(OutputRecord::*)($SSLCipher$SSLWriteCipher*,int8_t,int32_t)>(&OutputRecord::t10Encrypt))},
	{"t13Encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BLjava/nio/ByteBuffer;IIILsun/security/ssl/ProtocolVersion;)J", nullptr, $PRIVATE | $STATIC, $method(static_cast<int64_t(*)($SSLCipher$SSLWriteCipher*,int8_t,$ByteBuffer*,int32_t,int32_t,int32_t,$ProtocolVersion*)>(&OutputRecord::t13Encrypt))},
	{"t13Encrypt", "(Lsun/security/ssl/SSLCipher$SSLWriteCipher;BI)J", nullptr, $PRIVATE, $method(static_cast<int64_t(OutputRecord::*)($SSLCipher$SSLWriteCipher*,int8_t,int32_t)>(&OutputRecord::t13Encrypt))},
