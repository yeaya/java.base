#ifndef _sun_security_ssl_SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher_h_
#define _sun_security_ssl_SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher_h_
//$ class sun.security.ssl.SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher
...
class SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher : public ::sun::security::ssl::SSLCipher$SSLWriteCipher {
	$class(SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLWriteCipher)
public:
	SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher();
...
#endif // _sun_security_ssl_SSLCipher$T13CC20P1305WriteCipherGenerator$CC20P1305WriteCipher_h_