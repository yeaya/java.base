#ifndef _sun_security_ssl_Finished$T12FinishedConsumer_h_
#define _sun_security_ssl_Finished$T12FinishedConsumer_h_
//$ class sun.security.ssl.Finished$T12FinishedConsumer
...
class Finished$T12FinishedConsumer : public ::sun::security::ssl::SSLConsumer {
	$class(Finished$T12FinishedConsumer, $NO_CLASS_INIT, ::sun::security::ssl::SSLConsumer)
public:
...
#endif // _sun_security_ssl_Finished$T12FinishedConsumer_h_