...
$MethodInfo _CertSignAlgsExtension$CHCertSignatureSchemesProducer_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(CertSignAlgsExtension$CHCertSignatureSchemesProducer::*)()>(&CertSignAlgsExtension$CHCertSignatureSchemesProducer::init$))},
