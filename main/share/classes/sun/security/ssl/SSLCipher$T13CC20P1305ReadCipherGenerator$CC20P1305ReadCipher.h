#ifndef _sun_security_ssl_SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_h_
#define _sun_security_ssl_SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_h_
//$ class sun.security.ssl.SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher
...
class SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher : public ::sun::security::ssl::SSLCipher$SSLReadCipher {
	$class(SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLReadCipher)
public:
	SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher();
...
#endif // _sun_security_ssl_SSLCipher$T13CC20P1305ReadCipherGenerator$CC20P1305ReadCipher_h_