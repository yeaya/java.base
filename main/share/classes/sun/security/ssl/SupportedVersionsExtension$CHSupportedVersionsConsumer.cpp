...
$MethodInfo _SupportedVersionsExtension$CHSupportedVersionsConsumer_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(SupportedVersionsExtension$CHSupportedVersionsConsumer::*)()>(&SupportedVersionsExtension$CHSupportedVersionsConsumer::init$))},
