...
CipherSuite* CipherSuite::nameOf($String* ciperSuiteName) {
	...
	for (int32_t len$ = arr$->length, i$ = 0; i$ < len$; ++i$) {
		CipherSuite* cs = arr$->get(i$);
		{
			...
			if (var$0 || $nc(cs->aliases)->contains(ciperSuiteName)) {
				return cs;
			}
		}
	}
...
$Collection* CipherSuite::allowedCipherSuites() {
	$init(CipherSuite);
	$useLocalObjectStack();
	$var($Collection, cipherSuites, $cast($AbstractCollection, $new($LinkedList)));
	{
		$var($CipherSuiteArray, arr$, CipherSuite::values());
		for (int32_t len$ = arr$->length, i$ = 0; i$ < len$; ++i$) {
			CipherSuite* cs = arr$->get(i$);
...
void CipherSuite::clinit$($Class* clazz) {
	$init($ProtocolVersion);
	$init($SSLCipher);
...
$Class* CipherSuite::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"$values", "()[Lsun/security/ssl/CipherSuite;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(CipherSuite, $values, $CipherSuiteArray*)},
		{"<init>", "(Ljava/lang/String;ILjava/lang/String;I)V", "(Ljava/lang/String;I)V", $PRIVATE, $method(CipherSuite, init$, void, $String*, int32_t, $String*, int32_t)},
		{"<init>", "(Ljava/lang/String;IIZLjava/lang/String;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/SSLCipher;Lsun/security/ssl/CipherSuite$HashAlg;)V", "(IZLjava/lang/String;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/SSLCipher;Lsun/security/ssl/CipherSuite$HashAlg;)V", $PRIVATE, $method(CipherSuite, init$, void, $String*, int32_t, int32_t, bool, $String*, $ProtocolVersionArray*, $SSLCipher*, $CipherSuite$HashAlg*)},
		{"<init>", "(Ljava/lang/String;IIZLjava/lang/String;Ljava/lang/String;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/CipherSuite$KeyExchange;Lsun/security/ssl/SSLCipher;Lsun/security/ssl/CipherSuite$MacAlg;Lsun/security/ssl/CipherSuite$HashAlg;)V", "(IZLjava/lang/String;Ljava/lang/String;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/CipherSuite$KeyExchange;Lsun/security/ssl/SSLCipher;Lsun/security/ssl/CipherSuite$MacAlg;Lsun/security/ssl/CipherSuite$HashAlg;)V", $PRIVATE, $method(CipherSuite, init$, void, $String*, int32_t, int32_t, bool, $String*, $String*, $ProtocolVersionArray*, $CipherSuite$KeyExchange*, $SSLCipher*, $CipherSuite$MacAlg*, $CipherSuite$HashAlg*)},
		{"allowedCipherSuites", "()Ljava/util/Collection;", "()Ljava/util/Collection<Lsun/security/ssl/CipherSuite;>;", $STATIC, $staticMethod(CipherSuite, allowedCipherSuites, $Collection*)},
		{"calculateFragSize", "(ILsun/security/ssl/ProtocolVersion;Z)I", nullptr, 0, $method(CipherSuite, calculateFragSize, int32_t, int32_t, $ProtocolVersion*, bool)},
		{"calculatePacketSize", "(ILsun/security/ssl/ProtocolVersion;Z)I", nullptr, 0, $method(CipherSuite, calculatePacketSize, int32_t, int32_t, $ProtocolVersion*, bool)},
		{"defaultCipherSuites", "()Ljava/util/Collection;", "()Ljava/util/Collection<Lsun/security/ssl/CipherSuite;>;", $STATIC, $staticMethod(CipherSuite, defaultCipherSuites, $Collection*)},
		{"isAnonymous", "()Z", nullptr, 0, $method(CipherSuite, isAnonymous, bool)},
		{"isAvailable", "()Z", nullptr, 0, $method(CipherSuite, isAvailable, bool)},
		{"isNegotiable", "()Z", nullptr, 0, $method(CipherSuite, isNegotiable, bool)},
		{"nameOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite;", nullptr, $STATIC, $staticMethod(CipherSuite, nameOf, CipherSuite*, $String*)},
		{"nameOf", "(I)Ljava/lang/String;", nullptr, $STATIC, $staticMethod(CipherSuite, nameOf, $String*, int32_t)},
		{"namesOf", "(Ljava/util/List;)[Ljava/lang/String;", "(Ljava/util/List<Lsun/security/ssl/CipherSuite;>;)[Ljava/lang/String;", $STATIC, $staticMethod(CipherSuite, namesOf, $StringArray*, $List*)},
		{"supports", "(Lsun/security/ssl/ProtocolVersion;)Z", nullptr, $PUBLIC, $method(CipherSuite, supports, bool, $ProtocolVersion*)},
		{"validValuesOf", "([Ljava/lang/String;)Ljava/util/List;", "([Ljava/lang/String;)Ljava/util/List<Lsun/security/ssl/CipherSuite;>;", $STATIC, $staticMethod(CipherSuite, validValuesOf, $List*, $StringArray*)},
		{"valueOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite;", nullptr, $PUBLIC | $STATIC, $staticMethod(CipherSuite, valueOf, CipherSuite*, $String*)},
		{"valueOf", "(I)Lsun/security/ssl/CipherSuite;", nullptr, $STATIC, $staticMethod(CipherSuite, valueOf, CipherSuite*, int32_t)},
		{"values", "()[Lsun/security/ssl/CipherSuite;", nullptr, $PUBLIC | $STATIC, $staticMethod(CipherSuite, values, $CipherSuiteArray*)},
		{}
	};
	...
	$loadClass(CipherSuite, name, initialize, &classInfo$$, CipherSuite::clinit$, []($Class* clazz) -> $Object* {
