...
$MethodInfo _SSLExtension_MethodInfo_[] = {
	{"$values", "()[Lsun/security/ssl/SSLExtension;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$SSLExtensionArray*(*)()>(&SSLExtension::$values))},
	{"*clone", "()Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{"*equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC | $FINAL},
	{"*finalize", "()V", nullptr, $PROTECTED | $FINAL},
	{"*hashCode", "()I", nullptr, $PUBLIC | $FINAL},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;)V", "(ILjava/lang/String;)V", $PRIVATE, $method(static_cast<void(SSLExtension::*)($String*,int32_t,int32_t,$String*)>(&SSLExtension::init$))},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;Lsun/security/ssl/SSLHandshake;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/HandshakeProducer;Lsun/security/ssl/SSLExtension$ExtensionConsumer;Lsun/security/ssl/HandshakeAbsence;Lsun/security/ssl/HandshakeConsumer;Lsun/security/ssl/HandshakeAbsence;Lsun/security/ssl/SSLStringizer;)V", "(ILjava/lang/String;Lsun/security/ssl/SSLHandshake;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/HandshakeProducer;Lsun/security/ssl/SSLExtension$ExtensionConsumer;Lsun/security/ssl/HandshakeAbsence;Lsun/security/ssl/HandshakeConsumer;Lsun/security/ssl/HandshakeAbsence;Lsun/security/ssl/SSLStringizer;)V", $PRIVATE, $method(static_cast<void(SSLExtension::*)($String*,int32_t,int32_t,$String*,$SSLHandshake*,$ProtocolVersionArray*,$HandshakeProducer*,$SSLExtension$ExtensionConsumer*,$HandshakeAbsence*,$HandshakeConsumer*,$HandshakeAbsence*,$SSLStringizer*)>(&SSLExtension::init$))},
	{"absentOnLoad", "(Lsun/security/ssl/ConnectionContext;Lsun/security/ssl/SSLHandshake$HandshakeMessage;)V", nullptr, 0, $method(static_cast<void(SSLExtension::*)($ConnectionContext*,$SSLHandshake$HandshakeMessage*)>(&SSLExtension::absentOnLoad)), "java.io.IOException"},
	{"absentOnTrade", "(Lsun/security/ssl/ConnectionContext;Lsun/security/ssl/SSLHandshake$HandshakeMessage;)V", nullptr, 0, $method(static_cast<void(SSLExtension::*)($ConnectionContext*,$SSLHandshake$HandshakeMessage*)>(&SSLExtension::absentOnTrade)), "java.io.IOException"},
	{"consumeOnLoad", "(Lsun/security/ssl/ConnectionContext;Lsun/security/ssl/SSLHandshake$HandshakeMessage;Ljava/nio/ByteBuffer;)V", nullptr, $PUBLIC, $method(static_cast<void(SSLExtension::*)($ConnectionContext*,$SSLHandshake$HandshakeMessage*,$ByteBuffer*)>(&SSLExtension::consumeOnLoad)), "java.io.IOException"},
	{"consumeOnTrade", "(Lsun/security/ssl/ConnectionContext;Lsun/security/ssl/SSLHandshake$HandshakeMessage;)V", nullptr, $PUBLIC, $method(static_cast<void(SSLExtension::*)($ConnectionContext*,$SSLHandshake$HandshakeMessage*)>(&SSLExtension::consumeOnTrade)), "java.io.IOException"},
	{"getDisabledExtensions", "(Ljava/lang/String;)Ljava/util/Collection;", "(Ljava/lang/String;)Ljava/util/Collection<Ljava/lang/String;>;", $PRIVATE | $STATIC, $method(static_cast<$Collection*(*)($String*)>(&SSLExtension::getDisabledExtensions))},
	{"isAvailable", "(Lsun/security/ssl/ProtocolVersion;)Z", nullptr, $PUBLIC, $method(static_cast<bool(SSLExtension::*)($ProtocolVersion*)>(&SSLExtension::isAvailable))},
	{"isConsumable", "(I)Z", nullptr, $STATIC, $method(static_cast<bool(*)(int32_t)>(&SSLExtension::isConsumable))},
	{"nameOf", "(I)Ljava/lang/String;", nullptr, $STATIC, $method(static_cast<$String*(*)(int32_t)>(&SSLExtension::nameOf))},
	{"produce", "(Lsun/security/ssl/ConnectionContext;Lsun/security/ssl/SSLHandshake$HandshakeMessage;)[B", nullptr, $PUBLIC, $method(static_cast<$bytes*(SSLExtension::*)($ConnectionContext*,$SSLHandshake$HandshakeMessage*)>(&SSLExtension::produce)), "java.io.IOException"},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"toString", "(Lsun/security/ssl/HandshakeContext;Ljava/nio/ByteBuffer;)Ljava/lang/String;", nullptr, $PUBLIC},
	{"valueOf", "(Ljava/lang/String;)Lsun/security/ssl/SSLExtension;", nullptr, $PUBLIC | $STATIC, $method(static_cast<SSLExtension*(*)($String*)>(&SSLExtension::valueOf))},
	{"valueOf", "(Lsun/security/ssl/SSLHandshake;I)Lsun/security/ssl/SSLExtension;", nullptr, $STATIC, $method(static_cast<SSLExtension*(*)($SSLHandshake*,int32_t)>(&SSLExtension::valueOf))},
	{"values", "()[Lsun/security/ssl/SSLExtension;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$SSLExtensionArray*(*)()>(&SSLExtension::values))},
	{}
};
