...
$MethodInfo _ExtendedMasterSecretExtension$CHExtendedMasterSecretAbsence_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PRIVATE, $method(static_cast<void(ExtendedMasterSecretExtension$CHExtendedMasterSecretAbsence::*)()>(&ExtendedMasterSecretExtension$CHExtendedMasterSecretAbsence::init$))},
