#ifndef _sun_security_ssl_SSLCipher$T11BlockWriteCipherGenerator_h_
#define _sun_security_ssl_SSLCipher$T11BlockWriteCipherGenerator_h_
//$ class sun.security.ssl.SSLCipher$T11BlockWriteCipherGenerator
...
class SSLCipher$T11BlockWriteCipherGenerator : public ::sun::security::ssl::SSLCipher$WriteCipherGenerator {
	$class(SSLCipher$T11BlockWriteCipherGenerator, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$WriteCipherGenerator)
public:
...
#endif // _sun_security_ssl_SSLCipher$T11BlockWriteCipherGenerator_h_