#ifndef _sun_security_ssl_SSLCipher$T12GcmWriteCipherGenerator$GcmWriteCipher_h_
#define _sun_security_ssl_SSLCipher$T12GcmWriteCipherGenerator$GcmWriteCipher_h_
//$ class sun.security.ssl.SSLCipher$T12GcmWriteCipherGenerator$GcmWriteCipher
...
class SSLCipher$T12GcmWriteCipherGenerator$GcmWriteCipher : public ::sun::security::ssl::SSLCipher$SSLWriteCipher {
	$class(SSLCipher$T12GcmWriteCipherGenerator$GcmWriteCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLWriteCipher)
public:
...
#endif // _sun_security_ssl_SSLCipher$T12GcmWriteCipherGenerator$GcmWriteCipher_h_