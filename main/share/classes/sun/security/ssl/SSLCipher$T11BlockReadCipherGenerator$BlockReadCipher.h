#ifndef _sun_security_ssl_SSLCipher$T11BlockReadCipherGenerator$BlockReadCipher_h_
#define _sun_security_ssl_SSLCipher$T11BlockReadCipherGenerator$BlockReadCipher_h_
//$ class sun.security.ssl.SSLCipher$T11BlockReadCipherGenerator$BlockReadCipher
...
class SSLCipher$T11BlockReadCipherGenerator$BlockReadCipher : public ::sun::security::ssl::SSLCipher$SSLReadCipher {
	$class(SSLCipher$T11BlockReadCipherGenerator$BlockReadCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLReadCipher)
public:
	...
	bool sanityCheck(int32_t tagLen, int32_t fragmentLen);
...
#endif // _sun_security_ssl_SSLCipher$T11BlockReadCipherGenerator$BlockReadCipher_h_