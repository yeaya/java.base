#ifndef _sun_security_ssl_NamedGroup$ECDHEScheme_h_
#define _sun_security_ssl_NamedGroup$ECDHEScheme_h_
//$ class sun.security.ssl.NamedGroup$ECDHEScheme
...
class NamedGroup$ECDHEScheme : public ::sun::security::ssl::NamedGroup$NamedGroupScheme {
	$class(NamedGroup$ECDHEScheme, 0, ::sun::security::ssl::NamedGroup$NamedGroupScheme)
public:
	NamedGroup$ECDHEScheme();
	void init$();
	...
	static ::sun::security::ssl::NamedGroup$ECDHEScheme* instance;
};
...
#endif // _sun_security_ssl_NamedGroup$ECDHEScheme_h_