#ifndef _sun_security_ssl_SSLCipher$T11BlockWriteCipherGenerator$BlockWriteCipher_h_
#define _sun_security_ssl_SSLCipher$T11BlockWriteCipherGenerator$BlockWriteCipher_h_
//$ class sun.security.ssl.SSLCipher$T11BlockWriteCipherGenerator$BlockWriteCipher
...
class SSLCipher$T11BlockWriteCipherGenerator$BlockWriteCipher : public ::sun::security::ssl::SSLCipher$SSLWriteCipher {
	$class(SSLCipher$T11BlockWriteCipherGenerator$BlockWriteCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLWriteCipher)
public:
...
#endif // _sun_security_ssl_SSLCipher$T11BlockWriteCipherGenerator$BlockWriteCipher_h_