...
bool SSLCipher::checkMacTags(int8_t contentType, $ByteBuffer* bb, $Authenticator$MAC* signer, $bytes* sequence, bool isSimulated) {
	...
	if (hash == nullptr || tagLen != hash->length) {
...
int32_t SSLCipher::removePadding($ByteBuffer* bb, int32_t tagLen, int32_t blockSize, $ProtocolVersion* protocolVersion) {
	...
	int32_t padLen = bb->get(padOffset) & 0xff;
	int32_t newLen = len - (padLen + 1);
	if ((newLen - tagLen) < 0) {
		checkPadding($(bb->duplicate()), (int8_t)(padLen & 0xff));
		$throwNew($BadPaddingException, $$str({"Invalid Padding length: "_s, $$str(padLen)}));
	}
	$var($ints, results, checkPadding($($$nc(bb->duplicate())->position(offset + newLen)), (int8_t)(padLen & 0xff)));
...
void SSLCipher::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$beforeCallerSensitive();
	int64_t max = (int64_t)0x4000000000000000;
	...
	$var($Map$EntryArray, var$3, ($new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$NullReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_NONE),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$NullReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_13)
	})));
	$assignStatic(SSLCipher::B_NULL, $new(SSLCipher, var$0, 0, var$1, var$2, 0, 0, 0, 0, true, true, var$3, ($$new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$NullWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_NONE),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$NullWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_13)
	}))));
	$var($String, var$4, "B_RC4_40"_s);
	$var($String, var$5, "RC4"_s);
	$var($CipherType, var$6, $CipherType::STREAM_CIPHER);
	$var($Map$EntryArray, var$7, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$StreamReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10)})));
	$assignStatic(SSLCipher::B_RC4_40, $new(SSLCipher, var$4, 1, var$5, var$6, 5, 16, 0, 0, true, true, var$7, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$StreamWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10)}))));
	$var($String, var$8, "B_RC2_40"_s);
	$var($String, var$9, "RC2"_s);
	$var($CipherType, var$10, $CipherType::BLOCK_CIPHER);
	$var($Map$EntryArray, var$11, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$StreamReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10)})));
	$assignStatic(SSLCipher::B_RC2_40, $new(SSLCipher, var$8, 2, var$9, var$10, 5, 16, 8, 0, false, true, var$11, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$StreamWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10)}))));
	$var($String, var$12, "B_DES_40"_s);
	$var($String, var$13, "DES/CBC/NoPadding"_s);
	$var($CipherType, var$14, $CipherType::BLOCK_CIPHER);
	$var($Map$EntryArray, var$15, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T10BlockReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10)})));
	$assignStatic(SSLCipher::B_DES_40, $new(SSLCipher, var$12, 3, var$13, var$14, 5, 8, 8, 0, true, true, var$15, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T10BlockWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10)}))));
	$var($String, var$16, "B_RC4_128"_s);
	$var($String, var$17, "RC4"_s);
	$var($CipherType, var$18, $CipherType::STREAM_CIPHER);
	$var($Map$EntryArray, var$19, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$StreamReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_12)})));
	$assignStatic(SSLCipher::B_RC4_128, $new(SSLCipher, var$16, 4, var$17, var$18, 16, 16, 0, 0, true, false, var$19, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$StreamWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_12)}))));
	...
	$var($Map$EntryArray, var$23, ($new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T10BlockReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T11BlockReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_11)
	})));
	$assignStatic(SSLCipher::B_DES, $new(SSLCipher, var$20, 5, var$21, var$22, 8, 8, 8, 0, true, false, var$23, ($$new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T10BlockWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T11BlockWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_11)
	}))));
	...
	$var($Map$EntryArray, var$27, ($new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T10BlockReadCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T11BlockReadCipherGenerator), $ProtocolVersion::PROTOCOLS_11_12)
	})));
	$assignStatic(SSLCipher::B_3DES, $new(SSLCipher, var$24, 6, var$25, var$26, 24, 24, 8, 0, true, false, var$27, ($$new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T10BlockWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_TO_10),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T11BlockWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_11_12)
	}))));
	$var($String, var$28, "B_IDEA"_s);
	$var($String, var$29, "IDEA"_s);
	$var($CipherType, var$30, $CipherType::BLOCK_CIPHER);
	$var($Map$EntryArray, var$31, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, nullptr, $ProtocolVersion::PROTOCOLS_TO_12)})));
	$assignStatic(SSLCipher::B_IDEA, $new(SSLCipher, var$28, 7, var$29, var$30, 16, 16, 8, 0, false, false, var$31, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, nullptr, $ProtocolVersion::PROTOCOLS_TO_12)}))));
	...
	$var($Map$EntryArray, var$43, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T12GcmReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_12)})));
	$assignStatic(SSLCipher::B_AES_128_GCM, $new(SSLCipher, var$40, 10, var$41, var$42, 16, 16, 12, 4, true, false, var$43, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T12GcmWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_12)}))));
	$var($String, var$44, "B_AES_256_GCM"_s);
	$var($String, var$45, "AES/GCM/NoPadding"_s);
	$var($CipherType, var$46, $CipherType::AEAD_CIPHER);
	$var($Map$EntryArray, var$47, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T12GcmReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_12)})));
	$assignStatic(SSLCipher::B_AES_256_GCM, $new(SSLCipher, var$44, 11, var$45, var$46, 32, 32, 12, 4, true, false, var$47, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T12GcmWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_12)}))));
	$var($String, var$48, "B_AES_128_GCM_IV"_s);
	$var($String, var$49, "AES/GCM/NoPadding"_s);
	$var($CipherType, var$50, $CipherType::AEAD_CIPHER);
	$var($Map$EntryArray, var$51, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T13GcmReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_13)})));
	$assignStatic(SSLCipher::B_AES_128_GCM_IV, $new(SSLCipher, var$48, 12, var$49, var$50, 16, 16, 12, 0, true, false, var$51, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T13GcmWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_13)}))));
	$var($String, var$52, "B_AES_256_GCM_IV"_s);
	$var($String, var$53, "AES/GCM/NoPadding"_s);
	$var($CipherType, var$54, $CipherType::AEAD_CIPHER);
	$var($Map$EntryArray, var$55, ($new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T13GcmReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_13)})));
	$assignStatic(SSLCipher::B_AES_256_GCM_IV, $new(SSLCipher, var$52, 13, var$53, var$54, 32, 32, 12, 0, true, false, var$55, ($$new($Map$EntryArray, {$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T13GcmWriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_13)}))));
	...
	$var($Map$EntryArray, var$59, ($new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T12CC20P1305ReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_12),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T13CC20P1305ReadCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_13)
	})));
	$assignStatic(SSLCipher::B_CC20_P1305, $new(SSLCipher, var$56, 14, var$57, var$58, 32, 32, 12, 12, true, false, var$59, ($$new($Map$EntryArray, {
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T12CC20P1305WriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_12),
		$$new($AbstractMap$SimpleImmutableEntry, $$new($SSLCipher$T13CC20P1305WriteCipherGenerator), $ProtocolVersion::PROTOCOLS_OF_13)
	}))));
	...
	{
		int64_t max = (int64_t)0x4000000000000000;
		$var($String, prop, $cast($String, $AccessController::doPrivileged($$new($SSLCipher$1))));
		if (prop != nullptr) {
			$var($StringArray, propvalue, prop->split(","_s));
			{
				...
				for (int32_t len$ = arr$->length, i$ = 0; i$ < len$; ++i$) {
					$var($String, entry, arr$->get(i$));
					{
						...
						if ($nc(values->get(1))->contains(SSLCipher::tag->get(0))) {
							index = 0;
						} else {
							$init($SSLLogger);
							if ($SSLLogger::isOn$ && $SSLLogger::isOn("ssl"_s)) {
						...
						try {
							if (i >= 0) {
								size = $cast(int64_t, $Math::pow(2, (double)$Integer::parseInt($($nc(values->get(2))->substring(i + 1)))));
							} else {
						...
						$init($SSLLogger);
						if ($SSLLogger::isOn$ && $SSLLogger::isOn("ssl"_s)) {
							$SSLLogger::fine($$str({"jdk.tls.keyLimits:  entry = "_s, entry, ". "_s, values->get(0), ":"_s, SSLCipher::tag->get(index), " = "_s, $$str(size)}), $$new($ObjectArray, 0));
						}
						SSLCipher::cipherLimits->put($$str({values->get(0), ":"_s, SSLCipher::tag->get(index)}), $($Long::valueOf(size)));
					}
				}
			}
		}
...
$Class* SSLCipher::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"$values", "()[Lsun/security/ssl/SSLCipher;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(SSLCipher, $values, $SSLCipherArray*)},
		{"<init>", "(Ljava/lang/String;ILjava/lang/String;Lsun/security/ssl/CipherType;IIIIZZ[Ljava/util/Map$Entry;[Ljava/util/Map$Entry;)V", "(Ljava/lang/String;Lsun/security/ssl/CipherType;IIIIZZ[Ljava/util/Map$Entry<Lsun/security/ssl/SSLCipher$ReadCipherGenerator;[Lsun/security/ssl/ProtocolVersion;>;[Ljava/util/Map$Entry<Lsun/security/ssl/SSLCipher$WriteCipherGenerator;[Lsun/security/ssl/ProtocolVersion;>;)V", $PRIVATE, $method(SSLCipher, init$, void, $String*, int32_t, $String*, $CipherType*, int32_t, int32_t, int32_t, int32_t, bool, bool, $Map$EntryArray*, $Map$EntryArray*)},
		{"addMac", "(Lsun/security/ssl/Authenticator$MAC;Ljava/nio/ByteBuffer;B)V", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, addMac, void, $Authenticator$MAC*, $ByteBuffer*, int8_t)},
		{"addPadding", "(Ljava/nio/ByteBuffer;I)I", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, addPadding, int32_t, $ByteBuffer*, int32_t)},
		{"calculateRemainingLen", "(Lsun/security/ssl/Authenticator$MAC;II)I", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, calculateRemainingLen, int32_t, $Authenticator$MAC*, int32_t, int32_t)},
		{"checkCBCMac", "(Lsun/security/ssl/Authenticator$MAC;Ljava/nio/ByteBuffer;BI[B)V", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, checkCBCMac, void, $Authenticator$MAC*, $ByteBuffer*, int8_t, int32_t, $bytes*), "javax.crypto.BadPaddingException"},
		{"checkMacTags", "(BLjava/nio/ByteBuffer;Lsun/security/ssl/Authenticator$MAC;[BZ)Z", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, checkMacTags, bool, int8_t, $ByteBuffer*, $Authenticator$MAC*, $bytes*, bool)},
		{"checkPadding", "(Ljava/nio/ByteBuffer;B)[I", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, checkPadding, $ints*, $ByteBuffer*, int8_t)},
		{"checkStreamMac", "(Lsun/security/ssl/Authenticator$MAC;Ljava/nio/ByteBuffer;B[B)V", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, checkStreamMac, void, $Authenticator$MAC*, $ByteBuffer*, int8_t, $bytes*), "javax.crypto.BadPaddingException"},
		{"compareMacTags", "(Ljava/nio/ByteBuffer;[B)[I", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, compareMacTags, $ints*, $ByteBuffer*, $bytes*)},
		{"createReadCipher", "(Lsun/security/ssl/Authenticator;Lsun/security/ssl/ProtocolVersion;Ljavax/crypto/SecretKey;Ljavax/crypto/spec/IvParameterSpec;Ljava/security/SecureRandom;)Lsun/security/ssl/SSLCipher$SSLReadCipher;", nullptr, 0, $method(SSLCipher, createReadCipher, $SSLCipher$SSLReadCipher*, $Authenticator*, $ProtocolVersion*, $SecretKey*, $IvParameterSpec*, $SecureRandom*), "java.security.GeneralSecurityException"},
		{"createWriteCipher", "(Lsun/security/ssl/Authenticator;Lsun/security/ssl/ProtocolVersion;Ljavax/crypto/SecretKey;Ljavax/crypto/spec/IvParameterSpec;Ljava/security/SecureRandom;)Lsun/security/ssl/SSLCipher$SSLWriteCipher;", nullptr, 0, $method(SSLCipher, createWriteCipher, $SSLCipher$SSLWriteCipher*, $Authenticator*, $ProtocolVersion*, $SecretKey*, $IvParameterSpec*, $SecureRandom*), "java.security.GeneralSecurityException"},
		{"isAvailable", "()Z", nullptr, 0, $method(SSLCipher, isAvailable, bool)},
		{"isTransformationAvailable", "(Ljava/lang/String;)Z", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, isTransformationAvailable, bool, $String*)},
		{"isUnlimited", "(ILjava/lang/String;)Z", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, isUnlimited, bool, int32_t, $String*)},
		{"removePadding", "(Ljava/nio/ByteBuffer;IILsun/security/ssl/ProtocolVersion;)I", nullptr, $PRIVATE | $STATIC, $staticMethod(SSLCipher, removePadding, int32_t, $ByteBuffer*, int32_t, int32_t, $ProtocolVersion*), "javax.crypto.BadPaddingException"},
		{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(SSLCipher, toString, $String*)},
		{"valueOf", "(Ljava/lang/String;)Lsun/security/ssl/SSLCipher;", nullptr, $PUBLIC | $STATIC, $staticMethod(SSLCipher, valueOf, SSLCipher*, $String*)},
		{"values", "()[Lsun/security/ssl/SSLCipher;", nullptr, $PUBLIC | $STATIC, $staticMethod(SSLCipher, values, $SSLCipherArray*)},
		{}
	};
	...
	$loadClass(SSLCipher, name, initialize, &classInfo$$, SSLCipher::clinit$, []($Class* clazz) -> $Object* {
