...
$MethodInfo _X509TrustManagerImpl_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;Ljava/util/Collection;)V", "(Ljava/lang/String;Ljava/util/Collection<Ljava/security/cert/X509Certificate;>;)V", 0, $method(static_cast<void(X509TrustManagerImpl::*)($String*,$Collection*)>(&X509TrustManagerImpl::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/security/cert/PKIXBuilderParameters;)V", nullptr, 0, $method(static_cast<void(X509TrustManagerImpl::*)($String*,$PKIXBuilderParameters*)>(&X509TrustManagerImpl::init$))},
	...
	{"checkIdentity", "(Ljavax/net/ssl/SSLSession;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Z)V", nullptr, $STATIC, $method(static_cast<void(*)($SSLSession*,$X509CertificateArray*,$String*,bool)>(&X509TrustManagerImpl::checkIdentity)), "java.security.cert.CertificateException"},
	{"checkIdentity", "(Ljava/lang/String;Ljava/security/cert/X509Certificate;Ljava/lang/String;)V", nullptr, $STATIC, $method(static_cast<void(*)($String*,$X509Certificate*,$String*)>(&X509TrustManagerImpl::checkIdentity)), "java.security.cert.CertificateException"},
	{"checkIdentity", "(Ljava/lang/String;Ljava/security/cert/X509Certificate;Ljava/lang/String;Z)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*,$X509Certificate*,$String*,bool)>(&X509TrustManagerImpl::checkIdentity)), "java.security.cert.CertificateException"},
	...
	{"checkTrusted", "([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/net/Socket;Z)V", nullptr, $PRIVATE, $method(static_cast<void(X509TrustManagerImpl::*)($X509CertificateArray*,$String*,$Socket*,bool)>(&X509TrustManagerImpl::checkTrusted)), "java.security.cert.CertificateException"},
	{"checkTrusted", "([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;Z)V", nullptr, $PRIVATE, $method(static_cast<void(X509TrustManagerImpl::*)($X509CertificateArray*,$String*,$SSLEngine*,bool)>(&X509TrustManagerImpl::checkTrusted)), "java.security.cert.CertificateException"},
	{"checkTrustedInit", "([Ljava/security/cert/X509Certificate;Ljava/lang/String;Z)Lsun/security/validator/Validator;", nullptr, $PRIVATE, $method(static_cast<$Validator*(X509TrustManagerImpl::*)($X509CertificateArray*,$String*,bool)>(&X509TrustManagerImpl::checkTrustedInit))},
	{"getAcceptedIssuers", "()[Ljava/security/cert/X509Certificate;", nullptr, $PUBLIC},
	{"getHostNameInSNI", "(Ljava/util/List;)Ljava/lang/String;", "(Ljava/util/List<Ljavax/net/ssl/SNIServerName;>;)Ljava/lang/String;", $PRIVATE | $STATIC, $method(static_cast<$String*(*)($List*)>(&X509TrustManagerImpl::getHostNameInSNI))},
	{"getRequestedServerNames", "(Ljava/net/Socket;)Ljava/util/List;", "(Ljava/net/Socket;)Ljava/util/List<Ljavax/net/ssl/SNIServerName;>;", $STATIC, $method(static_cast<$List*(*)($Socket*)>(&X509TrustManagerImpl::getRequestedServerNames))},
	{"getRequestedServerNames", "(Ljavax/net/ssl/SSLEngine;)Ljava/util/List;", "(Ljavax/net/ssl/SSLEngine;)Ljava/util/List<Ljavax/net/ssl/SNIServerName;>;", $STATIC, $method(static_cast<$List*(*)($SSLEngine*)>(&X509TrustManagerImpl::getRequestedServerNames))},
	{"getRequestedServerNames", "(Ljavax/net/ssl/SSLSession;)Ljava/util/List;", "(Ljavax/net/ssl/SSLSession;)Ljava/util/List<Ljavax/net/ssl/SNIServerName;>;", $PRIVATE | $STATIC, $method(static_cast<$List*(*)($SSLSession*)>(&X509TrustManagerImpl::getRequestedServerNames))},
	{"getValidator", "(Ljava/lang/String;)Lsun/security/validator/Validator;", nullptr, $PRIVATE, $method(static_cast<$Validator*(X509TrustManagerImpl::*)($String*)>(&X509TrustManagerImpl::getValidator))},
	{}
};
