#ifndef _sun_security_ssl_SSLCipher$T10BlockReadCipherGenerator$BlockReadCipher_h_
#define _sun_security_ssl_SSLCipher$T10BlockReadCipherGenerator$BlockReadCipher_h_
//$ class sun.security.ssl.SSLCipher$T10BlockReadCipherGenerator$BlockReadCipher
...
class SSLCipher$T10BlockReadCipherGenerator$BlockReadCipher : public ::sun::security::ssl::SSLCipher$SSLReadCipher {
	$class(SSLCipher$T10BlockReadCipherGenerator$BlockReadCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLReadCipher)
public:
...
#endif // _sun_security_ssl_SSLCipher$T10BlockReadCipherGenerator$BlockReadCipher_h_