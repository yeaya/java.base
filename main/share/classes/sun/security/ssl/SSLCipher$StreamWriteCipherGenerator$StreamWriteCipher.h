#ifndef _sun_security_ssl_SSLCipher$StreamWriteCipherGenerator$StreamWriteCipher_h_
#define _sun_security_ssl_SSLCipher$StreamWriteCipherGenerator$StreamWriteCipher_h_
//$ class sun.security.ssl.SSLCipher$StreamWriteCipherGenerator$StreamWriteCipher
...
class SSLCipher$StreamWriteCipherGenerator$StreamWriteCipher : public ::sun::security::ssl::SSLCipher$SSLWriteCipher {
	$class(SSLCipher$StreamWriteCipherGenerator$StreamWriteCipher, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$SSLWriteCipher)
public:
...
#endif // _sun_security_ssl_SSLCipher$StreamWriteCipherGenerator$StreamWriteCipher_h_