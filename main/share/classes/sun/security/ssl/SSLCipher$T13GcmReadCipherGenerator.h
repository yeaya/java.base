#ifndef _sun_security_ssl_SSLCipher$T13GcmReadCipherGenerator_h_
#define _sun_security_ssl_SSLCipher$T13GcmReadCipherGenerator_h_
//$ class sun.security.ssl.SSLCipher$T13GcmReadCipherGenerator
...
class SSLCipher$T13GcmReadCipherGenerator : public ::sun::security::ssl::SSLCipher$ReadCipherGenerator {
	$class(SSLCipher$T13GcmReadCipherGenerator, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$ReadCipherGenerator)
public:
...
#endif // _sun_security_ssl_SSLCipher$T13GcmReadCipherGenerator_h_