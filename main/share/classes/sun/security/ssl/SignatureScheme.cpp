...
$MethodInfo _SignatureScheme_MethodInfo_[] = {
	{"$values", "()[Lsun/security/ssl/SignatureScheme;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$SignatureSchemeArray*(*)()>(&SignatureScheme::$values))},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Lsun/security/ssl/ProtocolVersion;)V", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Lsun/security/ssl/ProtocolVersion;)V", $PRIVATE, $method(static_cast<void(SignatureScheme::*)($String*,int32_t,int32_t,$String*,$String*,$String*,$ProtocolVersionArray*)>(&SignatureScheme::init$))},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I[Lsun/security/ssl/ProtocolVersion;)V", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I[Lsun/security/ssl/ProtocolVersion;)V", $PRIVATE, $method(static_cast<void(SignatureScheme::*)($String*,int32_t,int32_t,$String*,$String*,$String*,int32_t,$ProtocolVersionArray*)>(&SignatureScheme::init$))},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lsun/security/ssl/SignatureScheme$SigAlgParamSpec;I[Lsun/security/ssl/ProtocolVersion;)V", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lsun/security/ssl/SignatureScheme$SigAlgParamSpec;I[Lsun/security/ssl/ProtocolVersion;)V", $PRIVATE, $method(static_cast<void(SignatureScheme::*)($String*,int32_t,int32_t,$String*,$String*,$String*,$SignatureScheme$SigAlgParamSpec*,int32_t,$ProtocolVersionArray*)>(&SignatureScheme::init$))},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lsun/security/ssl/NamedGroup;[Lsun/security/ssl/ProtocolVersion;)V", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lsun/security/ssl/NamedGroup;[Lsun/security/ssl/ProtocolVersion;)V", $PRIVATE, $method(static_cast<void(SignatureScheme::*)($String*,int32_t,int32_t,$String*,$String*,$String*,$NamedGroup*,$ProtocolVersionArray*)>(&SignatureScheme::init$))},
	{"<init>", "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lsun/security/ssl/SignatureScheme$SigAlgParamSpec;Lsun/security/ssl/NamedGroup;I[Lsun/security/ssl/ProtocolVersion;[Lsun/security/ssl/ProtocolVersion;)V", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lsun/security/ssl/SignatureScheme$SigAlgParamSpec;Lsun/security/ssl/NamedGroup;I[Lsun/security/ssl/ProtocolVersion;[Lsun/security/ssl/ProtocolVersion;)V", $PRIVATE, $method(static_cast<void(SignatureScheme::*)($String*,int32_t,int32_t,$String*,$String*,$String*,$SignatureScheme$SigAlgParamSpec*,$NamedGroup*,int32_t,$ProtocolVersionArray*,$ProtocolVersionArray*)>(&SignatureScheme::init$))},
	{"getAlgorithmNames", "(Ljava/util/Collection;)[Ljava/lang/String;", "(Ljava/util/Collection<Lsun/security/ssl/SignatureScheme;>;)[Ljava/lang/String;", $STATIC, $method(static_cast<$StringArray*(*)($Collection*)>(&SignatureScheme::getAlgorithmNames))},
	{"getPreferableAlgorithm", "(Ljava/security/AlgorithmConstraints;Ljava/util/List;Lsun/security/ssl/SignatureScheme;Lsun/security/ssl/ProtocolVersion;)Lsun/security/ssl/SignatureScheme;", "(Ljava/security/AlgorithmConstraints;Ljava/util/List<Lsun/security/ssl/SignatureScheme;>;Lsun/security/ssl/SignatureScheme;Lsun/security/ssl/ProtocolVersion;)Lsun/security/ssl/SignatureScheme;", $STATIC, $method(static_cast<SignatureScheme*(*)($AlgorithmConstraints*,$List*,SignatureScheme*,$ProtocolVersion*)>(&SignatureScheme::getPreferableAlgorithm))},
	{"getSigner", "(Ljava/security/PrivateKey;)Ljava/security/Signature;", nullptr, $PRIVATE, $method(static_cast<$Signature*(SignatureScheme::*)($PrivateKey*)>(&SignatureScheme::getSigner))},
	{"getSignerOfPreferableAlgorithm", "(Ljava/security/AlgorithmConstraints;Ljava/util/List;Lsun/security/ssl/X509Authentication$X509Possession;Lsun/security/ssl/ProtocolVersion;)Ljava/util/Map$Entry;", "(Ljava/security/AlgorithmConstraints;Ljava/util/List<Lsun/security/ssl/SignatureScheme;>;Lsun/security/ssl/X509Authentication$X509Possession;Lsun/security/ssl/ProtocolVersion;)Ljava/util/Map$Entry<Lsun/security/ssl/SignatureScheme;Ljava/security/Signature;>;", $STATIC, $method(static_cast<$Map$Entry*(*)($AlgorithmConstraints*,$List*,$X509Authentication$X509Possession*,$ProtocolVersion*)>(&SignatureScheme::getSignerOfPreferableAlgorithm))},
	{"getSupportedAlgorithms", "(Lsun/security/ssl/SSLConfiguration;Ljava/security/AlgorithmConstraints;Ljava/util/List;)Ljava/util/List;", "(Lsun/security/ssl/SSLConfiguration;Ljava/security/AlgorithmConstraints;Ljava/util/List<Lsun/security/ssl/ProtocolVersion;>;)Ljava/util/List<Lsun/security/ssl/SignatureScheme;>;", $STATIC, $method(static_cast<$List*(*)($SSLConfiguration*,$AlgorithmConstraints*,$List*)>(&SignatureScheme::getSupportedAlgorithms))},
	{"getSupportedAlgorithms", "(Lsun/security/ssl/SSLConfiguration;Ljava/security/AlgorithmConstraints;Lsun/security/ssl/ProtocolVersion;[I)Ljava/util/List;", "(Lsun/security/ssl/SSLConfiguration;Ljava/security/AlgorithmConstraints;Lsun/security/ssl/ProtocolVersion;[I)Ljava/util/List<Lsun/security/ssl/SignatureScheme;>;", $STATIC, $method(static_cast<$List*(*)($SSLConfiguration*,$AlgorithmConstraints*,$ProtocolVersion*,$ints*)>(&SignatureScheme::getSupportedAlgorithms))},
	{"getVerifier", "(Ljava/security/PublicKey;)Ljava/security/Signature;", nullptr, 0, $method(static_cast<$Signature*(SignatureScheme::*)($PublicKey*)>(&SignatureScheme::getVerifier)), "java.security.NoSuchAlgorithmException,java.security.InvalidAlgorithmParameterException,java.security.InvalidKeyException"},
	{"isPermitted", "(Ljava/security/AlgorithmConstraints;)Z", nullptr, $PRIVATE, $method(static_cast<bool(SignatureScheme::*)($AlgorithmConstraints*)>(&SignatureScheme::isPermitted))},
	{"nameOf", "(I)Ljava/lang/String;", nullptr, $STATIC, $method(static_cast<$String*(*)(int32_t)>(&SignatureScheme::nameOf))},
	{"nameOf", "(Ljava/lang/String;)Lsun/security/ssl/SignatureScheme;", nullptr, $STATIC, $method(static_cast<SignatureScheme*(*)($String*)>(&SignatureScheme::nameOf))},
	{"sizeInRecord", "()I", nullptr, $STATIC, $method(static_cast<int32_t(*)()>(&SignatureScheme::sizeInRecord))},
	{"valueOf", "(Ljava/lang/String;)Lsun/security/ssl/SignatureScheme;", nullptr, $PUBLIC | $STATIC, $method(static_cast<SignatureScheme*(*)($String*)>(&SignatureScheme::valueOf))},
	{"valueOf", "(I)Lsun/security/ssl/SignatureScheme;", nullptr, $STATIC, $method(static_cast<SignatureScheme*(*)(int32_t)>(&SignatureScheme::valueOf))},
	{"values", "()[Lsun/security/ssl/SignatureScheme;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$SignatureSchemeArray*(*)()>(&SignatureScheme::values))},
	{}
};
