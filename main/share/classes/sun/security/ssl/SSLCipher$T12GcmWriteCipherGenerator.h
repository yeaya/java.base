#ifndef _sun_security_ssl_SSLCipher$T12GcmWriteCipherGenerator_h_
#define _sun_security_ssl_SSLCipher$T12GcmWriteCipherGenerator_h_
//$ class sun.security.ssl.SSLCipher$T12GcmWriteCipherGenerator
...
class SSLCipher$T12GcmWriteCipherGenerator : public ::sun::security::ssl::SSLCipher$WriteCipherGenerator {
	$class(SSLCipher$T12GcmWriteCipherGenerator, $NO_CLASS_INIT, ::sun::security::ssl::SSLCipher$WriteCipherGenerator)
public:
...
#endif // _sun_security_ssl_SSLCipher$T12GcmWriteCipherGenerator_h_