...
void MaxFragExtension::clinit$($Class* clazz) {
...
$Class* MaxFragExtension::load$($String* name, bool initialize) {
	...
	$loadClass(MaxFragExtension, name, initialize, &classInfo$$, MaxFragExtension::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(MaxFragExtension);
	});
	return class$;
}
