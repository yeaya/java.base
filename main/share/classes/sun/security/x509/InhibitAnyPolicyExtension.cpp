...
$MethodInfo _InhibitAnyPolicyExtension_MethodInfo_[] = {
	...
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(InhibitAnyPolicyExtension::*)(int32_t)>(&InhibitAnyPolicyExtension::init$)), "java.io.IOException"},
	{"<init>", "(Ljava/lang/Boolean;Ljava/lang/Object;)V", nullptr, $PUBLIC, $method(static_cast<void(InhibitAnyPolicyExtension::*)($Boolean*,Object$*)>(&InhibitAnyPolicyExtension::init$)), "java.io.IOException"},
	...
	{"encodeThis", "()V", nullptr, $PRIVATE, $method(static_cast<void(InhibitAnyPolicyExtension::*)()>(&InhibitAnyPolicyExtension::encodeThis)), "java.io.IOException"},
