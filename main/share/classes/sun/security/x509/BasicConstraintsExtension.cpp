...
$MethodInfo _BasicConstraintsExtension_MethodInfo_[] = {
	...
	{"<init>", "(ZI)V", nullptr, $PUBLIC, $method(static_cast<void(BasicConstraintsExtension::*)(bool,int32_t)>(&BasicConstraintsExtension::init$)), "java.io.IOException"},
	{"<init>", "(Ljava/lang/Boolean;ZI)V", nullptr, $PUBLIC, $method(static_cast<void(BasicConstraintsExtension::*)($Boolean*,bool,int32_t)>(&BasicConstraintsExtension::init$)), "java.io.IOException"},
	{"<init>", "(Ljava/lang/Boolean;Ljava/lang/Object;)V", nullptr, $PUBLIC, $method(static_cast<void(BasicConstraintsExtension::*)($Boolean*,Object$*)>(&BasicConstraintsExtension::init$)), "java.io.IOException"},
	...
	{"encodeThis", "()V", nullptr, $PRIVATE, $method(static_cast<void(BasicConstraintsExtension::*)()>(&BasicConstraintsExtension::encodeThis)), "java.io.IOException"},
