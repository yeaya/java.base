...
$MethodInfo _IntegerPolynomial$MutableElement_MethodInfo_[] = {
	...
	{"<init>", "(Lsun/security/util/math/intpoly/IntegerPolynomial;[JI)V", nullptr, $PROTECTED, $method(static_cast<void(IntegerPolynomial$MutableElement::*)($IntegerPolynomial*,$longs*,int32_t)>(&IntegerPolynomial$MutableElement::init$))},
	{"conditionalSet", "(Lsun/security/util/math/IntegerModuloP;I)V", nullptr, $PUBLIC},
	{"conditionalSwapWith", "(Lsun/security/util/math/MutableIntegerModuloP;I)V", nullptr, $PUBLIC},
	...
	{"setAdditiveInverse", "()Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setDifference", "(Lsun/security/util/math/IntegerModuloP;)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setProduct", "(Lsun/security/util/math/IntegerModuloP;)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setProduct", "(Lsun/security/util/math/SmallValue;)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setReduced", "()Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setSquare", "()Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setSum", "(Lsun/security/util/math/IntegerModuloP;)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setValue", "(Lsun/security/util/math/IntegerModuloP;)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setValue", "([BIIB)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
	{"setValue", "(Ljava/nio/ByteBuffer;IB)Lsun/security/util/math/intpoly/IntegerPolynomial$MutableElement;", nullptr, $PUBLIC},
