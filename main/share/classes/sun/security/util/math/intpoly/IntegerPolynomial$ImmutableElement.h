...
class $export IntegerPolynomial$ImmutableElement : public ::sun::security::util::math::intpoly::IntegerPolynomial$Element, public ::sun::security::util::math::ImmutableIntegerModuloP {
