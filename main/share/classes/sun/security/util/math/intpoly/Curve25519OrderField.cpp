...
$BigInteger* Curve25519OrderField::evaluateModulus() {
	...
	$useLocalObjectStack();
	$var($BigInteger, result, $($BigInteger::valueOf(2))->pow(252));
	$assign(result, result->add($($BigInteger::valueOf(0x00f5d3ed))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(26))->multiply($($BigInteger::valueOf(0x0098c697))))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(52))->multiply($($BigInteger::valueOf(0x01cd6581))))));
	$assign(result, result->subtract($($($($BigInteger::valueOf(2))->pow(78))->multiply($($BigInteger::valueOf(0x00857422))))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(104))->multiply($($BigInteger::valueOf(0x0014defa))))));
	return result;
}

void Curve25519OrderField::reduceIn($longs* limbs, int64_t v, int32_t i) {
	int64_t t0 = (int32_t)0xff0a2c13 * v;
	(*$nc(limbs))[i - 10] += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	(*limbs)[i - 9] += t0 >> 18;
	int64_t t1 = (int32_t)0xff673969 * v;
	(*limbs)[i - 9] += (t1 << 8) & Curve25519OrderField::LIMB_MASK;
	(*limbs)[i - 8] += t1 >> 18;
	int64_t t2 = (int32_t)0xfe329a7f * v;
	(*limbs)[i - 8] += (t2 << 8) & Curve25519OrderField::LIMB_MASK;
	(*limbs)[i - 7] += t2 >> 18;
	int64_t t3 = 0x00857422 * v;
	(*limbs)[i - 7] += (t3 << 8) & Curve25519OrderField::LIMB_MASK;
	(*limbs)[i - 6] += t3 >> 18;
	int64_t t4 = (int32_t)0xffeb2106 * v;
	(*limbs)[i - 6] += (t4 << 8) & Curve25519OrderField::LIMB_MASK;
	(*limbs)[i - 5] += t4 >> 18;
}
...
void Curve25519OrderField::carryReduce0($longs* r, int64_t c0, int64_t c1, int64_t c2, int64_t c3, int64_t c4, int64_t c5, int64_t c6, int64_t c7, int64_t c8, int64_t c9, int64_t c10, int64_t c11, int64_t c12, int64_t c13, int64_t c14, int64_t c15, int64_t c16, int64_t c17, int64_t c18, int64_t c19) {
	...
	c9 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c10 += t0 >> 18;
	t0 = (int32_t)0xff673969 * c19;
	c10 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c11 += t0 >> 18;
	t0 = (int32_t)0xfe329a7f * c19;
	c11 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c12 += t0 >> 18;
	t0 = 0x00857422 * c19;
	c12 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c13 += t0 >> 18;
	t0 = (int32_t)0xffeb2106 * c19;
	c13 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c14 += t0 >> 18;
	t0 = (int32_t)0xff0a2c13 * c18;
	c8 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c9 += t0 >> 18;
	...
	c7 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c8 += t0 >> 18;
	...
	c6 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c7 += t0 >> 18;
	...
	c5 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c6 += t0 >> 18;
	...
	c4 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c5 += t0 >> 18;
	...
	c3 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c4 += t0 >> 18;
	...
	c2 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c3 += t0 >> 18;
	...
	c1 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c2 += t0 >> 18;
	...
	c0 += (t0 << 8) & Curve25519OrderField::LIMB_MASK;
	c1 += t0 >> 18;
...
void Curve25519OrderField::clinit$($Class* clazz) {
...
$Class* Curve25519OrderField::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(Curve25519OrderField, init$, void)},
		{"carryReduce", "([JJJJJJJJJJJJJJJJJJJJ)V", nullptr, $PRIVATE, $method(Curve25519OrderField, carryReduce, void, $longs*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t)},
		{"carryReduce", "([JJJJJJJJJJJ)V", nullptr, $PRIVATE, $method(Curve25519OrderField, carryReduce, void, $longs*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t)},
		{"carryReduce0", "([JJJJJJJJJJJJJJJJJJJJJ)V", nullptr, 0, $virtualMethod(Curve25519OrderField, carryReduce0, void, $longs*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t)},
		{"carryReduce0", "([JJJJJJJJJJJJ)V", nullptr, 0, $virtualMethod(Curve25519OrderField, carryReduce0, void, $longs*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t)},
		{"carryReduce1", "([JJJJJJJJJJJJJJJJJJJJJ)V", nullptr, 0, $virtualMethod(Curve25519OrderField, carryReduce1, void, $longs*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t)},
		{"carryReduce2", "([JJJJJJJJJJJJJJJJJJJJJ)V", nullptr, 0, $virtualMethod(Curve25519OrderField, carryReduce2, void, $longs*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t)},
		{"evaluateModulus", "()Ljava/math/BigInteger;", nullptr, $PRIVATE | $STATIC, $staticMethod(Curve25519OrderField, evaluateModulus, $BigInteger*)},
		{"finalCarryReduceLast", "([J)V", nullptr, $PROTECTED, $virtualMethod(Curve25519OrderField, finalCarryReduceLast, void, $longs*)},
		{"mult", "([J[J[J)V", nullptr, $PROTECTED, $virtualMethod(Curve25519OrderField, mult, void, $longs*, $longs*, $longs*)},
		{"reduce", "([J)V", nullptr, $PROTECTED, $virtualMethod(Curve25519OrderField, reduce, void, $longs*)},
		{"reduceIn", "([JJI)V", nullptr, $PROTECTED, $virtualMethod(Curve25519OrderField, reduceIn, void, $longs*, int64_t, int32_t)},
		{"square", "([J[J)V", nullptr, $PROTECTED, $virtualMethod(Curve25519OrderField, square, void, $longs*, $longs*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$PUBLIC | $ACC_SUPER,
	...
	$loadClass(Curve25519OrderField, name, initialize, &classInfo$$, Curve25519OrderField::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Curve25519OrderField);
	});
	return class$;
}
