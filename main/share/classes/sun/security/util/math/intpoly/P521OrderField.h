#ifndef _sun_security_util_math_intpoly_P521OrderField_h_
#define _sun_security_util_math_intpoly_P521OrderField_h_
//$ class sun.security.util.math.intpoly.P521OrderField
...
class $export P521OrderField : public ::sun::security::util::math::intpoly::IntegerPolynomial {
	$class(P521OrderField, 0, ::sun::security::util::math::intpoly::IntegerPolynomial)
public:
	P521OrderField();
...
#endif // _sun_security_util_math_intpoly_P521OrderField_h_