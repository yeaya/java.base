#ifndef _sun_security_util_math_intpoly_P384OrderField_h_
#define _sun_security_util_math_intpoly_P384OrderField_h_
//$ class sun.security.util.math.intpoly.P384OrderField
...
class $export P384OrderField : public ::sun::security::util::math::intpoly::IntegerPolynomial {
	$class(P384OrderField, 0, ::sun::security::util::math::intpoly::IntegerPolynomial)
public:
	P384OrderField();
	...
	void carryReduce($longs* r, int64_t c0, int64_t c1, int64_t c2, int64_t c3, int64_t c4, int64_t c5, int64_t c6, int64_t c7, int64_t c8, int64_t c9, int64_t c10, int64_t c11, int64_t c12, int64_t c13);
	...
	virtual void carryReduce0($longs* r, int64_t c0, int64_t c1, int64_t c2, int64_t c3, int64_t c4, int64_t c5, int64_t c6, int64_t c7, int64_t c8, int64_t c9, int64_t c10, int64_t c11, int64_t c12, int64_t c13, int64_t c14);
	...
	static const int32_t NUM_LIMBS = 14;
...
#endif // _sun_security_util_math_intpoly_P384OrderField_h_