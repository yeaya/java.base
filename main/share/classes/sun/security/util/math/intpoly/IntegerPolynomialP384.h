#ifndef _sun_security_util_math_intpoly_IntegerPolynomialP384_h_
#define _sun_security_util_math_intpoly_IntegerPolynomialP384_h_
//$ class sun.security.util.math.intpoly.IntegerPolynomialP384
...
class $export IntegerPolynomialP384 : public ::sun::security::util::math::intpoly::IntegerPolynomial {
	$class(IntegerPolynomialP384, 0, ::sun::security::util::math::intpoly::IntegerPolynomial)
public:
...
#endif // _sun_security_util_math_intpoly_IntegerPolynomialP384_h_