#ifndef _sun_security_util_math_intpoly_P256OrderField_h_
#define _sun_security_util_math_intpoly_P256OrderField_h_
//$ class sun.security.util.math.intpoly.P256OrderField
...
class $export P256OrderField : public ::sun::security::util::math::intpoly::IntegerPolynomial {
	$class(P256OrderField, 0, ::sun::security::util::math::intpoly::IntegerPolynomial)
public:
	P256OrderField();
...
#endif // _sun_security_util_math_intpoly_P256OrderField_h_