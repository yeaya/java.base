...
$BigInteger* P521OrderField::evaluateModulus() {
	...
	$assign(result, result->add($($BigInteger::valueOf(0x01386409))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(28))->multiply($($BigInteger::valueOf(0x06fb71e9))))));
	$assign(result, result->subtract($($($($BigInteger::valueOf(2))->pow(56))->multiply($($BigInteger::valueOf(0x03b85145))))));
	$assign(result, result->subtract($($($($BigInteger::valueOf(2))->pow(84))->multiply($($BigInteger::valueOf(0x03647766))))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(112))->multiply($($BigInteger::valueOf(0x05d03bb6))))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(140))->multiply($($BigInteger::valueOf(0x048f709a))))));
	$assign(result, result->subtract($($($($BigInteger::valueOf(2))->pow(168))->multiply($($BigInteger::valueOf(0x048033ff))))));
	$assign(result, result->subtract($($($($BigInteger::valueOf(2))->pow(196))->multiply($($BigInteger::valueOf(0x040d0699))))));
	$assign(result, result->add($($($($BigInteger::valueOf(2))->pow(224))->multiply($($BigInteger::valueOf(0x01868784))))));
	$assign(result, result->subtract($($($($BigInteger::valueOf(2))->pow(252))->multiply($($BigInteger::valueOf(91))))));
	return result;
}

void P521OrderField::reduceIn($longs* limbs, int64_t v, int32_t i) {
	int64_t t0 = (int32_t)0xfec79bf7 * v;
	(*$nc(limbs))[i - 19] += (t0 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 18] += t0 >> 17;
	int64_t t1 = (int32_t)0xf9048e17 * v;
	(*limbs)[i - 18] += (t1 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 17] += t1 >> 17;
	int64_t t2 = 0x03b85145 * v;
	(*limbs)[i - 17] += (t2 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 16] += t2 >> 17;
	int64_t t3 = 0x03647766 * v;
	(*limbs)[i - 16] += (t3 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 15] += t3 >> 17;
	int64_t t4 = (int32_t)0xfa2fc44a * v;
	(*limbs)[i - 15] += (t4 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 14] += t4 >> 17;
	int64_t t5 = (int32_t)0xfb708f66 * v;
	(*limbs)[i - 14] += (t5 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 13] += t5 >> 17;
	int64_t t6 = 0x048033ff * v;
	(*limbs)[i - 13] += (t6 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 12] += t6 >> 17;
	int64_t t7 = 0x040d0699 * v;
	(*limbs)[i - 12] += (t7 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 11] += t7 >> 17;
	int64_t t8 = (int32_t)0xfe79787c * v;
	(*limbs)[i - 11] += (t8 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 10] += t8 >> 17;
	int64_t t9 = 91 * v;
	(*limbs)[i - 10] += (t9 << 11) & P521OrderField::LIMB_MASK;
	(*limbs)[i - 9] += t9 >> 17;
}
...
void P521OrderField::carryReduce0($longs* r, int64_t c0, int64_t c1, int64_t c2, int64_t c3, int64_t c4, int64_t c5, int64_t c6, int64_t c7, int64_t c8, int64_t c9, int64_t c10, int64_t c11, int64_t c12, int64_t c13, int64_t c14, int64_t c15, int64_t c16, int64_t c17, int64_t c18, int64_t c19, int64_t c20, int64_t c21, int64_t c22, int64_t c23, int64_t c24, int64_t c25, int64_t c26, int64_t c27, int64_t c28, int64_t c29, int64_t c30, int64_t c31, int64_t c32, int64_t c33, int64_t c34, int64_t c35, int64_t c36, int64_t c37) {
	...
	c18 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c19 += t0 >> 17;
	t0 = (int32_t)0xf9048e17 * c37;
	c19 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c20 += t0 >> 17;
	t0 = 0x03b85145 * c37;
	c20 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c21 += t0 >> 17;
	t0 = 0x03647766 * c37;
	c21 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c22 += t0 >> 17;
	t0 = (int32_t)0xfa2fc44a * c37;
	c22 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c23 += t0 >> 17;
	t0 = (int32_t)0xfb708f66 * c37;
	c23 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c24 += t0 >> 17;
	t0 = 0x048033ff * c37;
	c24 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c25 += t0 >> 17;
	t0 = 0x040d0699 * c37;
	c25 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c26 += t0 >> 17;
	t0 = (int32_t)0xfe79787c * c37;
	c26 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c27 += t0 >> 17;
	t0 = 91 * c37;
	c27 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c28 += t0 >> 17;
	t0 = (int32_t)0xfec79bf7 * c36;
	c17 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c18 += t0 >> 17;
	...
	c16 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c17 += t0 >> 17;
	...
	c15 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c16 += t0 >> 17;
	...
	c14 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c15 += t0 >> 17;
	...
	c13 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c14 += t0 >> 17;
	...
	c12 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c13 += t0 >> 17;
	...
	c11 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c12 += t0 >> 17;
	...
	c10 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c11 += t0 >> 17;
	...
	c9 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c10 += t0 >> 17;
...
void P521OrderField::carryReduce1($longs* r, int64_t c0, int64_t c1, int64_t c2, int64_t c3, int64_t c4, int64_t c5, int64_t c6, int64_t c7, int64_t c8, int64_t c9, int64_t c10, int64_t c11, int64_t c12, int64_t c13, int64_t c14, int64_t c15, int64_t c16, int64_t c17, int64_t c18, int64_t c19, int64_t c20, int64_t c21, int64_t c22, int64_t c23, int64_t c24, int64_t c25, int64_t c26, int64_t c27, int64_t c28, int64_t c29, int64_t c30, int64_t c31, int64_t c32, int64_t c33, int64_t c34, int64_t c35, int64_t c36, int64_t c37) {
	...
	c8 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c9 += t0 >> 17;
	...
	c7 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c8 += t0 >> 17;
	...
	c6 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c7 += t0 >> 17;
	...
	c5 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c6 += t0 >> 17;
	...
	c4 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c5 += t0 >> 17;
	...
	c3 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c4 += t0 >> 17;
	...
	c2 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c3 += t0 >> 17;
	...
	c1 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c2 += t0 >> 17;
	...
	c0 += (t0 << 11) & P521OrderField::LIMB_MASK;
	c1 += t0 >> 17;
...
void P521OrderField::clinit$($Class* clazz) {
...
$Class* P521OrderField::load$($String* name, bool initialize) {
	...
	$loadClass(P521OrderField, name, initialize, &classInfo$$, P521OrderField::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(P521OrderField);
	});
	return class$;
}
