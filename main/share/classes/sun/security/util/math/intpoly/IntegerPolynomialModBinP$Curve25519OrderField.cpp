...
$Class* IntegerPolynomialModBinP$Curve25519OrderField::load$($String* name, bool initialize) {
	...
	$loadClass(IntegerPolynomialModBinP$Curve25519OrderField, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(IntegerPolynomialModBinP$Curve25519OrderField);
	});
	return class$;
}
