...
void DisabledAlgorithmConstraints$Constraint$Operator::clinit$($Class* clazz) {
...
$Class* DisabledAlgorithmConstraints$Constraint$Operator::load$($String* name, bool initialize) {
	...
	$loadClass(DisabledAlgorithmConstraints$Constraint$Operator, name, initialize, &classInfo$$, DisabledAlgorithmConstraints$Constraint$Operator::clinit$, []($Class* clazz) -> $Object* {
