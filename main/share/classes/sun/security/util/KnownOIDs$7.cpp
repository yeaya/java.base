...
$Class* KnownOIDs$7::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V", nullptr, $PRIVATE | $TRANSIENT, $method(KnownOIDs$7, init$, void, $String*, int32_t, $String*, $String*, $StringArray*)},
		{"registerNames", "()Z", nullptr, 0, $virtualMethod(KnownOIDs$7, registerNames, bool)},
		{}
	};
	...
	$loadClass(KnownOIDs$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
