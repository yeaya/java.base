...
ConnectionResetException::ConnectionResetException(const ConnectionResetException& e) {
}

ConnectionResetException ConnectionResetException::wrapper$() {
	$pendingException(this);
	return *this;
}

void ConnectionResetException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
