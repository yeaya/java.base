...
void DefaultProxySelector$NonProxyInfo::clinit$($Class* clazz) {
...
$Class* DefaultProxySelector$NonProxyInfo::load$($String* name, bool initialize) {
	...
	$loadClass(DefaultProxySelector$NonProxyInfo, name, initialize, &classInfo$$, DefaultProxySelector$NonProxyInfo::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(DefaultProxySelector$NonProxyInfo);
	});
	return class$;
}
