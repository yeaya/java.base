...
$MethodInfo _KeepAliveStream_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/io/InputStream;Lsun/net/ProgressSource;JLsun/net/www/http/HttpClient;)V", nullptr, $PUBLIC, $method(static_cast<void(KeepAliveStream::*)($InputStream*,$ProgressSource*,int64_t,$HttpClient*)>(&KeepAliveStream::init$))},
	{"close", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"hurry", "()Z", nullptr, $PUBLIC},
	{"mark", "(I)V", nullptr, $PUBLIC},
	{"markSupported", "()Z", nullptr, $PUBLIC},
	{"queueForCleanup", "(Lsun/net/www/http/KeepAliveCleanerEntry;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($KeepAliveCleanerEntry*)>(&KeepAliveStream::queueForCleanup))},
	{"remainingToRead", "()J", nullptr, $PROTECTED},
	{"reset", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"setClosed", "()V", nullptr, $PROTECTED},
