...
$MethodInfo _HttpCaptureOutputStream_MethodInfo_[] = {
	{"<init>", "(Ljava/io/OutputStream;Lsun/net/www/http/HttpCapture;)V", nullptr, $PUBLIC, $method(static_cast<void(HttpCaptureOutputStream::*)($OutputStream*,$HttpCapture*)>(&HttpCaptureOutputStream::init$))},
