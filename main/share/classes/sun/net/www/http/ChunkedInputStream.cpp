...
$MethodInfo _ChunkedInputStream_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/io/InputStream;Lsun/net/www/http/HttpClient;Lsun/net/www/MessageHeader;)V", nullptr, $PUBLIC, $method(static_cast<void(ChunkedInputStream::*)($InputStream*,$HttpClient*,$MessageHeader*)>(&ChunkedInputStream::init$)), "java.io.IOException"},
	{"available", "()I", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"close", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"closeUnderlying", "()V", nullptr, $PRIVATE, $method(static_cast<void(ChunkedInputStream::*)()>(&ChunkedInputStream::closeUnderlying)), "java.io.IOException"},
	{"ensureOpen", "()V", nullptr, $PRIVATE, $method(static_cast<void(ChunkedInputStream::*)()>(&ChunkedInputStream::ensureOpen)), "java.io.IOException"},
	{"ensureRawAvailable", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(ChunkedInputStream::*)(int32_t)>(&ChunkedInputStream::ensureRawAvailable))},
	{"fastRead", "([BII)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ChunkedInputStream::*)($bytes*,int32_t,int32_t)>(&ChunkedInputStream::fastRead)), "java.io.IOException"},
	{"hurry", "()Z", nullptr, $PUBLIC},
	{"processRaw", "()V", nullptr, $PRIVATE, $method(static_cast<void(ChunkedInputStream::*)()>(&ChunkedInputStream::processRaw)), "java.io.IOException"},
	{"read", "()I", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"read", "([BII)I", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"readAhead", "(Z)I", nullptr, $PRIVATE, $method(static_cast<int32_t(ChunkedInputStream::*)(bool)>(&ChunkedInputStream::readAhead)), "java.io.IOException"},
	{"readAheadBlocking", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(ChunkedInputStream::*)()>(&ChunkedInputStream::readAheadBlocking)), "java.io.IOException"},
	{"readAheadNonBlocking", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(ChunkedInputStream::*)()>(&ChunkedInputStream::readAheadNonBlocking)), "java.io.IOException"},
