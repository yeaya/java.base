...
$MethodInfo HttpURLConnection$$Lambda$lambda$getNetProperty$0::methodInfos[3] = {
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(HttpURLConnection$$Lambda$lambda$getNetProperty$0::*)($String*)>(&HttpURLConnection$$Lambda$lambda$getNetProperty$0::init$))},
...
$MethodInfo _HttpURLConnection_MethodInfo_[] = {
	{"<init>", "(Ljava/net/URL;Lsun/net/www/protocol/http/Handler;)V", nullptr, $PROTECTED, $method(static_cast<void(HttpURLConnection::*)($URL*,$Handler*)>(&HttpURLConnection::init$)), "java.io.IOException"},
	{"<init>", "(Ljava/net/URL;Ljava/lang/String;I)V", nullptr, $PUBLIC, $method(static_cast<void(HttpURLConnection::*)($URL*,$String*,int32_t)>(&HttpURLConnection::init$)), "java.io.IOException"},
	{"<init>", "(Ljava/net/URL;Ljava/net/Proxy;)V", nullptr, $PUBLIC, $method(static_cast<void(HttpURLConnection::*)($URL*,$Proxy*)>(&HttpURLConnection::init$)), "java.io.IOException"},
	{"<init>", "(Ljava/net/URL;Ljava/net/Proxy;Lsun/net/www/protocol/http/Handler;)V", nullptr, $PROTECTED, $method(static_cast<void(HttpURLConnection::*)($URL*,$Proxy*,$Handler*)>(&HttpURLConnection::init$)), "java.io.IOException"},
	{"URLtoSocketPermission", "(Ljava/net/URL;)Ljava/net/SocketPermission;", nullptr, 0, nullptr, "java.io.IOException"},
	{"addRequestProperty", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"authObj", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{"authObj", "(Ljava/lang/Object;)V", nullptr, $PUBLIC},
	{"checkHost", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&HttpURLConnection::checkHost)), "java.io.IOException"},
	{"checkMessageHeader", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)($String*,$String*)>(&HttpURLConnection::checkMessageHeader))},
	{"checkResponseCredentials", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)(bool)>(&HttpURLConnection::checkResponseCredentials)), "java.io.IOException"},
	{"checkReuseConnection", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(HttpURLConnection::*)()>(&HttpURLConnection::checkReuseConnection))},
	{"checkSetHost", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(HttpURLConnection::*)()>(&HttpURLConnection::checkSetHost))},
	{"checkURL", "(Ljava/net/URL;)Ljava/net/URL;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$URL*(*)($URL*)>(&HttpURLConnection::checkURL)), "java.io.IOException"},
	{"checkURLFile", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::checkURLFile))},
	{"connect", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"connectRequestURI", "(Ljava/net/URL;)Ljava/lang/String;", nullptr, $STATIC, $method(static_cast<$String*(*)($URL*)>(&HttpURLConnection::connectRequestURI))},
	{"disconnect", "()V", nullptr, $PUBLIC},
	{"disconnectInternal", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::disconnectInternal))},
	{"disconnectWeb", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::disconnectWeb)), "java.io.IOException"},
	{"doTunneling", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"doTunneling0", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::doTunneling0)), "java.io.IOException"},
	{"expect100Continue", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::expect100Continue)), "java.io.IOException"},
	{"filterHeaderField", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(HttpURLConnection::*)($String*,$String*)>(&HttpURLConnection::filterHeaderField))},
	{"followRedirect", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(HttpURLConnection::*)()>(&HttpURLConnection::followRedirect)), "java.io.IOException"},
	{"followRedirect0", "(Ljava/lang/String;ILjava/net/URL;)Z", nullptr, $PRIVATE, $method(static_cast<bool(HttpURLConnection::*)($String*,int32_t,$URL*)>(&HttpURLConnection::followRedirect0)), "java.io.IOException"},
	{"getAuthenticatorKey", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getChainedException", "(Ljava/io/IOException;)Ljava/io/IOException;", nullptr, $PRIVATE, $method(static_cast<$IOException*(HttpURLConnection::*)($IOException*)>(&HttpURLConnection::getChainedException))},
	{"getConnectTimeout", "()I", nullptr, $PUBLIC},
	{"getCookieHandler", "()Ljava/net/CookieHandler;", nullptr, $PUBLIC},
	{"getErrorStream", "()Ljava/io/InputStream;", nullptr, $PUBLIC},
	{"getFilteredHeaderFields", "()Ljava/util/Map;", "()Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;", $PRIVATE, $method(static_cast<$Map*(HttpURLConnection::*)()>(&HttpURLConnection::getFilteredHeaderFields))},
	...
	{"getHostAndPort", "(Ljava/net/URL;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(HttpURLConnection::*)($URL*)>(&HttpURLConnection::getHostAndPort))},
	{"getHttpLogger", "()Lsun/util/logging/PlatformLogger;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$PlatformLogger*(*)()>(&HttpURLConnection::getHttpLogger))},
	{"getHttpProxyAuthentication", "(Lsun/net/www/protocol/http/AuthenticationHeader;)Lsun/net/www/protocol/http/AuthenticationInfo;", nullptr, $PRIVATE, $method(static_cast<$AuthenticationInfo*(HttpURLConnection::*)($AuthenticationHeader*)>(&HttpURLConnection::getHttpProxyAuthentication))},
	{"getInputStream", "()Ljava/io/InputStream;", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"getInputStream0", "()Ljava/io/InputStream;", nullptr, $PRIVATE, $method(static_cast<$InputStream*(HttpURLConnection::*)()>(&HttpURLConnection::getInputStream0)), "java.io.IOException"},
	{"getMethod", "()Ljava/lang/String;", nullptr, 0},
	{"getNetProperty", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&HttpURLConnection::getNetProperty))},
	...
	{"getOutputStream0", "()Ljava/io/OutputStream;", nullptr, $PRIVATE, $method(static_cast<$OutputStream*(HttpURLConnection::*)()>(&HttpURLConnection::getOutputStream0)), "java.io.IOException"},
	...
	{"getRequestURI", "()Ljava/lang/String;", nullptr, 0, nullptr, "java.io.IOException"},
	{"getServerAuthentication", "(Lsun/net/www/protocol/http/AuthenticationHeader;)Lsun/net/www/protocol/http/AuthenticationInfo;", nullptr, $PRIVATE, $method(static_cast<$AuthenticationInfo*(HttpURLConnection::*)($AuthenticationHeader*)>(&HttpURLConnection::getServerAuthentication))},
	{"getUserSetHeaders", "()Lsun/net/www/MessageHeader;", nullptr, 0},
	{"hostsEqual", "(Ljava/net/URL;Ljava/net/URL;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($URL*,$URL*)>(&HttpURLConnection::hostsEqual))},
	{"isExternalMessageHeaderAllowed", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(HttpURLConnection::*)($String*,$String*)>(&HttpURLConnection::isExternalMessageHeaderAllowed))},
	{"isLockHeldByCurrentThread", "()Z", nullptr, $PUBLIC | $FINAL, $method(static_cast<bool(HttpURLConnection::*)()>(&HttpURLConnection::isLockHeldByCurrentThread))},
	{"isRestrictedHeader", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(HttpURLConnection::*)($String*,$String*)>(&HttpURLConnection::isRestrictedHeader))},
	{"lambda$getNetProperty$0", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$String*(*)($String*)>(&HttpURLConnection::lambda$getNetProperty$0))},
	{"lock", "()V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::lock))},
	{"mapToMessageHeader", "(Ljava/util/Map;)Lsun/net/www/MessageHeader;", "(Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;)Lsun/net/www/MessageHeader;", $PRIVATE, $method(static_cast<$MessageHeader*(HttpURLConnection::*)($Map*)>(&HttpURLConnection::mapToMessageHeader))},
	{"openConnectionCheckRedirects", "(Ljava/net/URLConnection;)Ljava/io/InputStream;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$InputStream*(*)($URLConnection*)>(&HttpURLConnection::openConnectionCheckRedirects)), "java.io.IOException"},
	{"plainConnect", "()V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"plainConnect0", "()V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"privilegedRequestPasswordAuthentication", "(Ljava/net/Authenticator;Ljava/lang/String;Ljava/net/InetAddress;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/URL;Ljava/net/Authenticator$RequestorType;)Ljava/net/PasswordAuthentication;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$PasswordAuthentication*(*)($Authenticator*,$String*,$InetAddress*,int32_t,$String*,$String*,$String*,$URL*,$Authenticator$RequestorType*)>(&HttpURLConnection::privilegedRequestPasswordAuthentication))},
	{"proxiedConnect", "(Ljava/net/URL;Ljava/lang/String;IZ)V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"reset", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::reset)), "java.io.IOException"},
	{"resetProxyAuthentication", "(Lsun/net/www/protocol/http/AuthenticationInfo;Lsun/net/www/protocol/http/AuthenticationHeader;)Lsun/net/www/protocol/http/AuthenticationInfo;", nullptr, $PRIVATE, $method(static_cast<$AuthenticationInfo*(HttpURLConnection::*)($AuthenticationInfo*,$AuthenticationHeader*)>(&HttpURLConnection::resetProxyAuthentication)), "java.io.IOException"},
	{"sameDestination", "(Ljava/net/URL;Ljava/net/URL;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($URL*,$URL*)>(&HttpURLConnection::sameDestination))},
	{"schemesListToSet", "(Ljava/lang/String;)Ljava/util/Set;", "(Ljava/lang/String;)Ljava/util/Set<Ljava/lang/String;>;", $PRIVATE | $STATIC, $method(static_cast<$Set*(*)($String*)>(&HttpURLConnection::schemesListToSet))},
	{"sendCONNECTRequest", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::sendCONNECTRequest)), "java.io.IOException"},
	{"setAuthenticationProperty", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setAuthenticator", "(Ljava/net/Authenticator;)V", nullptr, $PUBLIC},
	{"setConnectTimeout", "(I)V", nullptr, $PUBLIC},
	{"setCookieHeader", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::setCookieHeader)), "java.io.IOException"},
	{"setDefaultAuthenticator", "(Lsun/net/www/protocol/http/HttpAuthenticator;)V", nullptr, $PUBLIC | $STATIC | $DEPRECATED, $method(static_cast<void(*)($HttpAuthenticator*)>(&HttpURLConnection::setDefaultAuthenticator)), nullptr, nullptr, _HttpURLConnection_MethodAnnotations_setDefaultAuthenticator74},
	...
	{"setPreemptiveProxyAuthentication", "(Lsun/net/www/MessageHeader;)V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)($MessageHeader*)>(&HttpURLConnection::setPreemptiveProxyAuthentication)), "java.io.IOException"},
	...
	{"setTunnelState", "(Lsun/net/www/protocol/http/HttpURLConnection$TunnelState;)V", nullptr, $PUBLIC},
	{"streaming", "()Z", nullptr, $PUBLIC},
	{"stripIPv6ZoneId", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $STATIC, $method(static_cast<$String*(*)($String*)>(&HttpURLConnection::stripIPv6ZoneId))},
	{"tunnelState", "()Lsun/net/www/protocol/http/HttpURLConnection$TunnelState;", nullptr, 0},
	{"unlock", "()V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::unlock))},
	{"usingProxy", "()Z", nullptr, $PUBLIC},
	{"usingProxyInternal", "()Z", nullptr, 0},
	{"writeRequests", "()V", nullptr, $PRIVATE, $method(static_cast<void(HttpURLConnection::*)()>(&HttpURLConnection::writeRequests)), "java.io.IOException"},
	{}
};
...
void HttpURLConnection::expect100Continue() {
	...
	try {
		...
		$var($SocketTimeoutException, se, $catch());
		if (!enforceTimeOut) {
			$throw(se);
		}
		timedOut = true;
...
$Map* HttpURLConnection::getFilteredHeaderFields() {
	...
	return $assignField(this, filteredHeaders, $Collections::unmodifiableMap(tmpMap));
}
