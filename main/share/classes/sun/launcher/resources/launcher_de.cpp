...
$ObjectArray2* launcher_de::getContents() {
	...
	return $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			"Fehler: Hauptklasse {0} konnte nicht gefunden oder geladen werden\nUrsache: {1}: {2}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error2"_s,
			"Fehler: Hauptmethode ist nicht {0} in Klasse {1}. Definieren Sie die Hauptmethode als:\n   public static void main(String[] args)"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error3"_s,
			u"Fehler: Hauptmethode muss einen Wert vom Typ void in Klasse {0} zurückgeben. Definieren Sie \ndie Hauptmethode als:\n   public static void main(String[] args)"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error4"_s,
			"Fehler: Hauptmethode in Klasse {0} nicht gefunden. Definieren Sie die Hauptmethode als:\n   public static void main(String[] args):\noder eine JavaFX-Anwendung muss {1} erweitern"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error5"_s,
			u"Fehler: Zum Ausführen dieser Anwendung benötigte JavaFX-Runtime-Komponenten fehlen"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error6"_s,
			"Fehler: Beim Laden der Klasse {0} ist ein LinkageError aufgetreten\n\t{1}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error7"_s,
			"Fehler: Hauptklasse {0} kann nicht initialisiert werden\nUrsache: {1}: {2}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.init.error"_s,
			"Initialisierungsfehler"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error1"_s,
			u"Fehler: Beim Versuch, Datei {0} zu öffnen, ist ein unerwarteter Fehler aufgetreten"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error2"_s,
			"Manifest in {0} nicht gefunden"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error3"_s,
			"kein Hauptmanifestattribut, in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error4"_s,
			"Fehler beim Laden des Java-Agents in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.javafx.error1"_s,
			u"Fehler: Die JavaFX-Methode launchApplication hat die falsche Signatur, sie\nmuss als statisch deklariert werden und einen Wert vom Typ VOID zurückgeben"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error1"_s,
			"Modul {0} weist kein MainClass-Attribut auf. Verwenden Sie -m <module>/<main-class>"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error2"_s,
			"Fehler: Hauptklasse {0} konnte in Modul {1} nicht gefunden oder geladen werden"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error3"_s,
			"Fehler: Hauptklasse {0} kann nicht in Modul {1} geladen werden\n\t{2}"_s
		}),
		$$new($ObjectArray, {
...
$Class* launcher_de::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(launcher_de, init$, void)},
		{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL, $virtualMethod(launcher_de, getContents, $ObjectArray2*)},
		{}
	};
	$ClassInfo classInfo$$ = {
	...
	$loadClass(launcher_de, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(launcher_de);
	});
	return class$;
}
