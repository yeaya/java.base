...
$ObjectArray2* launcher::getContents() {
	...
	return $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			"Error: JavaFX runtime components are missing, and are required to run this application"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			"initialization error"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error1"_s,
			"Error: An unexpected error occurred while trying to open file {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error2"_s,
			"manifest not found in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error3"_s,
			"no main manifest attribute, in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error4"_s,
			"error loading java agent in {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			"module {0} does not have a ModuleMainClass attribute, use -m <module>/<main-class>"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error2"_s,
			"Error: Could not find or load main class {0} in module {1}"_s
		}),
		$$new($ObjectArray, {
