...
$ObjectArray2* launcher_ja::getContents() {
	...
	return $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			u"エラー: メイン・クラス{0}を検出およびロードできませんでした\n原因: {1}: {2}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error2"_s,
			u"エラー: メイン・メソッドがクラス{1}の{0}ではありません。次のようにメイン・メソッドを定義してください。\n   public static void main(String[] args)"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error3"_s,
			u"エラー: メイン・メソッドはクラス{0}のvoid型の値を返す必要があります。\n次のようにメイン・メソッドを定義してください。\n   public static void main(String[] args)"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error4"_s,
			u"エラー: メイン・メソッドがクラス{0}で見つかりません。次のようにメイン・メソッドを定義してください。\n   public static void main(String[] args)\nまたはJavaFXアプリケーション・クラスは{1}を拡張する必要があります"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error5"_s,
			u"エラー: JavaFXランタイム・コンポーネントが不足しており、このアプリケーションの実行に必要です"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error6"_s,
			u"エラー: メイン・クラス{0}のロード中にLinkageErrorが発生しました\n\t{1}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error7"_s,
			u"エラー: メイン・クラス{0}を初期化できません\n原因: {1}: {2}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"エラー: ファイル{0}を開こうとしているときに、予期しないエラーが発生しました"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error2"_s,
			u"{0}にマニフェストが見つかりません"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error3"_s,
			u"{0}にメイン・マニフェスト属性がありません"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error4"_s,
			u"{0}内のJavaエージェントのロード中にエラーが発生しました"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.javafx.error1"_s,
			u"エラー: JavaFX launchApplicationメソッドに誤ったシグネチャがあり、\nstaticを宣言してvoid型の値を返す必要があります"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error1"_s,
			u"モジュール{0}にModuleMainClass属性がありません。-m <module>/<main-class>を使用してください"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error2"_s,
			u"エラー: モジュール{1}にメイン・クラス{0}が見つからなかったかロードできませんでした"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error3"_s,
			u"エラー: モジュール{1}のメイン・クラス{0}をロードできません\n\t{2}"_s
		}),
		$$new($ObjectArray, {
