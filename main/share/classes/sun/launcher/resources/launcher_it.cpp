...
$ObjectArray2* launcher_it::getContents() {
	...
	return $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			"Errore: impossibile trovare o caricare la classe principale {0}\nCausato da: {1}: {2}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error2"_s,
			u"Errore: il metodo principale non è {0} nella classe {1}. Definire il metodo principale come:\n   public static void main(String[] args)"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error3"_s,
			"Errore: il metodo principale deve restituire un valore di tipo void nella classe {0}. \nDefinire il metodo principale come:\n   public static void main(String[] args)"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error4"_s,
			u"Errore: il metodo principale non è stato trovato nella classe {0}. Definire il metodo principale come:\n   public static void main(String[] args)\naltrimenti una classe applicazione JavaFX deve estendere {1}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error5"_s,
			"Errore: non sono presenti i componenti runtime di JavaFX necessari per eseguire questa applicazione"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error6"_s,
			"Errore: LinkageError durante il caricamento della classe principale {0}\n\t{1}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.cls.error7"_s,
			"Errore: impossibile inizializzare la classe principale {0}\nCausato da: {1}: {2}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.init.error"_s,
			"errore di inizializzazione"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error1"_s,
			u"Errore: si è verificato un errore imprevisto durante il tentativo di aprire il file {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error2"_s,
			"manifest non trovato in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error3"_s,
			"nessun attributo manifest principale in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.jar.error4"_s,
			"errore durante il caricamento dell\'\'agente java in {0}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.javafx.error1"_s,
			"Errore: il metodo JavaFX launchApplication dispone di una firma errata, \nla firma deve essere dichiarata static e restituire un valore di tipo void"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error1"_s,
			"il modulo {0} non dispone di un attributo MainClass. Utilizzare -m <module>/<mail-class>"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error2"_s,
			"Errore: impossibile trovare o caricare la classe principale {0} nel modulo {1}"_s
		}),
		$$new($ObjectArray, {
			"java.launcher.module.error3"_s,
			"Errore: impossibile caricare la classe principale {0} nel modulo {1}\n\t{2}"_s
		}),
		$$new($ObjectArray, {
...
$Class* launcher_it::load$($String* name, bool initialize) {
	...
	$loadClass(launcher_it, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(launcher_it);
	});
	return class$;
}
