...
$MethodInfo _LocalGregorianCalendar_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;[Lsun/util/calendar/Era;)V", nullptr, $PRIVATE, $method(static_cast<void(LocalGregorianCalendar::*)($String*,$EraArray*)>(&LocalGregorianCalendar::init$))},
	{"adjustYear", "(Lsun/util/calendar/LocalGregorianCalendar$Date;JI)Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PRIVATE, $method(static_cast<$LocalGregorianCalendar$Date*(LocalGregorianCalendar::*)($LocalGregorianCalendar$Date*,int64_t,int32_t)>(&LocalGregorianCalendar::adjustYear))},
	{"convertUnicodeEscape", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&LocalGregorianCalendar::convertUnicodeEscape))},
	{"getCalendarDate", "()Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PUBLIC},
	{"getCalendarDate", "(J)Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PUBLIC},
	{"getCalendarDate", "(JLjava/util/TimeZone;)Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PUBLIC},
	{"getCalendarDate", "(JLsun/util/calendar/CalendarDate;)Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PUBLIC},
	{"getCalendarDateFromFixedDate", "(Lsun/util/calendar/CalendarDate;J)V", nullptr, $PUBLIC},
	{"getLocalGregorianCalendar", "(Ljava/lang/String;)Lsun/util/calendar/LocalGregorianCalendar;", nullptr, $STATIC, $method(static_cast<LocalGregorianCalendar*(*)($String*)>(&LocalGregorianCalendar::getLocalGregorianCalendar))},
	{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"isLeapYear", "(I)Z", nullptr, $PUBLIC},
	{"isLeapYear", "(Lsun/util/calendar/Era;I)Z", nullptr, $PUBLIC},
	{"isValidEra", "(Lsun/util/calendar/Era;[Lsun/util/calendar/Era;)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($Era*,$EraArray*)>(&LocalGregorianCalendar::isValidEra))},
	{"newCalendarDate", "()Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PUBLIC},
	{"newCalendarDate", "(Ljava/util/TimeZone;)Lsun/util/calendar/LocalGregorianCalendar$Date;", nullptr, $PUBLIC},
	{"normalize", "(Lsun/util/calendar/CalendarDate;)Z", nullptr, $PUBLIC},
	{"normalizeMonth", "(Lsun/util/calendar/CalendarDate;)V", nullptr, 0},
	{"normalizeYear", "(Lsun/util/calendar/CalendarDate;)V", nullptr, 0},
	{"parseEraEntry", "(Ljava/lang/String;)Lsun/util/calendar/Era;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$Era*(*)($String*)>(&LocalGregorianCalendar::parseEraEntry))},
	{"validate", "(Lsun/util/calendar/CalendarDate;)Z", nullptr, $PUBLIC},
	{"validateEra", "(Lsun/util/calendar/Era;)Z", nullptr, $PRIVATE, $method(static_cast<bool(LocalGregorianCalendar::*)($Era*)>(&LocalGregorianCalendar::validateEra))},
	{}
};
