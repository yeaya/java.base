...
class $export SPILocaleProviderAdapter$DateFormatProviderDelegate : public ::java::text::spi::DateFormatProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
