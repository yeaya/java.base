...
class $export SPILocaleProviderAdapter$LocaleNameProviderDelegate : public ::java::util::spi::LocaleNameProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
