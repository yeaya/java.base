...
class $export SPILocaleProviderAdapter$BreakIteratorProviderDelegate : public ::java::text::spi::BreakIteratorProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
