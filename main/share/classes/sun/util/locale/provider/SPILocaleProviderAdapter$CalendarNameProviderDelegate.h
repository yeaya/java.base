...
class $export SPILocaleProviderAdapter$CalendarNameProviderDelegate : public ::java::util::spi::CalendarNameProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
