...
class $export SPILocaleProviderAdapter$CalendarDataProviderDelegate : public ::java::util::spi::CalendarDataProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
