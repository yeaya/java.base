...
class $export SPILocaleProviderAdapter$CurrencyNameProviderDelegate : public ::java::util::spi::CurrencyNameProvider, public ::sun::util::locale::provider::SPILocaleProviderAdapter$Delegate {
