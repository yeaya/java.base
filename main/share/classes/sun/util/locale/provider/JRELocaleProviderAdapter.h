...
class $export JRELocaleProviderAdapter : public ::sun::util::locale::provider::LocaleProviderAdapter, public ::sun::util::locale::provider::ResourceBundleBasedAdapter {
