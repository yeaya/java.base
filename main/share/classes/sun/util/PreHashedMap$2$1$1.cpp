...
$Object* PreHashedMap$2$1$1::getValue() {
	return $nc($nc(this->this$2->this$1)->this$0)->get(this->k);
}
...
int32_t PreHashedMap$2$1$1::hashCode() {
	...
	return (var$0 + (v == nullptr ? 0 : v->hashCode()));
}
...
bool PreHashedMap$2$1$1::equals(Object$* ob) {
	...
	bool var$0 = $cast($String, this->getKey()) == nullptr ? $nc(that)->getKey() == nullptr : $$sure($String, this->getKey())->equals($($nc(that)->getKey()));
	return (var$0 && (this->getValue() == nullptr ? $nc(that)->getValue() == nullptr : $$nc(this->getValue())->equals($($nc(that)->getValue()))));
}
...
$Class* PreHashedMap$2$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(PreHashedMap$2$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PreHashedMap$2$1$1);
	});
	return class$;
}
