...
$InnerClassInfo _AESCipher$AES256_ECB_NoPadding_InnerClassesInfo_[] = {
...
$ClassInfo _AESCipher$AES256_ECB_NoPadding_ClassInfo_ = {
	$PUBLIC | $FINAL | $ACC_SUPER,
	"com.sun.crypto.provider.AESCipher$AES256_ECB_NoPadding",
	"com.sun.crypto.provider.AESCipher$OidImpl",
	nullptr,
	nullptr,
	_AESCipher$AES256_ECB_NoPadding_MethodInfo_,
	nullptr,
	nullptr,
	_AESCipher$AES256_ECB_NoPadding_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$AESCipher$AES256_ECB_NoPadding($Class* clazz) {
	return $of($alloc(AESCipher$AES256_ECB_NoPadding));
}
...
$Class* AESCipher$AES256_ECB_NoPadding::load$($String* name, bool initialize) {
	$loadClass(AESCipher$AES256_ECB_NoPadding, name, initialize, &_AESCipher$AES256_ECB_NoPadding_ClassInfo_, allocate$AESCipher$AES256_ECB_NoPadding);
	return class$;
}
