...
$MethodInfo _GaloisCounterMode_MethodInfo_[] = {
	{"<init>", "(ILcom/sun/crypto/provider/SymmetricCipher;)V", nullptr, 0, $method(static_cast<void(GaloisCounterMode::*)(int32_t,$SymmetricCipher*)>(&GaloisCounterMode::init$))},
	{"checkDataLength", "([I)V", nullptr, $PRIVATE | $TRANSIENT, $method(static_cast<void(GaloisCounterMode::*)($ints*)>(&GaloisCounterMode::checkDataLength))},
	{"checkInit", "()V", nullptr, 0},
	{"checkReInit", "()V", nullptr, 0},
	{"createIv", "(Ljava/security/SecureRandom;)[B", nullptr, $PRIVATE | $STATIC, $method(static_cast<$bytes*(*)($SecureRandom*)>(&GaloisCounterMode::createIv))},
	...
	{"expandToOneBlock", "([BIII)[B", nullptr, $PRIVATE | $STATIC, $method(static_cast<$bytes*(*)($bytes*,int32_t,int32_t,int32_t)>(&GaloisCounterMode::expandToOneBlock))},
	{"getJ0", "([B[BI)[B", nullptr, $PRIVATE | $STATIC, $method(static_cast<$bytes*(*)($bytes*,$bytes*,int32_t)>(&GaloisCounterMode::getJ0))},
	{"getLengthBlock", "(I)[B", nullptr, $PRIVATE | $STATIC, $method(static_cast<$bytes*(*)(int32_t)>(&GaloisCounterMode::getLengthBlock))},
	{"getLengthBlock", "(II)[B", nullptr, $PRIVATE | $STATIC, $method(static_cast<$bytes*(*)(int32_t,int32_t)>(&GaloisCounterMode::getLengthBlock))},
	{"increment32", "([B)V", nullptr, $STATIC, $method(static_cast<void(*)($bytes*)>(&GaloisCounterMode::increment32))},
	{"init", "(ILjava/security/Key;Ljavax/crypto/spec/GCMParameterSpec;)V", nullptr, 0, nullptr, "java.security.InvalidKeyException,java.security.InvalidAlgorithmParameterException"},
	{}
};
