...
$Class* PBEKeyFactory$PBEWithHmacSHA384AndAES_256::load$($String* name, bool initialize) {
	...
	$loadClass(PBEKeyFactory$PBEWithHmacSHA384AndAES_256, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBEKeyFactory$PBEWithHmacSHA384AndAES_256);
	});
	return class$;
}
