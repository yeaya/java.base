...
$Class* PBES2Parameters$HmacSHA224AndAES_128::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBES2Parameters$HmacSHA224AndAES_128, init$, void), "java.security.NoSuchAlgorithmException"},
		{}
	};
	...
	$loadClass(PBES2Parameters$HmacSHA224AndAES_128, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBES2Parameters$HmacSHA224AndAES_128);
	});
	return class$;
}
