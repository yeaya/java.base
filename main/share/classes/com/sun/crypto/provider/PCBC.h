#ifndef _com_sun_crypto_provider_PCBC_h_
#define _com_sun_crypto_provider_PCBC_h_
//$ class com.sun.crypto.provider.PCBC
...
class PCBC : public ::com::sun::crypto::provider::FeedbackCipher {
	$class(PCBC, $NO_CLASS_INIT, ::com::sun::crypto::provider::FeedbackCipher)
public:
	PCBC();
