...
$MethodInfo _PBES2Core$HmacSHA384AndAES_128_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(PBES2Core$HmacSHA384AndAES_128::*)()>(&PBES2Core$HmacSHA384AndAES_128::init$)), "java.security.NoSuchAlgorithmException,javax.crypto.NoSuchPaddingException"},
	{}
};
...
PBES2Core$HmacSHA384AndAES_128::PBES2Core$HmacSHA384AndAES_128() {
}
...
$Class* PBES2Core$HmacSHA384AndAES_128::class$ = nullptr;
