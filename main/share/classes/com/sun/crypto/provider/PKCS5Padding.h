#ifndef _com_sun_crypto_provider_PKCS5Padding_h_
#define _com_sun_crypto_provider_PKCS5Padding_h_
...
class PKCS5Padding : public ::com::sun::crypto::provider::Padding {
	$class(PKCS5Padding, $NO_CLASS_INIT, ::com::sun::crypto::provider::Padding)
public:
	PKCS5Padding();
...
#endif // _com_sun_crypto_provider_PKCS5Padding_h_