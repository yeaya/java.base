...
$MethodInfo _PBES2Parameters$HmacSHA384AndAES_256_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(PBES2Parameters$HmacSHA384AndAES_256::*)()>(&PBES2Parameters$HmacSHA384AndAES_256::init$)), "java.security.NoSuchAlgorithmException"},
	{}
};
