#ifndef _com_sun_crypto_provider_HmacSHA1KeyGenerator_h_
#define _com_sun_crypto_provider_HmacSHA1KeyGenerator_h_
//$ class com.sun.crypto.provider.HmacSHA1KeyGenerator
...
class $export HmacSHA1KeyGenerator : public ::javax::crypto::KeyGeneratorSpi {
	$class(HmacSHA1KeyGenerator, $NO_CLASS_INIT, ::javax::crypto::KeyGeneratorSpi)
public:
...
#endif // _com_sun_crypto_provider_HmacSHA1KeyGenerator_h_