...
$MethodInfo _DESedeWrapCipher_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DESedeWrapCipher::*)()>(&DESedeWrapCipher::init$))},
	...
	{"getChecksum", "([B)[B", nullptr, $PRIVATE | $STATIC | $FINAL, $method(static_cast<$bytes*(*)($bytes*)>(&DESedeWrapCipher::getChecksum))},
	{"getChecksum", "([BII)[B", nullptr, $PRIVATE | $STATIC | $FINAL, $method(static_cast<$bytes*(*)($bytes*,int32_t,int32_t)>(&DESedeWrapCipher::getChecksum))},
	{}
};
