...
$Class* KeyGeneratorCore$HmacKG$SHA512_224::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(KeyGeneratorCore$HmacKG$SHA512_224, init$, void)},
		{}
	};
	...
	$loadClass(KeyGeneratorCore$HmacKG$SHA512_224, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(KeyGeneratorCore$HmacKG$SHA512_224);
	});
	return class$;
}
