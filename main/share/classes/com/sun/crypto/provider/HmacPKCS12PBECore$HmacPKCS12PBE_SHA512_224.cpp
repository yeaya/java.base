...
$Class* HmacPKCS12PBECore$HmacPKCS12PBE_SHA512_224::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(HmacPKCS12PBECore$HmacPKCS12PBE_SHA512_224, init$, void), "java.security.NoSuchAlgorithmException"},
		{"clone", "()Ljava/lang/Object;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $virtualMethod(HmacPKCS12PBECore$HmacPKCS12PBE_SHA512_224, clone, $Object*), "java.lang.CloneNotSupportedException"},
		{}
	};
	...
	$loadClass(HmacPKCS12PBECore$HmacPKCS12PBE_SHA512_224, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
