...
$Class* KeyWrapCipher$AES128_KW_NoPadding::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(KeyWrapCipher$AES128_KW_NoPadding, init$, void)},
		{}
	};
	...
	$loadClass(KeyWrapCipher$AES128_KW_NoPadding, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(KeyWrapCipher$AES128_KW_NoPadding);
	});
	return class$;
}
