...
$Class* PBKDF2Core$HmacSHA512::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBKDF2Core$HmacSHA512, init$, void)},
		{}
	};
	...
	$loadClass(PBKDF2Core$HmacSHA512, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBKDF2Core$HmacSHA512);
	});
	return class$;
}
