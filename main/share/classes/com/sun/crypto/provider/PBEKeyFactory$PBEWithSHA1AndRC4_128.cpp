...
$Class* PBEKeyFactory$PBEWithSHA1AndRC4_128::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBEKeyFactory$PBEWithSHA1AndRC4_128, init$, void)},
		{}
	};
	...
	$loadClass(PBEKeyFactory$PBEWithSHA1AndRC4_128, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBEKeyFactory$PBEWithSHA1AndRC4_128);
	});
	return class$;
}
