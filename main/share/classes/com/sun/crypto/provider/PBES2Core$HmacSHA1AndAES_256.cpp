...
$Class* PBES2Core$HmacSHA1AndAES_256::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBES2Core$HmacSHA1AndAES_256, init$, void), "java.security.NoSuchAlgorithmException,javax.crypto.NoSuchPaddingException"},
		{}
	};
	...
	$loadClass(PBES2Core$HmacSHA1AndAES_256, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBES2Core$HmacSHA1AndAES_256);
	});
	return class$;
}
