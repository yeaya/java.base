...
$MethodInfo _PBES2Core_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;I)V", nullptr, 0, $method(static_cast<void(PBES2Core::*)($String*,$String*,int32_t)>(&PBES2Core::init$)), "java.security.NoSuchAlgorithmException,javax.crypto.NoSuchPaddingException"},
