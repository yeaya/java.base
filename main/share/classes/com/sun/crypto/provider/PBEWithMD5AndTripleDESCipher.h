#ifndef _com_sun_crypto_provider_PBEWithMD5AndTripleDESCipher_h_
#define _com_sun_crypto_provider_PBEWithMD5AndTripleDESCipher_h_
//$ class com.sun.crypto.provider.PBEWithMD5AndTripleDESCipher
...
class $export PBEWithMD5AndTripleDESCipher : public ::javax::crypto::CipherSpi {
	$class(PBEWithMD5AndTripleDESCipher, $NO_CLASS_INIT, ::javax::crypto::CipherSpi)
public:
...
#endif // _com_sun_crypto_provider_PBEWithMD5AndTripleDESCipher_h_