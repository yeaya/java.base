...
$MethodInfo _AESCipher$AES192_OFB_NoPadding_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(AESCipher$AES192_OFB_NoPadding::*)()>(&AESCipher$AES192_OFB_NoPadding::init$))},
	{}
};

$InnerClassInfo _AESCipher$AES192_OFB_NoPadding_InnerClassesInfo_[] = {
...
$ClassInfo _AESCipher$AES192_OFB_NoPadding_ClassInfo_ = {
	$PUBLIC | $FINAL | $ACC_SUPER,
	"com.sun.crypto.provider.AESCipher$AES192_OFB_NoPadding",
	"com.sun.crypto.provider.AESCipher$OidImpl",
	nullptr,
	nullptr,
	_AESCipher$AES192_OFB_NoPadding_MethodInfo_,
	nullptr,
	nullptr,
	_AESCipher$AES192_OFB_NoPadding_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
...
$Object* allocate$AESCipher$AES192_OFB_NoPadding($Class* clazz) {
	return $of($alloc(AESCipher$AES192_OFB_NoPadding));
}
...
$Class* AESCipher$AES192_OFB_NoPadding::load$($String* name, bool initialize) {
	$loadClass(AESCipher$AES192_OFB_NoPadding, name, initialize, &_AESCipher$AES192_OFB_NoPadding_ClassInfo_, allocate$AESCipher$AES192_OFB_NoPadding);
	return class$;
}
