...
$Class* AESCipher$AES128_OFB_NoPadding::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(AESCipher$AES128_OFB_NoPadding, init$, void)},
		{}
	};
	...
	$loadClass(AESCipher$AES128_OFB_NoPadding, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AESCipher$AES128_OFB_NoPadding);
	});
	return class$;
}
