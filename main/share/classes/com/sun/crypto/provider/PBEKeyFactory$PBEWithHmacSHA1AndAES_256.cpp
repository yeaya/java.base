...
$Class* PBEKeyFactory$PBEWithHmacSHA1AndAES_256::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBEKeyFactory$PBEWithHmacSHA1AndAES_256, init$, void)},
		{}
	};
	...
	$loadClass(PBEKeyFactory$PBEWithHmacSHA1AndAES_256, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBEKeyFactory$PBEWithHmacSHA1AndAES_256);
	});
	return class$;
}
