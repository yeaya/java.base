...
$MethodInfo _KeyWrapCipher$AES192_KW_PKCS5Padding_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(KeyWrapCipher$AES192_KW_PKCS5Padding::*)()>(&KeyWrapCipher$AES192_KW_PKCS5Padding::init$))},
	{}
};

$InnerClassInfo _KeyWrapCipher$AES192_KW_PKCS5Padding_InnerClassesInfo_[] = {
...
$ClassInfo _KeyWrapCipher$AES192_KW_PKCS5Padding_ClassInfo_ = {
	$PUBLIC | $FINAL | $ACC_SUPER,
	"com.sun.crypto.provider.KeyWrapCipher$AES192_KW_PKCS5Padding",
	"com.sun.crypto.provider.KeyWrapCipher",
	nullptr,
	nullptr,
	_KeyWrapCipher$AES192_KW_PKCS5Padding_MethodInfo_,
	nullptr,
	nullptr,
	_KeyWrapCipher$AES192_KW_PKCS5Padding_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"com.sun.crypto.provider.KeyWrapCipher"
...
$Object* allocate$KeyWrapCipher$AES192_KW_PKCS5Padding($Class* clazz) {
	return $of($alloc(KeyWrapCipher$AES192_KW_PKCS5Padding));
}
...
KeyWrapCipher$AES192_KW_PKCS5Padding::KeyWrapCipher$AES192_KW_PKCS5Padding() {
}

$Class* KeyWrapCipher$AES192_KW_PKCS5Padding::load$($String* name, bool initialize) {
	$loadClass(KeyWrapCipher$AES192_KW_PKCS5Padding, name, initialize, &_KeyWrapCipher$AES192_KW_PKCS5Padding_ClassInfo_, allocate$KeyWrapCipher$AES192_KW_PKCS5Padding);
	return class$;
}

$Class* KeyWrapCipher$AES192_KW_PKCS5Padding::class$ = nullptr;
