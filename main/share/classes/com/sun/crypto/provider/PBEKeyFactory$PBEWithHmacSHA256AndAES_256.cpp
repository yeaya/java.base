...
$Class* PBEKeyFactory$PBEWithHmacSHA256AndAES_256::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBEKeyFactory$PBEWithHmacSHA256AndAES_256, init$, void)},
		{}
	};
	...
	$loadClass(PBEKeyFactory$PBEWithHmacSHA256AndAES_256, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBEKeyFactory$PBEWithHmacSHA256AndAES_256);
	});
	return class$;
}
