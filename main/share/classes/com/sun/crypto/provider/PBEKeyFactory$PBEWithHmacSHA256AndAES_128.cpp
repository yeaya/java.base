...
$Class* PBEKeyFactory$PBEWithHmacSHA256AndAES_128::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(PBEKeyFactory$PBEWithHmacSHA256AndAES_128, init$, void)},
		{}
	};
	...
	$loadClass(PBEKeyFactory$PBEWithHmacSHA256AndAES_128, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PBEKeyFactory$PBEWithHmacSHA256AndAES_128);
	});
	return class$;
}
