...
$Class* AESCipher$AES256_CBC_NoPadding::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(AESCipher$AES256_CBC_NoPadding, init$, void)},
		{}
	};
	...
	$loadClass(AESCipher$AES256_CBC_NoPadding, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AESCipher$AES256_CBC_NoPadding);
	});
	return class$;
}
