...
$InnerClassInfo _KeyWrapCipher$AES192_KWP_NoPadding_InnerClassesInfo_[] = {
...
$ClassInfo _KeyWrapCipher$AES192_KWP_NoPadding_ClassInfo_ = {
	$PUBLIC | $FINAL | $ACC_SUPER,
	"com.sun.crypto.provider.KeyWrapCipher$AES192_KWP_NoPadding",
	"com.sun.crypto.provider.KeyWrapCipher",
	nullptr,
	nullptr,
	_KeyWrapCipher$AES192_KWP_NoPadding_MethodInfo_,
	nullptr,
	nullptr,
	_KeyWrapCipher$AES192_KWP_NoPadding_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"com.sun.crypto.provider.KeyWrapCipher"
...
$Object* allocate$KeyWrapCipher$AES192_KWP_NoPadding($Class* clazz) {
	return $of($alloc(KeyWrapCipher$AES192_KWP_NoPadding));
}

void KeyWrapCipher$AES192_KWP_NoPadding::init$() {
	$KeyWrapCipher::init$($$new($AESKeyWrapPadded), nullptr, 24);
}

KeyWrapCipher$AES192_KWP_NoPadding::KeyWrapCipher$AES192_KWP_NoPadding() {
}

$Class* KeyWrapCipher$AES192_KWP_NoPadding::load$($String* name, bool initialize) {
	$loadClass(KeyWrapCipher$AES192_KWP_NoPadding, name, initialize, &_KeyWrapCipher$AES192_KWP_NoPadding_ClassInfo_, allocate$KeyWrapCipher$AES192_KWP_NoPadding);
	return class$;
}

$Class* KeyWrapCipher$AES192_KWP_NoPadding::class$ = nullptr;
