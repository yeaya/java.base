...
using $JIS_X_0208_Solaris$DecodeHolder = ::sun::nio::cs::JIS_X_0208_Solaris$DecodeHolder;
using $JIS_X_0208_Solaris$EncodeHolder = ::sun::nio::cs::JIS_X_0208_Solaris$EncodeHolder;
...
$InnerClassInfo _JIS_X_0208_Solaris_InnerClassesInfo_[] = {
	{"sun.nio.cs.JIS_X_0208_Solaris$EncodeHolder", "sun.nio.cs.JIS_X_0208_Solaris", "EncodeHolder", $STATIC},
	{"sun.nio.cs.JIS_X_0208_Solaris$DecodeHolder", "sun.nio.cs.JIS_X_0208_Solaris", "DecodeHolder", $STATIC},
	{}
};
...
$ClassInfo _JIS_X_0208_Solaris_ClassInfo_ = {
	...
	nullptr,
	nullptr,
	"sun.nio.cs.JIS_X_0208_Solaris$EncodeHolder,sun.nio.cs.JIS_X_0208_Solaris$DecodeHolder"
};
...
bool JIS_X_0208_Solaris::equals(Object$* ob) {
...
void JIS_X_0208_Solaris::init$() {
	$Charset::init$("x-JIS0208_Solaris"_s, $($StandardCharsets::aliases_JIS_X_0208_Solaris()));
}
