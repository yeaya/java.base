#ifndef _sun_nio_cs_PCK_h_
#define _sun_nio_cs_PCK_h_
//$ class sun.nio.cs.PCK
...
class $export PCK : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
