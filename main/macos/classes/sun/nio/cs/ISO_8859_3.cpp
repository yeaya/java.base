...
using $ISO_8859_3$Holder = ::sun::nio::cs::ISO_8859_3$Holder;
...
$InnerClassInfo _ISO_8859_3_InnerClassesInfo_[] = {
	{"sun.nio.cs.ISO_8859_3$Holder", "sun.nio.cs.ISO_8859_3", "Holder", $PRIVATE | $STATIC},
	{}
};
...
bool ISO_8859_3::equals(Object$* ob) {
...
void ISO_8859_3::init$() {
	$Charset::init$("ISO-8859-3"_s, $($StandardCharsets::aliases_ISO_8859_3()));
}
