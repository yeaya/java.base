...
class $export StandardCharsets : public ::java::nio::charset::spi::CharsetProvider {
...
public:
	...
	static $StringArray* aliases_Big5_HKSCS();
	static $StringArray* aliases_Big5_Solaris();
	static $StringArray* aliases_CESU_8();
	static $StringArray* aliases_EUC_CN();
	static $StringArray* aliases_EUC_JP();
	static $StringArray* aliases_EUC_JP_LINUX();
	static $StringArray* aliases_EUC_JP_Open();
	static $StringArray* aliases_EUC_KR();
	static $StringArray* aliases_EUC_TW();
	...
	static $StringArray* aliases_ISO_8859_11();
	...
	static $StringArray* aliases_ISO_8859_3();
	static $StringArray* aliases_ISO_8859_4();
	static $StringArray* aliases_ISO_8859_5();
	static $StringArray* aliases_ISO_8859_6();
	static $StringArray* aliases_ISO_8859_7();
	static $StringArray* aliases_ISO_8859_8();
	static $StringArray* aliases_ISO_8859_9();
	static $StringArray* aliases_JIS_X_0201();
	static $StringArray* aliases_JIS_X_0208();
	static $StringArray* aliases_JIS_X_0208_Solaris();
	static $StringArray* aliases_JIS_X_0212();
	static $StringArray* aliases_JIS_X_0212_Solaris();
	...
	static $StringArray* aliases_PCK();
	static $StringArray* aliases_SJIS();
	static $StringArray* aliases_TIS_620();
