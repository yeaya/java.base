...
void StandardCharsets$Aliases::init($ObjectArray* ht) {
	...
	ht->set(393, $$new($ObjectArray, {
		$of("extended_unix_code_packed_format_for_japanese"_s),
		$of("euc-jp"_s)
	}));
	...
	ht->set(890, $$new($ObjectArray, {
		$of("iso_8859-6:1987"_s),
		$of("iso-8859-6"_s)
	}));
	ht->set(891, $$new($ObjectArray, {
		$of("csisolatinarabic"_s),
		$of("iso-8859-6"_s)
	}));
	...
	ht->set(984, $$new($ObjectArray, {
		$of("cseucpkdfmtjapanese"_s),
		$of("euc-jp"_s),
		$of($$new($ObjectArray, {
			$of("jis_c6226-1983"_s),
			$of("x-jis0208"_s)
		}))
	}));
