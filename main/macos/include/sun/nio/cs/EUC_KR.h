#ifndef _sun_nio_cs_EUC_KR_h_
#define _sun_nio_cs_EUC_KR_h_
...
class $import EUC_KR : public ::java::nio::charset::Charset, public ::sun::nio::cs::HistoricallyNamedCharset {
