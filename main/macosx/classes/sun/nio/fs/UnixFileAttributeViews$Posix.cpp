...
$MethodInfo _UnixFileAttributeViews$Posix_MethodInfo_[] = {
	...
	{"<init>", "(Lsun/nio/fs/UnixPath;Z)V", nullptr, 0, $method(static_cast<void(UnixFileAttributeViews$Posix::*)($UnixPath*,bool)>(&UnixFileAttributeViews$Posix::init$))},
	{"addRequestedPosixAttributes", "(Ljava/nio/file/attribute/PosixFileAttributes;Lsun/nio/fs/AbstractBasicFileAttributeView$AttributesBuilder;)V", nullptr, $FINAL, $method(static_cast<void(UnixFileAttributeViews$Posix::*)($PosixFileAttributes*,$AbstractBasicFileAttributeView$AttributesBuilder*)>(&UnixFileAttributeViews$Posix::addRequestedPosixAttributes))},
	{"checkReadExtended", "()V", nullptr, $FINAL, $method(static_cast<void(UnixFileAttributeViews$Posix::*)()>(&UnixFileAttributeViews$Posix::checkReadExtended))},
	{"checkWriteExtended", "()V", nullptr, $FINAL, $method(static_cast<void(UnixFileAttributeViews$Posix::*)()>(&UnixFileAttributeViews$Posix::checkWriteExtended))},
	...
	{"readAttributes", "()Lsun/nio/fs/UnixFileAttributes;", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	...
	{"setMode", "(I)V", nullptr, $FINAL, $method(static_cast<void(UnixFileAttributeViews$Posix::*)(int32_t)>(&UnixFileAttributeViews$Posix::setMode)), "java.io.IOException"},
	{"setOwner", "(Ljava/nio/file/attribute/UserPrincipal;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"setOwners", "(II)V", nullptr, $FINAL, $method(static_cast<void(UnixFileAttributeViews$Posix::*)(int32_t,int32_t)>(&UnixFileAttributeViews$Posix::setOwners)), "java.io.IOException"},
