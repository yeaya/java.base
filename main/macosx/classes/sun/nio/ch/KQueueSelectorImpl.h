#ifndef _sun_nio_ch_KQueueSelectorImpl_h_
#define _sun_nio_ch_KQueueSelectorImpl_h_
//$ class sun.nio.ch.KQueueSelectorImpl
//$ extends sun.nio.ch.SelectorImpl

#include <sun/nio/ch/SelectorImpl.h>

#pragma push_macro("MAX_KEVENTS")
#undef MAX_KEVENTS
...
class KQueueSelectorImpl : public ::sun::nio::ch::SelectorImpl {
	$class(KQueueSelectorImpl, 0, ::sun::nio::ch::SelectorImpl)
public:
	KQueueSelectorImpl();
	...
	static const int32_t MAX_KEVENTS = 256;
	int32_t kqfd = 0;
...
#pragma pop_macro("MAX_KEVENTS")

#endif // _sun_nio_ch_KQueueSelectorImpl_h_