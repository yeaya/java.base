...
#undef sun_nio_fs_UnixNativeDispatcher_SUPPORTS_FUTIMENS
#define sun_nio_fs_UnixNativeDispatcher_SUPPORTS_FUTIMENS 8L
#undef sun_nio_fs_UnixNativeDispatcher_SUPPORTS_LUTIMES
#define sun_nio_fs_UnixNativeDispatcher_SUPPORTS_LUTIMES 16L
#undef sun_nio_fs_UnixNativeDispatcher_SUPPORTS_XATTR
#define sun_nio_fs_UnixNativeDispatcher_SUPPORTS_XATTR 32L
 ...
 * Signature: (IJJ)V
 */
JNIEXPORT void JNICALL Java_sun_nio_fs_UnixNativeDispatcher_futimens
  (JNIEnv *, jclass, jint, jlong, jlong);
 ...
 * Signature: (JJJ)V
 */
JNIEXPORT void JNICALL Java_sun_nio_fs_UnixNativeDispatcher_lutimes0
  (JNIEnv *, jclass, jlong, jlong, jlong);
