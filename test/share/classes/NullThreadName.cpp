...
$MethodInfo _NullThreadName_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(NullThreadName::*)()>(&NullThreadName::init$))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&NullThreadName::main)), "java.lang.Exception"},
	{}
};
