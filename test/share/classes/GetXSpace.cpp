...
$MethodInfo _GetXSpace_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(GetXSpace::*)()>(&GetXSpace::init$))},
	{"allow", "(Ljava/nio/file/Path;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($Path*)>(&GetXSpace::allow)), "java.io.IOException"},
	{"compare", "(LGetXSpace$Space;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($GetXSpace$Space*)>(&GetXSpace::compare))},
	{"compareZeroExist", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&GetXSpace::compareZeroExist))},
	{"compareZeroNonExist", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&GetXSpace::compareZeroNonExist))},
	{"deny", "(Ljava/nio/file/Path;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($Path*)>(&GetXSpace::deny)), "java.io.IOException"},
	{"fail", "(Ljava/lang/String;)V", nullptr, $STATIC, $method(static_cast<void(*)($String*)>(&GetXSpace::fail))},
	{"fail", "(Ljava/lang/String;JLjava/lang/String;J)V", nullptr, $STATIC, $method(static_cast<void(*)($String*,int64_t,$String*,int64_t)>(&GetXSpace::fail))},
	{"fail", "(Ljava/lang/String;Ljava/lang/Class;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*,$Class*)>(&GetXSpace::fail))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&GetXSpace::main)), "java.lang.Exception"},
	{"pass", "()V", nullptr, $STATIC, $method(static_cast<void(*)()>(&GetXSpace::pass))},
	{"perms", "(Ljava/io/File;Z)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($File*,bool)>(&GetXSpace::perms)), "java.io.IOException"},
	{"reset", "()V", nullptr, $STATIC, $method(static_cast<void(*)()>(&GetXSpace::reset))},
	{"setFirst", "(Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*)>(&GetXSpace::setFirst))},
	{"space", "(Ljava/lang/String;)Ljava/util/ArrayList;", "(Ljava/lang/String;)Ljava/util/ArrayList<LGetXSpace$Space;>;", $PRIVATE | $STATIC, $method(static_cast<$ArrayList*(*)($String*)>(&GetXSpace::space)), "java.io.IOException"},
	{"testDF", "()I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)()>(&GetXSpace::testDF))},
	{"testFile", "(Ljava/nio/file/Path;)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($Path*)>(&GetXSpace::testFile))},
	{"tryCatch", "(LGetXSpace$Space;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($GetXSpace$Space*)>(&GetXSpace::tryCatch))},
	{}
};
