#ifndef _tck_java_time_MockSimplePeriod_h_
#define _tck_java_time_MockSimplePeriod_h_
//$ class tck.java.time.MockSimplePeriod
...
public:
	...
	int32_t compareTo(::tck::java::time::MockSimplePeriod* otherPeriod);
	...
	static ::tck::java::time::MockSimplePeriod* of(int64_t amount, ::java::time::temporal::TemporalUnit* unit);
	virtual ::java::time::temporal::Temporal* subtractFrom(::java::time::temporal::Temporal* temporal) override;
	virtual $String* toString() override;
	static ::tck::java::time::MockSimplePeriod* ZERO_DAYS;
	static ::tck::java::time::MockSimplePeriod* ZERO_SECONDS;
	int64_t amount = 0;
...
#endif // _tck_java_time_MockSimplePeriod_h_