...
$MethodInfo _OpsAfterClose4DataInputStream$9_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(static_cast<void(OpsAfterClose4DataInputStream$9::*)($String*,int32_t)>(&OpsAfterClose4DataInputStream$9::init$))},
