...
$Class* OpsAfterClose4FileOutputStream$6::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(OpsAfterClose4FileOutputStream$6, init$, void, $String*, int32_t)},
		{"check", "(Ljava/io/FileOutputStream;)Z", nullptr, 0, $virtualMethod(OpsAfterClose4FileOutputStream$6, check, bool, $FileOutputStream*)},
		{}
	};
	...
	$loadClass(OpsAfterClose4FileOutputStream$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
