...
$Class* OpsAfterClose4InputStream$9::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(OpsAfterClose4InputStream$9, init$, void, $String*, int32_t)},
		{"check", "(Ljava/io/InputStream;)Z", nullptr, 0, $virtualMethod(OpsAfterClose4InputStream$9, check, bool, $InputStream*)},
		{}
	};
	...
	$loadClass(OpsAfterClose4InputStream$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
