...
$Class* PublicSuper::load$($String* name, bool initialize) {
	...
	$loadClass(PublicSuper, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PublicSuper);
	});
	return class$;
}
