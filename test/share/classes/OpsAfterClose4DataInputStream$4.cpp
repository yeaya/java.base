...
$MethodInfo _OpsAfterClose4DataInputStream$4_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(static_cast<void(OpsAfterClose4DataInputStream$4::*)($String*,int32_t)>(&OpsAfterClose4DataInputStream$4::init$))},
