...
void ExceedMaxDim4Array::newInstanceOne() {
	...
	try {
		$assign(o, $1Array::newInstance($nc(o)->getClass(), 1));
...
void ExceedMaxDim4Array::newInstanceMulti() {
	...
	$var($Object, o, getArrayOf256Dimensions());
	try {
		$assign(o, $1Array::newInstance($nc(o)->getClass(), $$new($ints, {
			1,
			1
		})));
		$assign(o, $1Array::newInstance(o->getClass(), $$new($ints, {1})));
	} catch ($IllegalArgumentException& iae) {
...
$Object* ExceedMaxDim4Array::getArrayOf256Dimensions() {
	...
	for (int32_t i = 1; i <= 254; ++i) {
		$assign(o, $1Array::newInstance(o->getClass(), 1));
	}
	return o;
}
...
$Class* ExceedMaxDim4Array::load$($String* name, bool initialize) {
	...
	$loadClass(ExceedMaxDim4Array, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ExceedMaxDim4Array);
	});
	return class$;
}
