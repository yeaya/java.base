...
$Class* LambdaSerialization$$Lambda$lambda$main$344202ae$1::load$($String* name, bool initialize) {
	...
	$loadClass(LambdaSerialization$$Lambda$lambda$main$344202ae$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LambdaSerialization$$Lambda$lambda$main$344202ae$1);
	});
	return class$;
}
...
$Class* LambdaSerialization$$Lambda$lambda$main$344202ae$2$1::load$($String* name, bool initialize) {
	...
	$loadClass(LambdaSerialization$$Lambda$lambda$main$344202ae$2$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LambdaSerialization$$Lambda$lambda$main$344202ae$2$1);
	});
	return class$;
}
...
$Class* LambdaSerialization$$Lambda$lambda$main$344202ae$3$2::load$($String* name, bool initialize) {
	...
	$loadClass(LambdaSerialization$$Lambda$lambda$main$344202ae$3$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LambdaSerialization$$Lambda$lambda$main$344202ae$3$2);
	});
	return class$;
}
...
void LambdaSerialization::main($StringArray* args) {
	...
	try {
		...
		write(out, $$new(LambdaSerialization$$Lambda$lambda$main$344202ae$1));
		write(out, $$new(LambdaSerialization$$Lambda$lambda$main$344202ae$2$1));
		write(out, $$new(LambdaSerialization$$Lambda$lambda$main$344202ae$3$2));
		out->flush();
		out->close();
		...
		case 0:
			{
				...
				bool var$0 = var$1 && $$nc(lambda->getImplClass())->equals("LambdaSerialization"_s);
				if (var$0 && $$nc(lambda->getImplMethodSignature())->equals("(Ljava/lang/String;)Ljava/lang/String;"_s)) {
					return $new(LambdaSerialization$$Lambda$lambda$main$344202ae$3$2);
				}
				break;
			}
		case 1:
			{
				...
				bool var$8 = var$9 && $$nc(lambda->getFunctionalInterfaceClass())->equals("LSI"_s);
				bool var$7 = var$8 && $$nc(lambda->getFunctionalInterfaceMethodName())->equals("convert"_s);
				bool var$6 = var$7 && $$nc(lambda->getFunctionalInterfaceMethodSignature())->equals("(Ljava/lang/String;)Ljava/lang/String;"_s);
				bool var$5 = var$6 && $$nc(lambda->getImplClass())->equals("LambdaSerialization"_s);
				if (var$5 && $$nc(lambda->getImplMethodSignature())->equals("(Ljava/lang/String;)Ljava/lang/String;"_s)) {
					return $new(LambdaSerialization$$Lambda$lambda$main$344202ae$2$1);
				}
				break;
			}
		case 2:
			{
				...
				bool var$13 = var$14 && $$nc(lambda->getFunctionalInterfaceClass())->equals("LSI"_s);
				bool var$12 = var$13 && $$nc(lambda->getFunctionalInterfaceMethodName())->equals("convert"_s);
				bool var$11 = var$12 && $$nc(lambda->getFunctionalInterfaceMethodSignature())->equals("(Ljava/lang/String;)Ljava/lang/String;"_s);
				bool var$10 = var$11 && $$nc(lambda->getImplClass())->equals("LambdaSerialization"_s);
				if (var$10 && $$nc(lambda->getImplMethodSignature())->equals("(Ljava/lang/String;)Ljava/lang/String;"_s)) {
					return $new(LambdaSerialization$$Lambda$lambda$main$344202ae$1);
				}
				break;
			}
		}
...
void LambdaSerialization::clinit$($Class* clazz) {
...
$Class* LambdaSerialization::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("LambdaSerialization$$Lambda$lambda$main$344202ae$1")) {
			return LambdaSerialization$$Lambda$lambda$main$344202ae$1::load$(name, initialize);
		}
		if (name->equals("LambdaSerialization$$Lambda$lambda$main$344202ae$2$1")) {
			return LambdaSerialization$$Lambda$lambda$main$344202ae$2$1::load$(name, initialize);
		}
		if (name->equals("LambdaSerialization$$Lambda$lambda$main$344202ae$3$2")) {
	...
	$loadClass(LambdaSerialization, name, initialize, &classInfo$$, LambdaSerialization::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(LambdaSerialization);
	});
	return class$;
}
