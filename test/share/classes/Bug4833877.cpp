...
void Bug4833877::main($StringArray* args) {
	...
	Bug4833877::df->setMaximumFractionDigits(50);
	Bug4833877::df->setMultiplier(4);
	...
	checkFormat($($Long::valueOf(1000)), "4,000"_s);
	checkParse("-4,000"_s, $($Long::valueOf(-1000)));
	checkFormat($($Long::valueOf(-250)), "-1,000"_s);
	checkParse("1000"_s, $($Long::valueOf(250)));
	...
	checkFormat($($Double::valueOf(-3333.3333333)), "9,999.9999999"_s);
	checkParse("10,000.00000000000"_s, $($Long::valueOf(-3333)));
	$nc(Bug4833877::df)->setParseIntegerOnly(false);
	checkFormat($($Double::valueOf(-3333.3333333)), "9,999.9999999"_s);
	checkParse("10,000.00000000000"_s, $($Double::valueOf(-3333.3333333333335)));
	checkFormat($($Long::valueOf(3333)), "-9,999"_s);
	$nc(Bug4833877::df)->setParseIntegerOnly(true);
	checkParse("-10,000"_s, $($Long::valueOf(3333)));
	$nc(Bug4833877::df)->setParseIntegerOnly(false);
	...
	checkParse("8888.8888"_s, $($Double::valueOf(2222.2222)));
	checkFormat($($Long::valueOf(1000)), "4E3"_s);
	checkParse("-4E3"_s, $($Long::valueOf(-1000)));
	checkFormat($($Long::valueOf(-250)), "-1E3"_s);
	checkParse("1000"_s, $($Long::valueOf(250)));
	$nc(Bug4833877::df)->setParseBigDecimal(true);
	...
	$nc(Bug4833877::df)->setParseIntegerOnly(true);
	checkFormat($($Double::valueOf(-3333.3333333)), "9.9999999999E3"_s);
	checkParse("10.00000000000000E3"_s, $($Long::valueOf(-3)));
	$nc(Bug4833877::df)->setParseIntegerOnly(false);
	checkFormat($($Double::valueOf(-3333.3333333)), "9.9999999999E3"_s);
	checkParse("10.00000000000000E3"_s, $($Double::valueOf(-3333.3333333333335)));
	checkFormat($($Long::valueOf(3333)), "-9.999E3"_s);
	$nc(Bug4833877::df)->setParseIntegerOnly(true);
	...
	checkFormat($($Long::valueOf(-3333)), "9.999E3"_s);
	$nc(Bug4833877::df)->setParseIntegerOnly(true);
	checkParse("10.0E4"_s, $($Long::valueOf(-3)));
	$nc(Bug4833877::df)->setParseIntegerOnly(false);
...
void Bug4833877::checkFormat($Number* num, $String* expected) {
	...
	if (!$nc(got)->equals(expected)) {
		...
		var$0->append(num);
		var$0->append("\n\tpattern:    "_s);
		var$0->append($(Bug4833877::df->toPattern()));
		var$0->append("\n\tmultiplier: "_s);
		var$0->append(Bug4833877::df->getMultiplier());
		var$0->append("\n\tgot:        "_s);
		var$0->append(got);
		var$0->append("\n\texpected:   "_s);
...
void Bug4833877::checkParse($String* text, $Double* expected) {
	...
	if (!$nc(got)->equals(expected)) {
		Bug4833877::err = true;
		$var($StringBuilder, var$0, $new($StringBuilder));
		var$0->append("    DecimalFormat parse(double) error:\n\ttext:       "_s);
		var$0->append(text);
		var$0->append("\n\tpattern:    "_s);
		var$0->append($(Bug4833877::df->toPattern()));
		var$0->append("\n\tmultiplier: "_s);
...
void Bug4833877::checkParse($String* text, $Long* expected) {
	...
	if (!$nc(got)->equals(expected)) {
		Bug4833877::err = true;
		$var($StringBuilder, var$0, $new($StringBuilder));
		var$0->append("    DecimalFormat parse(long) error:\n\ttext:       "_s);
		var$0->append(text);
		var$0->append("\n\tpattern:    "_s);
		var$0->append($(Bug4833877::df->toPattern()));
		var$0->append("\n\tmultiplier: "_s);
...
void Bug4833877::checkParse($String* text, $BigDecimal* expected) {
	...
	if (!$nc(got)->equals(expected)) {
		Bug4833877::err = true;
		$var($StringBuilder, var$0, $new($StringBuilder));
		var$0->append("    DecimalFormat parse(BigDecimal) error:\n\ttext:       "_s);
		var$0->append(text);
		var$0->append("\n\tpattern:    "_s);
		var$0->append($(Bug4833877::df->toPattern()));
		var$0->append("\n\tmultiplier: "_s);
...
void Bug4833877::clinit$($Class* clazz) {
...
$Class* Bug4833877::load$($String* name, bool initialize) {
	...
	$loadClass(Bug4833877, name, initialize, &classInfo$$, Bug4833877::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Bug4833877);
	});
	return class$;
}
