#ifndef _UniTest_ArrayTypesWithDefault_h_
#define _UniTest_ArrayTypesWithDefault_h_
//$ interface UniTest.ArrayTypesWithDefault
...
class ArrayTypesWithDefault : public ::java::lang::annotation::Annotation {
	$interface(ArrayTypesWithDefault, $NO_CLASS_INIT, ::java::lang::annotation::Annotation)
public:
...
#endif // _UniTest_ArrayTypesWithDefault_h_