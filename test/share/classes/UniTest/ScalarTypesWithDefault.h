#ifndef _UniTest_ScalarTypesWithDefault_h_
#define _UniTest_ScalarTypesWithDefault_h_
//$ interface UniTest.ScalarTypesWithDefault
...
class ScalarTypesWithDefault : public ::java::lang::annotation::Annotation {
	$interface(ScalarTypesWithDefault, $NO_CLASS_INIT, ::java::lang::annotation::Annotation)
public:
...
#endif // _UniTest_ScalarTypesWithDefault_h_