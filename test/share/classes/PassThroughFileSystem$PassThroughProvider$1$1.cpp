...
$Class* PassThroughFileSystem$PassThroughProvider$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(PassThroughFileSystem$PassThroughProvider$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PassThroughFileSystem$PassThroughProvider$1$1);
	});
	return class$;
}
