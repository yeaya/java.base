...
$Class* OpsAfterClose4DataInputStream$5::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(OpsAfterClose4DataInputStream$5, init$, void, $String*, int32_t)},
		{"check", "(Ljava/io/DataInputStream;)Z", nullptr, 0, $virtualMethod(OpsAfterClose4DataInputStream$5, check, bool, $DataInputStream*)},
		{}
	};
	...
	$loadClass(OpsAfterClose4DataInputStream$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
