...
void ParameterCheck::doTest($String* method) {
	...
	try {
		...
		$System::err->println($$str({"\nRandomAccessFile."_s, method, "\nTotal test cases = "_s, $$str((ParameterCheck::off->length + 1))}));
...
void ParameterCheck::printErr($String* method, int32_t numGood, int32_t i, $String* expStr) {
	...
	if (i < 0) {
		$System::err->println("for case : b = null"_s);
	} else {
		$System::err->println($$str({"for case : b.length = "_s, $$str(32), " off = "_s, $$str($nc(ParameterCheck::off)->get(i)), " len = "_s, $$str($nc(ParameterCheck::len)->get(i))}));
	}
}
...
void ParameterCheck::clinit$($Class* clazz) {
...
$Class* ParameterCheck::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(ParameterCheck, init$, void)},
		{"doTest", "(Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $staticMethod(ParameterCheck, doTest, void, $String*), "java.lang.Exception"},
		{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $staticMethod(ParameterCheck, main, void, $StringArray*), "java.lang.Exception"},
		{"printErr", "(Ljava/lang/String;IILjava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $staticMethod(ParameterCheck, printErr, void, $String*, int32_t, int32_t, $String*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$PUBLIC | $ACC_SUPER,
	...
	$loadClass(ParameterCheck, name, initialize, &classInfo$$, ParameterCheck::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ParameterCheck);
	});
	return class$;
}
