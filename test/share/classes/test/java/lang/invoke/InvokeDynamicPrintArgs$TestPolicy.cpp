...
void InvokeDynamicPrintArgs$TestPolicy::clinit$($Class* clazz) {
...
$Class* InvokeDynamicPrintArgs$TestPolicy::load$($String* name, bool initialize) {
	...
	$loadClass(InvokeDynamicPrintArgs$TestPolicy, name, initialize, &classInfo$$, InvokeDynamicPrintArgs$TestPolicy::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(InvokeDynamicPrintArgs$TestPolicy);
	});
	return class$;
}
