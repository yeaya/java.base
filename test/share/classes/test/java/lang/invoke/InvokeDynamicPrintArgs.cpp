...
$MethodInfo _InvokeDynamicPrintArgs_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(InvokeDynamicPrintArgs::*)()>(&InvokeDynamicPrintArgs::init$))},
	{"INDY_bar", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::INDY_bar)), "java.lang.Throwable"},
	{"INDY_bar2", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::INDY_bar2)), "java.lang.Throwable"},
	{"INDY_baz", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::INDY_baz)), "java.lang.Throwable"},
	{"INDY_foo", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::INDY_foo)), "java.lang.Throwable"},
	{"INDY_nothing", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::INDY_nothing)), "java.lang.Throwable"},
	{"MH_bsm", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::MH_bsm)), "java.lang.ReflectiveOperationException"},
	{"MH_bsm2", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::MH_bsm2)), "java.lang.ReflectiveOperationException"},
	{"MH_printArgs", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::MH_printArgs)), "java.lang.ReflectiveOperationException"},
	{"MT_bsm", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&InvokeDynamicPrintArgs::MT_bsm))},
	{"MT_bsm2", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&InvokeDynamicPrintArgs::MT_bsm2))},
	{"assertEquals", "(Ljava/lang/Object;Ljava/lang/Object;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)(Object$*,Object$*)>(&InvokeDynamicPrintArgs::assertEquals))},
	{"bsm", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$CallSite*(*)($MethodHandles$Lookup*,$String*,$MethodType*)>(&InvokeDynamicPrintArgs::bsm)), "java.lang.ReflectiveOperationException"},
	{"bsm2", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;", nullptr, $PRIVATE | $STATIC | $TRANSIENT, $method(static_cast<$CallSite*(*)($MethodHandles$Lookup*,$String*,$MethodType*,$ObjectArray*)>(&InvokeDynamicPrintArgs::bsm2)), "java.lang.Throwable"},
	{"checkConstantRefs", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&InvokeDynamicPrintArgs::checkConstantRefs)), "java.lang.Throwable"},
	{"closeBuf", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&InvokeDynamicPrintArgs::closeBuf))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC | $TRANSIENT, $method(static_cast<void(*)($StringArray*)>(&InvokeDynamicPrintArgs::main)), "java.lang.Throwable"},
	{"non_MH_bsm", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&InvokeDynamicPrintArgs::non_MH_bsm)), "java.lang.ReflectiveOperationException"},
	{"openBuf", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&InvokeDynamicPrintArgs::openBuf))},
	{"printArgs", "(Ljava/lang/Object;[Ljava/lang/Object;)V", nullptr, $PRIVATE | $STATIC | $TRANSIENT, $method(static_cast<void(*)(Object$*,$ObjectArray*)>(&InvokeDynamicPrintArgs::printArgs))},
	{"setSM", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&InvokeDynamicPrintArgs::setSM))},
	{"shouldNotCallThis", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&InvokeDynamicPrintArgs::shouldNotCallThis))},
	{}
};
