...
$MethodInfo _MethodHandleConstants_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(MethodHandleConstants::*)()>(&MethodHandleConstants::init$))},
	{"MH_Class_forName_S", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&MethodHandleConstants::MH_Class_forName_S)), "java.lang.ReflectiveOperationException"},
	{"MH_Class_forName_SbCL", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&MethodHandleConstants::MH_Class_forName_SbCL)), "java.lang.ReflectiveOperationException"},
	{"MH_MethodHandle_invokeExact_SC2", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&MethodHandleConstants::MH_MethodHandle_invokeExact_SC2)), "java.lang.ReflectiveOperationException"},
	{"MH_MethodHandle_invoke_SC2", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&MethodHandleConstants::MH_MethodHandle_invoke_SC2)), "java.lang.ReflectiveOperationException"},
	{"MH_String_replace_C2", "()Ljava/lang/invoke/MethodHandle;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodHandle*(*)()>(&MethodHandleConstants::MH_String_replace_C2)), "java.lang.ReflectiveOperationException"},
	{"MT_Class_forName_S", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&MethodHandleConstants::MT_Class_forName_S))},
	{"MT_Class_forName_SbCL", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&MethodHandleConstants::MT_Class_forName_SbCL))},
	{"MT_MethodHandle_invokeExact_SC2", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&MethodHandleConstants::MT_MethodHandle_invokeExact_SC2))},
	{"MT_MethodHandle_invoke_SC2", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&MethodHandleConstants::MT_MethodHandle_invoke_SC2))},
	{"MT_String_replace_C2", "()Ljava/lang/invoke/MethodType;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodType*(*)()>(&MethodHandleConstants::MT_String_replace_C2))},
	{"assertEquals", "(Ljava/lang/Object;Ljava/lang/Object;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)(Object$*,Object$*)>(&MethodHandleConstants::assertEquals))},
	{"closeBuf", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&MethodHandleConstants::closeBuf))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC | $TRANSIENT, $method(static_cast<void(*)($StringArray*)>(&MethodHandleConstants::main)), "java.lang.Throwable"},
	{"openBuf", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&MethodHandleConstants::openBuf))},
	{"setSM", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&MethodHandleConstants::setSM))},
	{"shouldNotCallThis", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&MethodHandleConstants::shouldNotCallThis))},
	{"testCase", "(Ljava/lang/invoke/MethodHandle;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;)V", "(Ljava/lang/invoke/MethodHandle;Ljava/lang/Class<*>;Ljava/lang/String;Ljava/lang/Class<*>;[Ljava/lang/Class<*>;)V", $PRIVATE | $STATIC | $TRANSIENT, $method(static_cast<void(*)($MethodHandle*,$Class*,$String*,$Class*,$ClassArray*)>(&MethodHandleConstants::testCase)), "java.lang.Throwable"},
	{}
};
