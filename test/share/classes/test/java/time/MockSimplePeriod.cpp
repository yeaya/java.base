...
$MethodInfo _MockSimplePeriod_MethodInfo_[] = {
	...
	{"compareTo", "(Ltest/java/time/MockSimplePeriod;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(MockSimplePeriod::*)(MockSimplePeriod*)>(&MockSimplePeriod::compareTo))},
	...
	{"of", "(JLjava/time/temporal/TemporalUnit;)Ltest/java/time/MockSimplePeriod;", nullptr, $PUBLIC | $STATIC, $method(static_cast<MockSimplePeriod*(*)(int64_t,$TemporalUnit*)>(&MockSimplePeriod::of))},
