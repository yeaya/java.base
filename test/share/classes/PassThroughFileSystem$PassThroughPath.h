#ifndef _PassThroughFileSystem$PassThroughPath_h_
#define _PassThroughFileSystem$PassThroughPath_h_
...
class PassThroughFileSystem$PassThroughPath : public ::java::nio::file::Path {
	$class(PassThroughFileSystem$PassThroughPath, $NO_CLASS_INIT, ::java::nio::file::Path)
public:
	PassThroughFileSystem$PassThroughPath();
	void init$(::java::nio::file::FileSystem* fs, ::java::nio::file::Path* delegate);
	...
	::java::nio::file::Path* wrap(::java::nio::file::Path* path);
	::java::nio::file::FileSystem* fs = nullptr;
	::java::nio::file::Path* delegate = nullptr;
};

#endif // _PassThroughFileSystem$PassThroughPath_h_