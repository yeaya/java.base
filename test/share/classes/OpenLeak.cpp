...
$MethodInfo _OpenLeak_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(OpenLeak::*)()>(&OpenLeak::init$))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&OpenLeak::main)), "java.lang.Exception"},
	{}
};
