...
$MethodInfo _OpsAfterClose4RandomAccessFile$2_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(static_cast<void(OpsAfterClose4RandomAccessFile$2::*)($String*,int32_t)>(&OpsAfterClose4RandomAccessFile$2::init$))},
