...
$Class* StaticInterfaceMethodInWayOfDefault$V2ClassLoader::load$($String* name, bool initialize) {
	...
	$loadClass(StaticInterfaceMethodInWayOfDefault$V2ClassLoader, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StaticInterfaceMethodInWayOfDefault$V2ClassLoader);
	});
	return class$;
}
