...
void PrivateInterfaceCall$I3::invokeInterfaceMH($PrivateInterfaceCall$I2* i) {
	...
	$nc($PrivateInterfaceCall::mh_I2_priv_m_from_I3)->invokeExact($$new($ObjectArray, {i}));
}
...
$Class* PrivateInterfaceCall$I3::load$($String* name, bool initialize) {
	...
	$loadClass(PrivateInterfaceCall$I3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PrivateInterfaceCall$I3);
	});
	return class$;
}
