...
$MethodInfo _OpsAfterClose4FileInputStream$4_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;I)V", nullptr, $PRIVATE, $method(static_cast<void(OpsAfterClose4FileInputStream$4::*)($String*,int32_t)>(&OpsAfterClose4FileInputStream$4::init$))},
