...
void Supplementary4String::test1() {
	$init(Supplementary4String);
	$useLocalObjectStack();
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, s, Supplementary4String::input->get(i));
		testCodePoint(Supplementary4String::At, s, 0, $nc(Supplementary4String::golden1->get(0))->get(i));
		testCodePoint(Supplementary4String::At, s, 9, $nc(Supplementary4String::golden1->get(1))->get(i));
		testCodePoint(Supplementary4String::At, s, $nc(s)->length() - 1, $nc(Supplementary4String::golden1->get(2))->get(i));
		testCodePoint(Supplementary4String::At, $(s->substring(17)), 0, $nc(Supplementary4String::golden1->get(3))->get(i));
		testCodePoint(Supplementary4String::At, s, -1);
		testCodePoint(Supplementary4String::At, s, s->length());
	}
}
...
void Supplementary4String::test2() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, s, Supplementary4String::input->get(i));
		testCodePoint(Supplementary4String::Before, s, 1, $nc(Supplementary4String::golden2->get(0))->get(i));
		testCodePoint(Supplementary4String::Before, s, 13, $nc(Supplementary4String::golden2->get(1))->get(i));
		testCodePoint(Supplementary4String::Before, s, $nc(s)->length(), $nc(Supplementary4String::golden2->get(2))->get(i));
		testCodePoint(Supplementary4String::Before, $(s->substring(1)), 1, $nc(Supplementary4String::golden2->get(3))->get(i));
		testCodePoint(Supplementary4String::Before, s, 0);
		testCodePoint(Supplementary4String::Before, s, s->length() + 1);
	}
}
...
void Supplementary4String::test3() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, s, Supplementary4String::input->get(i));
		testIndexOf(s, $nc(Supplementary4String::golden3->get(i))->get(0), $nc(Supplementary4String::golden3->get(i))->get(2));
		testIndexOf(s, u'Z', -1);
...
void Supplementary4String::test4() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, s, Supplementary4String::input->get(i));
		int32_t ch = $nc(Supplementary4String::golden3->get(i))->get(0);
		int32_t fromIndex = 0;
		for (int32_t j = 2; j < $nc(Supplementary4String::golden3->get(i))->length; ++j) {
			fromIndex = testIndexOf(s, fromIndex, ch, $nc(Supplementary4String::golden3->get(i))->get(j)) + 1;
		}
		testIndexOf(s, -1, ch, $nc(Supplementary4String::golden3->get(i))->get(2));
		testIndexOf(s, $nc(s)->length(), ch, $nc(Supplementary4String::golden3->get(i))->get($nc(Supplementary4String::golden3->get(i))->length - 1));
...
void Supplementary4String::test5() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, s, Supplementary4String::input->get(i));
		testLastIndexOf(s, $nc(Supplementary4String::golden3->get(i))->get(0), $nc(Supplementary4String::golden3->get(i))->get($nc(Supplementary4String::golden3->get(i))->length - 2));
...
void Supplementary4String::test6() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		...
		for (int32_t j = $nc(Supplementary4String::golden3->get(i))->length - 2; j > 0; --j) {
			fromIndex = testLastIndexOf(s, fromIndex, ch, $nc(Supplementary4String::golden3->get(i))->get(j)) - 1;
		}
		testLastIndexOf(s, -1, ch, $nc(Supplementary4String::golden3->get(i))->get(1));
		testLastIndexOf(s, len, ch, $nc(Supplementary4String::golden3->get(i))->get($nc(Supplementary4String::golden3->get(i))->length - 2));
...
void Supplementary4String::test7() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		...
		int32_t mid = 0;
		int32_t offset = 0;
		for (int32_t j = 0; j < s->length(); j += $Character::charCount(c)) {
		...
		check(!s->equals(cps), $$str({"new String(int[]...) with input["_s, $$str(i), "]"_s}));
		$assign(cps, $new($String, codePoints, 0, offset));
		check(!$(s->substring(0, mid))->equals(cps), $$str({"first half: new String(int[]...) with input["_s, $$str(i), "]"_s}));
		$assign(cps, $new($String, codePoints, offset, count - offset));
		check(!$(s->substring(mid))->equals(cps), $$str({"second half: new String(int[]...) with input["_s, $$str(i), "]"_s}));
	...
	}
	{
		...
		for (int32_t i = 0, j = 0; i < x->length; ++i) {
...
void Supplementary4String::test8() {
	...
	$useLocalObjectStack();
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, str, Supplementary4String::input->get(i));
		int32_t length = $nc(str)->length();
		for (int32_t j = 0; j <= length; ++j) {
			int32_t result = str->codePointCount(j, length);
			int32_t expected = $Character::codePointCount(str, j, length);
		...
		for (int32_t j = length; j >= 0; --j) {
			...
			int32_t expected = $Character::codePointCount(str, 0, j);
...
void Supplementary4String::test9() {
	...
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		...
		int32_t length = $nc(str)->length();
		for (int32_t j = 0; j <= length; ++j) {
			int32_t nCodePoints = $Character::codePointCount(str, j, length);
		...
		for (int32_t j = length; j >= 0; --j) {
			int32_t nCodePoints = $Character::codePointCount(str, 0, j);
...
void Supplementary4String::test10() {
	$init(Supplementary4String);
	$useLocalObjectStack();
	$var($String, header, $cstr({'H', 0xd800, 'e', 0xdfff, 'a', 0x0010fc00, 'd', 'e', 'r', '<'}));
	for (int32_t i = 0; i < Supplementary4String::input->length; ++i) {
		$var($String, wholeString, $str({header, Supplementary4String::input->get(i)}));
		$var($String, str, wholeString->substring(header->length()));
...
void Supplementary4String::testCodePoint(bool isAt, $String* s, int32_t index, int32_t expected) {
	$init(Supplementary4String);
	$useLocalObjectStack();
	int32_t c = isAt ? $nc(s)->codePointAt(index) : $nc(s)->codePointBefore(index);
...
void Supplementary4String::testIndexOf($String* s, int32_t c, int32_t expected) {
	...
	if ($nc(s)->indexOf(c) != -1) {
		...
		if ($Character::isSupplementaryCodePoint(c)) {
			...
			testIndexOf2($$str({s, $$str(surrogates->get(1))}), c, expected);
			testIndexOf2($$str({$$new($String, surrogates), s}), c, 0);
			testIndexOf2($$str({$$str(surrogates->get(0)), s}), c, expected + 1);
			testIndexOf2($$str({$$str(surrogates->get(1)), s}), c, expected + 1);
		}
	}
}
...
void Supplementary4String::testLastIndexOf($String* s, int32_t c, int32_t expected) {
	...
	if ($nc(s)->lastIndexOf(c) != -1) {
		...
		if ($Character::isSupplementaryCodePoint(c)) {
			...
			testLastIndexOf2(var$0, c, s->length());
			testLastIndexOf2($$str({s, $$str($nc(surrogates)->get(0))}), c, expected);
			testLastIndexOf2($$str({s, $$str(surrogates->get(1))}), c, expected);
			testLastIndexOf2($$str({$$new($String, surrogates), s}), c, expected + 2);
			testLastIndexOf2($$str({$$str(surrogates->get(0)), s}), c, expected + 1);
			testLastIndexOf2($$str({$$str(surrogates->get(1)), s}), c, expected + 1);
		}
	}
}
...
void Supplementary4String::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$assignStatic(Supplementary4String::input, $new($StringArray, {
		...
		$cstr({0x00010000, 0x00010001, 0x00010002, 0x00010003, 0x00010004, 0x00010005, 0x00010006, 0x00010007, 0x00010008, 0x00010008, 0x00010009, 0x0001000a, 0x0001000b, 0x0001000c, 0x0001000d, 0x0001000a, 0x0001000f, 0x00010010})
	}));
...
$Class* Supplementary4String::load$($String* name, bool initialize) {
	...
	$loadClass(Supplementary4String, name, initialize, &classInfo$$, Supplementary4String::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Supplementary4String);
	});
	return class$;
}
