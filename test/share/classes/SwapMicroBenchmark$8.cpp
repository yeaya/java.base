...
void SwapMicroBenchmark$8::work() {
	...
	$var($LongBuffer, x, this->val$b->asLongBuffer());
...
$Class* SwapMicroBenchmark$8::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;Ljava/nio/ByteBuffer;I)V", nullptr, 0, $method(SwapMicroBenchmark$8, init$, void, $String*, $ByteBuffer*, int32_t)},
		{"work", "()V", nullptr, $PUBLIC, $virtualMethod(SwapMicroBenchmark$8, work, void), "java.lang.Throwable"},
		{}
	};
	...
	$loadClass(SwapMicroBenchmark$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SwapMicroBenchmark$8);
	});
	return class$;
}
