...
$MethodInfo _SwapMicroBenchmark$3_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;Ljava/nio/ByteBuffer;I)V", nullptr, 0, $method(static_cast<void(SwapMicroBenchmark$3::*)($String*,$ByteBuffer*,int32_t)>(&SwapMicroBenchmark$3::init$))},
