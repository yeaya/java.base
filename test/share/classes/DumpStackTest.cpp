...
$Class* DumpStackTest$$Lambda$lambda$testLambda$0::load$($String* name, bool initialize) {
	...
	$loadClass(DumpStackTest$$Lambda$lambda$testLambda$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DumpStackTest$$Lambda$lambda$testLambda$0);
	});
	return class$;
}
...
$Class* DumpStackTest$$Lambda$lambda$assertStackTrace$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(DumpStackTest$$Lambda$lambda$assertStackTrace$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DumpStackTest$$Lambda$lambda$assertStackTrace$1$1);
	});
	return class$;
}
...
$Class* DumpStackTest$$Lambda$lambda$assertStackTrace$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(DumpStackTest$$Lambda$lambda$assertStackTrace$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DumpStackTest$$Lambda$lambda$assertStackTrace$2$2);
	});
	return class$;
}
...
void DumpStackTest::testLambda() {
	$var($Consumer, c, $new(DumpStackTest$$Lambda$lambda$testLambda$0));
	$nc(c)->accept(nullptr);
}
...
void DumpStackTest::assertStackTrace($StackTraceElementArray* actual, $DumpStackTest$CallFrameArray* expected) {
	...
	$$nc($Arrays::stream(actual))->forEach($$new(DumpStackTest$$Lambda$lambda$assertStackTrace$1$1));
	$System::out->println("--- Expected ---"_s);
	$$nc($Arrays::stream(expected))->forEach($$new(DumpStackTest$$Lambda$lambda$assertStackTrace$2$2));
	for (int32_t i = 0, j = 0; i < $nc(actual)->length; ++i) {
...
void DumpStackTest::assertEquals($StackTraceElement* actual, $DumpStackTest$CallFrame* expected, int32_t idx) {
	...
	bool var$0 = var$1 || !$$nc(actual->getFileName())->equals($(expected->getFileName()));
	if (var$0 || !$$nc(actual->getMethodName())->equals($(expected->getMethodName()))) {
...
$Class* DumpStackTest::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("DumpStackTest$$Lambda$lambda$testLambda$0")) {
			return DumpStackTest$$Lambda$lambda$testLambda$0::load$(name, initialize);
		}
		if (name->equals("DumpStackTest$$Lambda$lambda$assertStackTrace$1$1")) {
			return DumpStackTest$$Lambda$lambda$assertStackTrace$1$1::load$(name, initialize);
		}
		if (name->equals("DumpStackTest$$Lambda$lambda$assertStackTrace$2$2")) {
	...
	$loadClass(DumpStackTest, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DumpStackTest);
	});
	return class$;
}
